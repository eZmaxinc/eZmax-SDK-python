...
```python
import eZmaxApi
from eZmaxApi.models.customer_get_list_v1_response import CustomerGetListV1Response
from eZmaxApi.models.header_accept_language import HeaderAcceptLanguage
from eZmaxApi.rest import ApiException
from pprint import pprint
...
with eZmaxApi.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve Customer list
        api_response = api_instance.customer_get_list_v1(e_order_by=e_order_by, i_row_max=i_row_max, i_row_offset=i_row_offset, accept_language=accept_language, s_filter=s_filter)
        print("The response of ObjectCustomerApi->customer_get_list_v1:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ObjectCustomerApi->customer_get_list_v1: %s\n" % e)
```
...
with eZmaxApi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = eZmaxApi.ObjectCustomerApi(api_client)
    pki_customer_id = 56 # int | 
    customer_import_into_edmv1_request = eZmaxApi.CustomerImportIntoEDMV1Request() # CustomerImportIntoEDMV1Request | 

    try:
        # Import attachments into the Buyercontract
        api_response = api_instance.customer_import_into_edmv1(pki_customer_id, customer_import_into_edmv1_request)
        print("The response of ObjectCustomerApi->customer_import_into_edmv1:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ObjectCustomerApi->customer_import_into_edmv1: %s\n" % e)
```
