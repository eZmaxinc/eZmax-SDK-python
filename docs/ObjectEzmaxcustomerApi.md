...
with eZmaxApi.ApiClient(configuration) as api_client:
    ...
    api_instance = eZmaxApi.ObjectEzmaxcustomerApi(api_client)
    pki_ezmaxcustomer_id = 56 # int | The unique ID of the Ezmaxcustomer
    ezmaxcustomer_patch_object_v1_request = eZmaxApi.EzmaxcustomerPatchObjectV1Request() # EzmaxcustomerPatchObjectV1Request | 

    try:
        # Patch an existing Ezmaxcustomer
        api_response = api_instance.ezmaxcustomer_patch_object_v1(pki_ezmaxcustomer_id, ezmaxcustomer_patch_object_v1_request)
        print("The response of ObjectEzmaxcustomerApi->ezmaxcustomer_patch_object_v1:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ObjectEzmaxcustomerApi->ezmaxcustomer_patch_object_v1: %s\n" % e)
```
