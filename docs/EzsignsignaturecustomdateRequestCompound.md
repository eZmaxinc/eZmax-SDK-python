...
json = "{}"
# create an instance of EzsignsignaturecustomdateRequestCompound from a JSON string
ezsignsignaturecustomdate_request_compound_instance = EzsignsignaturecustomdateRequestCompound.from_json(json)
# print the JSON string representation of the object
print EzsignsignaturecustomdateRequestCompound.to_json()
