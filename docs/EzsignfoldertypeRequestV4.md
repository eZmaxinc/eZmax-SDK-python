...
```python
from eZmaxApi.models.ezsignfoldertype_request_v4 import EzsignfoldertypeRequestV4

# TODO update the JSON string below
json = "{}"
# create an instance of EzsignfoldertypeRequestV4 from a JSON string
ezsignfoldertype_request_v4_instance = EzsignfoldertypeRequestV4.from_json(json)
# print the JSON string representation of the object
print(EzsignfoldertypeRequestV4.to_json())

# convert the object into a dict
ezsignfoldertype_request_v4_dict = ezsignfoldertype_request_v4_instance.to_dict()
# create an instance of EzsignfoldertypeRequestV4 from a dict
ezsignfoldertype_request_v4_from_dict = EzsignfoldertypeRequestV4.from_dict(ezsignfoldertype_request_v4_dict)
```
