...
> FranchiseofficeGetAutocompleteV2Response franchiseoffice_get_autocomplete_v2(s_selector, e_filter_active=e_filter_active, s_query=s_query, accept_language=accept_language)
...
with eZmaxApi.ApiClient(configuration) as api_client:
    ...
    api_instance = eZmaxApi.ObjectFranchiseofficeApi(api_client)
    s_selector = 's_selector_example' # str | The type of Franchiseoffices to return
    ...
    try:
        # Retrieve Franchiseoffices and IDs
        api_response = api_instance.franchiseoffice_get_autocomplete_v2(s_selector, e_filter_active=e_filter_active, s_query=s_query, accept_language=accept_language)
        print("The response of ObjectFranchiseofficeApi->franchiseoffice_get_autocomplete_v2:\n")
        pprint(api_response)
