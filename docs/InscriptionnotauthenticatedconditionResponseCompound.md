...
```python
from eZmaxApi.models.inscriptionnotauthenticatedcondition_response_compound import InscriptionnotauthenticatedconditionResponseCompound

# TODO update the JSON string below
json = "{}"
# create an instance of InscriptionnotauthenticatedconditionResponseCompound from a JSON string
inscriptionnotauthenticatedcondition_response_compound_instance = InscriptionnotauthenticatedconditionResponseCompound.from_json(json)
# print the JSON string representation of the object
print(InscriptionnotauthenticatedconditionResponseCompound.to_json())

# convert the object into a dict
inscriptionnotauthenticatedcondition_response_compound_dict = inscriptionnotauthenticatedcondition_response_compound_instance.to_dict()
# create an instance of InscriptionnotauthenticatedconditionResponseCompound from a dict
inscriptionnotauthenticatedcondition_response_compound_from_dict = InscriptionnotauthenticatedconditionResponseCompound.from_dict(inscriptionnotauthenticatedcondition_response_compound_dict)
```
