...
with eZmaxApi.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = eZmaxApi.ObjectEzsignsignatureApi(api_client)
    ezsignsignature_create_object_v4_request = eZmaxApi.EzsignsignatureCreateObjectV4Request() # EzsignsignatureCreateObjectV4Request | 

    try:
        # Create a new Ezsignsignature
        api_response = api_instance.ezsignsignature_create_object_v4(ezsignsignature_create_object_v4_request)
        print("The response of ObjectEzsignsignatureApi->ezsignsignature_create_object_v4:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ObjectEzsignsignatureApi->ezsignsignature_create_object_v4: %s\n" % e)
```
...
from eZmaxApi.models.ezsignsignature_edit_object_v3_response import EzsignsignatureEditObjectV3Response
from eZmaxApi.rest import ApiException
from pprint import pprint
...
with eZmaxApi.ApiClient(configuration) as api_client:
    ...
    api_instance = eZmaxApi.ObjectEzsignsignatureApi(api_client)
    pki_ezsignsignature_id = 56 # int | 
    ezsignsignature_edit_object_v3_request = eZmaxApi.EzsignsignatureEditObjectV3Request() # EzsignsignatureEditObjectV3Request | 

    try:
        # Edit an existing Ezsignsignature
        api_response = api_instance.ezsignsignature_edit_object_v3(pki_ezsignsignature_id, ezsignsignature_edit_object_v3_request)
        print("The response of ObjectEzsignsignatureApi->ezsignsignature_edit_object_v3:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ObjectEzsignsignatureApi->ezsignsignature_edit_object_v3: %s\n" % e)
```
...
with eZmaxApi.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve an existing Ezsignsignature
        api_response = api_instance.ezsignsignature_get_object_v4(pki_ezsignsignature_id)
        print("The response of ObjectEzsignsignatureApi->ezsignsignature_get_object_v4:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ObjectEzsignsignatureApi->ezsignsignature_get_object_v4: %s\n" % e)
```
