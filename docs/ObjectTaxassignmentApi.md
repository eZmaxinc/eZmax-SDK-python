...
with eZmaxApi.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve Taxassignments and IDs
        api_response = api_instance.taxassignment_get_autocomplete_v1(s_selector, e_filter_active=e_filter_active, s_query=s_query, accept_language=accept_language)
        pprint(api_response)
    except eZmaxApi.ApiException as e:
        print("Exception when calling ObjectTaxassignmentApi->taxassignment_get_autocomplete_v1: %s\n" % e)
```
...
> TaxassignmentGetAutocompleteV2Response taxassignment_get_autocomplete_v2(s_selector)
...
with eZmaxApi.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve Taxassignments and IDs
        api_response = api_instance.taxassignment_get_autocomplete_v2(s_selector)
        pprint(api_response)
    except eZmaxApi.ApiException as e:
        print("Exception when calling ObjectTaxassignmentApi->taxassignment_get_autocomplete_v2: %s\n" % e)

    # example passing only required values which don't have defaults set
    # and optional values
    try:
        # Retrieve Taxassignments and IDs
        api_response = api_instance.taxassignment_get_autocomplete_v2(s_selector, e_filter_active=e_filter_active, s_query=s_query, accept_language=accept_language)
        pprint(api_response)
    except eZmaxApi.ApiException as e:
        print("Exception when calling ObjectTaxassignmentApi->taxassignment_get_autocomplete_v2: %s\n" % e)
```
