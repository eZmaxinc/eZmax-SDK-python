...
ezsigntemplatesignaturecustomdate_request_compound_from_dict = EzsigntemplatesignaturecustomdateRequestCompound.from_dict(ezsigntemplatesignaturecustomdate_request_compound_dict)
```
