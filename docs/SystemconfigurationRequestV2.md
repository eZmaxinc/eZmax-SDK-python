...
```python
from eZmaxApi.models.systemconfiguration_request_v2 import SystemconfigurationRequestV2

# TODO update the JSON string below
json = "{}"
# create an instance of SystemconfigurationRequestV2 from a JSON string
systemconfiguration_request_v2_instance = SystemconfigurationRequestV2.from_json(json)
# print the JSON string representation of the object
print(SystemconfigurationRequestV2.to_json())

# convert the object into a dict
systemconfiguration_request_v2_dict = systemconfiguration_request_v2_instance.to_dict()
# create an instance of SystemconfigurationRequestV2 from a dict
systemconfiguration_request_v2_from_dict = SystemconfigurationRequestV2.from_dict(systemconfiguration_request_v2_dict)
```
