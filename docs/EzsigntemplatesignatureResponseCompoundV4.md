...
**s_ezsigntemplatesignature_creditcardamountdescription** | **str** | The description of the Creditcard signature | [optional] 
**d_ezsigntemplatesignature_creditcardamount** | **str** | The amount of the Creditcard signature | [optional] 
...
**a_obj_ezsigntemplatesignaturepaymentdetail** | [**List[EzsigntemplatesignaturepaymentdetailResponseCompound]**](EzsigntemplatesignaturepaymentdetailResponseCompound.md) |  | [optional] 

## Example

```python
from eZmaxApi.models.ezsigntemplatesignature_response_compound_v4 import EzsigntemplatesignatureResponseCompoundV4

# TODO update the JSON string below
json = "{}"
# create an instance of EzsigntemplatesignatureResponseCompoundV4 from a JSON string
ezsigntemplatesignature_response_compound_v4_instance = EzsigntemplatesignatureResponseCompoundV4.from_json(json)
# print the JSON string representation of the object
print(EzsigntemplatesignatureResponseCompoundV4.to_json())

# convert the object into a dict
ezsigntemplatesignature_response_compound_v4_dict = ezsigntemplatesignature_response_compound_v4_instance.to_dict()
# create an instance of EzsigntemplatesignatureResponseCompoundV4 from a dict
ezsigntemplatesignature_response_compound_v4_from_dict = EzsigntemplatesignatureResponseCompoundV4.from_dict(ezsigntemplatesignature_response_compound_v4_dict)
```
