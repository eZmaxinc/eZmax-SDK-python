...
with eZmaxApi.ApiClient(configuration) as api_client:
    ...
    ezsignfoldersignerassociation_create_embedded_url_v2_request = eZmaxApi.EzsignfoldersignerassociationCreateEmbeddedUrlV2Request() # EzsignfoldersignerassociationCreateEmbeddedUrlV2Request | 

    try:
        # Creates an Url to allow embedded signing
        api_response = api_instance.ezsignfoldersignerassociation_create_embedded_url_v2(pki_ezsignfoldersignerassociation_id, ezsignfoldersignerassociation_create_embedded_url_v2_request)
        print("The response of ObjectEzsignfoldersignerassociationApi->ezsignfoldersignerassociation_create_embedded_url_v2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ObjectEzsignfoldersignerassociationApi->ezsignfoldersignerassociation_create_embedded_url_v2: %s\n" % e)
```
