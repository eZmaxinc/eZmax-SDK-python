...
with eZmaxApi.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve Secretquestions and IDs
        api_response = api_instance.secretquestion_get_autocomplete_v1(e_filter_active=e_filter_active, s_query=s_query, accept_language=accept_language)
        pprint(api_response)
    except eZmaxApi.ApiException as e:
        print("Exception when calling ObjectSecretquestionApi->secretquestion_get_autocomplete_v1: %s\n" % e)
```
...
> SecretquestionGetAutocompleteV2Response secretquestion_get_autocomplete_v2()
...
with eZmaxApi.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve Secretquestions and IDs
        api_response = api_instance.secretquestion_get_autocomplete_v2()
        pprint(api_response)
    except eZmaxApi.ApiException as e:
    ...
    try:
        # Retrieve Secretquestions and IDs
        api_response = api_instance.secretquestion_get_autocomplete_v2(e_filter_active=e_filter_active, s_query=s_query, accept_language=accept_language)
        pprint(api_response)
    except eZmaxApi.ApiException as e:
        print("Exception when calling ObjectSecretquestionApi->secretquestion_get_autocomplete_v2: %s\n" % e)
```
