...
json = "{}"
# create an instance of EzsignfoldertypeResponseV3 from a JSON string
ezsignfoldertype_response_v3_instance = EzsignfoldertypeResponseV3.from_json(json)
# print the JSON string representation of the object
print(EzsignfoldertypeResponseV3.to_json())

# convert the object into a dict
ezsignfoldertype_response_v3_dict = ezsignfoldertype_response_v3_instance.to_dict()
# create an instance of EzsignfoldertypeResponseV3 from a dict
ezsignfoldertype_response_v3_form_dict = ezsignfoldertype_response_v3.from_dict(ezsignfoldertype_response_v3_dict)
```
