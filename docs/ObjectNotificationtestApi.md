...
with eZmaxApi.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve an existing Notificationtest's Elements
        api_response = api_instance.notificationtest_get_elements_v2(pki_notificationtest_id)
        print("The response of ObjectNotificationtestApi->notificationtest_get_elements_v2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ObjectNotificationtestApi->notificationtest_get_elements_v2: %s\n" % e)
```
