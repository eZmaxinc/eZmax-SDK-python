...
json = "{}"
# create an instance of EzsignfoldertypeResponseCompoundV3 from a JSON string
ezsignfoldertype_response_compound_v3_instance = EzsignfoldertypeResponseCompoundV3.from_json(json)
# print the JSON string representation of the object
print(EzsignfoldertypeResponseCompoundV3.to_json())

# convert the object into a dict
ezsignfoldertype_response_compound_v3_dict = ezsignfoldertype_response_compound_v3_instance.to_dict()
# create an instance of EzsignfoldertypeResponseCompoundV3 from a dict
ezsignfoldertype_response_compound_v3_form_dict = ezsignfoldertype_response_compound_v3.from_dict(ezsignfoldertype_response_compound_v3_dict)
```
