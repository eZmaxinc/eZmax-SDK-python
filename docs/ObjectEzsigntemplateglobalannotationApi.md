...
with eZmaxApi.ApiClient(configuration) as api_client:
    ...
    api_instance = eZmaxApi.ObjectEzsigntemplateglobalannotationApi(api_client)
    pki_ezsigntemplateglobalannotation_id = 56 # int | The unique ID of the Ezsigntemplateglobalannotation

    try:
        # Retrieve an existing Ezsigntemplateglobalannotation
        api_response = api_instance.ezsigntemplateglobalannotation_get_object_v2(pki_ezsigntemplateglobalannotation_id)
        print("The response of ObjectEzsigntemplateglobalannotationApi->ezsigntemplateglobalannotation_get_object_v2:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ObjectEzsigntemplateglobalannotationApi->ezsigntemplateglobalannotation_get_object_v2: %s\n" % e)
```
