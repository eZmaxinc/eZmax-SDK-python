...
# create an instance of EzsigntemplatesignatureRequest from a dict
ezsigntemplatesignature_request_from_dict = EzsigntemplatesignatureRequest.from_dict(ezsigntemplatesignature_request_dict)
```
