...
with eZmaxApi.ApiClient(configuration) as api_client:
    ...
    api_instance = eZmaxApi.ObjectTranqcontractApi(api_client)
    pki_tranqcontract_id = 56 # int | 
    tranqcontract_import_into_edmv1_request = eZmaxApi.TranqcontractImportIntoEDMV1Request() # TranqcontractImportIntoEDMV1Request | 

    try:
        # Import attachments into the Tranqcontract
        api_response = api_instance.tranqcontract_import_into_edmv1(pki_tranqcontract_id, tranqcontract_import_into_edmv1_request)
        print("The response of ObjectTranqcontractApi->tranqcontract_import_into_edmv1:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ObjectTranqcontractApi->tranqcontract_import_into_edmv1: %s\n" % e)
```
