...
> TimezoneGetAutocompleteV2Response timezone_get_autocomplete_v2(s_selector, e_filter_active=e_filter_active, s_query=s_query, accept_language=accept_language)
...
with eZmaxApi.ApiClient(configuration) as api_client:
    ...
    api_instance = eZmaxApi.ObjectTimezoneApi(api_client)
    s_selector = 's_selector_example' # str | The type of Timezones to return
    ...
    try:
        ...
        print("The response of ObjectTimezoneApi->timezone_get_autocomplete_v2:\n")
        pprint(api_response)
