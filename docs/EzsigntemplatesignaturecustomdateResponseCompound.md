...
ezsigntemplatesignaturecustomdate_response_compound_from_dict = EzsigntemplatesignaturecustomdateResponseCompound.from_dict(ezsigntemplatesignaturecustomdate_response_compound_dict)
```
