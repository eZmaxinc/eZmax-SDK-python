...
json = "{}"
# create an instance of EzsigntemplateannotationResponseCompound from a JSON string
ezsigntemplateannotation_response_compound_instance = EzsigntemplateannotationResponseCompound.from_json(json)
# print the JSON string representation of the object
print(EzsigntemplateannotationResponseCompound.to_json())

# convert the object into a dict
ezsigntemplateannotation_response_compound_dict = ezsigntemplateannotation_response_compound_instance.to_dict()
# create an instance of EzsigntemplateannotationResponseCompound from a dict
ezsigntemplateannotation_response_compound_from_dict = EzsigntemplateannotationResponseCompound.from_dict(ezsigntemplateannotation_response_compound_dict)
```
