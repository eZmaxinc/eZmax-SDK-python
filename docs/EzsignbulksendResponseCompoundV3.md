...
```python
from eZmaxApi.models.ezsignbulksend_response_compound_v3 import EzsignbulksendResponseCompoundV3

# TODO update the JSON string below
json = "{}"
# create an instance of EzsignbulksendResponseCompoundV3 from a JSON string
ezsignbulksend_response_compound_v3_instance = EzsignbulksendResponseCompoundV3.from_json(json)
# print the JSON string representation of the object
print(EzsignbulksendResponseCompoundV3.to_json())

# convert the object into a dict
ezsignbulksend_response_compound_v3_dict = ezsignbulksend_response_compound_v3_instance.to_dict()
# create an instance of EzsignbulksendResponseCompoundV3 from a dict
ezsignbulksend_response_compound_v3_from_dict = EzsignbulksendResponseCompoundV3.from_dict(ezsignbulksend_response_compound_v3_dict)
```
