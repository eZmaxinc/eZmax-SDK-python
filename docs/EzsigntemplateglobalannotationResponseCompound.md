...
ezsigntemplateglobalannotation_response_compound_instance = EzsigntemplateglobalannotationResponseCompound.from_json(json)
# print the JSON string representation of the object
print(EzsigntemplateglobalannotationResponseCompound.to_json())

# convert the object into a dict
ezsigntemplateglobalannotation_response_compound_dict = ezsigntemplateglobalannotation_response_compound_instance.to_dict()
# create an instance of EzsigntemplateglobalannotationResponseCompound from a dict
ezsigntemplateglobalannotation_response_compound_from_dict = EzsigntemplateglobalannotationResponseCompound.from_dict(ezsigntemplateglobalannotation_response_compound_dict)
```
