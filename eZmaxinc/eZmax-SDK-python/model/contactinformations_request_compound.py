...
class ContactinformationsRequestCompound(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, a_obj_address, a_obj_phone, a_obj_email, a_obj_website, i_address_default, i_phone_default, i_email_default, i_website_default, *args, **kwargs):  # noqa: E501
