...
class WebhookEzsignDocumentCompleted(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, obj_ezsigndocument, obj_webhook, a_obj_attempt, *args, **kwargs):  # noqa: E501
        """WebhookEzsignDocumentCompleted - a model defined in OpenAPI
