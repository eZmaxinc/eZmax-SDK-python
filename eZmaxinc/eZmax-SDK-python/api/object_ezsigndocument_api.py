...
class ObjectEzsigndocumentApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __ezsigndocument_edit_object_v1(
            self,
            pki_ezsigndocument_id,
            ezsigndocument_edit_object_v1_request,
            **kwargs
        ):
            """Modify an existing Ezsigndocument  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.ezsigndocument_edit_object_v1(pki_ezsigndocument_id, ezsigndocument_edit_object_v1_request, async_req=True)
            >>> result = thread.get()
            ...
            kwargs['pki_ezsigndocument_id'] = \
                pki_ezsigndocument_id
            kwargs['ezsigndocument_edit_object_v1_request'] = \
                ezsigndocument_edit_object_v1_request
            return self.call_with_http_info(**kwargs)

        self.ezsigndocument_edit_object_v1 = _Endpoint(
            settings={
                'response_type': (EzsigndocumentEditObjectV1Response,),
                'auth': [
                    'Authorization'
                ],
                'endpoint_path': '/1/object/ezsigndocument/{pkiEzsigndocumentID}',
                'operation_id': 'ezsigndocument_edit_object_v1',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'pki_ezsigndocument_id': 'path',
                    'ezsigndocument_edit_object_v1_request': 'body',
                },
                'collection_format_map': {
                }
            },
            ...
            api_client=api_client,
            callable=__ezsigndocument_edit_object_v1
        )
        ...
        def __ezsigndocument_get_object_get_children_v1(
            self,
            pki_ezsigndocument_id,
            **kwargs
        ):
            ...
            >>> thread = api.ezsigndocument_get_object_get_children_v1(pki_ezsigndocument_id, async_req=True)
            >>> result = thread.get()
        ...
        self.ezsigndocument_get_object_get_children_v1 = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'Authorization'
                ...
                'operation_id': 'ezsigndocument_get_object_get_children_v1',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__ezsigndocument_get_object_get_children_v1
        )
