...
class ModuleSsprApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __sspr_remind_usernames_v1(
            self,
            **kwargs
        ):
            ...
            >>> thread = api.sspr_remind_usernames_v1(async_req=True)
            >>> result = thread.get()
        ...
        self.sspr_remind_usernames_v1 = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'Authorization'
                ],
                'endpoint_path': '/1/module/sspr/remindUsernames',
                'operation_id': 'sspr_remind_usernames_v1',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            callable=__sspr_remind_usernames_v1
        )
