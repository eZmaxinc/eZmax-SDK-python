...
class FranchisereferalincomeCreateObjectV2Request(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.a_obj_franchisereferalincome:
            for _item_a_obj_franchisereferalincome in self.a_obj_franchisereferalincome:
                if _item_a_obj_franchisereferalincome:
                    _items.append(_item_a_obj_franchisereferalincome.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objFranchisereferalincome": [FranchisereferalincomeRequestCompound.from_dict(_item) for _item in obj["a_objFranchisereferalincome"]] if obj.get("a_objFranchisereferalincome") is not None else None
        })
        return _obj
