...
class EzsigntemplatesignaturecustomdateRequestCompoundV2(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["pkiEzsigntemplatesignaturecustomdateID", "iEzsigntemplatesignaturecustomdateOffsetx", "iEzsigntemplatesignaturecustomdateOffsety", "sEzsigntemplatesignaturecustomdateFormat"]
