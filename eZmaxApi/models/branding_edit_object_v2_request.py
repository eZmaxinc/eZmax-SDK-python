...
class BrandingEditObjectV2Request(BaseModel):
    """
    Request for PUT /2/object/branding/{pkiBrandingID}
    """ # noqa: E501
    obj_branding: BrandingRequestCompoundV2 = Field(alias="objBranding")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objBranding": BrandingRequestCompoundV2.from_dict(obj["objBranding"]) if obj.get("objBranding") is not None else None
        })
        return _obj
