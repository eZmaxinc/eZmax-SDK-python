...
class EzsignbulksendsignermappingRequest(BaseModel):
    ...
    """ # noqa: E501
    pki_ezsignbulksendsignermapping_id: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The unique ID of the Ezsignbulksendsignermapping", alias="pkiEzsignbulksendsignermappingID", json_schema_extra={"examples": [57]})
