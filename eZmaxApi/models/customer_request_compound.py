...
class CustomerRequestCompound(BaseModel):
    """
    A Customer Object and children
    """ # noqa: E501
    pki_customer_id: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The unique ID of the Customer.", alias="pkiCustomerID")
