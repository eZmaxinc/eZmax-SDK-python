...
class CustomEzsigndocumentGetEzsignformfieldgroupsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["pkiEzsigndocumentID", "sEzsigndocumentName", "a_objEzsignformfieldgroup"]
