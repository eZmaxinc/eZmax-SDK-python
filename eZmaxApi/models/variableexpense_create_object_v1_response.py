...
class VariableexpenseCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/variableexpense  # noqa: E501
    """
    ...
    m_payload: VariableexpenseCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VariableexpenseCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VariableexpenseCreateObjectV1Response:
        """Create an instance of VariableexpenseCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VariableexpenseCreateObjectV1Response.parse_obj(obj)

        _obj = VariableexpenseCreateObjectV1Response.parse_obj({
            ...
            "m_payload": VariableexpenseCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
