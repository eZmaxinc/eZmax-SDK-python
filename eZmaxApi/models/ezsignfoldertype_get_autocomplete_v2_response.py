...
class EzsignfoldertypeGetAutocompleteV2Response(BaseModel):
    """
    Response for GET /2/object/ezsignfoldertype/getAutocomplete  # noqa: E501
    """
    ...
    m_payload: EzsignfoldertypeGetAutocompleteV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfoldertypeGetAutocompleteV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfoldertypeGetAutocompleteV2Response:
        """Create an instance of EzsignfoldertypeGetAutocompleteV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfoldertypeGetAutocompleteV2Response.parse_obj(obj)

        _obj = EzsignfoldertypeGetAutocompleteV2Response.parse_obj({
            ...
            "m_payload": EzsignfoldertypeGetAutocompleteV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
