...
class EzsigndocumentSubmitEzsignformV1Response(BaseModel):
    """
    Response for POST /1/object/ezsigndocument/{pkiEzsigndocumentID}/submitEzsignform  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentSubmitEzsignformV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentSubmitEzsignformV1Response:
        """Create an instance of EzsigndocumentSubmitEzsignformV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentSubmitEzsignformV1Response.parse_obj(obj)

        _obj = EzsigndocumentSubmitEzsignformV1Response.parse_obj({
