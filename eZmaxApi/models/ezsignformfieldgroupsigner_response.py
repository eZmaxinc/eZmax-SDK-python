...
class EzsignformfieldgroupsignerResponse(BaseModel):
    """
    A Ezsignformfieldgroupsigner Object  # noqa: E501
    """
    pki_ezsignformfieldgroupsigner_id: conint(strict=True, ge=0) = Field(..., alias="pkiEzsignformfieldgroupsignerID", description="The unique ID of the Ezsignformfieldgroupsigner")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignformfieldgroupsignerResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignformfieldgroupsignerResponse:
        """Create an instance of EzsignformfieldgroupsignerResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignformfieldgroupsignerResponse.parse_obj(obj)

        _obj = EzsignformfieldgroupsignerResponse.parse_obj({
