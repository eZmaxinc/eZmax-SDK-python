...
class EzsigndocumentGetFormDataV1Response(BaseModel):
    """
    Response for GET /1/object/ezsigndocument/{pkiEzsigndocument}/getFormData  # noqa: E501
    """
    ...
    m_payload: EzsigndocumentGetFormDataV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentGetFormDataV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentGetFormDataV1Response:
        """Create an instance of EzsigndocumentGetFormDataV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentGetFormDataV1Response.parse_obj(obj)

        _obj = EzsigndocumentGetFormDataV1Response.parse_obj({
            ...
            "m_payload": EzsigndocumentGetFormDataV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
