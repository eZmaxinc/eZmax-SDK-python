...
class EzsigntemplatesignerDeleteObjectV1Response(BaseModel):
    """
    Response for DELETE /1/object/ezsigntemplatesigner/{pkiEzsigntemplatesignerID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatesignerDeleteObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatesignerDeleteObjectV1Response:
        """Create an instance of EzsigntemplatesignerDeleteObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatesignerDeleteObjectV1Response.parse_obj(obj)

        _obj = EzsigntemplatesignerDeleteObjectV1Response.parse_obj({
