...
class UsergroupGetUsergroupmembershipsV1Response(BaseModel):
    """
    ...
    m_payload: UsergroupGetUsergroupmembershipsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupGetUsergroupmembershipsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupGetUsergroupmembershipsV1Response:
        """Create an instance of UsergroupGetUsergroupmembershipsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupGetUsergroupmembershipsV1Response.parse_obj(obj)

        _obj = UsergroupGetUsergroupmembershipsV1Response.parse_obj({
            ...
            "m_payload": UsergroupGetUsergroupmembershipsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
