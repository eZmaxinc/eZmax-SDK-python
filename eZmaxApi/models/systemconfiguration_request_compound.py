...
class SystemconfigurationRequestCompound(BaseModel):
    """
    A Systemconfiguration Object and children  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SystemconfigurationRequestCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SystemconfigurationRequestCompound:
        """Create an instance of SystemconfigurationRequestCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SystemconfigurationRequestCompound.parse_obj(obj)

        _obj = SystemconfigurationRequestCompound.parse_obj({
