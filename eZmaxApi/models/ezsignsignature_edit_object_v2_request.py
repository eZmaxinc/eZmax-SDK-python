...
class EzsignsignatureEditObjectV2Request(BaseModel):
    """
    Request for PUT /2/object/ezsignsignature/{pkiEzsignsignatureID}
    """ # noqa: E501
    obj_ezsignsignature: EzsignsignatureRequestCompoundV2 = Field(alias="objEzsignsignature")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objEzsignsignature": EzsignsignatureRequestCompoundV2.from_dict(obj["objEzsignsignature"]) if obj.get("objEzsignsignature") is not None else None
        })
        return _obj
