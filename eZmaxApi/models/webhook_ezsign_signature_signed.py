...
class WebhookEzsignSignatureSigned(BaseModel):
    """
    ...
    obj_ezsignsignature: EzsignsignatureResponse = Field(alias="objEzsignsignature")
    __properties: ClassVar[List[str]] = ["objWebhook", "a_objAttempt", "objEzsignsignature"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "objEzsignsignature": EzsignsignatureResponse.from_dict(obj["objEzsignsignature"]) if obj.get("objEzsignsignature") is not None else None
        })
        return _obj
