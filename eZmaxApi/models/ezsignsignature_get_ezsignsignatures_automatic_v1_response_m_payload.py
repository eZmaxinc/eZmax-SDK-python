...
class EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload(BaseModel):
    """
    Payload for GET /1/object/ezsigsignature/getEzsignsignaturesAutomatic  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload:
        """Create an instance of EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload.parse_obj(obj)

        _obj = EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload.parse_obj({
