...
class EzsignSuggestSignersV1Response(BaseModel):
    """
    Response for GET /1/module/ezsign/suggestSigners  # noqa: E501
    """
    ...
    m_payload: EzsignSuggestSignersV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignSuggestSignersV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignSuggestSignersV1Response:
        """Create an instance of EzsignSuggestSignersV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignSuggestSignersV1Response.parse_obj(obj)

        _obj = EzsignSuggestSignersV1Response.parse_obj({
            ...
            "m_payload": EzsignSuggestSignersV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
