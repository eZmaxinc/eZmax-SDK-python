...
class ApikeyGetListV1Response(BaseModel):
    """
    Response for GET /1/object/apikey/getList  # noqa: E501
    """
    ...
    m_payload: ApikeyGetListV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApikeyGetListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApikeyGetListV1Response:
        """Create an instance of ApikeyGetListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApikeyGetListV1Response.parse_obj(obj)

        _obj = ApikeyGetListV1Response.parse_obj({
            ...
            "m_payload": ApikeyGetListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
