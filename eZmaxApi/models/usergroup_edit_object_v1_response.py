...
class UsergroupEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/usergroup/{pkiUsergroupID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupEditObjectV1Response:
        """Create an instance of UsergroupEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupEditObjectV1Response.parse_obj(obj)

        _obj = UsergroupEditObjectV1Response.parse_obj({
