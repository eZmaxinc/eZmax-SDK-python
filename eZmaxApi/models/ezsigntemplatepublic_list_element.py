...
class EzsigntemplatepublicListElement(BaseModel):
    ...
    """ # noqa: E501
    pki_ezsigntemplatepublic_id: Annotated[int, Field(le=65535, strict=True, ge=0)] = Field(description="The unique ID of the Ezsigntemplatepublic", alias="pkiEzsigntemplatepublicID", json_schema_extra={"examples": [96]})
    ...
    s_ezsigntemplatepublic_description: Annotated[str, Field(strict=True)] = Field(description="The description of the Ezsigntemplatepublic", alias="sEzsigntemplatepublicDescription", json_schema_extra={"examples": ["Inscription form"]})
    b_ezsigntemplatepublic_isactive: StrictBool = Field(description="Whether the ezsigntemplatepublic is active or not", alias="bEzsigntemplatepublicIsactive", json_schema_extra={"examples": [True]})
    t_ezsigntemplatepublic_note: Annotated[str, Field(strict=True)] = Field(description="The note of the Ezsigntemplatepublic", alias="tEzsigntemplatepublicNote", json_schema_extra={"examples": ["This is a note"]})
    e_ezsigntemplatepublic_limittype: FieldEEzsigntemplatepublicLimittype = Field(alias="eEzsigntemplatepublicLimittype")
    i_ezsigntemplatepublic_limit: Annotated[int, Field(le=65535, strict=True, ge=0)] = Field(description="The limit of the Ezsigntemplatepublic", alias="iEzsigntemplatepublicLimit", json_schema_extra={"examples": [10]})
    i_ezsigntemplatepublic_limitexceeded: Annotated[int, Field(le=65535, strict=True, ge=0)] = Field(description="The limitexceeded of the Ezsigntemplatepublic", alias="iEzsigntemplatepublicLimitexceeded", json_schema_extra={"examples": [5]})
