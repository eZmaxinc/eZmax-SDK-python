...
class BillingentityinternalCreateObjectV1Request(BaseModel):
    ...
    """ # noqa: E501
    a_obj_billingentityinternal: Annotated[List[BillingentityinternalRequestCompound], Field(min_length=1)] = Field(alias="a_objBillingentityinternal")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objBillingentityinternal": [BillingentityinternalRequestCompound.from_dict(_item) for _item in obj.get("a_objBillingentityinternal")] if obj.get("a_objBillingentityinternal") is not None else None
        })
        return _obj
