...
class InscriptionGetCommunicationListV1ResponseMPayload(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InscriptionGetCommunicationListV1ResponseMPayload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InscriptionGetCommunicationListV1ResponseMPayload:
        """Create an instance of InscriptionGetCommunicationListV1ResponseMPayload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InscriptionGetCommunicationListV1ResponseMPayload.parse_obj(obj)

        _obj = InscriptionGetCommunicationListV1ResponseMPayload.parse_obj({
