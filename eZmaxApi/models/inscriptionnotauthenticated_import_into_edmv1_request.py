...
class InscriptionnotauthenticatedImportIntoEDMV1Request(BaseModel):
    """
    Request for POST /1/object/inscriptionnotauthenticated/{pkiInscriptionnotauthenticatedID}/importIntoEDM
    """ # noqa: E501
    a_obj_attachment: List[CustomAttachmentImportIntoEDMRequest] = Field(alias="a_objAttachment")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objAttachment": [CustomAttachmentImportIntoEDMRequest.from_dict(_item) for _item in obj["a_objAttachment"]] if obj.get("a_objAttachment") is not None else None
        })
        return _obj
