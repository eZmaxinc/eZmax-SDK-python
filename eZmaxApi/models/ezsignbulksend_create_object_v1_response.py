...
class EzsignbulksendCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/ezsignbulksend  # noqa: E501
    """
    ...
    m_payload: EzsignbulksendCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignbulksendCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignbulksendCreateObjectV1Response:
        """Create an instance of EzsignbulksendCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignbulksendCreateObjectV1Response.parse_obj(obj)

        _obj = EzsignbulksendCreateObjectV1Response.parse_obj({
            ...
            "m_payload": EzsignbulksendCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
