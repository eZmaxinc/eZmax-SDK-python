...
class ElectronicfundstransferGetCommunicationListV1ResponseMPayload(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ElectronicfundstransferGetCommunicationListV1ResponseMPayload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ElectronicfundstransferGetCommunicationListV1ResponseMPayload:
        """Create an instance of ElectronicfundstransferGetCommunicationListV1ResponseMPayload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ElectronicfundstransferGetCommunicationListV1ResponseMPayload.parse_obj(obj)

        _obj = ElectronicfundstransferGetCommunicationListV1ResponseMPayload.parse_obj({
