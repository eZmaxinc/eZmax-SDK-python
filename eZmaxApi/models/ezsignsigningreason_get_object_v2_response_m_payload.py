...
class EzsignsigningreasonGetObjectV2ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "objEzsignsigningreason": EzsignsigningreasonResponseCompound.from_dict(obj.get("objEzsignsigningreason")) if obj.get("objEzsignsigningreason") is not None else None
        })
        return _obj
