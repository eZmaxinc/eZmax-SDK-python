...
class EzsignbulksendsignermappingDeleteObjectV1Response(BaseModel):
    """
    Response for DELETE /1/object/ezsignbulksendsignermapping/{pkiEzsignbulksendsignermappingID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignbulksendsignermappingDeleteObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignbulksendsignermappingDeleteObjectV1Response:
        """Create an instance of EzsignbulksendsignermappingDeleteObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignbulksendsignermappingDeleteObjectV1Response.parse_obj(obj)

        _obj = EzsignbulksendsignermappingDeleteObjectV1Response.parse_obj({
