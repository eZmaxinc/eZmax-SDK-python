...
class EzsigndocumentDeclineToSignV1Response(BaseModel):
    """
    Response for POST /1/object/ezsigndocument/{pkiEzsigndocumentID}/declineToSign  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentDeclineToSignV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentDeclineToSignV1Response:
        """Create an instance of EzsigndocumentDeclineToSignV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentDeclineToSignV1Response.parse_obj(obj)

        _obj = EzsigndocumentDeclineToSignV1Response.parse_obj({
