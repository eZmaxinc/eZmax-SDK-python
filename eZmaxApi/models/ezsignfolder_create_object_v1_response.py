...
class EzsignfolderCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/ezsignfolder  # noqa: E501
    """
    ...
    m_payload: EzsignfolderCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderCreateObjectV1Response:
        """Create an instance of EzsignfolderCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderCreateObjectV1Response.parse_obj(obj)

        _obj = EzsignfolderCreateObjectV1Response.parse_obj({
            ...
            "m_payload": EzsignfolderCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
