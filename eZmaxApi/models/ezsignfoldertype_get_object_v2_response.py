...
class EzsignfoldertypeGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/ezsignfoldertype/{pkiEzsignfoldertypeID}  # noqa: E501
    """
    ...
    m_payload: EzsignfoldertypeGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfoldertypeGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfoldertypeGetObjectV2Response:
        """Create an instance of EzsignfoldertypeGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfoldertypeGetObjectV2Response.parse_obj(obj)

        _obj = EzsignfoldertypeGetObjectV2Response.parse_obj({
            ...
            "m_payload": EzsignfoldertypeGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
