...
class EzmaxinvoicingGetProvisionalV1Response(BaseModel):
    """
    Response for GET /1/object/ezmaxinvoicing/getProvisional  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzmaxinvoicingGetProvisionalV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzmaxinvoicingGetProvisionalV1Response:
        """Create an instance of EzmaxinvoicingGetProvisionalV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzmaxinvoicingGetProvisionalV1Response.parse_obj(obj)

        _obj = EzmaxinvoicingGetProvisionalV1Response.parse_obj({
            ...
            "m_payload": EzmaxinvoicingGetProvisionalV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
