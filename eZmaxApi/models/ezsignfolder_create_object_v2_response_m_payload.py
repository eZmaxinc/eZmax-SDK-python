...
class EzsignfolderCreateObjectV2ResponseMPayload(BaseModel):
    """
    Payload for POST /2/object/ezsignfolder  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderCreateObjectV2ResponseMPayload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderCreateObjectV2ResponseMPayload:
        """Create an instance of EzsignfolderCreateObjectV2ResponseMPayload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderCreateObjectV2ResponseMPayload.parse_obj(obj)

        _obj = EzsignfolderCreateObjectV2ResponseMPayload.parse_obj({
