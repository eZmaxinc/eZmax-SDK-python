...
class BrandingGetObjectV3ResponseMPayload(BaseModel):
    """
    Payload for GET /3/object/branding/{pkiBrandingID}
    """ # noqa: E501
    obj_branding: BrandingResponseCompoundV3 = Field(alias="objBranding")
    __properties: ClassVar[List[str]] = ["objBranding"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objBranding": BrandingResponseCompoundV3.from_dict(obj["objBranding"]) if obj.get("objBranding") is not None else None
        })
        return _obj
