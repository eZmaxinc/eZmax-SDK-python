...
class EzsignbulksendEditObjectV2Request(BaseModel):
    """
    Request for PUT /2/object/ezsignbulksend/{pkiEzsignbulksendID}
    """ # noqa: E501
    obj_ezsignbulksend: EzsignbulksendRequestCompoundV2 = Field(alias="objEzsignbulksend")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objEzsignbulksend": EzsignbulksendRequestCompoundV2.from_dict(obj["objEzsignbulksend"]) if obj.get("objEzsignbulksend") is not None else None
        })
        return _obj
