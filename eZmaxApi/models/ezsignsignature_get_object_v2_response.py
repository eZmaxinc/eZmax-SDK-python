...
class EzsignsignatureGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/ezsignsignature/{pkiEzsignsignatureID}  # noqa: E501
    """
    ...
    m_payload: EzsignsignatureGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignatureGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignatureGetObjectV2Response:
        """Create an instance of EzsignsignatureGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignatureGetObjectV2Response.parse_obj(obj)

        _obj = EzsignsignatureGetObjectV2Response.parse_obj({
            ...
            "m_payload": EzsignsignatureGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
