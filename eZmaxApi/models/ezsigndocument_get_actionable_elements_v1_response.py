...
class EzsigndocumentGetActionableElementsV1Response(BaseModel):
    """
    Response for GET /1/object/ezsigndocument/{pkiEzsigndocumentID}/getActionableElements  # noqa: E501
    """
    ...
    m_payload: EzsigndocumentGetActionableElementsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentGetActionableElementsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentGetActionableElementsV1Response:
        """Create an instance of EzsigndocumentGetActionableElementsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentGetActionableElementsV1Response.parse_obj(obj)

        _obj = EzsigndocumentGetActionableElementsV1Response.parse_obj({
            ...
            "m_payload": EzsigndocumentGetActionableElementsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
