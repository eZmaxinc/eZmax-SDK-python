...
class EzsigndocumentGetTemporaryProofV1Response(BaseModel):
    """
    Response for GET /1/object/ezsigndocument/{pkiEzsigndocumentID}/getTemporaryProof  # noqa: E501
    """
    ...
    m_payload: EzsigndocumentGetTemporaryProofV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentGetTemporaryProofV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentGetTemporaryProofV1Response:
        """Create an instance of EzsigndocumentGetTemporaryProofV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentGetTemporaryProofV1Response.parse_obj(obj)

        _obj = EzsigndocumentGetTemporaryProofV1Response.parse_obj({
            ...
            "m_payload": EzsigndocumentGetTemporaryProofV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
