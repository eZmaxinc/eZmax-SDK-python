...
class EzsigntsarequirementAutocompleteElementResponse(BaseModel):
    ...
    """ # noqa: E501
    s_ezsigntsarequirement_description_x: StrictStr = Field(description="The description of the Ezsigntsarequirement in the language of the requester", alias="sEzsigntsarequirementDescriptionX", json_schema_extra={"examples": ["No"]})
    ...
    b_ezsigntsarequirement_isactive: StrictBool = Field(description="Whether the Ezsigntsarequirement is active or not", alias="bEzsigntsarequirementIsactive", json_schema_extra={"examples": [True]})
