...
class ActivesessionGetListV1Response(BaseModel):
    """
    Response for GET /1/object/activesession/getList  # noqa: E501
    """
    ...
    m_payload: ActivesessionGetListV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivesessionGetListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivesessionGetListV1Response:
        """Create an instance of ActivesessionGetListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivesessionGetListV1Response.parse_obj(obj)

        _obj = ActivesessionGetListV1Response.parse_obj({
            ...
            "m_payload": ActivesessionGetListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
