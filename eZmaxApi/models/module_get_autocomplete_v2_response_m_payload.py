...
class ModuleGetAutocompleteV2ResponseMPayload(BaseModel):
    """
    Payload for POST /2/object/module/getAutocomplete
    """ # noqa: E501
    a_obj_module: List[ModuleAutocompleteElementResponse] = Field(description="An array of Module autocomplete element response.", alias="a_objModule")
    __properties: ClassVar[List[str]] = ["a_objModule"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objModule": [ModuleAutocompleteElementResponse.from_dict(_item) for _item in obj["a_objModule"]] if obj.get("a_objModule") is not None else None
        })
        return _obj
