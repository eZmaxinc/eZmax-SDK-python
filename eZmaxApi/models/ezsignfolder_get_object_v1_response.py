...
class EzsignfolderGetObjectV1Response(BaseModel):
    """
    Response for GET /1/object/ezsignfolder/{pkiEzsignfolderID}  # noqa: E501
    """
    ...
    m_payload: EzsignfolderGetObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderGetObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderGetObjectV1Response:
        """Create an instance of EzsignfolderGetObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderGetObjectV1Response.parse_obj(obj)

        _obj = EzsignfolderGetObjectV1Response.parse_obj({
            ...
            "m_payload": EzsignfolderGetObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
