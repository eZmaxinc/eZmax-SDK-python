...
class EzsigntemplateGetObjectV3ResponseMPayload(BaseModel):
    """
    Payload for GET /3/object/ezsigntemplate/{pkiEzsigntemplateID}
    """ # noqa: E501
    obj_ezsigntemplate: EzsigntemplateResponseCompoundV3 = Field(alias="objEzsigntemplate")
    __properties: ClassVar[List[str]] = ["objEzsigntemplate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objEzsigntemplate": EzsigntemplateResponseCompoundV3.from_dict(obj["objEzsigntemplate"]) if obj.get("objEzsigntemplate") is not None else None
        })
        return _obj
