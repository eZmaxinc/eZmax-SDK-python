...
class FontGetAutocompleteV2Response(BaseModel):
    """
    Response for GET /2/object/font/getAutocomplete  # noqa: E501
    """
    ...
    m_payload: FontGetAutocompleteV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FontGetAutocompleteV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FontGetAutocompleteV2Response:
        """Create an instance of FontGetAutocompleteV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FontGetAutocompleteV2Response.parse_obj(obj)

        _obj = FontGetAutocompleteV2Response.parse_obj({
            ...
            "m_payload": FontGetAutocompleteV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
