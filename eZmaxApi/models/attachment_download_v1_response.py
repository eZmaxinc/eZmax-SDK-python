...
class AttachmentDownloadV1Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttachmentDownloadV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttachmentDownloadV1Response:
        """Create an instance of AttachmentDownloadV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AttachmentDownloadV1Response.parse_obj(obj)

        _obj = AttachmentDownloadV1Response.parse_obj({
