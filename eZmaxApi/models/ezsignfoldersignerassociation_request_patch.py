...
class EzsignfoldersignerassociationRequestPatch(BaseModel):
    """
    ...
    __properties = ["tEzsignfoldersignerassociationMessage"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfoldersignerassociationRequestPatch:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfoldersignerassociationRequestPatch:
        """Create an instance of EzsignfoldersignerassociationRequestPatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfoldersignerassociationRequestPatch.parse_obj(obj)

        _obj = EzsignfoldersignerassociationRequestPatch.parse_obj({
