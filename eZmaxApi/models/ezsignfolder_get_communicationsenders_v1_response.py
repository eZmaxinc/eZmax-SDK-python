...
class EzsignfolderGetCommunicationsendersV1Response(BaseModel):
    """
    ...
    m_payload: EzsignfolderGetCommunicationsendersV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderGetCommunicationsendersV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderGetCommunicationsendersV1Response:
        """Create an instance of EzsignfolderGetCommunicationsendersV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderGetCommunicationsendersV1Response.parse_obj(obj)

        _obj = EzsignfolderGetCommunicationsendersV1Response.parse_obj({
            ...
            "m_payload": EzsignfolderGetCommunicationsendersV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
