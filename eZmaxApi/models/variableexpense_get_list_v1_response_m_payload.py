...
class VariableexpenseGetListV1ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "a_objVariableexpense": [VariableexpenseListElement.from_dict(_item) for _item in obj.get("a_objVariableexpense")] if obj.get("a_objVariableexpense") is not None else None
        })
        return _obj
