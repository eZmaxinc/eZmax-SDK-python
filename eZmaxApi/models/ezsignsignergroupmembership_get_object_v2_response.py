...
class EzsignsignergroupmembershipGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/ezsignsignergroupmembership/{pkiEzsignsignergroupmembershipID}  # noqa: E501
    """
    ...
    m_payload: EzsignsignergroupmembershipGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignergroupmembershipGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignergroupmembershipGetObjectV2Response:
        """Create an instance of EzsignsignergroupmembershipGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignergroupmembershipGetObjectV2Response.parse_obj(obj)

        _obj = EzsignsignergroupmembershipGetObjectV2Response.parse_obj({
            ...
            "m_payload": EzsignsignergroupmembershipGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
