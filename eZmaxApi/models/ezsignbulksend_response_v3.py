...
class EzsignbulksendResponseV3(BaseModel):
    """
    ...
    e_ezsignbulksend_ezsignformfieldorder: FieldEEzsignbulksendEzsignformfieldorder = Field(alias="eEzsignbulksendEzsignformfieldorder")
    ...
    t_ezsignbulksend_note: StrictStr = Field(description="Note about the Ezsignbulksend", alias="tEzsignbulksendNote", json_schema_extra={"examples": ["This is a note"]})
    ...
    __properties: ClassVar[List[str]] = ["pkiEzsignbulksendID", "fkiEzsignfoldertypeID", "fkiLanguageID", "sLanguageNameX", "eEzsignbulksendEzsignformfieldorder", "eEzsignfoldertypePrivacylevel", "sEzsignfoldertypeNameX", "sEzsignbulksendDescription", "tEzsignbulksendNote", "bEzsignbulksendNeedvalidation", "bEzsignbulksendIsactive", "objAudit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "eEzsignbulksendEzsignformfieldorder": obj.get("eEzsignbulksendEzsignformfieldorder"),
