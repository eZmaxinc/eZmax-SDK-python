...
class EzsigntemplateCreateObjectV1Request(BaseModel):
    ...
    """ # noqa: E501
    a_obj_ezsigntemplate: Annotated[List[EzsigntemplateRequestCompound], Field(min_length=1)] = Field(alias="a_objEzsigntemplate")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objEzsigntemplate": [EzsigntemplateRequestCompound.from_dict(_item) for _item in obj.get("a_objEzsigntemplate")] if obj.get("a_objEzsigntemplate") is not None else None
        })
        return _obj
