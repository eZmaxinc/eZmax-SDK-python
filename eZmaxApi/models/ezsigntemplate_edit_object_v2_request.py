...
class EzsigntemplateEditObjectV2Request(BaseModel):
    """
    Request for PUT /2/object/ezsigntemplate/{pkiEzsigntemplateID}
    """ # noqa: E501
    obj_ezsigntemplate: EzsigntemplateRequestCompoundV2 = Field(alias="objEzsigntemplate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objEzsigntemplate": EzsigntemplateRequestCompoundV2.from_dict(obj["objEzsigntemplate"]) if obj.get("objEzsigntemplate") is not None else None
        })
        return _obj
