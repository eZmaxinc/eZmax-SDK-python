...
class EzsigndocumentApplyEzsigntemplateV2Response(BaseModel):
    """
    Response for POST /2/object/ezsigndocument/{pkiEzsigndocument}/applyEzsigntemplate  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentApplyEzsigntemplateV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentApplyEzsigntemplateV2Response:
        """Create an instance of EzsigndocumentApplyEzsigntemplateV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentApplyEzsigntemplateV2Response.parse_obj(obj)

        _obj = EzsigndocumentApplyEzsigntemplateV2Response.parse_obj({
