...
class FontGetAutocompleteV2ResponseMPayload(BaseModel):
    ...
    """ # noqa: E501
    a_obj_font: List[FontAutocompleteElementResponse] = Field(description="An array of Font autocomplete element response.", alias="a_objFont")
    __properties: ClassVar[List[str]] = ["a_objFont"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objFont": [FontAutocompleteElementResponse.from_dict(_item) for _item in obj.get("a_objFont")] if obj.get("a_objFont") is not None else None
        })
        return _obj
