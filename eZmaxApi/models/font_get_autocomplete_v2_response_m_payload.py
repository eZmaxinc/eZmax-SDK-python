...
class FontGetAutocompleteV2ResponseMPayload(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FontGetAutocompleteV2ResponseMPayload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FontGetAutocompleteV2ResponseMPayload:
        """Create an instance of FontGetAutocompleteV2ResponseMPayload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FontGetAutocompleteV2ResponseMPayload.parse_obj(obj)

        _obj = FontGetAutocompleteV2ResponseMPayload.parse_obj({
            "a_obj_font": [FontAutocompleteElementResponse.from_dict(_item) for _item in obj.get("a_objFont")] if obj.get("a_objFont") is not None else None
        })
        return _obj
