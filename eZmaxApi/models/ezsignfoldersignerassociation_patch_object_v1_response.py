...
class EzsignfoldersignerassociationPatchObjectV1Response(BaseModel):
    """
    Response for PATCH /1/object/ezsignfoldersignerassociation/{pkiEzsignfoldersignerassociationID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfoldersignerassociationPatchObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfoldersignerassociationPatchObjectV1Response:
        """Create an instance of EzsignfoldersignerassociationPatchObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfoldersignerassociationPatchObjectV1Response.parse_obj(obj)

        _obj = EzsignfoldersignerassociationPatchObjectV1Response.parse_obj({
