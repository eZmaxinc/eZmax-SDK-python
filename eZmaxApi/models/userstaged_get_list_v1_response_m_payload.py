...
class UserstagedGetListV1ResponseMPayload(BaseModel):
    ...
    a_obj_userstaged: List[UserstagedListElement] = Field(alias="a_objUserstaged")
    __properties: ClassVar[List[str]] = ["iRowReturned", "iRowFiltered", "a_objUserstaged"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "a_objUserstaged": [UserstagedListElement.from_dict(_item) for _item in obj.get("a_objUserstaged")] if obj.get("a_objUserstaged") is not None else None
        })
        return _obj
