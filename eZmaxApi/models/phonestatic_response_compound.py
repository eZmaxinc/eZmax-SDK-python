...
class PhonestaticResponseCompound(BaseModel):
    """
    A Phonestatic Object and children to create a complete structure  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PhonestaticResponseCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PhonestaticResponseCompound:
        """Create an instance of PhonestaticResponseCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PhonestaticResponseCompound.parse_obj(obj)

        _obj = PhonestaticResponseCompound.parse_obj({
