...
class EzmaxinvoicingGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/ezmaxinvoicing/{pkiEzmaxinvoicingID}  # noqa: E501
    """
    ...
    m_payload: EzmaxinvoicingGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzmaxinvoicingGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzmaxinvoicingGetObjectV2Response:
        """Create an instance of EzmaxinvoicingGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzmaxinvoicingGetObjectV2Response.parse_obj(obj)

        _obj = EzmaxinvoicingGetObjectV2Response.parse_obj({
            ...
            "m_payload": EzmaxinvoicingGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
