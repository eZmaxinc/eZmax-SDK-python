...
class EzsignsignergroupEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/ezsignsignergroup/{pkiEzsignsignergroupID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignergroupEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignergroupEditObjectV1Response:
        """Create an instance of EzsignsignergroupEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignergroupEditObjectV1Response.parse_obj(obj)

        _obj = EzsignsignergroupEditObjectV1Response.parse_obj({
