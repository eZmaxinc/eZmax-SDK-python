...
class EzsigntemplatepackagemembershipGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/ezsigntemplatepackagemembership/{pkiEzsigntemplatepackagemembershipID}  # noqa: E501
    """
    ...
    m_payload: EzsigntemplatepackagemembershipGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatepackagemembershipGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatepackagemembershipGetObjectV2Response:
        """Create an instance of EzsigntemplatepackagemembershipGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatepackagemembershipGetObjectV2Response.parse_obj(obj)

        _obj = EzsigntemplatepackagemembershipGetObjectV2Response.parse_obj({
            ...
            "m_payload": EzsigntemplatepackagemembershipGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
