...
class EzsignfoldersignerassociationGetObjectV1Response(BaseModel):
    """
    Response for GET /1/object/ezsignfoldersignerassociation/{pkiEzsignfoldersignerassociationID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfoldersignerassociationGetObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfoldersignerassociationGetObjectV1Response:
        """Create an instance of EzsignfoldersignerassociationGetObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfoldersignerassociationGetObjectV1Response.parse_obj(obj)

        _obj = EzsignfoldersignerassociationGetObjectV1Response.parse_obj({
            ...
            "m_payload": EzsignfoldersignerassociationGetObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
