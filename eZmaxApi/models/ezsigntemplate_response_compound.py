...
class EzsigntemplateResponseCompound(BaseModel):
    ...
    s_ezsigntemplate_filenamepattern: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The filename pattern of the Ezsigntemplate", alias="sEzsigntemplateFilenamepattern", json_schema_extra={"examples": ["Contract"]})
