...
class EzsigndocumentUnsendV1Response(BaseModel):
    """
    Response for POST /1/object/ezsigndocument/{pkiEzsigndocumentID}/unsend  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentUnsendV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentUnsendV1Response:
        """Create an instance of EzsigndocumentUnsendV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentUnsendV1Response.parse_obj(obj)

        _obj = EzsigndocumentUnsendV1Response.parse_obj({
