...
class EzsignfolderGetFormsDataV1ResponseMPayload(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["objFormsDataFolder"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "objFormsDataFolder": CustomFormsDataFolderResponse.from_dict(obj.get("objFormsDataFolder")) if obj.get("objFormsDataFolder") is not None else None
        })
        return _obj
