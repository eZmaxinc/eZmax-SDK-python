...
class PeriodGetAutocompleteV2ResponseMPayload(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PeriodGetAutocompleteV2ResponseMPayload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PeriodGetAutocompleteV2ResponseMPayload:
        """Create an instance of PeriodGetAutocompleteV2ResponseMPayload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PeriodGetAutocompleteV2ResponseMPayload.parse_obj(obj)

        _obj = PeriodGetAutocompleteV2ResponseMPayload.parse_obj({
            "a_obj_period": [PeriodAutocompleteElementResponse.from_dict(_item) for _item in obj.get("a_objPeriod")] if obj.get("a_objPeriod") is not None else None
        })
        return _obj
