...
class PeriodGetAutocompleteV2ResponseMPayload(BaseModel):
    ...
    """ # noqa: E501
    a_obj_period: List[PeriodAutocompleteElementResponse] = Field(description="An array of Period autocomplete element response.", alias="a_objPeriod")
    __properties: ClassVar[List[str]] = ["a_objPeriod"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objPeriod": [PeriodAutocompleteElementResponse.from_dict(_item) for _item in obj.get("a_objPeriod")] if obj.get("a_objPeriod") is not None else None
        })
        return _obj
