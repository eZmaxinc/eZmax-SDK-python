...
class PermissionGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/permission/{pkiPermissionID}  # noqa: E501
    """
    ...
    m_payload: PermissionGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PermissionGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PermissionGetObjectV2Response:
        """Create an instance of PermissionGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PermissionGetObjectV2Response.parse_obj(obj)

        _obj = PermissionGetObjectV2Response.parse_obj({
            ...
            "m_payload": PermissionGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
