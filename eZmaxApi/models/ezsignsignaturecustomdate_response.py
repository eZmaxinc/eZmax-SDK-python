...
class EzsignsignaturecustomdateResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignaturecustomdateResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignaturecustomdateResponse:
        """Create an instance of EzsignsignaturecustomdateResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignaturecustomdateResponse.parse_obj(obj)

        _obj = EzsignsignaturecustomdateResponse.parse_obj({
