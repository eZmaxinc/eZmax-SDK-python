...
class BrandingCreateObjectV2Request(BaseModel):
    """
    Request for POST /2/object/branding
    """ # noqa: E501
    a_obj_branding: Annotated[List[BrandingRequestCompoundV2], Field(min_length=1)] = Field(alias="a_objBranding")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objBranding": [BrandingRequestCompoundV2.from_dict(_item) for _item in obj["a_objBranding"]] if obj.get("a_objBranding") is not None else None
        })
        return _obj
