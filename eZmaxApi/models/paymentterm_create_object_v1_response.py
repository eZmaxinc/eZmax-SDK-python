...
class PaymenttermCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/paymentterm  # noqa: E501
    """
    ...
    m_payload: PaymenttermCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymenttermCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymenttermCreateObjectV1Response:
        """Create an instance of PaymenttermCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymenttermCreateObjectV1Response.parse_obj(obj)

        _obj = PaymenttermCreateObjectV1Response.parse_obj({
            ...
            "m_payload": PaymenttermCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
