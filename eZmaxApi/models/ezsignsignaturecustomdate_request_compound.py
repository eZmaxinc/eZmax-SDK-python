...
class EzsignsignaturecustomdateRequestCompound(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pkiEzsignsignaturecustomdateID", "iEzsignsignaturecustomdateX", "iEzsignsignaturecustomdateY", "sEzsignsignaturecustomdateFormat"]
