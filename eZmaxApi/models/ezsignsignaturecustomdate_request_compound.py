...
class EzsignsignaturecustomdateRequestCompound(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignaturecustomdateRequestCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignaturecustomdateRequestCompound:
        """Create an instance of EzsignsignaturecustomdateRequestCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignaturecustomdateRequestCompound.parse_obj(obj)

        _obj = EzsignsignaturecustomdateRequestCompound.parse_obj({
