...
class EzsigntemplateelementdependencyRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplateelementdependencyRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplateelementdependencyRequest:
        """Create an instance of EzsigntemplateelementdependencyRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplateelementdependencyRequest.parse_obj(obj)

        _obj = EzsigntemplateelementdependencyRequest.parse_obj({
