...
class EzsignfolderGetEzsignfoldersignerassociationsmineV1Response(BaseModel):
    """
    Response for GET /1/object/ezsignfolder/{pkiEzsignfolder}/getEzsignfoldersignerassociationsmine  # noqa: E501
    """
    ...
    m_payload: EzsignfolderGetEzsignfoldersignerassociationsmineV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderGetEzsignfoldersignerassociationsmineV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderGetEzsignfoldersignerassociationsmineV1Response:
        """Create an instance of EzsignfolderGetEzsignfoldersignerassociationsmineV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderGetEzsignfoldersignerassociationsmineV1Response.parse_obj(obj)

        _obj = EzsignfolderGetEzsignfoldersignerassociationsmineV1Response.parse_obj({
            ...
            "m_payload": EzsignfolderGetEzsignfoldersignerassociationsmineV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
