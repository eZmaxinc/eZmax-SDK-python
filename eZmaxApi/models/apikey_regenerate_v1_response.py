...
class ApikeyRegenerateV1Response(BaseModel):
    """
    Response for GET /1/object/apikey/{pkiApikeyID}/regenerate  # noqa: E501
    """
    ...
    m_payload: ApikeyRegenerateV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApikeyRegenerateV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApikeyRegenerateV1Response:
        """Create an instance of ApikeyRegenerateV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApikeyRegenerateV1Response.parse_obj(obj)

        _obj = ApikeyRegenerateV1Response.parse_obj({
            ...
            "m_payload": ApikeyRegenerateV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
