...
class FranchisereferalincomeCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/franchisereferalincome  # noqa: E501
    """
    ...
    m_payload: FranchisereferalincomeCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FranchisereferalincomeCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FranchisereferalincomeCreateObjectV1Response:
        """Create an instance of FranchisereferalincomeCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FranchisereferalincomeCreateObjectV1Response.parse_obj(obj)

        _obj = FranchisereferalincomeCreateObjectV1Response.parse_obj({
            ...
            "m_payload": FranchisereferalincomeCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
