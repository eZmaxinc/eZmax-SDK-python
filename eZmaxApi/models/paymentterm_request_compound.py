...
class PaymenttermRequestCompound(BaseModel):
    """
    A Paymentterm Object and children  # noqa: E501
    """
    pki_paymentterm_id: Optional[StrictInt] = Field(None, alias="pkiPaymenttermID", description="The unique ID of the Paymentterm")
    ...
    __properties = ["pkiPaymenttermID", "sPaymenttermCode", "ePaymenttermType", "iPaymenttermDay", "objPaymenttermDescription", "bPaymenttermIsactive"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymenttermRequestCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymenttermRequestCompound:
        """Create an instance of PaymenttermRequestCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymenttermRequestCompound.parse_obj(obj)
