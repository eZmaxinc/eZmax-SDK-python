...
class TaxassignmentGetAutocompleteV2ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objTaxassignment": [TaxassignmentAutocompleteElementResponse.from_dict(_item) for _item in obj["a_objTaxassignment"]] if obj.get("a_objTaxassignment") is not None else None
        })
        return _obj
