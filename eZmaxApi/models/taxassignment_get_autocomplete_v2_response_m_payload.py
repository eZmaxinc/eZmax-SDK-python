...
class TaxassignmentGetAutocompleteV2ResponseMPayload(BaseModel):
    ...
    """ # noqa: E501
    a_obj_taxassignment: List[TaxassignmentAutocompleteElementResponse] = Field(description="An array of Taxassignment autocomplete element response.", alias="a_objTaxassignment")
    __properties: ClassVar[List[str]] = ["a_objTaxassignment"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objTaxassignment": [TaxassignmentAutocompleteElementResponse.from_dict(_item) for _item in obj.get("a_objTaxassignment")] if obj.get("a_objTaxassignment") is not None else None
        })
        return _obj
