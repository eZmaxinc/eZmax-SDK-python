...
class EzsignfolderSendV2Request(BaseModel):
    ...
    """ # noqa: E501
    t_ezsignfolder_message: StrictStr = Field(description="A custom text message that will be added to the email sent.", alias="tEzsignfolderMessage")
    ...
    a_obj_ezsignfoldersignerassociationmessage: List[CustomEzsignfoldersignerassociationmessageRequest] = Field(alias="a_objEzsignfoldersignerassociationmessage")
    __properties: ClassVar[List[str]] = ["tEzsignfolderMessage", "a_fkiEzsignfoldersignerassociationID", "a_objEzsignfoldersignerassociationmessage"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "a_objEzsignfoldersignerassociationmessage": [CustomEzsignfoldersignerassociationmessageRequest.from_dict(_item) for _item in obj.get("a_objEzsignfoldersignerassociationmessage")] if obj.get("a_objEzsignfoldersignerassociationmessage") is not None else None
        })
        return _obj
