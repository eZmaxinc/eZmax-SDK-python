...
class ApikeyGenerateDelegatedCredentialsV1ResponseMPayload(BaseModel):
    """
    Payload for POST /1/object/apikey/generateDelegatedCredentials
    """ # noqa: E501
    obj_apikey: CustomApikey = Field(alias="objApikey")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objApikey": CustomApikey.from_dict(obj["objApikey"]) if obj.get("objApikey") is not None else None
        })
        return _obj
