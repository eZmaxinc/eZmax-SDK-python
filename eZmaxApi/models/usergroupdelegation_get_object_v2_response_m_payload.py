...
class UsergroupdelegationGetObjectV2ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objUsergroupdelegation": UsergroupdelegationResponseCompound.from_dict(obj["objUsergroupdelegation"]) if obj.get("objUsergroupdelegation") is not None else None
        })
        return _obj
