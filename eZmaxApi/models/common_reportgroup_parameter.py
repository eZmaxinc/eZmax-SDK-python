...
class CommonReportgroupParameter(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sReportgroupParameterName": obj.get("sReportgroupParameterName"),
            "sReportgroupParameterValue": obj.get("sReportgroupParameterValue"),
            "a_sReportgroupParameterValue": obj.get("a_sReportgroupParameterValue")
        })
        return _obj
