...
class UsergroupGetListV1Response(BaseModel):
    """
    Response for GET /1/object/usergroup/getList  # noqa: E501
    """
    ...
    m_payload: UsergroupGetListV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupGetListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupGetListV1Response:
        """Create an instance of UsergroupGetListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupGetListV1Response.parse_obj(obj)

        _obj = UsergroupGetListV1Response.parse_obj({
            ...
            "m_payload": UsergroupGetListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
