...
class VariableexpenseCreateObjectV1ResponseMPayload(BaseModel):
    ...
    """ # noqa: E501
    a_pki_variableexpense_id: List[Annotated[int, Field(le=255, strict=True, ge=1)]] = Field(description="An array of unique IDs representing the object that were requested to be created.  They are returned in the same order as the array containing the objects to be created that was sent in the request.", alias="a_pkiVariableexpenseID")
    __properties: ClassVar[List[str]] = ["a_pkiVariableexpenseID"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_pkiVariableexpenseID": obj.get("a_pkiVariableexpenseID")
        })
        return _obj
