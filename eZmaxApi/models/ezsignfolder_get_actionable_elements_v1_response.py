...
class EzsignfolderGetActionableElementsV1Response(BaseModel):
    """
    Response for GET /1/object/ezsignfolder/{pkiEzsignfolderID}/getActionableElements  # noqa: E501
    """
    ...
    m_payload: EzsignfolderGetActionableElementsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderGetActionableElementsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderGetActionableElementsV1Response:
        """Create an instance of EzsignfolderGetActionableElementsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderGetActionableElementsV1Response.parse_obj(obj)

        _obj = EzsignfolderGetActionableElementsV1Response.parse_obj({
            ...
            "m_payload": EzsignfolderGetActionableElementsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
