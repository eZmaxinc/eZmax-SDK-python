...
class EzsigntemplateCreateObjectV3Request(BaseModel):
    """
    Request for POST /3/object/ezsigntemplate
    """ # noqa: E501
    a_obj_ezsigntemplate: Annotated[List[EzsigntemplateRequestCompoundV3], Field(min_length=1)] = Field(alias="a_objEzsigntemplate")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objEzsigntemplate": [EzsigntemplateRequestCompoundV3.from_dict(_item) for _item in obj["a_objEzsigntemplate"]] if obj.get("a_objEzsigntemplate") is not None else None
        })
        return _obj
