...
class WebhookEzsignDocumentCompleted(BaseModel):
    ...
    __properties = ["objWebhook", "a_objAttempt", "objEzsigndocument"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhookEzsignDocumentCompleted:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookEzsignDocumentCompleted:
        """Create an instance of WebhookEzsignDocumentCompleted from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookEzsignDocumentCompleted.parse_obj(obj)

        _obj = WebhookEzsignDocumentCompleted.parse_obj({
            ...
            "obj_ezsigndocument": EzsigndocumentResponse.from_dict(obj.get("objEzsigndocument")) if obj.get("objEzsigndocument") is not None else None
        })
        return _obj
