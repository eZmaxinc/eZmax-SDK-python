...
class EzsignfolderGetCommunicationCountV1Response(BaseModel):
    """
    ...
    m_payload: EzsignfolderGetCommunicationCountV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderGetCommunicationCountV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderGetCommunicationCountV1Response:
        """Create an instance of EzsignfolderGetCommunicationCountV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderGetCommunicationCountV1Response.parse_obj(obj)

        _obj = EzsignfolderGetCommunicationCountV1Response.parse_obj({
            ...
            "m_payload": EzsignfolderGetCommunicationCountV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
