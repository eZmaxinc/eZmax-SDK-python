...
class AttachmentGetAttachmentlogsV1Response(BaseModel):
    """
    ...
    m_payload: AttachmentGetAttachmentlogsV1ResponseMPayload = Field(alias="mPayload")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "mPayload": AttachmentGetAttachmentlogsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
