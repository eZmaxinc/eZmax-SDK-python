...
class UserEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/user/{pkiUserID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserEditObjectV1Response:
        """Create an instance of UserEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserEditObjectV1Response.parse_obj(obj)

        _obj = UserEditObjectV1Response.parse_obj({
