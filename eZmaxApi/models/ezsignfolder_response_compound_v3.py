...
class EzsignfolderResponseCompoundV3(BaseModel):
    """
    ...
    e_ezsignfolder_documentdependency: Optional[FieldEEzsignfolderDocumentdependency] = Field(default=None, alias="eEzsignfolderDocumentdependency")
    ...
    i_ezsignfolder_stepcurrent: Optional[Annotated[int, Field(le=255, strict=True, ge=0)]] = Field(default=None, description="The current step of the ezsignfolder when eEzsignfolderCompletion = 'PerEzsignfolderStepSync'", alias="iEzsignfolderStepcurrent", json_schema_extra={"examples": [30]})
    ...
    dt_ezsignfolder_archive: Optional[StrictStr] = Field(default=None, description="The date and time at which the Ezsignfolder was archived.", alias="dtEzsignfolderArchive", json_schema_extra={"examples": ["2020-12-31 23:59:59"]})
    dt_ezsignfolder_dispose: Optional[StrictStr] = Field(default=None, description="The date and time at which the Ezsignfolder was disposed.", alias="dtEzsignfolderDispose", json_schema_extra={"examples": ["2020-12-31 23:59:59"]})
