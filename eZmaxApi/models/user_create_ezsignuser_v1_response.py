...
class UserCreateEzsignuserV1Response(BaseModel):
    """
    Response for POST /1/module/user/createEzsignuser  # noqa: E501
    """
    ...
    m_payload: UserCreateEzsignuserV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserCreateEzsignuserV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserCreateEzsignuserV1Response:
        """Create an instance of UserCreateEzsignuserV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserCreateEzsignuserV1Response.parse_obj(obj)

        _obj = UserCreateEzsignuserV1Response.parse_obj({
            ...
            "m_payload": UserCreateEzsignuserV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
