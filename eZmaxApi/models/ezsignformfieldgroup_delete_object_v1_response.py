...
class EzsignformfieldgroupDeleteObjectV1Response(BaseModel):
    """
    Response for DELETE /1/object/ezsignformfieldgroup/{pkiEzsignformfieldgroupID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignformfieldgroupDeleteObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignformfieldgroupDeleteObjectV1Response:
        """Create an instance of EzsignformfieldgroupDeleteObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignformfieldgroupDeleteObjectV1Response.parse_obj(obj)

        _obj = EzsignformfieldgroupDeleteObjectV1Response.parse_obj({
