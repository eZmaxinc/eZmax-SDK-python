...
class UsergroupCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/usergroup  # noqa: E501
    """
    ...
    m_payload: UsergroupCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupCreateObjectV1Response:
        """Create an instance of UsergroupCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupCreateObjectV1Response.parse_obj(obj)

        _obj = UsergroupCreateObjectV1Response.parse_obj({
            ...
            "m_payload": UsergroupCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
