...
class UsergroupexternalGetUsergroupexternalmembershipsV1ResponseMPayload(BaseModel):
    """
    Response for GET /1/object/usergroupexternal/{pkiUsergroupexternalID}/getUsergroupexternalmemberships
    """ # noqa: E501
    a_obj_usergroupexternalmembership: List[UsergroupexternalmembershipResponseCompound] = Field(alias="a_objUsergroupexternalmembership")
    __properties: ClassVar[List[str]] = ["a_objUsergroupexternalmembership"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objUsergroupexternalmembership": [UsergroupexternalmembershipResponseCompound.from_dict(_item) for _item in obj["a_objUsergroupexternalmembership"]] if obj.get("a_objUsergroupexternalmembership") is not None else None
        })
        return _obj
