...
class EzsignfolderGetEzsignsignaturesV1Response(BaseModel):
    """
    ...
    m_payload: EzsignfolderGetEzsignsignaturesV1ResponseMPayload = Field(alias="mPayload")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mPayload": EzsignfolderGetEzsignsignaturesV1ResponseMPayload.from_dict(obj["mPayload"]) if obj.get("mPayload") is not None else None
        })
        return _obj
