...
class ClonehistoryGetListV1Response(BaseModel):
    """
    Response for GET /1/object/clonehistory/getList  # noqa: E501
    """
    ...
    m_payload: ClonehistoryGetListV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClonehistoryGetListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClonehistoryGetListV1Response:
        """Create an instance of ClonehistoryGetListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClonehistoryGetListV1Response.parse_obj(obj)

        _obj = ClonehistoryGetListV1Response.parse_obj({
            ...
            "m_payload": ClonehistoryGetListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
