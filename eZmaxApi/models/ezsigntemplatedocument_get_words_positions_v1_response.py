...
class EzsigntemplatedocumentGetWordsPositionsV1Response(BaseModel):
    ...
    m_payload: List[CustomWordPositionWordResponse] = Field(description="Payload for POST /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/getWordsPositions", alias="mPayload")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.m_payload:
            for _item_m_payload in self.m_payload:
                if _item_m_payload:
                    _items.append(_item_m_payload.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mPayload": [CustomWordPositionWordResponse.from_dict(_item) for _item in obj["mPayload"]] if obj.get("mPayload") is not None else None
        })
        return _obj
