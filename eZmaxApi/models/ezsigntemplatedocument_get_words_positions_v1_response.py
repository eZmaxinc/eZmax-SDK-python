...
class EzsigntemplatedocumentGetWordsPositionsV1Response(BaseModel):
    """
    Response for POST /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/getWordsPositions  # noqa: E501
    """
    ...
    m_payload: conlist(CustomWordPositionWordResponse) = Field(..., alias="mPayload", description="Payload for POST /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/getWordsPositions")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatedocumentGetWordsPositionsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatedocumentGetWordsPositionsV1Response:
        """Create an instance of EzsigntemplatedocumentGetWordsPositionsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatedocumentGetWordsPositionsV1Response.parse_obj(obj)

        _obj = EzsigntemplatedocumentGetWordsPositionsV1Response.parse_obj({
            ...
            "m_payload": [CustomWordPositionWordResponse.from_dict(_item) for _item in obj.get("mPayload")] if obj.get("mPayload") is not None else None
        })
        return _obj
