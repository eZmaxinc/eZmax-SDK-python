...
class EzsignfoldertypeGetAutocompleteV2ResponseMPayload(BaseModel):
    ...
    """ # noqa: E501
    a_obj_ezsignfoldertype: List[EzsignfoldertypeAutocompleteElementResponse] = Field(description="An array of Ezsignfoldertype autocomplete element response.", alias="a_objEzsignfoldertype")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objEzsignfoldertype": [EzsignfoldertypeAutocompleteElementResponse.from_dict(_item) for _item in obj.get("a_objEzsignfoldertype")] if obj.get("a_objEzsignfoldertype") is not None else None
        })
        return _obj
