...
class UserEditPermissionsV1Response(BaseModel):
    """
    Response for PUT /1/object/user/{pkiUserID}/editPermissions  # noqa: E501
    """
    ...
    m_payload: UserEditPermissionsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserEditPermissionsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserEditPermissionsV1Response:
        """Create an instance of UserEditPermissionsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserEditPermissionsV1Response.parse_obj(obj)

        _obj = UserEditPermissionsV1Response.parse_obj({
            ...
            "m_payload": UserEditPermissionsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
