...
class EzsigntemplatepublicCreateEzsignfolderV1Response(BaseModel):
    """
    ...
    m_payload: EzsigntemplatepublicCreateEzsignfolderV1ResponseMPayload = Field(alias="mPayload")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mPayload": EzsigntemplatepublicCreateEzsignfolderV1ResponseMPayload.from_dict(obj["mPayload"]) if obj.get("mPayload") is not None else None
        })
        return _obj
