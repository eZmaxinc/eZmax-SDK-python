...
class AuthenticationexternalGetAutocompleteV2ResponseMPayload(BaseModel):
    """
    Payload for POST /2/object/authenticationexternal/getAutocomplete
    """ # noqa: E501
    a_obj_authenticationexternal: List[AuthenticationexternalAutocompleteElementResponse] = Field(description="An array of Authenticationexternal autocomplete element response.", alias="a_objAuthenticationexternal")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objAuthenticationexternal": [AuthenticationexternalAutocompleteElementResponse.from_dict(_item) for _item in obj["a_objAuthenticationexternal"]] if obj.get("a_objAuthenticationexternal") is not None else None
        })
        return _obj
