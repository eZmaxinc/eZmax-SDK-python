...
class AddressRequestCompound(BaseModel):
    ...
    s_address_suite: StrictStr = Field(description="The Suite or appartment number", alias="sAddressSuite")
    ...
    __properties: ClassVar[List[str]] = ["fkiAddresstypeID", "sAddressCivic", "sAddressStreet", "sAddressSuite", "sAddressCity", "fkiProvinceID", "fkiCountryID", "sAddressZip", "fAddressLongitude", "fAddressLatitude"]
