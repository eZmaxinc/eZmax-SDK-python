...
class CommunicationSendV1Request(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objCommunication": [CommunicationRequestCompound.from_dict(_item) for _item in obj["a_objCommunication"]] if obj.get("a_objCommunication") is not None else None
        })
        return _obj
