...
class CommunicationSendV1Request(BaseModel):
    ...
    """ # noqa: E501
    a_obj_communication: Annotated[List[CommunicationRequestCompound], Field(min_length=1)] = Field(alias="a_objCommunication")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objCommunication": [CommunicationRequestCompound.from_dict(_item) for _item in obj.get("a_objCommunication")] if obj.get("a_objCommunication") is not None else None
        })
        return _obj
