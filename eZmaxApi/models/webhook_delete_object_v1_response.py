...
class WebhookDeleteObjectV1Response(BaseModel):
    """
    Response for DELETE /1/object/webhook/{pkiWebhookID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhookDeleteObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookDeleteObjectV1Response:
        """Create an instance of WebhookDeleteObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookDeleteObjectV1Response.parse_obj(obj)

        _obj = WebhookDeleteObjectV1Response.parse_obj({
