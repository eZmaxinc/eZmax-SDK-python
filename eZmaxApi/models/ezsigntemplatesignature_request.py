...
class EzsigntemplatesignatureRequest(BaseModel):
    ...
    """
    pki_ezsigntemplatesignature_id: Optional[conint(strict=True, ge=0)] = Field(None, alias="pkiEzsigntemplatesignatureID", description="The unique ID of the Ezsigntemplatesignature")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatesignatureRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatesignatureRequest:
        """Create an instance of EzsigntemplatesignatureRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatesignatureRequest.parse_obj(obj)

        _obj = EzsigntemplatesignatureRequest.parse_obj({
