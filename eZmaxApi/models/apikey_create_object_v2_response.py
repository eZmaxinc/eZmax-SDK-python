...
class ApikeyCreateObjectV2Response(BaseModel):
    """
    Response for POST /2/object/apikey  # noqa: E501
    """
    ...
    m_payload: ApikeyCreateObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApikeyCreateObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApikeyCreateObjectV2Response:
        """Create an instance of ApikeyCreateObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApikeyCreateObjectV2Response.parse_obj(obj)

        _obj = ApikeyCreateObjectV2Response.parse_obj({
            ...
            "m_payload": ApikeyCreateObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
