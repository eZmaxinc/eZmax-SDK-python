...
class SecretquestionGetAutocompleteV2ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objSecretquestion": [SecretquestionAutocompleteElementResponse.from_dict(_item) for _item in obj.get("a_objSecretquestion")] if obj.get("a_objSecretquestion") is not None else None
        })
        return _obj
