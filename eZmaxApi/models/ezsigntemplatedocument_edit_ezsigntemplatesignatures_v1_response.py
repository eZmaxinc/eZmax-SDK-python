...
class EzsigntemplatedocumentEditEzsigntemplatesignaturesV1Response(BaseModel):
    """
    Response for PUT /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/editEzsigntemplatesignatures  # noqa: E501
    """
    ...
    m_payload: EzsigntemplatedocumentEditEzsigntemplatesignaturesV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatedocumentEditEzsigntemplatesignaturesV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatedocumentEditEzsigntemplatesignaturesV1Response:
        """Create an instance of EzsigntemplatedocumentEditEzsigntemplatesignaturesV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatedocumentEditEzsigntemplatesignaturesV1Response.parse_obj(obj)

        _obj = EzsigntemplatedocumentEditEzsigntemplatesignaturesV1Response.parse_obj({
            ...
            "m_payload": EzsigntemplatedocumentEditEzsigntemplatesignaturesV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
