...
class EzsignfoldersignerassociationResponseCompound(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfoldersignerassociationResponseCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfoldersignerassociationResponseCompound:
        """Create an instance of EzsignfoldersignerassociationResponseCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfoldersignerassociationResponseCompound.parse_obj(obj)

        _obj = EzsignfoldersignerassociationResponseCompound.parse_obj({
