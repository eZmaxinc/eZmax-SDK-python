...
class EzsigndocumentGetDownloadUrlV1Response(BaseModel):
    """
    Response for GET /1/object/ezsigndocument/{pkiEzsigndocument}/getDownloadUrl  # noqa: E501
    """
    ...
    m_payload: EzsigndocumentGetDownloadUrlV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentGetDownloadUrlV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentGetDownloadUrlV1Response:
        """Create an instance of EzsigndocumentGetDownloadUrlV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentGetDownloadUrlV1Response.parse_obj(obj)

        _obj = EzsigndocumentGetDownloadUrlV1Response.parse_obj({
            ...
            "m_payload": EzsigndocumentGetDownloadUrlV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
