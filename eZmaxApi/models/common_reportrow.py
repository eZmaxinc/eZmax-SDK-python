...
class CommonReportrow(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of obj_reportcellstyle_custom
        if self.obj_reportcellstyle_custom:
            _dict['objReportcellstyleCustom'] = self.obj_reportcellstyle_custom.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "objReportcellstyleCustom": CommonReportcellstylecustom.from_dict(obj["objReportcellstyleCustom"]) if obj.get("objReportcellstyleCustom") is not None else None
        })
        return _obj
