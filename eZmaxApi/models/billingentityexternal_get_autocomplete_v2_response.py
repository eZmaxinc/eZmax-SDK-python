...
class BillingentityexternalGetAutocompleteV2Response(BaseModel):
    """
    Response for GET /2/object/billingentityexternal/getAutocomplete  # noqa: E501
    """
    ...
    m_payload: BillingentityexternalGetAutocompleteV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillingentityexternalGetAutocompleteV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillingentityexternalGetAutocompleteV2Response:
        """Create an instance of BillingentityexternalGetAutocompleteV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillingentityexternalGetAutocompleteV2Response.parse_obj(obj)

        _obj = BillingentityexternalGetAutocompleteV2Response.parse_obj({
            ...
            "m_payload": BillingentityexternalGetAutocompleteV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
