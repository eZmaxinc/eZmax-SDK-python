...
class SignatureDeleteObjectV1Response(BaseModel):
    """
    Response for DELETE /1/object/signature/{pkiSignatureID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SignatureDeleteObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SignatureDeleteObjectV1Response:
        """Create an instance of SignatureDeleteObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SignatureDeleteObjectV1Response.parse_obj(obj)

        _obj = SignatureDeleteObjectV1Response.parse_obj({
