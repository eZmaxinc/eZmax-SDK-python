...
class EzsignformfieldResponseCompound(BaseModel):
    ...
    """ # noqa: E501
    pki_ezsignformfield_id: Annotated[int, Field(strict=True, ge=0)] = Field(description="The unique ID of the Ezsignformfield", alias="pkiEzsignformfieldID", json_schema_extra={"examples": [32]})
    ...
    s_ezsignformfield_value: Optional[StrictStr] = Field(default=None, description="The value for the Ezsignformfield  This can only be set if eEzsignformfieldgroupType is Checkbox or Radio", alias="sEzsignformfieldValue", json_schema_extra={"examples": ["Yes"]})
    i_ezsignformfield_x: Annotated[int, Field(strict=True, ge=0)] = Field(description="The X coordinate (Horizontal) where to put the Ezsignformfield on the Ezsignpage.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the Ezsignformfield 2 inches from the left border of the page, you would use \"200\" for the X coordinate.", alias="iEzsignformfieldX", json_schema_extra={"examples": [200]})
    ...
    i_ezsignformfield_width: Annotated[int, Field(strict=True, ge=0)] = Field(description="The Width of the Ezsignformfield in pixels calculated at 100 DPI", alias="iEzsignformfieldWidth", json_schema_extra={"examples": [102]})
    i_ezsignformfield_height: Annotated[int, Field(strict=True, ge=0)] = Field(description="The Height of the Ezsignformfield in pixels calculated at 100 DPI ", alias="iEzsignformfieldHeight", json_schema_extra={"examples": [22]})
