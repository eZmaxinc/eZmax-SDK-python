...
class EzsignformfieldResponseCompound(BaseModel):
    """
    An Ezsignformfield Object and children to create a complete structure  # noqa: E501
    """
    pki_ezsignformfield_id: conint(strict=True, ge=0) = Field(..., alias="pkiEzsignformfieldID", description="The unique ID of the Ezsignformfield")
    ...
    __properties = ["pkiEzsignformfieldID", "iEzsignpagePagenumber", "sEzsignformfieldLabel", "sEzsignformfieldValue", "iEzsignformfieldX", "iEzsignformfieldY", "iEzsignformfieldWidth", "iEzsignformfieldHeight", "bEzsignformfieldSelected", "sEzsignformfieldEnteredvalue"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignformfieldResponseCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignformfieldResponseCompound:
        """Create an instance of EzsignformfieldResponseCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignformfieldResponseCompound.parse_obj(obj)

        _obj = EzsignformfieldResponseCompound.parse_obj({
