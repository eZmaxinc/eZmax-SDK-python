...
class EzsignbulksendtransmissionResponse(BaseModel):
    """
    An Ezsignbulksendtransmission Object  # noqa: E501
    """
    ...
    __properties = ["pkiEzsignbulksendtransmissionID", "fkiEzsignbulksendID", "sEzsignbulksendtransmissionDescription", "iEzsignbulksendtransmissionErrors", "objAudit"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignbulksendtransmissionResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignbulksendtransmissionResponse:
        """Create an instance of EzsignbulksendtransmissionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignbulksendtransmissionResponse.parse_obj(obj)

        _obj = EzsignbulksendtransmissionResponse.parse_obj({
