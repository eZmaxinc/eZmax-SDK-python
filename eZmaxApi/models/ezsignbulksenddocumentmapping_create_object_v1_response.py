...
class EzsignbulksenddocumentmappingCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/ezsignbulksenddocumentmapping  # noqa: E501
    """
    ...
    m_payload: EzsignbulksenddocumentmappingCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignbulksenddocumentmappingCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignbulksenddocumentmappingCreateObjectV1Response:
        """Create an instance of EzsignbulksenddocumentmappingCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignbulksenddocumentmappingCreateObjectV1Response.parse_obj(obj)

        _obj = EzsignbulksenddocumentmappingCreateObjectV1Response.parse_obj({
            ...
            "m_payload": EzsignbulksenddocumentmappingCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
