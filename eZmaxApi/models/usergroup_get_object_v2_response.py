...
class UsergroupGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/usergroup/{pkiUsergroupID}  # noqa: E501
    """
    ...
    m_payload: UsergroupGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupGetObjectV2Response:
        """Create an instance of UsergroupGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupGetObjectV2Response.parse_obj(obj)

        _obj = UsergroupGetObjectV2Response.parse_obj({
            ...
            "m_payload": UsergroupGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
