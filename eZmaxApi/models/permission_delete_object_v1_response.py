...
class PermissionDeleteObjectV1Response(BaseModel):
    """
    Response for DELETE /1/object/permission/{pkiPermissionID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PermissionDeleteObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PermissionDeleteObjectV1Response:
        """Create an instance of PermissionDeleteObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PermissionDeleteObjectV1Response.parse_obj(obj)

        _obj = PermissionDeleteObjectV1Response.parse_obj({
