...
class FieldEErrorCode(str, Enum):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FieldEErrorCode:
        """Create an instance of FieldEErrorCode from a JSON string"""
        return FieldEErrorCode(json.loads(json_str))
