...
class CustomEzsigndocumentEzsignsignaturesAutomaticResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "a_objEzsignsignature": [CustomEzsignsignatureEzsignsignaturesAutomaticResponse.from_dict(_item) for _item in obj["a_objEzsignsignature"]] if obj.get("a_objEzsignsignature") is not None else None
        })
        return _obj
