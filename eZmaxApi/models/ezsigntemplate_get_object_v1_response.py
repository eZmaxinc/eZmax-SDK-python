...
class EzsigntemplateGetObjectV1Response(BaseModel):
    """
    Response for GET /1/object/ezsigntemplate/{pkiEzsigntemplateID}  # noqa: E501
    """
    ...
    m_payload: EzsigntemplateGetObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplateGetObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplateGetObjectV1Response:
        """Create an instance of EzsigntemplateGetObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplateGetObjectV1Response.parse_obj(obj)

        _obj = EzsigntemplateGetObjectV1Response.parse_obj({
            ...
            "m_payload": EzsigntemplateGetObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
