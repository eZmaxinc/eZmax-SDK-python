...
class EzsignfolderGetEzsignfoldersignerassociationsV1ResponseMPayload(BaseModel):
    ...
    """ # noqa: E501
    a_obj_ezsignfoldersignerassociation: List[CustomEzsignfoldersignerassociationActionableElementResponse] = Field(alias="a_objEzsignfoldersignerassociation")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objEzsignfoldersignerassociation": [CustomEzsignfoldersignerassociationActionableElementResponse.from_dict(_item) for _item in obj.get("a_objEzsignfoldersignerassociation")] if obj.get("a_objEzsignfoldersignerassociation") is not None else None
        })
        return _obj
