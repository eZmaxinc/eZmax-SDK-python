...
class MultilingualEzmaxcustomerCompany(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sEzmaxcustomerCompany1": obj.get("sEzmaxcustomerCompany1"),
            "sEzmaxcustomerCompany2": obj.get("sEzmaxcustomerCompany2")
        })
        return _obj
