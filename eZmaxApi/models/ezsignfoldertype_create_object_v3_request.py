...
class EzsignfoldertypeCreateObjectV3Request(BaseModel):
    """
    Request for POST /3/object/ezsignfoldertype
    """ # noqa: E501
    a_obj_ezsignfoldertype: Annotated[List[EzsignfoldertypeRequestCompoundV3], Field(min_length=1)] = Field(alias="a_objEzsignfoldertype")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objEzsignfoldertype": [EzsignfoldertypeRequestCompoundV3.from_dict(_item) for _item in obj["a_objEzsignfoldertype"]] if obj.get("a_objEzsignfoldertype") is not None else None
        })
        return _obj
