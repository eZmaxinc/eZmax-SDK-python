...
class CommunicationGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/communication/{pkiCommunicationID}  # noqa: E501
    """
    ...
    m_payload: CommunicationGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommunicationGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommunicationGetObjectV2Response:
        """Create an instance of CommunicationGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommunicationGetObjectV2Response.parse_obj(obj)

        _obj = CommunicationGetObjectV2Response.parse_obj({
            ...
            "m_payload": CommunicationGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
