...
class EzsigntemplatedocumentGetEzsigntemplatesignaturesV1ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objEzsigntemplatesignature": [EzsigntemplatesignatureResponseCompound.from_dict(_item) for _item in obj["a_objEzsigntemplatesignature"]] if obj.get("a_objEzsigntemplatesignature") is not None else None
        })
        return _obj
