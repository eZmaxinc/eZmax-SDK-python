...
class EzsigntemplatedocumentGetEzsigntemplatesignaturesV1ResponseMPayload(BaseModel):
    ...
    """ # noqa: E501
    a_obj_ezsigntemplatesignature: List[EzsigntemplatesignatureResponseCompound] = Field(alias="a_objEzsigntemplatesignature")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objEzsigntemplatesignature": [EzsigntemplatesignatureResponseCompound.from_dict(_item) for _item in obj.get("a_objEzsigntemplatesignature")] if obj.get("a_objEzsigntemplatesignature") is not None else None
        })
        return _obj
