...
class SupplyGetAutocompleteV2ResponseMPayload(BaseModel):
    """
    Payload for POST /2/object/supply/getAutocomplete
    """ # noqa: E501
    a_obj_supply: List[SupplyAutocompleteElementResponse] = Field(description="An array of Supply autocomplete element response.", alias="a_objSupply")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objSupply": [SupplyAutocompleteElementResponse.from_dict(_item) for _item in obj["a_objSupply"]] if obj.get("a_objSupply") is not None else None
        })
        return _obj
