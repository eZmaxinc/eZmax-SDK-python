...
class BuyercontractGetCommunicationListV1Response(BaseModel):
    """
    ...
    m_payload: BuyercontractGetCommunicationListV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BuyercontractGetCommunicationListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BuyercontractGetCommunicationListV1Response:
        """Create an instance of BuyercontractGetCommunicationListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BuyercontractGetCommunicationListV1Response.parse_obj(obj)

        _obj = BuyercontractGetCommunicationListV1Response.parse_obj({
            ...
            "m_payload": BuyercontractGetCommunicationListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
