...
class UserCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/user  # noqa: E501
    """
    ...
    m_payload: UserCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserCreateObjectV1Response:
        """Create an instance of UserCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserCreateObjectV1Response.parse_obj(obj)

        _obj = UserCreateObjectV1Response.parse_obj({
            ...
            "m_payload": UserCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
