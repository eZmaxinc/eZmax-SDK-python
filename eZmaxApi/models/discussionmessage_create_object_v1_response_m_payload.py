...
class DiscussionmessageCreateObjectV1ResponseMPayload(BaseModel):
    """
    Payload for POST /1/object/discussionmessage
    """ # noqa: E501
    a_pki_discussionmessage_id: List[Annotated[int, Field(le=16777215, strict=True, ge=0)]] = Field(description="An array of unique IDs representing the object that were requested to be created.  They are returned in the same order as the array containing the objects to be created that was sent in the request.", alias="a_pkiDiscussionmessageID")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_pkiDiscussionmessageID": obj.get("a_pkiDiscussionmessageID")
        })
        return _obj
