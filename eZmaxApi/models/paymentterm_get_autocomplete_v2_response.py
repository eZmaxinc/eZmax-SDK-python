...
class PaymenttermGetAutocompleteV2Response(BaseModel):
    """
    Response for GET /2/object/paymentterm/getAutocomplete  # noqa: E501
    """
    ...
    m_payload: PaymenttermGetAutocompleteV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymenttermGetAutocompleteV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymenttermGetAutocompleteV2Response:
        """Create an instance of PaymenttermGetAutocompleteV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymenttermGetAutocompleteV2Response.parse_obj(obj)

        _obj = PaymenttermGetAutocompleteV2Response.parse_obj({
            ...
            "m_payload": PaymenttermGetAutocompleteV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
