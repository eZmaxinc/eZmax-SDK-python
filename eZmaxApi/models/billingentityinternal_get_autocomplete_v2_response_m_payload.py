...
class BillingentityinternalGetAutocompleteV2ResponseMPayload(BaseModel):
    ...
    """ # noqa: E501
    a_obj_billingentityinternal: List[BillingentityinternalAutocompleteElementResponse] = Field(description="An array of Billingentityinternal object containing the description, ID and active status about the element.", alias="a_objBillingentityinternal")
    __properties: ClassVar[List[str]] = ["a_objBillingentityinternal"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objBillingentityinternal": [BillingentityinternalAutocompleteElementResponse.from_dict(_item) for _item in obj.get("a_objBillingentityinternal")] if obj.get("a_objBillingentityinternal") is not None else None
        })
        return _obj
