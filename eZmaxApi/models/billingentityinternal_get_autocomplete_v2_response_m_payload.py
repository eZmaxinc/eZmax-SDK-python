...
class BillingentityinternalGetAutocompleteV2ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objBillingentityinternal": [BillingentityinternalAutocompleteElementResponse.from_dict(_item) for _item in obj["a_objBillingentityinternal"]] if obj.get("a_objBillingentityinternal") is not None else None
        })
        return _obj
