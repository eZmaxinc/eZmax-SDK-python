...
class EzsignfolderResponse(BaseModel):
    """
    An Ezsignfolder Object  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderResponse:
        """Create an instance of EzsignfolderResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderResponse.parse_obj(obj)

        _obj = EzsignfolderResponse.parse_obj({
