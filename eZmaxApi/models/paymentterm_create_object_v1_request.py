...
class PaymenttermCreateObjectV1Request(BaseModel):
    ...
    """ # noqa: E501
    a_obj_paymentterm: Annotated[List[PaymenttermRequestCompound], Field(min_length=1)] = Field(alias="a_objPaymentterm")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objPaymentterm": [PaymenttermRequestCompound.from_dict(_item) for _item in obj.get("a_objPaymentterm")] if obj.get("a_objPaymentterm") is not None else None
        })
        return _obj
