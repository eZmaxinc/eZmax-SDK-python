...
class EzsigndocumentFlattenV1Response(BaseModel):
    """
    Response for POST /1/object/ezsigndocument/{pkiEzsigndocument}/flatten  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentFlattenV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentFlattenV1Response:
        """Create an instance of EzsigndocumentFlattenV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentFlattenV1Response.parse_obj(obj)

        _obj = EzsigndocumentFlattenV1Response.parse_obj({
