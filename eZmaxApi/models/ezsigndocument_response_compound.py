...
class EzsigndocumentResponseCompound(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentResponseCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentResponseCompound:
        """Create an instance of EzsigndocumentResponseCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentResponseCompound.parse_obj(obj)

        _obj = EzsigndocumentResponseCompound.parse_obj({
