...
class EzsignfoldertypeRequestCompoundV3(BaseModel):
    ...
    b_ezsignfoldertype_sendattachmentreceivecopy: Optional[StrictBool] = Field(default=None, description="Whether we send the Ezsigndocument in the email to Ezsignsigner or User when bEzsignfoldersignerassociationReceivecopy = 1", alias="bEzsignfoldertypeSendattachmentreceivecopy")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bEzsignfoldertypeSendattachmentreceivecopy": obj.get("bEzsignfoldertypeSendattachmentreceivecopy"),
