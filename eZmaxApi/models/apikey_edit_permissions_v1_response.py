...
class ApikeyEditPermissionsV1Response(BaseModel):
    """
    Response for PUT /1/object/apikey/{pkiApikeyID}/editPermissions  # noqa: E501
    """
    ...
    m_payload: ApikeyEditPermissionsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApikeyEditPermissionsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApikeyEditPermissionsV1Response:
        """Create an instance of ApikeyEditPermissionsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApikeyEditPermissionsV1Response.parse_obj(obj)

        _obj = ApikeyEditPermissionsV1Response.parse_obj({
            ...
            "m_payload": ApikeyEditPermissionsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
