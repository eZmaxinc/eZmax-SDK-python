...
class PaymenttermGetAutocompleteV2ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objPaymentterm": [PaymenttermAutocompleteElementResponse.from_dict(_item) for _item in obj["a_objPaymentterm"]] if obj.get("a_objPaymentterm") is not None else None
        })
        return _obj
