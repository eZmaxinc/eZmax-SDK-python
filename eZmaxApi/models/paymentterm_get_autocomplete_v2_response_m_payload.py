...
class PaymenttermGetAutocompleteV2ResponseMPayload(BaseModel):
    ...
    """ # noqa: E501
    a_obj_paymentterm: List[PaymenttermAutocompleteElementResponse] = Field(description="An array of Paymentterm autocomplete element response.", alias="a_objPaymentterm")
    __properties: ClassVar[List[str]] = ["a_objPaymentterm"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objPaymentterm": [PaymenttermAutocompleteElementResponse.from_dict(_item) for _item in obj.get("a_objPaymentterm")] if obj.get("a_objPaymentterm") is not None else None
        })
        return _obj
