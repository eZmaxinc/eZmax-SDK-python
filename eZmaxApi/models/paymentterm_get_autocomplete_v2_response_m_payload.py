...
class PaymenttermGetAutocompleteV2ResponseMPayload(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymenttermGetAutocompleteV2ResponseMPayload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymenttermGetAutocompleteV2ResponseMPayload:
        """Create an instance of PaymenttermGetAutocompleteV2ResponseMPayload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymenttermGetAutocompleteV2ResponseMPayload.parse_obj(obj)

        _obj = PaymenttermGetAutocompleteV2ResponseMPayload.parse_obj({
            "a_obj_paymentterm": [PaymenttermAutocompleteElementResponse.from_dict(_item) for _item in obj.get("a_objPaymentterm")] if obj.get("a_objPaymentterm") is not None else None
        })
        return _obj
