...
class PermissionCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/permission  # noqa: E501
    """
    ...
    m_payload: PermissionCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PermissionCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PermissionCreateObjectV1Response:
        """Create an instance of PermissionCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PermissionCreateObjectV1Response.parse_obj(obj)

        _obj = PermissionCreateObjectV1Response.parse_obj({
            ...
            "m_payload": PermissionCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
