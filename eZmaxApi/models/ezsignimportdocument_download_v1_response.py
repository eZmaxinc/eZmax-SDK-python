...
class EzsignimportdocumentDownloadV1Response(BaseModel):
    """
    ...
    m_payload: Dict[str, Any] = Field(description="Response for GET /1/object/ezsignimportdocument/{pkiEzsignimportdocumentID}/download", alias="mPayload")
