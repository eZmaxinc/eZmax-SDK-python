...
class EzsignelementdependencyResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignelementdependencyResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignelementdependencyResponse:
        """Create an instance of EzsignelementdependencyResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignelementdependencyResponse.parse_obj(obj)

        _obj = EzsignelementdependencyResponse.parse_obj({
