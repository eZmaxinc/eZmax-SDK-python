...
class EzsignfolderCreateObjectV2Response(BaseModel):
    """
    Response for POST /2/object/ezsignfolder  # noqa: E501
    """
    ...
    m_payload: EzsignfolderCreateObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderCreateObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderCreateObjectV2Response:
        """Create an instance of EzsignfolderCreateObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderCreateObjectV2Response.parse_obj(obj)

        _obj = EzsignfolderCreateObjectV2Response.parse_obj({
            ...
            "m_payload": EzsignfolderCreateObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
