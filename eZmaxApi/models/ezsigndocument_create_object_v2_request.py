...
class EzsigndocumentCreateObjectV2Request(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objEzsigndocument": [EzsigndocumentRequestCompound.from_dict(_item) for _item in obj.get("a_objEzsigndocument")] if obj.get("a_objEzsigndocument") is not None else None
        })
        return _obj
