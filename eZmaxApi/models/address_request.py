...
class AddressRequest(BaseModel):
    ...
    An Address Object
    """ # noqa: E501
    pki_address_id: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The unique ID of the Address", alias="pkiAddressID", json_schema_extra={"examples": [142]})
