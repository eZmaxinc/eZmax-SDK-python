...
class EzsigntemplatedocumentpagerecognitionRequestCompound(BaseModel):
    ...
    """ # noqa: E501
    pki_ezsigntemplatedocumentpagerecognition_id: Optional[Annotated[int, Field(le=65535, strict=True, ge=0)]] = Field(default=None, description="The unique ID of the Ezsigntemplatedocumentpagerecognition", alias="pkiEzsigntemplatedocumentpagerecognitionID")
