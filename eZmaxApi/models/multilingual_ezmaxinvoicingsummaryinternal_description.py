...
class MultilingualEzmaxinvoicingsummaryinternalDescription(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "sEzmaxinvoicingsummaryinternalDescription1": obj.get("sEzmaxinvoicingsummaryinternalDescription1"),
            "sEzmaxinvoicingsummaryinternalDescription2": obj.get("sEzmaxinvoicingsummaryinternalDescription2")
        })
        return _obj
