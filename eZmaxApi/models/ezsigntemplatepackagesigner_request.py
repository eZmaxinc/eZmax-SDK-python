...
class EzsigntemplatepackagesignerRequest(BaseModel):
    ...
    """ # noqa: E501
    pki_ezsigntemplatepackagesigner_id: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The unique ID of the Ezsigntemplatepackagesigner", alias="pkiEzsigntemplatepackagesignerID", json_schema_extra={"examples": [174]})
