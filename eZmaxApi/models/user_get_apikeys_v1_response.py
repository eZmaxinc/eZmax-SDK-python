...
class UserGetApikeysV1Response(BaseModel):
    """
    ...
    m_payload: UserGetApikeysV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserGetApikeysV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserGetApikeysV1Response:
        """Create an instance of UserGetApikeysV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserGetApikeysV1Response.parse_obj(obj)

        _obj = UserGetApikeysV1Response.parse_obj({
            ...
            "m_payload": UserGetApikeysV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
