...
class SubnetDeleteObjectV1Response(BaseModel):
    """
    Response for DELETE /1/object/subnet/{pkiSubnetID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubnetDeleteObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubnetDeleteObjectV1Response:
        """Create an instance of SubnetDeleteObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubnetDeleteObjectV1Response.parse_obj(obj)

        _obj = SubnetDeleteObjectV1Response.parse_obj({
