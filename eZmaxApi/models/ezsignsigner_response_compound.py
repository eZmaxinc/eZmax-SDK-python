...
class EzsignsignerResponseCompound(BaseModel):
    ...
    __properties = ["pkiEzsignsignerID", "fkiTaxassignmentID", "fkiSecretquestionID", "fkiUserlogintypeID", "sUserlogintypeDescriptionX", "objContact"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignerResponseCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignerResponseCompound:
        """Create an instance of EzsignsignerResponseCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignerResponseCompound.parse_obj(obj)

        _obj = EzsignsignerResponseCompound.parse_obj({
            ...
            "obj_contact": EzsignsignerResponseCompoundContact.from_dict(obj.get("objContact")) if obj.get("objContact") is not None else None
        })
        return _obj
