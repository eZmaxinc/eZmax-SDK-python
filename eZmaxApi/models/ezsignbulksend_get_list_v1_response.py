...
class EzsignbulksendGetListV1Response(BaseModel):
    """
    Response for GET /1/object/ezsignbulksend/getList  # noqa: E501
    """
    ...
    m_payload: EzsignbulksendGetListV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignbulksendGetListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignbulksendGetListV1Response:
        """Create an instance of EzsignbulksendGetListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignbulksendGetListV1Response.parse_obj(obj)

        _obj = EzsignbulksendGetListV1Response.parse_obj({
            ...
            "m_payload": EzsignbulksendGetListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
