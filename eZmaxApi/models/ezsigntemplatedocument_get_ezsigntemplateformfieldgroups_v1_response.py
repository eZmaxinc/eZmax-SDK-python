...
class EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response(BaseModel):
    """
    Response for GET /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocument}/getEzsigntemplateformfieldgroups  # noqa: E501
    """
    ...
    m_payload: EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response:
        """Create an instance of EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response.parse_obj(obj)

        _obj = EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1Response.parse_obj({
            ...
            "m_payload": EzsigntemplatedocumentGetEzsigntemplateformfieldgroupsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
