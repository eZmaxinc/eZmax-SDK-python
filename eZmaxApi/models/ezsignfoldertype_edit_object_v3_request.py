...
class EzsignfoldertypeEditObjectV3Request(BaseModel):
    """
    Request for PUT /3/object/ezsignfoldertype/{pkiEzsignfoldertypeID}
    """ # noqa: E501
    obj_ezsignfoldertype: EzsignfoldertypeRequestCompoundV3 = Field(alias="objEzsignfoldertype")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objEzsignfoldertype": EzsignfoldertypeRequestCompoundV3.from_dict(obj["objEzsignfoldertype"]) if obj.get("objEzsignfoldertype") is not None else None
        })
        return _obj
