...
class TextstylestaticResponse(BaseModel):
    ...
    """ # noqa: E501
    pki_textstylestatic_id: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The unique ID of the Textstylestatic", alias="pkiTextstylestaticID", json_schema_extra={"examples": [216]})
