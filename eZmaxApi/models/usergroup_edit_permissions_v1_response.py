...
class UsergroupEditPermissionsV1Response(BaseModel):
    """
    Response for PUT /1/object/usergroup/{pkiUsergroupID}/editPermissions  # noqa: E501
    """
    ...
    m_payload: UsergroupEditPermissionsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupEditPermissionsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupEditPermissionsV1Response:
        """Create an instance of UsergroupEditPermissionsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupEditPermissionsV1Response.parse_obj(obj)

        _obj = UsergroupEditPermissionsV1Response.parse_obj({
            ...
            "m_payload": UsergroupEditPermissionsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
