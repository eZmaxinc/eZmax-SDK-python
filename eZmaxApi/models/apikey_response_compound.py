...
class ApikeyResponseCompound(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApikeyResponseCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApikeyResponseCompound:
        """Create an instance of ApikeyResponseCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApikeyResponseCompound.parse_obj(obj)

        _obj = ApikeyResponseCompound.parse_obj({
