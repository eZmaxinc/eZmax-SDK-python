...
class EzsignfoldersignerassociationCreateObjectV2Response(BaseModel):
    """
    Response for POST /2/object/ezsignfoldersignerassociation  # noqa: E501
    """
    ...
    m_payload: EzsignfoldersignerassociationCreateObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfoldersignerassociationCreateObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfoldersignerassociationCreateObjectV2Response:
        """Create an instance of EzsignfoldersignerassociationCreateObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfoldersignerassociationCreateObjectV2Response.parse_obj(obj)

        _obj = EzsignfoldersignerassociationCreateObjectV2Response.parse_obj({
            ...
            "m_payload": EzsignfoldersignerassociationCreateObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
