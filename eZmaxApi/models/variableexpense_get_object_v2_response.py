...
class VariableexpenseGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/variableexpense/{pkiVariableexpenseID}  # noqa: E501
    """
    ...
    m_payload: VariableexpenseGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VariableexpenseGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VariableexpenseGetObjectV2Response:
        """Create an instance of VariableexpenseGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VariableexpenseGetObjectV2Response.parse_obj(obj)

        _obj = VariableexpenseGetObjectV2Response.parse_obj({
            ...
            "m_payload": VariableexpenseGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
