...
class EzsigntemplateformfieldgroupEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/ezsigntemplateformfieldgroup/{pkiEzsigntemplateformfieldgroupID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplateformfieldgroupEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplateformfieldgroupEditObjectV1Response:
        """Create an instance of EzsigntemplateformfieldgroupEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplateformfieldgroupEditObjectV1Response.parse_obj(obj)

        _obj = EzsigntemplateformfieldgroupEditObjectV1Response.parse_obj({
