...
class MultilingualSupplyDescription(BaseModel):
    """
    ...
    def s_supply_description1_validate_regular_expression(cls, value):
    ...
    @field_validator('s_supply_description2')
    def s_supply_description2_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sSupplyDescription1": obj.get("sSupplyDescription1"),
            "sSupplyDescription2": obj.get("sSupplyDescription2")
        })
        return _obj
