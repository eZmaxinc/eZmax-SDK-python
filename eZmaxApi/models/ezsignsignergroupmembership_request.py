...
class EzsignsignergroupmembershipRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignergroupmembershipRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignergroupmembershipRequest:
        """Create an instance of EzsignsignergroupmembershipRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignergroupmembershipRequest.parse_obj(obj)

        _obj = EzsignsignergroupmembershipRequest.parse_obj({
