...
class EzsignsignergroupmembershipRequest(BaseModel):
    ...
    """ # noqa: E501
    pki_ezsignsignergroupmembership_id: Optional[Annotated[int, Field(le=16777215, strict=True, ge=0)]] = Field(default=None, description="The unique ID of the Ezsignsignergroupmembership", alias="pkiEzsignsignergroupmembershipID", json_schema_extra={"examples": [153]})
