...
class EzsignsignergroupmembershipCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/ezsignsignergroupmembership  # noqa: E501
    """
    ...
    m_payload: EzsignsignergroupmembershipCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignergroupmembershipCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignergroupmembershipCreateObjectV1Response:
        """Create an instance of EzsignsignergroupmembershipCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignergroupmembershipCreateObjectV1Response.parse_obj(obj)

        _obj = EzsignsignergroupmembershipCreateObjectV1Response.parse_obj({
            ...
            "m_payload": EzsignsignergroupmembershipCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
