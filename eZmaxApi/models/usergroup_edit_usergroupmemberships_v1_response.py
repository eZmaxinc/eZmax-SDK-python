...
class UsergroupEditUsergroupmembershipsV1Response(BaseModel):
    """
    ...
    m_payload: UsergroupEditUsergroupmembershipsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupEditUsergroupmembershipsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupEditUsergroupmembershipsV1Response:
        """Create an instance of UsergroupEditUsergroupmembershipsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupEditUsergroupmembershipsV1Response.parse_obj(obj)

        _obj = UsergroupEditUsergroupmembershipsV1Response.parse_obj({
            ...
            "m_payload": UsergroupEditUsergroupmembershipsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
