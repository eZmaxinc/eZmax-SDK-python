...
class CommonResponseErrorCreditcardValidation(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["sErrorMessage", "eErrorCode", "a_sErrorMessagedetail", "objCreditcardtransactionresponse"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of obj_creditcardtransactionresponse
        if self.obj_creditcardtransactionresponse:
            _dict['objCreditcardtransactionresponse'] = self.obj_creditcardtransactionresponse.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "objCreditcardtransactionresponse": CustomCreditcardtransactionresponseResponse.from_dict(obj["objCreditcardtransactionresponse"]) if obj.get("objCreditcardtransactionresponse") is not None else None
        })
        return _obj
