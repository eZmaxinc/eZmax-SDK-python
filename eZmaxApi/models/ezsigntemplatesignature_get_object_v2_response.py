...
class EzsigntemplatesignatureGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/ezsigntemplatesignature/{pkiEzsigntemplatesignatureID}  # noqa: E501
    """
    ...
    m_payload: EzsigntemplatesignatureGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatesignatureGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatesignatureGetObjectV2Response:
        """Create an instance of EzsigntemplatesignatureGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatesignatureGetObjectV2Response.parse_obj(obj)

        _obj = EzsigntemplatesignatureGetObjectV2Response.parse_obj({
            ...
            "m_payload": EzsigntemplatesignatureGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
