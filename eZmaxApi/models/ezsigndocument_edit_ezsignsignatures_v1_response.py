...
class EzsigndocumentEditEzsignsignaturesV1Response(BaseModel):
    """
    Response for PUT /1/object/ezsigndocument/{pkiEzsigndocumentID}/editEzsignsignatures  # noqa: E501
    """
    ...
    m_payload: EzsigndocumentEditEzsignsignaturesV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentEditEzsignsignaturesV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentEditEzsignsignaturesV1Response:
        """Create an instance of EzsigndocumentEditEzsignsignaturesV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentEditEzsignsignaturesV1Response.parse_obj(obj)

        _obj = EzsigndocumentEditEzsignsignaturesV1Response.parse_obj({
            ...
            "m_payload": EzsigndocumentEditEzsignsignaturesV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
