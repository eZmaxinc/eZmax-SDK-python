...
class SubnetGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/subnet/{pkiSubnetID}  # noqa: E501
    """
    ...
    m_payload: SubnetGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubnetGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubnetGetObjectV2Response:
        """Create an instance of SubnetGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubnetGetObjectV2Response.parse_obj(obj)

        _obj = SubnetGetObjectV2Response.parse_obj({
            ...
            "m_payload": SubnetGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
