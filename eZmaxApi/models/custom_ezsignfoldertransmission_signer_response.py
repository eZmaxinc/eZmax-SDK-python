...
class CustomEzsignfoldertransmissionSignerResponse(BaseModel):
    """
    A form Signer Object in the context of an Ezsignfoldertransmissions  # noqa: E501
    """
    ...
    __properties = ["fkiUserID", "sContactFirstname", "sContactLastname"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomEzsignfoldertransmissionSignerResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomEzsignfoldertransmissionSignerResponse:
        """Create an instance of CustomEzsignfoldertransmissionSignerResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomEzsignfoldertransmissionSignerResponse.parse_obj(obj)

        _obj = CustomEzsignfoldertransmissionSignerResponse.parse_obj({
