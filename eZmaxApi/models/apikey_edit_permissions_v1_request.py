...
class ApikeyEditPermissionsV1Request(BaseModel):
    """
    Request for PUT /1/object/apikey/{pkiApikeyID}/editPermissions  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApikeyEditPermissionsV1Request:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApikeyEditPermissionsV1Request:
        """Create an instance of ApikeyEditPermissionsV1Request from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApikeyEditPermissionsV1Request.parse_obj(obj)

        _obj = ApikeyEditPermissionsV1Request.parse_obj({
