...
class CommunicationexternalrecipientResponseCompound(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommunicationexternalrecipientResponseCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommunicationexternalrecipientResponseCompound:
        """Create an instance of CommunicationexternalrecipientResponseCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommunicationexternalrecipientResponseCompound.parse_obj(obj)

        _obj = CommunicationexternalrecipientResponseCompound.parse_obj({
