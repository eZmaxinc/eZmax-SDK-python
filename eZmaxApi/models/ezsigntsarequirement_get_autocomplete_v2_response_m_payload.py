...
class EzsigntsarequirementGetAutocompleteV2ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objEzsigntsarequirement": [EzsigntsarequirementAutocompleteElementResponse.from_dict(_item) for _item in obj["a_objEzsigntsarequirement"]] if obj.get("a_objEzsigntsarequirement") is not None else None
        })
        return _obj
