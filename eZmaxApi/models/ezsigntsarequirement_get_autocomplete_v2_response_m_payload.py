...
class EzsigntsarequirementGetAutocompleteV2ResponseMPayload(BaseModel):
    ...
    """ # noqa: E501
    a_obj_ezsigntsarequirement: List[EzsigntsarequirementAutocompleteElementResponse] = Field(description="An array of Ezsigntsarequirement autocomplete element response.", alias="a_objEzsigntsarequirement")
    __properties: ClassVar[List[str]] = ["a_objEzsigntsarequirement"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objEzsigntsarequirement": [EzsigntsarequirementAutocompleteElementResponse.from_dict(_item) for _item in obj.get("a_objEzsigntsarequirement")] if obj.get("a_objEzsigntsarequirement") is not None else None
        })
        return _obj
