...
class EzsignsignaturepaymentdetailResponseCompound(BaseModel):
    ...
    """ # noqa: E501
    pki_ezsignsignaturepaymentdetail_id: Annotated[int, Field(le=65535, strict=True, ge=0)] = Field(description="The unique ID of the Ezsignsignaturepaymentdetail", alias="pkiEzsignsignaturepaymentdetailID")
