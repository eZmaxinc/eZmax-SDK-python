...
class EzsignsignaturepaymentdetailResponseCompound(BaseModel):
    """
    An Ezsignsignaturepaymentdetail Object and children to create a complete structure
    """ # noqa: E501
    pki_ezsignsignaturepaymentdetail_id: Annotated[int, Field(le=65535, strict=True, ge=0)] = Field(description="The unique ID of the Ezsignsignaturepaymentdetail", alias="pkiEzsignsignaturepaymentdetailID", json_schema_extra={"examples": [154]})
    ...
    @field_validator('d_ezsignsignaturepaymentdetail_amount')
    def d_ezsignsignaturepaymentdetail_amount_validate_regular_expression(cls, value):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pkiEzsignsignaturepaymentdetailID": obj.get("pkiEzsignsignaturepaymentdetailID"),
            "fkiGlaccountcontainerID": obj.get("fkiGlaccountcontainerID"),
            "tEzsignsignaturepaymentdetailDescription": obj.get("tEzsignsignaturepaymentdetailDescription"),
            "dEzsignsignaturepaymentdetailAmount": obj.get("dEzsignsignaturepaymentdetailAmount"),
            "eEzsignsignaturepaymentdetailTaxable": obj.get("eEzsignsignaturepaymentdetailTaxable")
        })
        return _obj
