...
class EzsignformfieldgroupsignerResponseCompound(BaseModel):
    ...
    """ # noqa: E501
    pki_ezsignformfieldgroupsigner_id: Annotated[int, Field(strict=True, ge=0)] = Field(description="The unique ID of the Ezsignformfieldgroupsigner", alias="pkiEzsignformfieldgroupsignerID", json_schema_extra={"examples": [81]})
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pkiEzsignformfieldgroupsignerID": obj.get("pkiEzsignformfieldgroupsignerID"),
