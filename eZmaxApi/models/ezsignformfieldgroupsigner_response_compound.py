...
class EzsignformfieldgroupsignerResponseCompound(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignformfieldgroupsignerResponseCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignformfieldgroupsignerResponseCompound:
        """Create an instance of EzsignformfieldgroupsignerResponseCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignformfieldgroupsignerResponseCompound.parse_obj(obj)

        _obj = EzsignformfieldgroupsignerResponseCompound.parse_obj({
