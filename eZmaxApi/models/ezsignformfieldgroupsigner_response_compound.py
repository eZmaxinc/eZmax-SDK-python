...
class EzsignformfieldgroupsignerResponseCompound(BaseModel):
    ...
    """ # noqa: E501
    pki_ezsignformfieldgroupsigner_id: Annotated[int, Field(strict=True, ge=0)] = Field(description="The unique ID of the Ezsignformfieldgroupsigner", alias="pkiEzsignformfieldgroupsignerID")
