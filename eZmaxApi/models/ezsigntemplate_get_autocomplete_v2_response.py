...
class EzsigntemplateGetAutocompleteV2Response(BaseModel):
    """
    Response for GET /2/object/ezsigntemplate/getAutocomplete  # noqa: E501
    """
    ...
    m_payload: EzsigntemplateGetAutocompleteV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplateGetAutocompleteV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplateGetAutocompleteV2Response:
        """Create an instance of EzsigntemplateGetAutocompleteV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplateGetAutocompleteV2Response.parse_obj(obj)

        _obj = EzsigntemplateGetAutocompleteV2Response.parse_obj({
            ...
            "m_payload": EzsigntemplateGetAutocompleteV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
