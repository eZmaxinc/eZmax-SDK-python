...
class EzsignbulksendReorderV1Response(BaseModel):
    """
    Response for POST /1/object/ezsignbulksend/{pkiEzsignbulksendID}/reorder  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignbulksendReorderV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignbulksendReorderV1Response:
        """Create an instance of EzsignbulksendReorderV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignbulksendReorderV1Response.parse_obj(obj)

        _obj = EzsignbulksendReorderV1Response.parse_obj({
