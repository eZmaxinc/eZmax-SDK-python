...
class EzsignsignatureCreateObjectV3Request(BaseModel):
    """
    Request for POST /3/object/ezsignsignature
    """ # noqa: E501
    a_obj_ezsignsignature: Annotated[List[EzsignsignatureRequestCompoundV2], Field(min_length=1)] = Field(alias="a_objEzsignsignature")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objEzsignsignature": [EzsignsignatureRequestCompoundV2.from_dict(_item) for _item in obj["a_objEzsignsignature"]] if obj.get("a_objEzsignsignature") is not None else None
        })
        return _obj
