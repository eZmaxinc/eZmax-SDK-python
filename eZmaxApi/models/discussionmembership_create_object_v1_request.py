...
class DiscussionmembershipCreateObjectV1Request(BaseModel):
    """
    Request for POST /1/object/discussionmembership
    """ # noqa: E501
    a_obj_discussionmembership: Annotated[List[DiscussionmembershipRequestCompound], Field(min_length=1)] = Field(alias="a_objDiscussionmembership")
    __properties: ClassVar[List[str]] = ["a_objDiscussionmembership"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objDiscussionmembership": [DiscussionmembershipRequestCompound.from_dict(_item) for _item in obj.get("a_objDiscussionmembership")] if obj.get("a_objDiscussionmembership") is not None else None
        })
        return _obj
