...
class DiscussionmembershipCreateObjectV1Request(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objDiscussionmembership": [DiscussionmembershipRequestCompound.from_dict(_item) for _item in obj["a_objDiscussionmembership"]] if obj.get("a_objDiscussionmembership") is not None else None
        })
        return _obj
