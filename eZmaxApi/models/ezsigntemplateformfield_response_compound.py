...
class EzsigntemplateformfieldResponseCompound(BaseModel):
    """
    An Ezsigntemplateformfield Object and children
    """ # noqa: E501
    pki_ezsigntemplateformfield_id: Annotated[int, Field(strict=True, ge=0)] = Field(description="The unique ID of the Ezsigntemplateformfield", alias="pkiEzsigntemplateformfieldID", json_schema_extra={"examples": [71]})
