...
class EzsigntemplatepackageGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}  # noqa: E501
    """
    ...
    m_payload: EzsigntemplatepackageGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatepackageGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatepackageGetObjectV2Response:
        """Create an instance of EzsigntemplatepackageGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatepackageGetObjectV2Response.parse_obj(obj)

        _obj = EzsigntemplatepackageGetObjectV2Response.parse_obj({
            ...
            "m_payload": EzsigntemplatepackageGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
