...
class EzsignsignatureCreateObjectV2Response(BaseModel):
    """
    Response for POST /2/object/ezsignsignature  # noqa: E501
    """
    ...
    m_payload: EzsignsignatureCreateObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignatureCreateObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignatureCreateObjectV2Response:
        """Create an instance of EzsignsignatureCreateObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignatureCreateObjectV2Response.parse_obj(obj)

        _obj = EzsignsignatureCreateObjectV2Response.parse_obj({
            ...
            "m_payload": EzsignsignatureCreateObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
