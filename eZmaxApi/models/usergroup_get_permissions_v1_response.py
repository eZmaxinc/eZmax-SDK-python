...
class UsergroupGetPermissionsV1Response(BaseModel):
    """
    ...
    m_payload: UsergroupGetPermissionsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupGetPermissionsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupGetPermissionsV1Response:
        """Create an instance of UsergroupGetPermissionsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupGetPermissionsV1Response.parse_obj(obj)

        _obj = UsergroupGetPermissionsV1Response.parse_obj({
            ...
            "m_payload": UsergroupGetPermissionsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
