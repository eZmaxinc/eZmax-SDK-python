...
class EzsignformfieldgroupsignerRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignformfieldgroupsignerRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignformfieldgroupsignerRequest:
        """Create an instance of EzsignformfieldgroupsignerRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignformfieldgroupsignerRequest.parse_obj(obj)

        _obj = EzsignformfieldgroupsignerRequest.parse_obj({
