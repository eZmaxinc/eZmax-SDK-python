...
class EzsignsigningreasonEditObjectV1Request(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objEzsignsigningreason": EzsignsigningreasonRequestCompound.from_dict(obj["objEzsignsigningreason"]) if obj.get("objEzsignsigningreason") is not None else None
        })
        return _obj
