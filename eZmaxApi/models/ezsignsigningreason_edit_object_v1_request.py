...
class EzsignsigningreasonEditObjectV1Request(BaseModel):
    """
    Request for PUT /1/object/ezsignsigningreason/{pkiEzsignsigningreasonID}
    """ # noqa: E501
    obj_ezsignsigningreason: EzsignsigningreasonRequestCompound = Field(alias="objEzsignsigningreason")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "objEzsignsigningreason": EzsignsigningreasonRequestCompound.from_dict(obj.get("objEzsignsigningreason")) if obj.get("objEzsignsigningreason") is not None else None
        })
        return _obj
