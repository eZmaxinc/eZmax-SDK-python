...
class BrandingGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/branding/{pkiBrandingID}  # noqa: E501
    """
    ...
    m_payload: BrandingGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BrandingGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BrandingGetObjectV2Response:
        """Create an instance of BrandingGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BrandingGetObjectV2Response.parse_obj(obj)

        _obj = BrandingGetObjectV2Response.parse_obj({
            ...
            "m_payload": BrandingGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
