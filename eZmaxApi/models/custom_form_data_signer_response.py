...
class CustomFormDataSignerResponse(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "a_objEzsignformfieldgroup": [CustomFormDataEzsignformfieldgroupResponse.from_dict(_item) for _item in obj.get("a_objEzsignformfieldgroup")] if obj.get("a_objEzsignformfieldgroup") is not None else None
        })
        return _obj
