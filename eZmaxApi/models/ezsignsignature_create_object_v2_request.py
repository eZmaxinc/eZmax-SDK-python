...
class EzsignsignatureCreateObjectV2Request(BaseModel):
    ...
    """ # noqa: E501
    a_obj_ezsignsignature: Annotated[List[EzsignsignatureRequestCompound], Field(min_length=1)] = Field(alias="a_objEzsignsignature")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objEzsignsignature": [EzsignsignatureRequestCompound.from_dict(_item) for _item in obj.get("a_objEzsignsignature")] if obj.get("a_objEzsignsignature") is not None else None
        })
        return _obj
