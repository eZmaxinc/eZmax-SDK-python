...
class EzsignsignatureCreateObjectV2Request(BaseModel):
    """
    Request for POST /2/object/ezsignsignature  # noqa: E501
    """
    a_obj_ezsignsignature: conlist(EzsignsignatureRequestCompound, min_items=1) = Field(..., alias="a_objEzsignsignature")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignatureCreateObjectV2Request:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignatureCreateObjectV2Request:
        """Create an instance of EzsignsignatureCreateObjectV2Request from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignatureCreateObjectV2Request.parse_obj(obj)

        _obj = EzsignsignatureCreateObjectV2Request.parse_obj({
