...
class FranchiseofficeGetAutocompleteV2Response(BaseModel):
    """
    Response for GET /2/object/franchiseoffice/getAutocomplete  # noqa: E501
    """
    ...
    m_payload: FranchiseofficeGetAutocompleteV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FranchiseofficeGetAutocompleteV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FranchiseofficeGetAutocompleteV2Response:
        """Create an instance of FranchiseofficeGetAutocompleteV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FranchiseofficeGetAutocompleteV2Response.parse_obj(obj)

        _obj = FranchiseofficeGetAutocompleteV2Response.parse_obj({
            ...
            "m_payload": FranchiseofficeGetAutocompleteV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
