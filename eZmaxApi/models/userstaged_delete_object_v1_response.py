...
class UserstagedDeleteObjectV1Response(BaseModel):
    """
    Response for DELETE /1/object/userstaged/{pkiUserstagedID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserstagedDeleteObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserstagedDeleteObjectV1Response:
        """Create an instance of UserstagedDeleteObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserstagedDeleteObjectV1Response.parse_obj(obj)

        _obj = UserstagedDeleteObjectV1Response.parse_obj({
