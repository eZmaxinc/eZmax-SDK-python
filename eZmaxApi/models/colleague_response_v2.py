...
class ColleagueResponseV2(BaseModel):
    ...
    A Colleague Object
    """ # noqa: E501
    pki_colleague_id: Annotated[int, Field(le=65535, strict=True, ge=0)] = Field(description="The unique ID of the Colleague", alias="pkiColleagueID", json_schema_extra={"examples": [60]})
