...
class CustomCommunicationrecipientsrecipientResponse(BaseModel):
    ...
    fki_contact_id: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The unique ID of the Contact", alias="fkiContactID", json_schema_extra={"examples": [21]})
    ...
    fki_ezcomagent_id: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The unique ID of the Ezcomagent.", alias="fkiEzcomagentID", json_schema_extra={"examples": [1]})
    ...
    fki_rewardmember_id: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The unique ID of the Rewardmember.", alias="fkiRewardmemberID", json_schema_extra={"examples": [1]})
    ...
    e_communicationrecipientsrecipient_objecttype: StrictStr = Field(alias="eCommunicationrecipientsrecipientObjecttype", json_schema_extra={"examples": ["User"]})
