...
class EzsignfolderSendV1Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderSendV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderSendV1Response:
        """Create an instance of EzsignfolderSendV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderSendV1Response.parse_obj(obj)

        _obj = EzsignfolderSendV1Response.parse_obj({
