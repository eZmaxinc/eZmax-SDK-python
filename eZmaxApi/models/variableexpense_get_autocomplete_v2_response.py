...
class VariableexpenseGetAutocompleteV2Response(BaseModel):
    """
    Response for GET /2/object/variableexpense/getAutocomplete  # noqa: E501
    """
    ...
    m_payload: VariableexpenseGetAutocompleteV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VariableexpenseGetAutocompleteV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VariableexpenseGetAutocompleteV2Response:
        """Create an instance of VariableexpenseGetAutocompleteV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VariableexpenseGetAutocompleteV2Response.parse_obj(obj)

        _obj = VariableexpenseGetAutocompleteV2Response.parse_obj({
            ...
            "m_payload": VariableexpenseGetAutocompleteV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
