...
class EzmaxproductGetAutocompleteV2Response(BaseModel):
    """
    Response for GET /2/object/ezmaxproduct/getAutocomplete  # noqa: E501
    """
    ...
    m_payload: EzmaxproductGetAutocompleteV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzmaxproductGetAutocompleteV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzmaxproductGetAutocompleteV2Response:
        """Create an instance of EzmaxproductGetAutocompleteV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzmaxproductGetAutocompleteV2Response.parse_obj(obj)

        _obj = EzmaxproductGetAutocompleteV2Response.parse_obj({
            ...
            "m_payload": EzmaxproductGetAutocompleteV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
