...
class WebhookGetListV1Response(BaseModel):
    """
    Response for GET /1/object/webhook/getList  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhookGetListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookGetListV1Response:
        """Create an instance of WebhookGetListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookGetListV1Response.parse_obj(obj)

        _obj = WebhookGetListV1Response.parse_obj({
            ...
            "m_payload": WebhookGetListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
