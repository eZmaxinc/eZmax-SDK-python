...
class EzsignformfieldgroupGetObjectV2ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "objEzsignformfieldgroup": EzsignformfieldgroupResponseCompound.from_dict(obj.get("objEzsignformfieldgroup")) if obj.get("objEzsignformfieldgroup") is not None else None
        })
        return _obj
