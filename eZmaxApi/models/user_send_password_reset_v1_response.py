...
class UserSendPasswordResetV1Response(BaseModel):
    """
    Response for POST /1/object/user/{pkiUserID}/sendPasswordReset  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserSendPasswordResetV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserSendPasswordResetV1Response:
        """Create an instance of UserSendPasswordResetV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserSendPasswordResetV1Response.parse_obj(obj)

        _obj = UserSendPasswordResetV1Response.parse_obj({
