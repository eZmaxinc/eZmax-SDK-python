...
class EzsigntemplatesignerGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/ezsigntemplatesigner/{pkiEzsigntemplatesignerID}  # noqa: E501
    """
    ...
    m_payload: EzsigntemplatesignerGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatesignerGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatesignerGetObjectV2Response:
        """Create an instance of EzsigntemplatesignerGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatesignerGetObjectV2Response.parse_obj(obj)

        _obj = EzsigntemplatesignerGetObjectV2Response.parse_obj({
            ...
            "m_payload": EzsigntemplatesignerGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
