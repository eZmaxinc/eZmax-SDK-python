...
class EzsigntemplatepackagesignerCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/ezsigntemplatepackagesigner  # noqa: E501
    """
    ...
    m_payload: EzsigntemplatepackagesignerCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatepackagesignerCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatepackagesignerCreateObjectV1Response:
        """Create an instance of EzsigntemplatepackagesignerCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatepackagesignerCreateObjectV1Response.parse_obj(obj)

        _obj = EzsigntemplatepackagesignerCreateObjectV1Response.parse_obj({
            ...
            "m_payload": EzsigntemplatepackagesignerCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
