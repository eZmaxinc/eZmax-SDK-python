...
class CommunicationrecipientRequestCompound(BaseModel):
    ...
    """ # noqa: E501
    pki_communicationrecipient_id: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The unique ID of the Communicationrecipient.", alias="pkiCommunicationrecipientID", json_schema_extra={"examples": [1]})
