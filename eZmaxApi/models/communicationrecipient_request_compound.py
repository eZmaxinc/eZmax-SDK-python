...
class CommunicationrecipientRequestCompound(BaseModel):
    """
    A Communicationrecipient Object and children  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommunicationrecipientRequestCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommunicationrecipientRequestCompound:
        """Create an instance of CommunicationrecipientRequestCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommunicationrecipientRequestCompound.parse_obj(obj)

        _obj = CommunicationrecipientRequestCompound.parse_obj({
