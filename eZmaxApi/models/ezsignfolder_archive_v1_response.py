...
class EzsignfolderArchiveV1Response(BaseModel):
    """
    Response for POST /1/object/ezsignfolder/{pkiEzsignfolderID}/archive  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderArchiveV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderArchiveV1Response:
        """Create an instance of EzsignfolderArchiveV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderArchiveV1Response.parse_obj(obj)

        _obj = EzsignfolderArchiveV1Response.parse_obj({
