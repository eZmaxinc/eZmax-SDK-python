...
class EzsignfoldersignerassociationCreateEmbeddedUrlV1Request(BaseModel):
    ...
    s_iframedomain: Optional[StrictStr] = Field(default=None, description="Domain protection for the iFrame", alias="sIframedomain", json_schema_extra={"examples": ["*.example.com"]})
