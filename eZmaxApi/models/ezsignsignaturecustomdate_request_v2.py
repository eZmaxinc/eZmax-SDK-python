...
class EzsignsignaturecustomdateRequestV2(BaseModel):
    ...
    """ # noqa: E501
    pki_ezsignsignaturecustomdate_id: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The unique ID of the Ezsignsignaturecustomdate", alias="pkiEzsignsignaturecustomdateID")
