...
class DiscussionmessageCreateObjectV1Request(BaseModel):
    """
    Request for POST /1/object/discussionmessage
    """ # noqa: E501
    a_obj_discussionmessage: Annotated[List[DiscussionmessageRequestCompound], Field(min_length=1)] = Field(alias="a_objDiscussionmessage")
    __properties: ClassVar[List[str]] = ["a_objDiscussionmessage"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objDiscussionmessage": [DiscussionmessageRequestCompound.from_dict(_item) for _item in obj.get("a_objDiscussionmessage")] if obj.get("a_objDiscussionmessage") is not None else None
        })
        return _obj
