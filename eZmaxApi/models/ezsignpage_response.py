...
class EzsignpageResponse(BaseModel):
    """
    An Ezsignpage Object  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignpageResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignpageResponse:
        """Create an instance of EzsignpageResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignpageResponse.parse_obj(obj)

        _obj = EzsignpageResponse.parse_obj({
