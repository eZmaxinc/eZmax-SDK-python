...
class EzmaxinvoicingagentResponseCompound(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzmaxinvoicingagentResponseCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzmaxinvoicingagentResponseCompound:
        """Create an instance of EzmaxinvoicingagentResponseCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzmaxinvoicingagentResponseCompound.parse_obj(obj)

        _obj = EzmaxinvoicingagentResponseCompound.parse_obj({
