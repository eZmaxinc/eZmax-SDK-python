...
class EzsignfoldertypeRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfoldertypeRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfoldertypeRequest:
        """Create an instance of EzsignfoldertypeRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfoldertypeRequest.parse_obj(obj)

        _obj = EzsignfoldertypeRequest.parse_obj({
