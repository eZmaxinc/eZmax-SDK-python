...
class EzsignsignergroupCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/ezsignsignergroup  # noqa: E501
    """
    ...
    m_payload: EzsignsignergroupCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignergroupCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignergroupCreateObjectV1Response:
        """Create an instance of EzsignsignergroupCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignergroupCreateObjectV1Response.parse_obj(obj)

        _obj = EzsignsignergroupCreateObjectV1Response.parse_obj({
            ...
            "m_payload": EzsignsignergroupCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
