...
class BrandingEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/branding/{pkiBrandingID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BrandingEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BrandingEditObjectV1Response:
        """Create an instance of BrandingEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BrandingEditObjectV1Response.parse_obj(obj)

        _obj = BrandingEditObjectV1Response.parse_obj({
