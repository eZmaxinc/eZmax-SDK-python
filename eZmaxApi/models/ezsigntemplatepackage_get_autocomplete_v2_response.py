...
class EzsigntemplatepackageGetAutocompleteV2Response(BaseModel):
    """
    Response for GET /2/object/ezsigntemplatepackage/getAutocomplete  # noqa: E501
    """
    ...
    m_payload: EzsigntemplatepackageGetAutocompleteV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatepackageGetAutocompleteV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatepackageGetAutocompleteV2Response:
        """Create an instance of EzsigntemplatepackageGetAutocompleteV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatepackageGetAutocompleteV2Response.parse_obj(obj)

        _obj = EzsigntemplatepackageGetAutocompleteV2Response.parse_obj({
            ...
            "m_payload": EzsigntemplatepackageGetAutocompleteV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
