...
class BillingentityinternalGetListV1ResponseMPayload(BaseModel):
    ...
    a_obj_billingentityinternal: List[BillingentityinternalListElement] = Field(alias="a_objBillingentityinternal")
    __properties: ClassVar[List[str]] = ["iRowReturned", "iRowFiltered", "a_objBillingentityinternal"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "a_objBillingentityinternal": [BillingentityinternalListElement.from_dict(_item) for _item in obj.get("a_objBillingentityinternal")] if obj.get("a_objBillingentityinternal") is not None else None
        })
        return _obj
