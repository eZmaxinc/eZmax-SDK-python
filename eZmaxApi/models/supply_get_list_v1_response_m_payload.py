...
class SupplyGetListV1ResponseMPayload(BaseModel):
    """
    ...
    a_obj_supply: List[SupplyListElement] = Field(alias="a_objSupply")
    __properties: ClassVar[List[str]] = ["iRowReturned", "iRowFiltered", "a_objSupply"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "a_objSupply": [SupplyListElement.from_dict(_item) for _item in obj["a_objSupply"]] if obj.get("a_objSupply") is not None else None
        })
        return _obj
