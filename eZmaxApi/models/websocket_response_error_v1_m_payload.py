...
class WebsocketResponseErrorV1MPayload(BaseModel):
    """
    Payload for Websocket Error V1  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebsocketResponseErrorV1MPayload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebsocketResponseErrorV1MPayload:
        """Create an instance of WebsocketResponseErrorV1MPayload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebsocketResponseErrorV1MPayload.parse_obj(obj)

        _obj = WebsocketResponseErrorV1MPayload.parse_obj({
