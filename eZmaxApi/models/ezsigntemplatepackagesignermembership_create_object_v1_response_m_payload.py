...
class EzsigntemplatepackagesignermembershipCreateObjectV1ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_pkiEzsigntemplatepackagesignermembershipID": obj.get("a_pkiEzsigntemplatepackagesignermembershipID")
        })
        return _obj
