...
class SystemconfigurationGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/systemconfiguration/{pkiSystemconfigurationID}  # noqa: E501
    """
    ...
    m_payload: SystemconfigurationGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SystemconfigurationGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SystemconfigurationGetObjectV2Response:
        """Create an instance of SystemconfigurationGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SystemconfigurationGetObjectV2Response.parse_obj(obj)

        _obj = SystemconfigurationGetObjectV2Response.parse_obj({
            ...
            "m_payload": SystemconfigurationGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
