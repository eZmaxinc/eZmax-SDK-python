...
class EzsignfoldersignerassociationGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/ezsignfoldersignerassociation/{pkiEzsignfoldersignerassociationID}  # noqa: E501
    """
    ...
    m_payload: EzsignfoldersignerassociationGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfoldersignerassociationGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfoldersignerassociationGetObjectV2Response:
        """Create an instance of EzsignfoldersignerassociationGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfoldersignerassociationGetObjectV2Response.parse_obj(obj)

        _obj = EzsignfoldersignerassociationGetObjectV2Response.parse_obj({
            ...
            "m_payload": EzsignfoldersignerassociationGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
