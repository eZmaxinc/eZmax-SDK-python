...
class EzsignfolderGetCommunicationrecipientsV1Response(BaseModel):
    """
    ...
    m_payload: EzsignfolderGetCommunicationrecipientsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderGetCommunicationrecipientsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderGetCommunicationrecipientsV1Response:
        """Create an instance of EzsignfolderGetCommunicationrecipientsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderGetCommunicationrecipientsV1Response.parse_obj(obj)

        _obj = EzsignfolderGetCommunicationrecipientsV1Response.parse_obj({
            ...
            "m_payload": EzsignfolderGetCommunicationrecipientsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
