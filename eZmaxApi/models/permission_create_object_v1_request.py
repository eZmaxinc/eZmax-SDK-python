...
class PermissionCreateObjectV1Request(BaseModel):
    """
    Request for POST /1/object/permission  # noqa: E501
    """
    a_obj_permission: conlist(PermissionRequestCompound, min_items=1) = Field(..., alias="a_objPermission")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PermissionCreateObjectV1Request:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PermissionCreateObjectV1Request:
        """Create an instance of PermissionCreateObjectV1Request from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PermissionCreateObjectV1Request.parse_obj(obj)

        _obj = PermissionCreateObjectV1Request.parse_obj({
