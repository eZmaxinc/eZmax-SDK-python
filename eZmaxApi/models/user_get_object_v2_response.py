...
class UserGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/user/{pkiUserID}  # noqa: E501
    """
    ...
    m_payload: UserGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserGetObjectV2Response:
        """Create an instance of UserGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserGetObjectV2Response.parse_obj(obj)

        _obj = UserGetObjectV2Response.parse_obj({
            ...
            "m_payload": UserGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
