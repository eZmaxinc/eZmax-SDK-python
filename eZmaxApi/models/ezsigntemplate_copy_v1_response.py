...
class EzsigntemplateCopyV1Response(BaseModel):
    """
    Response for POST /1/object/ezsigntemplate/{pkiEzsigntemplateID}/copy  # noqa: E501
    """
    ...
    m_payload: EzsigntemplateCopyV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplateCopyV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplateCopyV1Response:
        """Create an instance of EzsigntemplateCopyV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplateCopyV1Response.parse_obj(obj)

        _obj = EzsigntemplateCopyV1Response.parse_obj({
            ...
            "m_payload": EzsigntemplateCopyV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
