...
class EzsigntemplatesignerCreateObjectV1ResponseMPayload(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["a_pkiEzsigntemplatesignerID", "bEzsigntemplatepackageNeedvalidation", "bEzsignbulksendNeedvalidation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_pkiEzsigntemplatesignerID": obj.get("a_pkiEzsigntemplatesignerID"),
