...
class EzsignfoldersignerassociationEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/ezsignfoldersignerassociation/{pkiEzsignfoldersignerassociationID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfoldersignerassociationEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfoldersignerassociationEditObjectV1Response:
        """Create an instance of EzsignfoldersignerassociationEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfoldersignerassociationEditObjectV1Response.parse_obj(obj)

        _obj = EzsignfoldersignerassociationEditObjectV1Response.parse_obj({
