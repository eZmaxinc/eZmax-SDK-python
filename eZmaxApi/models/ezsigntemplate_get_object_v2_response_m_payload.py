...
class EzsigntemplateGetObjectV2ResponseMPayload(BaseModel):
    """
    Payload for GET /2/object/ezsigntemplate/{pkiEzsigntemplateID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplateGetObjectV2ResponseMPayload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplateGetObjectV2ResponseMPayload:
        """Create an instance of EzsigntemplateGetObjectV2ResponseMPayload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplateGetObjectV2ResponseMPayload.parse_obj(obj)

        _obj = EzsigntemplateGetObjectV2ResponseMPayload.parse_obj({
