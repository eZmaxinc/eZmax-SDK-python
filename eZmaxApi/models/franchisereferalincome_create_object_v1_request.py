...
class FranchisereferalincomeCreateObjectV1Request(BaseModel):
    ...
    """ # noqa: E501
    obj_franchisereferalincome: Optional[FranchisereferalincomeRequest] = Field(default=None, alias="objFranchisereferalincome")
    obj_franchisereferalincome_compound: Optional[FranchisereferalincomeRequestCompound] = Field(default=None, alias="objFranchisereferalincomeCompound")
    __properties: ClassVar[List[str]] = ["objFranchisereferalincome", "objFranchisereferalincomeCompound"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "objFranchisereferalincome": FranchisereferalincomeRequest.from_dict(obj.get("objFranchisereferalincome")) if obj.get("objFranchisereferalincome") is not None else None,
            "objFranchisereferalincomeCompound": FranchisereferalincomeRequestCompound.from_dict(obj.get("objFranchisereferalincomeCompound")) if obj.get("objFranchisereferalincomeCompound") is not None else None
        })
        return _obj
