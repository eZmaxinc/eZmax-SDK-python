...
class EzsigndocumentEndPrematurelyV1Response(BaseModel):
    """
    Response for POST /1/object/ezsigndocument/{pkiEzsigndocument}/endPrematurely  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentEndPrematurelyV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentEndPrematurelyV1Response:
        """Create an instance of EzsigndocumentEndPrematurelyV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentEndPrematurelyV1Response.parse_obj(obj)

        _obj = EzsigndocumentEndPrematurelyV1Response.parse_obj({
