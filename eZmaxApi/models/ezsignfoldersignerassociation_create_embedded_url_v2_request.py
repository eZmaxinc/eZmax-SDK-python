...
class EzsignfoldersignerassociationCreateEmbeddedUrlV2Request(BaseModel):
    ...
    s_iframe_origin: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="This is used to fill the header frame ancestor to allow the application to embed the Ezsign signature page", alias="sIframeOrigin")
