...
class EzsigntemplatedocumentGetEzsigntemplatedocumentpagesV1ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objEzsigntemplatedocumentpage": [EzsigntemplatedocumentpageResponseCompound.from_dict(_item) for _item in obj.get("a_objEzsigntemplatedocumentpage")] if obj.get("a_objEzsigntemplatedocumentpage") is not None else None
        })
        return _obj
