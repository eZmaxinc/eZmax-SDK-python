...
class EzmaxinvoicingsummaryinternaldetailResponseCompound(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzmaxinvoicingsummaryinternaldetailResponseCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzmaxinvoicingsummaryinternaldetailResponseCompound:
        """Create an instance of EzmaxinvoicingsummaryinternaldetailResponseCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzmaxinvoicingsummaryinternaldetailResponseCompound.parse_obj(obj)

        _obj = EzmaxinvoicingsummaryinternaldetailResponseCompound.parse_obj({
