...
class EzsignformfieldgroupEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/ezsignformfieldgroup/{pkiEzsignfoldersignerassociationID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignformfieldgroupEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignformfieldgroupEditObjectV1Response:
        """Create an instance of EzsignformfieldgroupEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignformfieldgroupEditObjectV1Response.parse_obj(obj)

        _obj = EzsignformfieldgroupEditObjectV1Response.parse_obj({
