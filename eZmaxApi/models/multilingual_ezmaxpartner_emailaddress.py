...
class MultilingualEzmaxpartnerEmailaddress(BaseModel):
    """
    ...
    def s_ezmaxpartner_emailaddress1_validate_regular_expression(cls, value):
    ...
    @field_validator('s_ezmaxpartner_emailaddress2')
    def s_ezmaxpartner_emailaddress2_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MultilingualEzmaxpartnerEmailaddress from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MultilingualEzmaxpartnerEmailaddress from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "sEzmaxpartnerEmailaddress1": obj.get("sEzmaxpartnerEmailaddress1"),
            "sEzmaxpartnerEmailaddress2": obj.get("sEzmaxpartnerEmailaddress2")
        })
        return _obj
