...
class EzsigntemplatedocumentPatchObjectV1Request(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "objEzsigntemplatedocument": EzsigntemplatedocumentRequestPatch.from_dict(obj.get("objEzsigntemplatedocument")) if obj.get("objEzsigntemplatedocument") is not None else None
        })
        return _obj
