...
class EzdoctemplatetypeAutocompleteElementResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pkiEzdoctemplatetypeID": obj.get("pkiEzdoctemplatetypeID"),
            "sEzdoctemplatetypeDescriptionX": obj.get("sEzdoctemplatetypeDescriptionX"),
            "bEzdoctemplatetypeIsactive": obj.get("bEzdoctemplatetypeIsactive")
        })
        return _obj
