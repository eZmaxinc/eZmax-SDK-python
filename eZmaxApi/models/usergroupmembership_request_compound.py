...
class UsergroupmembershipRequestCompound(BaseModel):
    """
    A Usergroupmembership Object and children  # noqa: E501
    """
    pki_usergroupmembership_id: Optional[conint(strict=True, le=65535, ge=0)] = Field(None, alias="pkiUsergroupmembershipID", description="The unique ID of the Usergroupmembership")
    ...
    __properties = ["pkiUsergroupmembershipID", "fkiUsergroupID", "fkiUserID"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupmembershipRequestCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupmembershipRequestCompound:
        """Create an instance of UsergroupmembershipRequestCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupmembershipRequestCompound.parse_obj(obj)

        _obj = UsergroupmembershipRequestCompound.parse_obj({
