...
class EzsigntemplatepackageDeleteObjectV1Response(BaseModel):
    """
    Response for DELETE /1/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatepackageDeleteObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatepackageDeleteObjectV1Response:
        """Create an instance of EzsigntemplatepackageDeleteObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatepackageDeleteObjectV1Response.parse_obj(obj)

        _obj = EzsigntemplatepackageDeleteObjectV1Response.parse_obj({
