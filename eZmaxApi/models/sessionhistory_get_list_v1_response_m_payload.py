...
class SessionhistoryGetListV1ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "a_objSessionhistory": [SessionhistoryListElement.from_dict(_item) for _item in obj.get("a_objSessionhistory")] if obj.get("a_objSessionhistory") is not None else None
        })
        return _obj
