...
class EzsigntemplateformfieldgroupCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/ezsigntemplateformfieldgroup  # noqa: E501
    """
    ...
    m_payload: EzsigntemplateformfieldgroupCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplateformfieldgroupCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplateformfieldgroupCreateObjectV1Response:
        """Create an instance of EzsigntemplateformfieldgroupCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplateformfieldgroupCreateObjectV1Response.parse_obj(obj)

        _obj = EzsigntemplateformfieldgroupCreateObjectV1Response.parse_obj({
            ...
            "m_payload": EzsigntemplateformfieldgroupCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
