...
class EzsignsignatureCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/ezsignsignature  # noqa: E501
    """
    ...
    m_payload: EzsignsignatureCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignatureCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignatureCreateObjectV1Response:
        """Create an instance of EzsignsignatureCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignatureCreateObjectV1Response.parse_obj(obj)

        _obj = EzsignsignatureCreateObjectV1Response.parse_obj({
            ...
            "m_payload": EzsignsignatureCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
