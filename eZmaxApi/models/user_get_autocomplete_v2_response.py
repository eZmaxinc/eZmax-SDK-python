...
class UserGetAutocompleteV2Response(BaseModel):
    """
    Response for GET /2/object/user/getAutocomplete  # noqa: E501
    """
    ...
    m_payload: UserGetAutocompleteV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserGetAutocompleteV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserGetAutocompleteV2Response:
        """Create an instance of UserGetAutocompleteV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserGetAutocompleteV2Response.parse_obj(obj)

        _obj = UserGetAutocompleteV2Response.parse_obj({
            ...
            "m_payload": UserGetAutocompleteV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
