...
class WebhookGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/webhook/{pkiWebhookID}  # noqa: E501
    """
    ...
    m_payload: WebhookGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhookGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookGetObjectV2Response:
        """Create an instance of WebhookGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookGetObjectV2Response.parse_obj(obj)

        _obj = WebhookGetObjectV2Response.parse_obj({
            ...
            "m_payload": WebhookGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
