...
class EzsignfolderUnsendV1Response(BaseModel):
    """
    Response for POST /1/object/ezsignfolder/{pkiEzsignfolderID}/unsend  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderUnsendV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderUnsendV1Response:
        """Create an instance of EzsignfolderUnsendV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderUnsendV1Response.parse_obj(obj)

        _obj = EzsignfolderUnsendV1Response.parse_obj({
