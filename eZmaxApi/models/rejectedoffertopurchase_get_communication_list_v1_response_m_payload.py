...
class RejectedoffertopurchaseGetCommunicationListV1ResponseMPayload(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RejectedoffertopurchaseGetCommunicationListV1ResponseMPayload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RejectedoffertopurchaseGetCommunicationListV1ResponseMPayload:
        """Create an instance of RejectedoffertopurchaseGetCommunicationListV1ResponseMPayload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RejectedoffertopurchaseGetCommunicationListV1ResponseMPayload.parse_obj(obj)

        _obj = RejectedoffertopurchaseGetCommunicationListV1ResponseMPayload.parse_obj({
