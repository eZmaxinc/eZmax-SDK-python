...
class EzsignsignatureGetEzsignsignaturesAutomaticV1Response(BaseModel):
    """
    Response for GET /1/object/ezsignsignature/getEzsignsignaturesAutomatic  # noqa: E501
    """
    ...
    m_payload: EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignatureGetEzsignsignaturesAutomaticV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignatureGetEzsignsignaturesAutomaticV1Response:
        """Create an instance of EzsignsignatureGetEzsignsignaturesAutomaticV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignatureGetEzsignsignaturesAutomaticV1Response.parse_obj(obj)

        _obj = EzsignsignatureGetEzsignsignaturesAutomaticV1Response.parse_obj({
            ...
            "m_payload": EzsignsignatureGetEzsignsignaturesAutomaticV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
