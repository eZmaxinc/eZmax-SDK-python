...
class ApikeyEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/apikey/{pkiApikeyID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApikeyEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApikeyEditObjectV1Response:
        """Create an instance of ApikeyEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApikeyEditObjectV1Response.parse_obj(obj)

        _obj = ApikeyEditObjectV1Response.parse_obj({
