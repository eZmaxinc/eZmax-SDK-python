...
class CommonResponseGetList(BaseModel):
    """
    All API response will inherit this based Response  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommonResponseGetList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommonResponseGetList:
        """Create an instance of CommonResponseGetList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommonResponseGetList.parse_obj(obj)

        _obj = CommonResponseGetList.parse_obj({
