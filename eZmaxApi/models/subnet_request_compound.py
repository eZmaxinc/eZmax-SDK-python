...
class SubnetRequestCompound(BaseModel):
    """
    A Subnet Object and children  # noqa: E501
    """
    pki_subnet_id: Optional[conint(strict=True, le=65535, ge=0)] = Field(None, alias="pkiSubnetID", description="The unique ID of the Subnet")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubnetRequestCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubnetRequestCompound:
        """Create an instance of SubnetRequestCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubnetRequestCompound.parse_obj(obj)

        _obj = SubnetRequestCompound.parse_obj({
