...
class EzsignbulksenddocumentmappingDeleteObjectV1Response(BaseModel):
    """
    Response for DELETE /1/object/ezsignbulksenddocumentmapping/{pkiEzsignbulksenddocumentmappingID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignbulksenddocumentmappingDeleteObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignbulksenddocumentmappingDeleteObjectV1Response:
        """Create an instance of EzsignbulksenddocumentmappingDeleteObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignbulksenddocumentmappingDeleteObjectV1Response.parse_obj(obj)

        _obj = EzsignbulksenddocumentmappingDeleteObjectV1Response.parse_obj({
