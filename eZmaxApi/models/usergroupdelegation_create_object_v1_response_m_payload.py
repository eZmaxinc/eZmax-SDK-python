...
class UsergroupdelegationCreateObjectV1ResponseMPayload(BaseModel):
    ...
    """ # noqa: E501
    a_pki_usergroupdelegation_id: List[Annotated[int, Field(le=65535, strict=True, ge=0)]] = Field(description="An array of unique IDs representing the object that were requested to be created.  They are returned in the same order as the array containing the objects to be created that was sent in the request.", alias="a_pkiUsergroupdelegationID")
