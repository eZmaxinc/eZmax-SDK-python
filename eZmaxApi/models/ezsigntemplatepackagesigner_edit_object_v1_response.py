...
class EzsigntemplatepackagesignerEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/ezsigntemplatepackagesigner/{pkiEzsigntemplatepackagesignerID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatepackagesignerEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatepackagesignerEditObjectV1Response:
        """Create an instance of EzsigntemplatepackagesignerEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatepackagesignerEditObjectV1Response.parse_obj(obj)

        _obj = EzsigntemplatepackagesignerEditObjectV1Response.parse_obj({
