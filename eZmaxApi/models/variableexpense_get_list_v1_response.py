...
class VariableexpenseGetListV1Response(BaseModel):
    """
    Response for GET /1/object/variableexpense/getList  # noqa: E501
    """
    ...
    m_payload: VariableexpenseGetListV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VariableexpenseGetListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VariableexpenseGetListV1Response:
        """Create an instance of VariableexpenseGetListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VariableexpenseGetListV1Response.parse_obj(obj)

        _obj = VariableexpenseGetListV1Response.parse_obj({
            ...
            "m_payload": VariableexpenseGetListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
