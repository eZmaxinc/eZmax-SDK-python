...
class PeriodGetAutocompleteV2Response(BaseModel):
    """
    Response for GET /2/object/period/getAutocomplete  # noqa: E501
    """
    ...
    m_payload: PeriodGetAutocompleteV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PeriodGetAutocompleteV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PeriodGetAutocompleteV2Response:
        """Create an instance of PeriodGetAutocompleteV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PeriodGetAutocompleteV2Response.parse_obj(obj)

        _obj = PeriodGetAutocompleteV2Response.parse_obj({
            ...
            "m_payload": PeriodGetAutocompleteV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
