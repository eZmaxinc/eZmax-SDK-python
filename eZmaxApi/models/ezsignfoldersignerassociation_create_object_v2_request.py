...
class EzsignfoldersignerassociationCreateObjectV2Request(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objEzsignfoldersignerassociation": [EzsignfoldersignerassociationRequestCompound.from_dict(_item) for _item in obj.get("a_objEzsignfoldersignerassociation")] if obj.get("a_objEzsignfoldersignerassociation") is not None else None
        })
        return _obj
