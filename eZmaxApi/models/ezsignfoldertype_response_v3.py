...
class EzsignfoldertypeResponseV3(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.a_obj_usergroup_all:
            for _item in self.a_obj_usergroup_all:
                if _item:
                    _items.append(_item.to_dict())
        ...
        if self.a_obj_usergroup_restricted:
            for _item in self.a_obj_usergroup_restricted:
                if _item:
                    _items.append(_item.to_dict())
        ...
        if self.a_obj_usergroup_template:
            for _item in self.a_obj_usergroup_template:
                if _item:
                    _items.append(_item.to_dict())
