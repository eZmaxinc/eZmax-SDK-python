...
class EzsigndocumentGetCompletedElementsV1Response(BaseModel):
    """
    Response for GET /1/object/ezsigndocument/{pkiEzsigndocumentID}/getCompletedElements  # noqa: E501
    """
    ...
    m_payload: EzsigndocumentGetCompletedElementsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentGetCompletedElementsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentGetCompletedElementsV1Response:
        """Create an instance of EzsigndocumentGetCompletedElementsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentGetCompletedElementsV1Response.parse_obj(obj)

        _obj = EzsigndocumentGetCompletedElementsV1Response.parse_obj({
            ...
            "m_payload": EzsigndocumentGetCompletedElementsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
