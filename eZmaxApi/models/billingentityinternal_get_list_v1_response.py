...
class BillingentityinternalGetListV1Response(BaseModel):
    """
    Response for GET /1/object/billingentityinternal/getList  # noqa: E501
    """
    ...
    m_payload: BillingentityinternalGetListV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillingentityinternalGetListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillingentityinternalGetListV1Response:
        """Create an instance of BillingentityinternalGetListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillingentityinternalGetListV1Response.parse_obj(obj)

        _obj = BillingentityinternalGetListV1Response.parse_obj({
            ...
            "m_payload": BillingentityinternalGetListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
