...
class WebhookCreateObjectV2Request(BaseModel):
    """
    Request for POST /2/object/webhook
    """ # noqa: E501
    a_obj_webhook: Annotated[List[WebhookRequestCompound], Field(min_length=1)] = Field(alias="a_objWebhook")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objWebhook": [WebhookRequestCompound.from_dict(_item) for _item in obj.get("a_objWebhook")] if obj.get("a_objWebhook") is not None else None
        })
        return _obj
