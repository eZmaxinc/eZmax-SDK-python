...
class EzsigntemplatedocumentCreateObjectV1ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_pkiEzsigntemplatedocumentID": obj.get("a_pkiEzsigntemplatedocumentID")
        })
        return _obj
