...
class EzsignfoldersignerassociationGetInPersonLoginUrlV1Response(BaseModel):
    """
    Response for GET /1/object/ezsignfoldersignerassociation/getInPersonLoginUrl  # noqa: E501
    """
    ...
    m_payload: EzsignfoldersignerassociationGetInPersonLoginUrlV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfoldersignerassociationGetInPersonLoginUrlV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfoldersignerassociationGetInPersonLoginUrlV1Response:
        """Create an instance of EzsignfoldersignerassociationGetInPersonLoginUrlV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfoldersignerassociationGetInPersonLoginUrlV1Response.parse_obj(obj)

        _obj = EzsignfoldersignerassociationGetInPersonLoginUrlV1Response.parse_obj({
            ...
            "m_payload": EzsignfoldersignerassociationGetInPersonLoginUrlV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
