...
class EzsignfoldertypeRequestCompoundV4(BaseModel):
    ...
    b_ezsignfoldertype_sendsignatureattachmentezsignsigner: Optional[StrictBool] = Field(default=None, description="Whether we send the attachments contained in the Ezsignsignatures in the email to Ezsignsigner", alias="bEzsignfoldertypeSendsignatureattachmentezsignsigner")
    b_ezsignfoldertype_sendsignatureattachment: Optional[StrictBool] = Field(default=None, description="Whether we send the attachments contained in the Ezsignsignatures in the email to external recipient", alias="bEzsignfoldertypeSendsignatureattachment")
    ...
    b_ezsignfoldertype_sendsignatureattachmentuser: Optional[StrictBool] = Field(default=None, description="Whether we send the attachments contained in the Ezsignsignatures in the email to User", alias="bEzsignfoldertypeSendsignatureattachmentuser")
    ...
    b_ezsignfoldertype_allowdownloadsignatureattachmentezsignsigner: Optional[StrictBool] = Field(default=None, description="Whether we allow the attachments in the Ezsignsignatures to be downloaded by an Ezsignsigner", alias="bEzsignfoldertypeAllowdownloadsignatureattachmentezsignsigner")
    ...
    b_ezsignfoldertype_sendsignatureattachmentreceivealldocument: Optional[StrictBool] = Field(default=None, description="Whether we send the attachments contained in the Ezsignsignatures to user and Ezsignsigner who receive all documents.", alias="bEzsignfoldertypeSendsignatureattachmentreceivealldocument")
