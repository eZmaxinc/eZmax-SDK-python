...
class EzsignpageConsultV1Response(BaseModel):
    """
    Response for POST /1/object/ezsignpage/{pkiEzsignpageID}/consult  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignpageConsultV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignpageConsultV1Response:
        """Create an instance of EzsignpageConsultV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignpageConsultV1Response.parse_obj(obj)

        _obj = EzsignpageConsultV1Response.parse_obj({
