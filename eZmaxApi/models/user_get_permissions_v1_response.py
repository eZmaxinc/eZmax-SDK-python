...
class UserGetPermissionsV1Response(BaseModel):
    """
    ...
    m_payload: UserGetPermissionsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserGetPermissionsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserGetPermissionsV1Response:
        """Create an instance of UserGetPermissionsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserGetPermissionsV1Response.parse_obj(obj)

        _obj = UserGetPermissionsV1Response.parse_obj({
            ...
            "m_payload": UserGetPermissionsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
