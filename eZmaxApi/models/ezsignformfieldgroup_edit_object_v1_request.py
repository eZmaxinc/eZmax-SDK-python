...
class EzsignformfieldgroupEditObjectV1Request(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["objEzsignformfieldgroup"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "objEzsignformfieldgroup": EzsignformfieldgroupRequestCompound.from_dict(obj.get("objEzsignformfieldgroup")) if obj.get("objEzsignformfieldgroup") is not None else None
        })
        return _obj
