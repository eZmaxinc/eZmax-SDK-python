...
class EzsignformfieldgroupEditObjectV1Request(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objEzsignformfieldgroup": EzsignformfieldgroupRequestCompound.from_dict(obj["objEzsignformfieldgroup"]) if obj.get("objEzsignformfieldgroup") is not None else None
        })
        return _obj
