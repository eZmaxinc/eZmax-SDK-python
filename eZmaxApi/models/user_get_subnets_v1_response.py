...
class UserGetSubnetsV1Response(BaseModel):
    """
    Response for GET /1/object/user/{pkiUserID}/getSubnets  # noqa: E501
    """
    ...
    m_payload: UserGetSubnetsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserGetSubnetsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserGetSubnetsV1Response:
        """Create an instance of UserGetSubnetsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserGetSubnetsV1Response.parse_obj(obj)

        _obj = UserGetSubnetsV1Response.parse_obj({
            ...
            "m_payload": UserGetSubnetsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
