...
class EzsigntemplatepackageGetListV1Response(BaseModel):
    """
    Response for GET /1/object/ezsigntemplatepackage/getList  # noqa: E501
    """
    ...
    m_payload: EzsigntemplatepackageGetListV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatepackageGetListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatepackageGetListV1Response:
        """Create an instance of EzsigntemplatepackageGetListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatepackageGetListV1Response.parse_obj(obj)

        _obj = EzsigntemplatepackageGetListV1Response.parse_obj({
            ...
            "m_payload": EzsigntemplatepackageGetListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
