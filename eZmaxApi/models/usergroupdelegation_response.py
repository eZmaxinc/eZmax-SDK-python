...
class UsergroupdelegationResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupdelegationResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupdelegationResponse:
        """Create an instance of UsergroupdelegationResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupdelegationResponse.parse_obj(obj)

        _obj = UsergroupdelegationResponse.parse_obj({
