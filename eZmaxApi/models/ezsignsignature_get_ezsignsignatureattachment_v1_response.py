...
class EzsignsignatureGetEzsignsignatureattachmentV1Response(BaseModel):
    """
    ...
    m_payload: EzsignsignatureGetEzsignsignatureattachmentV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignatureGetEzsignsignatureattachmentV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignatureGetEzsignsignatureattachmentV1Response:
        """Create an instance of EzsignsignatureGetEzsignsignatureattachmentV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignatureGetEzsignsignatureattachmentV1Response.parse_obj(obj)

        _obj = EzsignsignatureGetEzsignsignatureattachmentV1Response.parse_obj({
            ...
            "m_payload": EzsignsignatureGetEzsignsignatureattachmentV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
