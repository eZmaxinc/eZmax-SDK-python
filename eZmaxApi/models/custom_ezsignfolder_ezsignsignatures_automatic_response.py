...
class CustomEzsignfolderEzsignsignaturesAutomaticResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "a_objEzsigndocument": [CustomEzsigndocumentEzsignsignaturesAutomaticResponse.from_dict(_item) for _item in obj["a_objEzsigndocument"]] if obj.get("a_objEzsigndocument") is not None else None
        })
        return _obj
