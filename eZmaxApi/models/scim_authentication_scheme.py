...
class ScimAuthenticationScheme(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ScimAuthenticationScheme:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ScimAuthenticationScheme:
        """Create an instance of ScimAuthenticationScheme from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ScimAuthenticationScheme.parse_obj(obj)

        _obj = ScimAuthenticationScheme.parse_obj({
