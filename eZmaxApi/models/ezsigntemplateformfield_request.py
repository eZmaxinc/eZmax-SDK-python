...
class EzsigntemplateformfieldRequest(BaseModel):
    """
    A Ezsigntemplateformfield Object  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplateformfieldRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplateformfieldRequest:
        """Create an instance of EzsigntemplateformfieldRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplateformfieldRequest.parse_obj(obj)

        _obj = EzsigntemplateformfieldRequest.parse_obj({
