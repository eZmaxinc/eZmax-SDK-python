...
class EzsigntemplatepackagemembershipCreateObjectV1Request(BaseModel):
    ...
    """ # noqa: E501
    a_obj_ezsigntemplatepackagemembership: Annotated[List[EzsigntemplatepackagemembershipRequestCompound], Field(min_length=1)] = Field(alias="a_objEzsigntemplatepackagemembership")
    __properties: ClassVar[List[str]] = ["a_objEzsigntemplatepackagemembership"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objEzsigntemplatepackagemembership": [EzsigntemplatepackagemembershipRequestCompound.from_dict(_item) for _item in obj.get("a_objEzsigntemplatepackagemembership")] if obj.get("a_objEzsigntemplatepackagemembership") is not None else None
        })
        return _obj
