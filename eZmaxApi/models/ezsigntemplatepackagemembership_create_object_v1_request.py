...
class EzsigntemplatepackagemembershipCreateObjectV1Request(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objEzsigntemplatepackagemembership": [EzsigntemplatepackagemembershipRequestCompound.from_dict(_item) for _item in obj["a_objEzsigntemplatepackagemembership"]] if obj.get("a_objEzsigntemplatepackagemembership") is not None else None
        })
        return _obj
