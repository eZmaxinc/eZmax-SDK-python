...
class AttachmentGetDownloadUrlV1ResponseMPayload(BaseModel):
    """
    Payload for GET /1/object/attachment/{pkiAttachmentID}/getDownloadUrl
    """ # noqa: E501
    s_download_url: StrictStr = Field(description="The Url to the requested attachment.  Url will expire after 5 minutes.", alias="sDownloadUrl")
