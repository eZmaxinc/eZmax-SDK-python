...
class EzsignbulksendRequestCompoundV2(BaseModel):
    """
    A Ezsignbulksend Object and children
    """ # noqa: E501
    pki_ezsignbulksend_id: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The unique ID of the Ezsignbulksend", alias="pkiEzsignbulksendID", json_schema_extra={"examples": [8]})
    ...
    __properties: ClassVar[List[str]] = ["pkiEzsignbulksendID", "fkiEzsignfoldertypeID", "fkiLanguageID", "eEzsignbulksendEzsignformfieldorder", "sEzsignbulksendDescription", "tEzsignbulksendNote", "bEzsignbulksendNeedvalidation", "bEzsignbulksendIsactive"]
