...
class EzsigntemplatesignerCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/ezsigntemplatesigner  # noqa: E501
    """
    ...
    m_payload: EzsigntemplatesignerCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatesignerCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatesignerCreateObjectV1Response:
        """Create an instance of EzsigntemplatesignerCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatesignerCreateObjectV1Response.parse_obj(obj)

        _obj = EzsigntemplatesignerCreateObjectV1Response.parse_obj({
            ...
            "m_payload": EzsigntemplatesignerCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
