...
class EzsigntemplatesignatureCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/ezsigntemplatesignature  # noqa: E501
    """
    ...
    m_payload: EzsigntemplatesignatureCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatesignatureCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatesignatureCreateObjectV1Response:
        """Create an instance of EzsigntemplatesignatureCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatesignatureCreateObjectV1Response.parse_obj(obj)

        _obj = EzsigntemplatesignatureCreateObjectV1Response.parse_obj({
            ...
            "m_payload": EzsigntemplatesignatureCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
