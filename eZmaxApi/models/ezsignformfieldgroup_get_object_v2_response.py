...
class EzsignformfieldgroupGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/ezsignformfieldgroup/{pkiEzsignformfieldgroupID}  # noqa: E501
    """
    ...
    m_payload: EzsignformfieldgroupGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignformfieldgroupGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignformfieldgroupGetObjectV2Response:
        """Create an instance of EzsignformfieldgroupGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignformfieldgroupGetObjectV2Response.parse_obj(obj)

        _obj = EzsignformfieldgroupGetObjectV2Response.parse_obj({
            ...
            "m_payload": EzsignformfieldgroupGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
