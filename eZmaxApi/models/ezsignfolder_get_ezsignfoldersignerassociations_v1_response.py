...
class EzsignfolderGetEzsignfoldersignerassociationsV1Response(BaseModel):
    """
    Response for GET /1/object/ezsignfolder/{pkiEzsignfolder}/getEzsignfoldersignerassociations  # noqa: E501
    """
    ...
    m_payload: EzsignfolderGetEzsignfoldersignerassociationsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderGetEzsignfoldersignerassociationsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderGetEzsignfoldersignerassociationsV1Response:
        """Create an instance of EzsignfolderGetEzsignfoldersignerassociationsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderGetEzsignfoldersignerassociationsV1Response.parse_obj(obj)

        _obj = EzsignfolderGetEzsignfoldersignerassociationsV1Response.parse_obj({
            ...
            "m_payload": EzsignfolderGetEzsignfoldersignerassociationsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
