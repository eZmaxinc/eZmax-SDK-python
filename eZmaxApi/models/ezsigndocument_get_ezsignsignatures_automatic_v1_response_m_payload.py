...
class EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "a_objEzsignfolder": [CustomEzsignfolderEzsignsignaturesAutomaticResponse.from_dict(_item) for _item in obj["a_objEzsignfolder"]] if obj.get("a_objEzsignfolder") is not None else None
        })
        return _obj
