...
class EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload(BaseModel):
    """
    Payload for GET /1/object/ezsigndocument/{pkiEzsigndocumentID}/getEzsignsignaturesAutomatic  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload:
        """Create an instance of EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload.parse_obj(obj)

        _obj = EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload.parse_obj({
