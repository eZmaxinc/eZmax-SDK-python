...
class InscriptionnotauthenticatedGetCommunicationListV1Response(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "objDebugPayload": CommonResponseObjDebugPayloadGetList.from_dict(obj.get("objDebugPayload")) if obj.get("objDebugPayload") is not None else None,
            "objDebug": CommonResponseObjDebug.from_dict(obj.get("objDebug")) if obj.get("objDebug") is not None else None,
            "mPayload": InscriptionnotauthenticatedGetCommunicationListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
