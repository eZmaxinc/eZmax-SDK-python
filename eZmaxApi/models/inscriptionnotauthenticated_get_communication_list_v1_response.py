...
class InscriptionnotauthenticatedGetCommunicationListV1Response(BaseModel):
    """
    Response for GET /1/object/inscriptionnotauthenticated/{pkiInscriptionnotauthenticatedID}/getCommunicationList  # noqa: E501
    """
    ...
    m_payload: InscriptionnotauthenticatedGetCommunicationListV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InscriptionnotauthenticatedGetCommunicationListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InscriptionnotauthenticatedGetCommunicationListV1Response:
        """Create an instance of InscriptionnotauthenticatedGetCommunicationListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InscriptionnotauthenticatedGetCommunicationListV1Response.parse_obj(obj)

        _obj = InscriptionnotauthenticatedGetCommunicationListV1Response.parse_obj({
            "obj_debug_payload": CommonResponseObjDebugPayloadGetList.from_dict(obj.get("objDebugPayload")) if obj.get("objDebugPayload") is not None else None,
            "obj_debug": CommonResponseObjDebug.from_dict(obj.get("objDebug")) if obj.get("objDebug") is not None else None,
            "m_payload": InscriptionnotauthenticatedGetCommunicationListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
