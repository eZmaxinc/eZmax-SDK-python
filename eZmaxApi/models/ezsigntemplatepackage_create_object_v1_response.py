...
class EzsigntemplatepackageCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/ezsigntemplatepackage  # noqa: E501
    """
    ...
    m_payload: EzsigntemplatepackageCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatepackageCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatepackageCreateObjectV1Response:
        """Create an instance of EzsigntemplatepackageCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatepackageCreateObjectV1Response.parse_obj(obj)

        _obj = EzsigntemplatepackageCreateObjectV1Response.parse_obj({
            ...
            "m_payload": EzsigntemplatepackageCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
