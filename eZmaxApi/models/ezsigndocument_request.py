...
class EzsigndocumentRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentRequest:
        """Create an instance of EzsigndocumentRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentRequest.parse_obj(obj)

        _obj = EzsigndocumentRequest.parse_obj({
