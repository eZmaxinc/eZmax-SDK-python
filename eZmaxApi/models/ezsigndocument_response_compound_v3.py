...
class EzsigndocumentResponseCompoundV3(BaseModel):
    ...
    s_ezsigndocument_md5initial: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="MD5 Hash of the initial PDF Document before signatures were applied to it.", alias="sEzsigndocumentMD5initial")
    ...
    s_ezsigndocument_md5signed: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="MD5 Hash of the final PDF Document after all signatures were applied to it.", alias="sEzsigndocumentMD5signed")
    ...
    b_ezsigndocument_sendtoged: Optional[StrictBool] = Field(default=None, description="Whether the Ezsigndocument was copied to EDM", alias="bEzsigndocumentSendtoged")
    ...
    i_ezsigndocument_steptotal: StrictInt = Field(description="The total number of steps", alias="iEzsigndocumentSteptotal")
    i_ezsigndocument_stepcurrent: StrictInt = Field(description="The current step", alias="iEzsigndocumentStepcurrent")
