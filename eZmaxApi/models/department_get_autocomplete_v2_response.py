...
class DepartmentGetAutocompleteV2Response(BaseModel):
    """
    Response for GET /2/object/department/getAutocomplete  # noqa: E501
    """
    ...
    m_payload: DepartmentGetAutocompleteV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DepartmentGetAutocompleteV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DepartmentGetAutocompleteV2Response:
        """Create an instance of DepartmentGetAutocompleteV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DepartmentGetAutocompleteV2Response.parse_obj(obj)

        _obj = DepartmentGetAutocompleteV2Response.parse_obj({
            ...
            "m_payload": DepartmentGetAutocompleteV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
