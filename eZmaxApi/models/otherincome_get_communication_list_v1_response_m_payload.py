...
class OtherincomeGetCommunicationListV1ResponseMPayload(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OtherincomeGetCommunicationListV1ResponseMPayload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OtherincomeGetCommunicationListV1ResponseMPayload:
        """Create an instance of OtherincomeGetCommunicationListV1ResponseMPayload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OtherincomeGetCommunicationListV1ResponseMPayload.parse_obj(obj)
