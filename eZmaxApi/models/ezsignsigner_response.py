...
class EzsignsignerResponse(BaseModel):
    ...
    """ # noqa: E501
    pki_ezsignsigner_id: Annotated[int, Field(strict=True, ge=0)] = Field(description="The unique ID of the Ezsignsigner", alias="pkiEzsignsignerID", json_schema_extra={"examples": [89]})
