...
class CustomEzsignfoldersignerassociationActionableElementResponse(BaseModel):
    """
    A Ezsignfoldersignerassociation Object with actionable elements  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomEzsignfoldersignerassociationActionableElementResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomEzsignfoldersignerassociationActionableElementResponse:
        """Create an instance of CustomEzsignfoldersignerassociationActionableElementResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomEzsignfoldersignerassociationActionableElementResponse.parse_obj(obj)

        _obj = CustomEzsignfoldersignerassociationActionableElementResponse.parse_obj({
            ...
            "b_ezsignfoldersignerassociation_hasactionableelements_current": obj.get("bEzsignfoldersignerassociationHasactionableelementsCurrent"),
            "b_ezsignfoldersignerassociation_hasactionableelements_future": obj.get("bEzsignfoldersignerassociationHasactionableelementsFuture")
        })
        return _obj
