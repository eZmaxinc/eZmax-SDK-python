...
class SignatureGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/signature/{pkiSignatureID}  # noqa: E501
    """
    ...
    m_payload: SignatureGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SignatureGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SignatureGetObjectV2Response:
        """Create an instance of SignatureGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SignatureGetObjectV2Response.parse_obj(obj)

        _obj = SignatureGetObjectV2Response.parse_obj({
            ...
            "m_payload": SignatureGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
