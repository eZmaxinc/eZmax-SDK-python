...
class PaymenttermResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymenttermResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymenttermResponse:
        """Create an instance of PaymenttermResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymenttermResponse.parse_obj(obj)

        _obj = PaymenttermResponse.parse_obj({
