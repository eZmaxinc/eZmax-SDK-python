...
class EzsignfolderGetEzsigndocumentsV1Response(BaseModel):
    """
    Response for GET /1/object/ezsignfolder/{pkiEzsignfolder}/getEzsigndocuments  # noqa: E501
    """
    ...
    m_payload: EzsignfolderGetEzsigndocumentsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderGetEzsigndocumentsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderGetEzsigndocumentsV1Response:
        """Create an instance of EzsignfolderGetEzsigndocumentsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderGetEzsigndocumentsV1Response.parse_obj(obj)

        _obj = EzsignfolderGetEzsigndocumentsV1Response.parse_obj({
            ...
            "m_payload": EzsignfolderGetEzsigndocumentsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
