...
class EzsigntemplatedocumentGetEzsigntemplatesignaturesV1Response(BaseModel):
    """
    Response for GET /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocument}/getEzsigntemplatesignatures  # noqa: E501
    """
    ...
    m_payload: EzsigntemplatedocumentGetEzsigntemplatesignaturesV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatedocumentGetEzsigntemplatesignaturesV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatedocumentGetEzsigntemplatesignaturesV1Response:
        """Create an instance of EzsigntemplatedocumentGetEzsigntemplatesignaturesV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatedocumentGetEzsigntemplatesignaturesV1Response.parse_obj(obj)

        _obj = EzsigntemplatedocumentGetEzsigntemplatesignaturesV1Response.parse_obj({
            ...
            "m_payload": EzsigntemplatedocumentGetEzsigntemplatesignaturesV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
