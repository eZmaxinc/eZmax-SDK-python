...
class EzsignsignergroupmembershipResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignergroupmembershipResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignergroupmembershipResponse:
        """Create an instance of EzsignsignergroupmembershipResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignergroupmembershipResponse.parse_obj(obj)

        _obj = EzsignsignergroupmembershipResponse.parse_obj({
