...
class MultilingualEzdoctemplatedocumentName(BaseModel):
    """
    ...
    def s_ezdoctemplatedocument_name1_validate_regular_expression(cls, value):
    ...
    @field_validator('s_ezdoctemplatedocument_name2')
    def s_ezdoctemplatedocument_name2_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sEzdoctemplatedocumentName1": obj.get("sEzdoctemplatedocumentName1"),
            "sEzdoctemplatedocumentName2": obj.get("sEzdoctemplatedocumentName2")
        })
        return _obj
