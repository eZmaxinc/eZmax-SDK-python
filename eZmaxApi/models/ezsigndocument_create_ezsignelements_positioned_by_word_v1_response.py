...
class EzsigndocumentCreateEzsignelementsPositionedByWordV1Response(BaseModel):
    """
    ...
    m_payload: EzsigndocumentCreateEzsignelementsPositionedByWordV1ResponseMPayload = Field(alias="mPayload")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "mPayload": EzsigndocumentCreateEzsignelementsPositionedByWordV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
