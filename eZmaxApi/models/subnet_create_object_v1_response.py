...
class SubnetCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/subnet  # noqa: E501
    """
    ...
    m_payload: SubnetCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubnetCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubnetCreateObjectV1Response:
        """Create an instance of SubnetCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubnetCreateObjectV1Response.parse_obj(obj)

        _obj = SubnetCreateObjectV1Response.parse_obj({
            ...
            "m_payload": SubnetCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
