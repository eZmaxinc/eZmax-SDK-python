...
class MultilingualPaymenttermDescription(BaseModel):
    ...
    @field_validator('s_paymentterm_description2')
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sPaymenttermDescription1": obj.get("sPaymenttermDescription1"),
            "sPaymenttermDescription2": obj.get("sPaymenttermDescription2")
        })
        return _obj
