...
class EzsignformfieldResponse(BaseModel):
    """
    An Ezsignformfield Object  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignformfieldResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignformfieldResponse:
        """Create an instance of EzsignformfieldResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignformfieldResponse.parse_obj(obj)

        _obj = EzsignformfieldResponse.parse_obj({
