...
class EzsigntsarequirementGetAutocompleteV2Response(BaseModel):
    """
    Response for GET /2/object/ezsigntsarequirement/getAutocomplete  # noqa: E501
    """
    ...
    m_payload: EzsigntsarequirementGetAutocompleteV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntsarequirementGetAutocompleteV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntsarequirementGetAutocompleteV2Response:
        """Create an instance of EzsigntsarequirementGetAutocompleteV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntsarequirementGetAutocompleteV2Response.parse_obj(obj)

        _obj = EzsigntsarequirementGetAutocompleteV2Response.parse_obj({
            ...
            "m_payload": EzsigntsarequirementGetAutocompleteV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
