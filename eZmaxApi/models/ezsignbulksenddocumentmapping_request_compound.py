...
class EzsignbulksenddocumentmappingRequestCompound(BaseModel):
    """
    A Ezsignbulksenddocumentmapping Object and children  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignbulksenddocumentmappingRequestCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignbulksenddocumentmappingRequestCompound:
        """Create an instance of EzsignbulksenddocumentmappingRequestCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignbulksenddocumentmappingRequestCompound.parse_obj(obj)

        _obj = EzsignbulksenddocumentmappingRequestCompound.parse_obj({
