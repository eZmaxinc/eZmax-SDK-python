...
class UsergroupexternalCreateObjectV1ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_pkiUsergroupexternalID": obj.get("a_pkiUsergroupexternalID")
        })
        return _obj
