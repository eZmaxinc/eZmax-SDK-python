...
class DepartmentGetAutocompleteV2ResponseMPayload(BaseModel):
    ...
    """ # noqa: E501
    a_obj_department: List[DepartmentAutocompleteElementResponse] = Field(description="An array of Department autocomplete element response.", alias="a_objDepartment")
    __properties: ClassVar[List[str]] = ["a_objDepartment"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objDepartment": [DepartmentAutocompleteElementResponse.from_dict(_item) for _item in obj.get("a_objDepartment")] if obj.get("a_objDepartment") is not None else None
        })
        return _obj
