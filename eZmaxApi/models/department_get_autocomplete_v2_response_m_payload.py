...
class DepartmentGetAutocompleteV2ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objDepartment": [DepartmentAutocompleteElementResponse.from_dict(_item) for _item in obj["a_objDepartment"]] if obj.get("a_objDepartment") is not None else None
        })
        return _obj
