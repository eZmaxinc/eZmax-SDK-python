...
class EzsigntemplatesignatureEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/ezsigntemplatesignature/{pkiEzsigntemplatesignatureID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatesignatureEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatesignatureEditObjectV1Response:
        """Create an instance of EzsigntemplatesignatureEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatesignatureEditObjectV1Response.parse_obj(obj)

        _obj = EzsigntemplatesignatureEditObjectV1Response.parse_obj({
