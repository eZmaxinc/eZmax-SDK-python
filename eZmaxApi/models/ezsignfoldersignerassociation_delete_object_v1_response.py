...
class EzsignfoldersignerassociationDeleteObjectV1Response(BaseModel):
    """
    Response for DELETE /1/object/ezsignfoldersignerassociation/{pkiEzsignfoldersignerassociationID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfoldersignerassociationDeleteObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfoldersignerassociationDeleteObjectV1Response:
        """Create an instance of EzsignfoldersignerassociationDeleteObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfoldersignerassociationDeleteObjectV1Response.parse_obj(obj)

        _obj = EzsignfoldersignerassociationDeleteObjectV1Response.parse_obj({
