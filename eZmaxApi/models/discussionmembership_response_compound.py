...
class DiscussionmembershipResponseCompound(BaseModel):
    """
    ...
    def s_discussionmembership_description_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"^.{0,100}$", value):
            raise ValueError(r"must validate the regular expression /^.{0,100}$/")
        return value
