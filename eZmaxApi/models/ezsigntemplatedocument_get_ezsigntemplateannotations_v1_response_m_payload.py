...
class EzsigntemplatedocumentGetEzsigntemplateannotationsV1ResponseMPayload(BaseModel):
    """
    Payload for GET /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/getEzsigntemplateannotations
    """ # noqa: E501
    a_obj_ezsigntemplateannotation: List[EzsigntemplateannotationResponseCompound] = Field(alias="a_objEzsigntemplateannotation")
    __properties: ClassVar[List[str]] = ["a_objEzsigntemplateannotation"]
