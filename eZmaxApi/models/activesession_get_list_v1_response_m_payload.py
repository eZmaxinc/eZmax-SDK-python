...
class ActivesessionGetListV1ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "a_objActivesession": [ActivesessionListElement.from_dict(_item) for _item in obj.get("a_objActivesession")] if obj.get("a_objActivesession") is not None else None
        })
        return _obj
