...
class UsergroupmembershipRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupmembershipRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupmembershipRequest:
        """Create an instance of UsergroupmembershipRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupmembershipRequest.parse_obj(obj)

        _obj = UsergroupmembershipRequest.parse_obj({
