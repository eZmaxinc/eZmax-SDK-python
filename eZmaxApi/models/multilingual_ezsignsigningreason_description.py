...
class MultilingualEzsignsigningreasonDescription(BaseModel):
    """
    ...
    def s_ezsignsigningreason_description1_validate_regular_expression(cls, value):
    ...
    @field_validator('s_ezsignsigningreason_description2')
    def s_ezsignsigningreason_description2_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "sEzsignsigningreasonDescription1": obj.get("sEzsignsigningreasonDescription1"),
            "sEzsignsigningreasonDescription2": obj.get("sEzsignsigningreasonDescription2")
        })
        return _obj
