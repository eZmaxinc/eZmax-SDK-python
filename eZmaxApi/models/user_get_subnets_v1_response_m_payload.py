...
class UserGetSubnetsV1ResponseMPayload(BaseModel):
    """
    Response for GET /1/object/user/{pkiUserID}/getSubnets
    """ # noqa: E501
    a_obj_subnet: List[SubnetResponseCompound] = Field(alias="a_objSubnet")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objSubnet": [SubnetResponseCompound.from_dict(_item) for _item in obj["a_objSubnet"]] if obj.get("a_objSubnet") is not None else None
        })
        return _obj
