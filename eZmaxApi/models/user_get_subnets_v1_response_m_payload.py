...
class UserGetSubnetsV1ResponseMPayload(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserGetSubnetsV1ResponseMPayload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserGetSubnetsV1ResponseMPayload:
        """Create an instance of UserGetSubnetsV1ResponseMPayload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserGetSubnetsV1ResponseMPayload.parse_obj(obj)

        _obj = UserGetSubnetsV1ResponseMPayload.parse_obj({
