...
class EzmaxinvoicingsummaryexternaldetailResponseCompound(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzmaxinvoicingsummaryexternaldetailResponseCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzmaxinvoicingsummaryexternaldetailResponseCompound:
        """Create an instance of EzmaxinvoicingsummaryexternaldetailResponseCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzmaxinvoicingsummaryexternaldetailResponseCompound.parse_obj(obj)

        _obj = EzmaxinvoicingsummaryexternaldetailResponseCompound.parse_obj({
