...
class PaymenttermEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/paymentterm/{pkiPaymenttermID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymenttermEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymenttermEditObjectV1Response:
        """Create an instance of PaymenttermEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymenttermEditObjectV1Response.parse_obj(obj)

        _obj = PaymenttermEditObjectV1Response.parse_obj({
