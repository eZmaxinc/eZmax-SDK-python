...
class CommonReportsection(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objReportsubsection": [CommonReportsubsection.from_dict(_item) for _item in obj.get("a_objReportsubsection")] if obj.get("a_objReportsubsection") is not None else None,
            "a_objReportcolumn": [CommonReportcolumn.from_dict(_item) for _item in obj.get("a_objReportcolumn")] if obj.get("a_objReportcolumn") is not None else None,
