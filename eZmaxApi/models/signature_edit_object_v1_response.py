...
class SignatureEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/signature/{pkiSignatureID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SignatureEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SignatureEditObjectV1Response:
        """Create an instance of SignatureEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SignatureEditObjectV1Response.parse_obj(obj)

        _obj = SignatureEditObjectV1Response.parse_obj({
