...
class PhonetypeGetAutocompleteV2Response(BaseModel):
    """
    Response for GET /2/object/phonetype/getAutocomplete  # noqa: E501
    """
    ...
    m_payload: PhonetypeGetAutocompleteV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PhonetypeGetAutocompleteV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PhonetypeGetAutocompleteV2Response:
        """Create an instance of PhonetypeGetAutocompleteV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PhonetypeGetAutocompleteV2Response.parse_obj(obj)

        _obj = PhonetypeGetAutocompleteV2Response.parse_obj({
            ...
            "m_payload": PhonetypeGetAutocompleteV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
