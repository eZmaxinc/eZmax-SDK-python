...
class UsergroupmembershipDeleteObjectV1Response(BaseModel):
    """
    Response for DELETE /1/object/usergroupmembership/{pkiUsergroupmembershipID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupmembershipDeleteObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupmembershipDeleteObjectV1Response:
        """Create an instance of UsergroupmembershipDeleteObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupmembershipDeleteObjectV1Response.parse_obj(obj)

        _obj = UsergroupmembershipDeleteObjectV1Response.parse_obj({
