...
class DiscussionCreateObjectV1Request(BaseModel):
    """
    Request for POST /1/object/discussion
    """ # noqa: E501
    a_obj_discussion: Annotated[List[DiscussionRequestCompound], Field(min_length=1)] = Field(alias="a_objDiscussion")
    __properties: ClassVar[List[str]] = ["a_objDiscussion"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objDiscussion": [DiscussionRequestCompound.from_dict(_item) for _item in obj.get("a_objDiscussion")] if obj.get("a_objDiscussion") is not None else None
        })
        return _obj
