...
class EzsignbulksendRequest(BaseModel):
    """
    A Ezsignbulksend Object  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignbulksendRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignbulksendRequest:
        """Create an instance of EzsignbulksendRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignbulksendRequest.parse_obj(obj)

        _obj = EzsignbulksendRequest.parse_obj({
