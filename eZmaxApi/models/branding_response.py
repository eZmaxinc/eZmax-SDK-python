...
class BrandingResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BrandingResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BrandingResponse:
        """Create an instance of BrandingResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BrandingResponse.parse_obj(obj)

        _obj = BrandingResponse.parse_obj({
