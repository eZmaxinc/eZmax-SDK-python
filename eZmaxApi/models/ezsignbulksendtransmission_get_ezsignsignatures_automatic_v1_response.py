...
class EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1Response(BaseModel):
    """
    Response for GET /1/object/ezsignbulksendtransmission/{pkiEzsignbulksendtransmissionID}/getEzsignsignaturesAutomatic  # noqa: E501
    """
    ...
    m_payload: EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1Response:
        """Create an instance of EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1Response.parse_obj(obj)

        _obj = EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1Response.parse_obj({
            ...
            "m_payload": EzsignbulksendtransmissionGetEzsignsignaturesAutomaticV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
