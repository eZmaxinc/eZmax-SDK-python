...
class UsergroupGetUsergroupdelegationsV1ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objUsergroupdelegation": [UsergroupdelegationResponseCompound.from_dict(_item) for _item in obj["a_objUsergroupdelegation"]] if obj.get("a_objUsergroupdelegation") is not None else None
        })
        return _obj
