...
class SystemconfigurationEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/systemconfiguration/{pkiSystemconfigurationID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SystemconfigurationEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SystemconfigurationEditObjectV1Response:
        """Create an instance of SystemconfigurationEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SystemconfigurationEditObjectV1Response.parse_obj(obj)

        _obj = SystemconfigurationEditObjectV1Response.parse_obj({
