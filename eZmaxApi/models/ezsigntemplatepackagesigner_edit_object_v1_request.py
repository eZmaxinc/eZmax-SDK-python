...
class EzsigntemplatepackagesignerEditObjectV1Request(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objEzsigntemplatepackagesigner": EzsigntemplatepackagesignerRequestCompound.from_dict(obj["objEzsigntemplatepackagesigner"]) if obj.get("objEzsigntemplatepackagesigner") is not None else None
        })
        return _obj
