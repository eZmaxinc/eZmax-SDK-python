...
class EzsigntemplatepackagesignerEditObjectV1Request(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "objEzsigntemplatepackagesigner": EzsigntemplatepackagesignerRequestCompound.from_dict(obj.get("objEzsigntemplatepackagesigner")) if obj.get("objEzsigntemplatepackagesigner") is not None else None
        })
        return _obj
