...
class CustomEzsignfoldersignerassociationmineResponse(BaseModel):
    """
    A custom Ezsignfoldersignerassociation Object  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomEzsignfoldersignerassociationmineResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomEzsignfoldersignerassociationmineResponse:
        """Create an instance of CustomEzsignfoldersignerassociationmineResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomEzsignfoldersignerassociationmineResponse.parse_obj(obj)

        _obj = CustomEzsignfoldersignerassociationmineResponse.parse_obj({
