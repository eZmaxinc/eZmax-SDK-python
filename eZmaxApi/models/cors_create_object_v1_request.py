...
class CorsCreateObjectV1Request(BaseModel):
    ...
    """ # noqa: E501
    a_obj_cors: Annotated[List[CorsRequestCompound], Field(min_length=1)] = Field(alias="a_objCors")
    __properties: ClassVar[List[str]] = ["a_objCors"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objCors": [CorsRequestCompound.from_dict(_item) for _item in obj.get("a_objCors")] if obj.get("a_objCors") is not None else None
        })
        return _obj
