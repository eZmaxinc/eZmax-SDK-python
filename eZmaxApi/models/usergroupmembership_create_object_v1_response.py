...
class UsergroupmembershipCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/usergroupmembership  # noqa: E501
    """
    ...
    m_payload: UsergroupmembershipCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupmembershipCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupmembershipCreateObjectV1Response:
        """Create an instance of UsergroupmembershipCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupmembershipCreateObjectV1Response.parse_obj(obj)

        _obj = UsergroupmembershipCreateObjectV1Response.parse_obj({
            ...
            "m_payload": UsergroupmembershipCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
