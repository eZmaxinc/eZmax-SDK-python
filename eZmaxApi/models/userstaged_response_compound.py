...
class UserstagedResponseCompound(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserstagedResponseCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserstagedResponseCompound:
        """Create an instance of UserstagedResponseCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserstagedResponseCompound.parse_obj(obj)

        _obj = UserstagedResponseCompound.parse_obj({
