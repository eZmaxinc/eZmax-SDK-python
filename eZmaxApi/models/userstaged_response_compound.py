...
class UserstagedResponseCompound(BaseModel):
    ...
    fki_email_id: Annotated[int, Field(le=16777215, strict=True, ge=1)] = Field(description="The unique ID of the Email", alias="fkiEmailID", json_schema_extra={"examples": [22]})
