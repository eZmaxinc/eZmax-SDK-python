...
class RejectedoffertopurchaseGetCommunicationListV1Response(BaseModel):
    """
    Response for GET /1/object/rejectedoffertopurchase/{pkiRejectedoffertopurchaseID}/getCommunicationList  # noqa: E501
    """
    ...
    m_payload: RejectedoffertopurchaseGetCommunicationListV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RejectedoffertopurchaseGetCommunicationListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RejectedoffertopurchaseGetCommunicationListV1Response:
        """Create an instance of RejectedoffertopurchaseGetCommunicationListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RejectedoffertopurchaseGetCommunicationListV1Response.parse_obj(obj)

        _obj = RejectedoffertopurchaseGetCommunicationListV1Response.parse_obj({
            ...
            "m_payload": RejectedoffertopurchaseGetCommunicationListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
