...
class EzsignfoldersignerassociationPatchObjectV1Request(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "objEzsignfoldersignerassociation": EzsignfoldersignerassociationRequestPatch.from_dict(obj.get("objEzsignfoldersignerassociation")) if obj.get("objEzsignfoldersignerassociation") is not None else None
        })
        return _obj
