...
class EzsignsignergroupDeleteObjectV1Response(BaseModel):
    """
    Response for DELETE /1/object/ezsignsignergroup/{pkiEzsignsignergroupID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignergroupDeleteObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignergroupDeleteObjectV1Response:
        """Create an instance of EzsignsignergroupDeleteObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignergroupDeleteObjectV1Response.parse_obj(obj)

        _obj = EzsignsignergroupDeleteObjectV1Response.parse_obj({
