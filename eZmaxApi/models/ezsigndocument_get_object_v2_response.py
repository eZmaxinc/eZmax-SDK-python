...
class EzsigndocumentGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/ezsigndocument/{pkiEzsigndocumentID}  # noqa: E501
    """
    ...
    m_payload: EzsigndocumentGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentGetObjectV2Response:
        """Create an instance of EzsigndocumentGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentGetObjectV2Response.parse_obj(obj)

        _obj = EzsigndocumentGetObjectV2Response.parse_obj({
            ...
            "m_payload": EzsigndocumentGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
