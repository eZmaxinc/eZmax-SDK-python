...
class EzsignsignergroupmembershipDeleteObjectV1Response(BaseModel):
    """
    Response for DELETE /1/object/ezsignsignergroupmembership/{pkiEzsignsignergroupmembershipID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignergroupmembershipDeleteObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignergroupmembershipDeleteObjectV1Response:
        """Create an instance of EzsignsignergroupmembershipDeleteObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignergroupmembershipDeleteObjectV1Response.parse_obj(obj)

        _obj = EzsignsignergroupmembershipDeleteObjectV1Response.parse_obj({
