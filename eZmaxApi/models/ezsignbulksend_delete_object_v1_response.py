...
class EzsignbulksendDeleteObjectV1Response(BaseModel):
    """
    Response for DELETE /1/object/ezsignbulksend/{pkiEzsignbulksendID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignbulksendDeleteObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignbulksendDeleteObjectV1Response:
        """Create an instance of EzsignbulksendDeleteObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignbulksendDeleteObjectV1Response.parse_obj(obj)

        _obj = EzsignbulksendDeleteObjectV1Response.parse_obj({
