...
class MultilingualEzmaxpartnerAddress(BaseModel):
    """
    ...
    def s_ezmaxpartner_address1_validate_regular_expression(cls, value):
    ...
    @field_validator('s_ezmaxpartner_address2')
    def s_ezmaxpartner_address2_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sEzmaxpartnerAddress1": obj.get("sEzmaxpartnerAddress1"),
            "sEzmaxpartnerAddress2": obj.get("sEzmaxpartnerAddress2")
        })
        return _obj
