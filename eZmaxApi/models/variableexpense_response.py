...
class VariableexpenseResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VariableexpenseResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VariableexpenseResponse:
        """Create an instance of VariableexpenseResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VariableexpenseResponse.parse_obj(obj)

        _obj = VariableexpenseResponse.parse_obj({
