...
class WebhookTestV1Response(BaseModel):
    """
    Response for POST /1/object/webhook/{pkiWebhookID}/test  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhookTestV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookTestV1Response:
        """Create an instance of WebhookTestV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookTestV1Response.parse_obj(obj)

        _obj = WebhookTestV1Response.parse_obj({
