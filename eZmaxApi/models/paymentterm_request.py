...
class PaymenttermRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymenttermRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymenttermRequest:
        """Create an instance of PaymenttermRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymenttermRequest.parse_obj(obj)

        _obj = PaymenttermRequest.parse_obj({
