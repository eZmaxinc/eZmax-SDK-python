...
class EzsignsignergroupEditEzsignsignergroupmembershipsV1Response(BaseModel):
    """
    ...
    m_payload: EzsignsignergroupEditEzsignsignergroupmembershipsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignergroupEditEzsignsignergroupmembershipsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignergroupEditEzsignsignergroupmembershipsV1Response:
        """Create an instance of EzsignsignergroupEditEzsignsignergroupmembershipsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignergroupEditEzsignsignergroupmembershipsV1Response.parse_obj(obj)

        _obj = EzsignsignergroupEditEzsignsignergroupmembershipsV1Response.parse_obj({
            ...
            "m_payload": EzsignsignergroupEditEzsignsignergroupmembershipsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
