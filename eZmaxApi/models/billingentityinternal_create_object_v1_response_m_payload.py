...
class BillingentityinternalCreateObjectV1ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_pkiBillingentityinternalID": obj.get("a_pkiBillingentityinternalID")
        })
        return _obj
