...
class BillingentityinternalGetAutocompleteV2Response(BaseModel):
    """
    Response for GET /2/object/billingentityinternal/getAutocomplete  # noqa: E501
    """
    ...
    m_payload: BillingentityinternalGetAutocompleteV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillingentityinternalGetAutocompleteV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillingentityinternalGetAutocompleteV2Response:
        """Create an instance of BillingentityinternalGetAutocompleteV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillingentityinternalGetAutocompleteV2Response.parse_obj(obj)

        _obj = BillingentityinternalGetAutocompleteV2Response.parse_obj({
            ...
            "m_payload": BillingentityinternalGetAutocompleteV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
