...
class BrandingGetListV1Response(BaseModel):
    """
    Response for GET /1/object/branding/getList  # noqa: E501
    """
    ...
    m_payload: BrandingGetListV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BrandingGetListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BrandingGetListV1Response:
        """Create an instance of BrandingGetListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BrandingGetListV1Response.parse_obj(obj)

        _obj = BrandingGetListV1Response.parse_obj({
            ...
            "m_payload": BrandingGetListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
