...
class MultilingualEzmaxpartnerPhoneE164(BaseModel):
    """
    ...
    def s_ezmaxpartner_phone_e1641_validate_regular_expression(cls, value):
    ...
    @field_validator('s_ezmaxpartner_phone_e1642')
    def s_ezmaxpartner_phone_e1642_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MultilingualEzmaxpartnerPhoneE164 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MultilingualEzmaxpartnerPhoneE164 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "sEzmaxpartnerPhoneE1641": obj.get("sEzmaxpartnerPhoneE1641"),
            "sEzmaxpartnerPhoneE1642": obj.get("sEzmaxpartnerPhoneE1642")
        })
        return _obj
