...
class EzsignbulksenddocumentmappingGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/ezsignbulksenddocumentmapping/{pkiEzsignbulksenddocumentmappingID}  # noqa: E501
    """
    ...
    m_payload: EzsignbulksenddocumentmappingGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignbulksenddocumentmappingGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignbulksenddocumentmappingGetObjectV2Response:
        """Create an instance of EzsignbulksenddocumentmappingGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignbulksenddocumentmappingGetObjectV2Response.parse_obj(obj)

        _obj = EzsignbulksenddocumentmappingGetObjectV2Response.parse_obj({
            ...
            "m_payload": EzsignbulksenddocumentmappingGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
