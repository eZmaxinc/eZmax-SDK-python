...
class EzsigntemplatesignatureCreateObjectV2Request(BaseModel):
    """
    Request for POST /2/object/ezsigntemplatesignature
    """ # noqa: E501
    a_obj_ezsigntemplatesignature: Annotated[List[EzsigntemplatesignatureRequestCompoundV2], Field(min_length=1)] = Field(alias="a_objEzsigntemplatesignature")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objEzsigntemplatesignature": [EzsigntemplatesignatureRequestCompoundV2.from_dict(_item) for _item in obj["a_objEzsigntemplatesignature"]] if obj.get("a_objEzsigntemplatesignature") is not None else None
        })
        return _obj
