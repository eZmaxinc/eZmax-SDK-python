...
class UsergroupdelegationRequestCompound(BaseModel):
    """
    A Usergroupdelegation Object and children  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupdelegationRequestCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupdelegationRequestCompound:
        """Create an instance of UsergroupdelegationRequestCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupdelegationRequestCompound.parse_obj(obj)

        _obj = UsergroupdelegationRequestCompound.parse_obj({
