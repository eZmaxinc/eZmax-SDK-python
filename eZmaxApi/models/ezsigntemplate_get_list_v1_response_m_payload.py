...
class EzsigntemplateGetListV1ResponseMPayload(BaseModel):
    ...
    a_obj_ezsigntemplate: List[EzsigntemplateListElement] = Field(alias="a_objEzsigntemplate")
    __properties: ClassVar[List[str]] = ["iRowReturned", "iRowFiltered", "a_objEzsigntemplate"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "a_objEzsigntemplate": [EzsigntemplateListElement.from_dict(_item) for _item in obj.get("a_objEzsigntemplate")] if obj.get("a_objEzsigntemplate") is not None else None
        })
        return _obj
