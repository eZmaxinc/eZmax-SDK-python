...
class EzsigntemplateformfieldgroupGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/ezsigntemplateformfieldgroup/{pkiEzsigntemplateformfieldgroupID}  # noqa: E501
    """
    ...
    m_payload: EzsigntemplateformfieldgroupGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplateformfieldgroupGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplateformfieldgroupGetObjectV2Response:
        """Create an instance of EzsigntemplateformfieldgroupGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplateformfieldgroupGetObjectV2Response.parse_obj(obj)

        _obj = EzsigntemplateformfieldgroupGetObjectV2Response.parse_obj({
            ...
            "m_payload": EzsigntemplateformfieldgroupGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
