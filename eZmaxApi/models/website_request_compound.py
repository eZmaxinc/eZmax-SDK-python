...
class WebsiteRequestCompound(BaseModel):
    """
    A Website Object and children to create a complete structure  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebsiteRequestCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebsiteRequestCompound:
        """Create an instance of WebsiteRequestCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebsiteRequestCompound.parse_obj(obj)

        _obj = WebsiteRequestCompound.parse_obj({
