...
class WebsiteRequestCompound(BaseModel):
    ...
    """ # noqa: E501
    pki_website_id: Optional[Annotated[int, Field(le=16777215, strict=True, ge=0)]] = Field(default=None, description="The unique ID of the Website Default", alias="pkiWebsiteID", json_schema_extra={"examples": [145]})
