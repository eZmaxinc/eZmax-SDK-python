...
class EzsignfoldertypeResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfoldertypeResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfoldertypeResponse:
        """Create an instance of EzsignfoldertypeResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfoldertypeResponse.parse_obj(obj)

        _obj = EzsignfoldertypeResponse.parse_obj({
