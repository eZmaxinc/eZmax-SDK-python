...
class EzsignfoldertypeResponse(BaseModel):
    """
    ...
    fki_usergroup_id_restricted: Optional[Annotated[int, Field(le=255, strict=True, ge=0)]] = Field(default=None, description="The unique ID of the Usergroup", alias="fkiUsergroupIDRestricted", json_schema_extra={"examples": [2]})
    ...
    s_usergroup_name_x_restricted: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The Name of the Usergroup in the language of the requester", alias="sUsergroupNameXRestricted", json_schema_extra={"examples": ["Administration"]})
