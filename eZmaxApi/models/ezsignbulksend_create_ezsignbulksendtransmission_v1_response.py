...
class EzsignbulksendCreateEzsignbulksendtransmissionV1Response(BaseModel):
    """
    Response for POST /1/object/ezsignbulksend/{pkiEzsignbulksendID}/createEzsignbulksendtransmission  # noqa: E501
    """
    ...
    m_payload: EzsignbulksendCreateEzsignbulksendtransmissionV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignbulksendCreateEzsignbulksendtransmissionV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignbulksendCreateEzsignbulksendtransmissionV1Response:
        """Create an instance of EzsignbulksendCreateEzsignbulksendtransmissionV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignbulksendCreateEzsignbulksendtransmissionV1Response.parse_obj(obj)

        _obj = EzsignbulksendCreateEzsignbulksendtransmissionV1Response.parse_obj({
            ...
            "m_payload": EzsignbulksendCreateEzsignbulksendtransmissionV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
