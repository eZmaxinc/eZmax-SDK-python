...
class CreditcardmerchantEditObjectV1Request(BaseModel):
    """
    Request for PUT /1/object/creditcardmerchant/{pkiCreditcardmerchantID}
    """ # noqa: E501
    obj_creditcardmerchant: CreditcardmerchantRequestCompound = Field(alias="objCreditcardmerchant")
    __properties: ClassVar[List[str]] = ["objCreditcardmerchant"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objCreditcardmerchant": CreditcardmerchantRequestCompound.from_dict(obj["objCreditcardmerchant"]) if obj.get("objCreditcardmerchant") is not None else None
        })
        return _obj
