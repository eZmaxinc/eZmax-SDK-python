...
class EzsignfoldertypeEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/ezsignfoldertype/{pkiEzsignfoldertypeID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfoldertypeEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfoldertypeEditObjectV1Response:
        """Create an instance of EzsignfoldertypeEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfoldertypeEditObjectV1Response.parse_obj(obj)

        _obj = EzsignfoldertypeEditObjectV1Response.parse_obj({
