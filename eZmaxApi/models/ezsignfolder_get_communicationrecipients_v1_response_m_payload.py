...
class EzsignfolderGetCommunicationrecipientsV1ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objCommunicationrecipientsgroup": [CustomCommunicationrecipientsgroupResponse.from_dict(_item) for _item in obj.get("a_objCommunicationrecipientsgroup")] if obj.get("a_objCommunicationrecipientsgroup") is not None else None
        })
        return _obj
