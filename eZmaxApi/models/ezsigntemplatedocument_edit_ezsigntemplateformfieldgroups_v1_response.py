...
class EzsigntemplatedocumentEditEzsigntemplateformfieldgroupsV1Response(BaseModel):
    """
    Response for PUT /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/editEzsigntemplateformfieldgroups  # noqa: E501
    """
    ...
    m_payload: EzsigntemplatedocumentEditEzsigntemplateformfieldgroupsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatedocumentEditEzsigntemplateformfieldgroupsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatedocumentEditEzsigntemplateformfieldgroupsV1Response:
        """Create an instance of EzsigntemplatedocumentEditEzsigntemplateformfieldgroupsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatedocumentEditEzsigntemplateformfieldgroupsV1Response.parse_obj(obj)

        _obj = EzsigntemplatedocumentEditEzsigntemplateformfieldgroupsV1Response.parse_obj({
            ...
            "m_payload": EzsigntemplatedocumentEditEzsigntemplateformfieldgroupsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
