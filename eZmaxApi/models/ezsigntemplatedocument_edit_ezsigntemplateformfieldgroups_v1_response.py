...
class EzsigntemplatedocumentEditEzsigntemplateformfieldgroupsV1Response(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "mPayload": EzsigntemplatedocumentEditEzsigntemplateformfieldgroupsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
