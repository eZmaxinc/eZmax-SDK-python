...
class EzsignbulksendGetEzsignsignaturesAutomaticV1Response(BaseModel):
    """
    Response for GET /1/object/ezsignbulksend/{pkiEzsignbulksendID}/getEzsignsignaturesAutomatic  # noqa: E501
    """
    ...
    m_payload: EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignbulksendGetEzsignsignaturesAutomaticV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignbulksendGetEzsignsignaturesAutomaticV1Response:
        """Create an instance of EzsignbulksendGetEzsignsignaturesAutomaticV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignbulksendGetEzsignsignaturesAutomaticV1Response.parse_obj(obj)

        _obj = EzsignbulksendGetEzsignsignaturesAutomaticV1Response.parse_obj({
            ...
            "m_payload": EzsignbulksendGetEzsignsignaturesAutomaticV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
