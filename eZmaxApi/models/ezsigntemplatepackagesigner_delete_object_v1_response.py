...
class EzsigntemplatepackagesignerDeleteObjectV1Response(BaseModel):
    """
    Response for DELETE /1/object/ezsigntemplatepackagesigner/{pkiEzsigntemplatepackagesignerID}  # noqa: E501
    """
    ...
    m_payload: EzsigntemplatepackagesignerDeleteObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatepackagesignerDeleteObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatepackagesignerDeleteObjectV1Response:
        """Create an instance of EzsigntemplatepackagesignerDeleteObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatepackagesignerDeleteObjectV1Response.parse_obj(obj)

        _obj = EzsigntemplatepackagesignerDeleteObjectV1Response.parse_obj({
            ...
            "m_payload": EzsigntemplatepackagesignerDeleteObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
