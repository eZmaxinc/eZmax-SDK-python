...
class EzsigntemplatepackagemembershipCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/ezsigntemplatepackagemembership  # noqa: E501
    """
    ...
    m_payload: EzsigntemplatepackagemembershipCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatepackagemembershipCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatepackagemembershipCreateObjectV1Response:
        """Create an instance of EzsigntemplatepackagemembershipCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatepackagemembershipCreateObjectV1Response.parse_obj(obj)

        _obj = EzsigntemplatepackagemembershipCreateObjectV1Response.parse_obj({
            ...
            "m_payload": EzsigntemplatepackagemembershipCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
