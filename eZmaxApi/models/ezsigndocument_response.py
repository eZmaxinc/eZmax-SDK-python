...
class EzsigndocumentResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentResponse:
        """Create an instance of EzsigndocumentResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentResponse.parse_obj(obj)

        _obj = EzsigndocumentResponse.parse_obj({
