...
class EzsigntemplatedocumentEditObjectV1Request(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objEzsigntemplatedocument": EzsigntemplatedocumentRequestCompound.from_dict(obj["objEzsigntemplatedocument"]) if obj.get("objEzsigntemplatedocument") is not None else None
        })
        return _obj
