...
class EzsignfolderGetObjectV3ResponseMPayload(BaseModel):
    """
    Payload for GET /3/object/ezsignfolder/{pkiEzsignfolderID}
    """ # noqa: E501
    obj_ezsignfolder: EzsignfolderResponseCompoundV3 = Field(alias="objEzsignfolder")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objEzsignfolder": EzsignfolderResponseCompoundV3.from_dict(obj["objEzsignfolder"]) if obj.get("objEzsignfolder") is not None else None
        })
        return _obj
