...
class ApikeyGetPermissionsV1Response(BaseModel):
    """
    ...
    m_payload: ApikeyGetPermissionsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApikeyGetPermissionsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApikeyGetPermissionsV1Response:
        """Create an instance of ApikeyGetPermissionsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApikeyGetPermissionsV1Response.parse_obj(obj)

        _obj = ApikeyGetPermissionsV1Response.parse_obj({
            ...
            "m_payload": ApikeyGetPermissionsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
