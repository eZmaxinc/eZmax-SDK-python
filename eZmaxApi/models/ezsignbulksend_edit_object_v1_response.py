...
class EzsignbulksendEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/ezsignbulksend/{pkiEzsignbulksendID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignbulksendEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignbulksendEditObjectV1Response:
        """Create an instance of EzsignbulksendEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignbulksendEditObjectV1Response.parse_obj(obj)

        _obj = EzsignbulksendEditObjectV1Response.parse_obj({
