...
class PaymentmethodAutocompleteElementResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pkiPaymentmethodID": obj.get("pkiPaymentmethodID"),
            "sPaymentmethodDescriptionX": obj.get("sPaymentmethodDescriptionX"),
            "bPaymentmethodIsactive": obj.get("bPaymentmethodIsactive")
        })
        return _obj
