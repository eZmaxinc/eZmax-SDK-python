...
class EzsigndocumentGetEzsignsignaturesV1Response(BaseModel):
    """
    Response for GET /1/object/ezsigndocument/{pkiEzsigndocument}/getEzsignsignatures  # noqa: E501
    """
    ...
    m_payload: EzsigndocumentGetEzsignsignaturesV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentGetEzsignsignaturesV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentGetEzsignsignaturesV1Response:
        """Create an instance of EzsigndocumentGetEzsignsignaturesV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentGetEzsignsignaturesV1Response.parse_obj(obj)

        _obj = EzsigndocumentGetEzsignsignaturesV1Response.parse_obj({
            ...
            "m_payload": EzsigndocumentGetEzsignsignaturesV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
