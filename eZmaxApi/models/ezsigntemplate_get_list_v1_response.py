...
class EzsigntemplateGetListV1Response(BaseModel):
    """
    Response for GET /1/object/ezsigntemplate/getList  # noqa: E501
    """
    ...
    m_payload: EzsigntemplateGetListV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplateGetListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplateGetListV1Response:
        """Create an instance of EzsigntemplateGetListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplateGetListV1Response.parse_obj(obj)

        _obj = EzsigntemplateGetListV1Response.parse_obj({
            ...
            "m_payload": EzsigntemplateGetListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
