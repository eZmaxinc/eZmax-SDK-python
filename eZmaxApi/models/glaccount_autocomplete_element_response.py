...
class GlaccountAutocompleteElementResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pkiGlaccountID": obj.get("pkiGlaccountID"),
            "iGlaccountCode": obj.get("iGlaccountCode"),
            "sGlaccountDescriptionX": obj.get("sGlaccountDescriptionX"),
            "bGlaccountIsactive": obj.get("bGlaccountIsactive")
        })
        return _obj
