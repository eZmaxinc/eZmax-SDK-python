...
class CommunicationrecipientResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommunicationrecipientResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommunicationrecipientResponse:
        """Create an instance of CommunicationrecipientResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommunicationrecipientResponse.parse_obj(obj)

        _obj = CommunicationrecipientResponse.parse_obj({
