...
class EzsigntemplateformfieldgroupResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplateformfieldgroupResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplateformfieldgroupResponse:
        """Create an instance of EzsigntemplateformfieldgroupResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplateformfieldgroupResponse.parse_obj(obj)

        _obj = EzsigntemplateformfieldgroupResponse.parse_obj({
