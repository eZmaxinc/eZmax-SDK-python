...
class EzsigntemplatesignerEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/ezsigntemplatesigner/{pkiEzsigntemplatesignerID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatesignerEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatesignerEditObjectV1Response:
        """Create an instance of EzsigntemplatesignerEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatesignerEditObjectV1Response.parse_obj(obj)

        _obj = EzsigntemplatesignerEditObjectV1Response.parse_obj({
