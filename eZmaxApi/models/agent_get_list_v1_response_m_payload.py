...
class AgentGetListV1ResponseMPayload(BaseModel):
    """
    ...
    a_obj_agent: List[AgentListElement] = Field(alias="a_objAgent")
    __properties: ClassVar[List[str]] = ["iRowReturned", "iRowFiltered", "a_objAgent"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "a_objAgent": [AgentListElement.from_dict(_item) for _item in obj["a_objAgent"]] if obj.get("a_objAgent") is not None else None
        })
        return _obj
