...
class CommonGetAutocompleteV1Response(BaseModel):
    ...
    m_payload: List[CustomAutocompleteElementResponse] = Field(description="Generic Autocomplete Response", alias="mPayload")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "mPayload": [CustomAutocompleteElementResponse.from_dict(_item) for _item in obj.get("mPayload")] if obj.get("mPayload") is not None else None
        })
        return _obj
