...
class EzsignbulksendGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/ezsignbulksend/{pkiEzsignbulksendID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignbulksendGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignbulksendGetObjectV2Response:
        """Create an instance of EzsignbulksendGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignbulksendGetObjectV2Response.parse_obj(obj)

        _obj = EzsignbulksendGetObjectV2Response.parse_obj({
            ...
            "m_payload": EzsignbulksendGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
