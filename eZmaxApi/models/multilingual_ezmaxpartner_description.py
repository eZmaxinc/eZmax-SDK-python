...
class MultilingualEzmaxpartnerDescription(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sEzmaxpartnerDescription1": obj.get("sEzmaxpartnerDescription1"),
            "sEzmaxpartnerDescription2": obj.get("sEzmaxpartnerDescription2")
        })
        return _obj
