...
class EzsignfolderSendV3Response(BaseModel):
    """
    Response for POST /3/object/ezsignfolder/{pkiEzsignfolderID}/send  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderSendV3Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderSendV3Response:
        """Create an instance of EzsignfolderSendV3Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderSendV3Response.parse_obj(obj)

        _obj = EzsignfolderSendV3Response.parse_obj({
