...
class EzsignfolderDisposeV1Response(BaseModel):
    """
    Response for POST /1/object/ezsignfolder/{pkiEzsignfolderID}/dispose  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderDisposeV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderDisposeV1Response:
        """Create an instance of EzsignfolderDisposeV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderDisposeV1Response.parse_obj(obj)

        _obj = EzsignfolderDisposeV1Response.parse_obj({
