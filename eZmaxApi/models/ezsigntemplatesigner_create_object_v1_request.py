...
class EzsigntemplatesignerCreateObjectV1Request(BaseModel):
    ...
    """ # noqa: E501
    a_obj_ezsigntemplatesigner: Annotated[List[EzsigntemplatesignerRequestCompound], Field(min_length=1)] = Field(alias="a_objEzsigntemplatesigner")
    __properties: ClassVar[List[str]] = ["a_objEzsigntemplatesigner"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objEzsigntemplatesigner": [EzsigntemplatesignerRequestCompound.from_dict(_item) for _item in obj.get("a_objEzsigntemplatesigner")] if obj.get("a_objEzsigntemplatesigner") is not None else None
        })
        return _obj
