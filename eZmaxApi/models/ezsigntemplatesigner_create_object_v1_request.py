...
class EzsigntemplatesignerCreateObjectV1Request(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objEzsigntemplatesigner": [EzsigntemplatesignerRequestCompound.from_dict(_item) for _item in obj["a_objEzsigntemplatesigner"]] if obj.get("a_objEzsigntemplatesigner") is not None else None
        })
        return _obj
