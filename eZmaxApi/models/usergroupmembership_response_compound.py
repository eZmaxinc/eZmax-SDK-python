...
class UsergroupmembershipResponseCompound(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupmembershipResponseCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupmembershipResponseCompound:
        """Create an instance of UsergroupmembershipResponseCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupmembershipResponseCompound.parse_obj(obj)

        _obj = UsergroupmembershipResponseCompound.parse_obj({
