...
class EzsignbulksendsignermappingCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/ezsignbulksendsignermapping  # noqa: E501
    """
    ...
    m_payload: EzsignbulksendsignermappingCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignbulksendsignermappingCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignbulksendsignermappingCreateObjectV1Response:
        """Create an instance of EzsignbulksendsignermappingCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignbulksendsignermappingCreateObjectV1Response.parse_obj(obj)

        _obj = EzsignbulksendsignermappingCreateObjectV1Response.parse_obj({
            ...
            "m_payload": EzsignbulksendsignermappingCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
