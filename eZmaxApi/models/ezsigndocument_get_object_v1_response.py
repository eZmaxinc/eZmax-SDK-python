...
class EzsigndocumentGetObjectV1Response(BaseModel):
    """
    Response for GET /1/object/ezsigndocument/{pkiEzsigndocumentID}  # noqa: E501
    """
    ...
    m_payload: EzsigndocumentGetObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentGetObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentGetObjectV1Response:
        """Create an instance of EzsigndocumentGetObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentGetObjectV1Response.parse_obj(obj)

        _obj = EzsigndocumentGetObjectV1Response.parse_obj({
            ...
            "m_payload": EzsigndocumentGetObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
