...
class UsergroupResponseCompound(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupResponseCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupResponseCompound:
        """Create an instance of UsergroupResponseCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupResponseCompound.parse_obj(obj)

        _obj = UsergroupResponseCompound.parse_obj({
