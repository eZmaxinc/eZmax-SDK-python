...
class SignatureCreateObjectV1Request(BaseModel):
    ...
    """ # noqa: E501
    a_obj_signature: Annotated[List[SignatureRequestCompound], Field(min_length=1)] = Field(alias="a_objSignature")
    __properties: ClassVar[List[str]] = ["a_objSignature"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objSignature": [SignatureRequestCompound.from_dict(_item) for _item in obj.get("a_objSignature")] if obj.get("a_objSignature") is not None else None
        })
        return _obj
