...
class BrandingCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/branding  # noqa: E501
    """
    ...
    m_payload: BrandingCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BrandingCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BrandingCreateObjectV1Response:
        """Create an instance of BrandingCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BrandingCreateObjectV1Response.parse_obj(obj)

        _obj = BrandingCreateObjectV1Response.parse_obj({
            ...
            "m_payload": BrandingCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
