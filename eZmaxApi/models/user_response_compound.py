...
class UserResponseCompound(BaseModel):
    """
    A User Object and children to create a complete structure  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserResponseCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserResponseCompound:
        """Create an instance of UserResponseCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserResponseCompound.parse_obj(obj)

        _obj = UserResponseCompound.parse_obj({
