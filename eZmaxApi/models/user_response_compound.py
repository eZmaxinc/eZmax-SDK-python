...
class UserResponseCompound(BaseModel):
    """
    ...
    dt_user_lastlogondate: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The last logon date of the User", alias="dtUserLastlogondate", json_schema_extra={"examples": ["2020-12-31 23:59:59"]})
    dt_user_passwordchanged: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The date at which the User's password was last changed", alias="dtUserPasswordchanged", json_schema_extra={"examples": ["2020-12-31 23:59:59"]})
    ...
    b_user_changepassword: StrictBool = Field(description="Whether if the User is forced to change its password", alias="bUserChangepassword", json_schema_extra={"examples": [True]})
