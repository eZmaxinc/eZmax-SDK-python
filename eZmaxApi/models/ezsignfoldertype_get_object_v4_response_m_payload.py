...
class EzsignfoldertypeGetObjectV4ResponseMPayload(BaseModel):
    """
    Payload for GET /4/object/ezsignfoldertype/{pkiEzsignfoldertypeID}
    """ # noqa: E501
    obj_ezsignfoldertype: EzsignfoldertypeResponseCompoundV4 = Field(alias="objEzsignfoldertype")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objEzsignfoldertype": EzsignfoldertypeResponseCompoundV4.from_dict(obj["objEzsignfoldertype"]) if obj.get("objEzsignfoldertype") is not None else None
        })
        return _obj
