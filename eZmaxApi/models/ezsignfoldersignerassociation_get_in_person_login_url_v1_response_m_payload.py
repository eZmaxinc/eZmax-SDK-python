...
class EzsignfoldersignerassociationGetInPersonLoginUrlV1ResponseMPayload(BaseModel):
    ...
    """ # noqa: E501
    s_login_url: StrictStr = Field(description="The Url to login to the signing application.    Url will expire after 30 minutes.  ", alias="sLoginUrl")
    __properties: ClassVar[List[str]] = ["sLoginUrl"]
