...
class CreditcardmerchantResponseCompound(BaseModel):
    """
    ...
    s_bankaccount_bankname: Optional[StrictStr] = Field(default=None, description="The name of the bank", alias="sBankaccountBankname")
    ...
    __properties: ClassVar[List[str]] = ["pkiCreditcardmerchantID", "fkiBankaccountID", "sBankaccountBankname", "fkiLanguageID", "sLanguageNameX", "bCreditcardmerchantDenyvisa", "bCreditcardmerchantDenymastercard", "bCreditcardmerchantDenyamex", "bCreditcardmerchantIsactive", "sCreditcardmerchantDescription", "sCreditcardmerchantStoreid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sBankaccountBankname": obj.get("sBankaccountBankname"),
