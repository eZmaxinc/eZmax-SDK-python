...
class UsergroupEditUsergroupdelegationsV1Response(BaseModel):
    """
    Response for PUT /1/object/usergroup/{pkiUsergroupID}/editUsergroupdelegations  # noqa: E501
    """
    ...
    m_payload: UsergroupEditUsergroupdelegationsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupEditUsergroupdelegationsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupEditUsergroupdelegationsV1Response:
        """Create an instance of UsergroupEditUsergroupdelegationsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupEditUsergroupdelegationsV1Response.parse_obj(obj)

        _obj = UsergroupEditUsergroupdelegationsV1Response.parse_obj({
            ...
            "m_payload": UsergroupEditUsergroupdelegationsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
