...
class AgentListElement(BaseModel):
    ...
    dt_agent_contractdate: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The contract date of the Agent", alias="dtAgentContractdate")
    dt_agent_transferdate: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The transfer date of the Agent", alias="dtAgentTransferdate")
    dt_agent_senioritydate: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The seniority date of the Agent", alias="dtAgentSenioritydate")
    dt_agent_sickleavestart: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The sick leave start date of the Agent", alias="dtAgentSickleavestart")
    dt_agent_sickleaveend: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The sick leave end date of the Agent", alias="dtAgentSickleaveend")
