...
class EzsignfolderDisposeEzsignfoldersV1Response(BaseModel):
    """
    Response for POST /1/object/ezsignfolder/disposeEzsignfolders  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderDisposeEzsignfoldersV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderDisposeEzsignfoldersV1Response:
        """Create an instance of EzsignfolderDisposeEzsignfoldersV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderDisposeEzsignfoldersV1Response.parse_obj(obj)

        _obj = EzsignfolderDisposeEzsignfoldersV1Response.parse_obj({
