...
class UsergroupmembershipGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/usergroupmembership/{pkiUsergroupmembershipID}  # noqa: E501
    """
    ...
    m_payload: UsergroupmembershipGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupmembershipGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupmembershipGetObjectV2Response:
        """Create an instance of UsergroupmembershipGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupmembershipGetObjectV2Response.parse_obj(obj)

        _obj = UsergroupmembershipGetObjectV2Response.parse_obj({
            ...
            "m_payload": UsergroupmembershipGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
