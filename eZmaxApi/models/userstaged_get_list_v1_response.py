...
class UserstagedGetListV1Response(BaseModel):
    """
    Response for GET /1/object/userstaged/getList  # noqa: E501
    """
    ...
    m_payload: UserstagedGetListV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserstagedGetListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserstagedGetListV1Response:
        """Create an instance of UserstagedGetListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserstagedGetListV1Response.parse_obj(obj)

        _obj = UserstagedGetListV1Response.parse_obj({
            ...
            "m_payload": UserstagedGetListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
