...
class InscriptionchecklistAutocompleteElementResponse(BaseModel):
    """
    ...
    def s_inscriptionchecklistelement_name_x_validate_regular_expression(cls, value):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pkiInscriptionchecklistID": obj.get("pkiInscriptionchecklistID"),
            "sInscriptionchecklistelementNameX": obj.get("sInscriptionchecklistelementNameX"),
            "bInscriptionchecklistIsactive": obj.get("bInscriptionchecklistIsactive")
        })
        return _obj
