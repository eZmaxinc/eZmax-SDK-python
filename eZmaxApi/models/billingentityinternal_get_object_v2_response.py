...
class BillingentityinternalGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/billingentityinternal/{pkiBillingentityinternalID}  # noqa: E501
    """
    ...
    m_payload: BillingentityinternalGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillingentityinternalGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillingentityinternalGetObjectV2Response:
        """Create an instance of BillingentityinternalGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillingentityinternalGetObjectV2Response.parse_obj(obj)

        _obj = BillingentityinternalGetObjectV2Response.parse_obj({
            ...
            "m_payload": BillingentityinternalGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
