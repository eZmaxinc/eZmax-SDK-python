...
class EzsignbulksendGetEzsignbulksendtransmissionsV1Response(BaseModel):
    """
    Response for GET /1/object/ezsignbulksend/{pkiEzsignbulksend}/getEzsignbulksendtransmissions  # noqa: E501
    """
    ...
    m_payload: EzsignbulksendGetEzsignbulksendtransmissionsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignbulksendGetEzsignbulksendtransmissionsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignbulksendGetEzsignbulksendtransmissionsV1Response:
        """Create an instance of EzsignbulksendGetEzsignbulksendtransmissionsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignbulksendGetEzsignbulksendtransmissionsV1Response.parse_obj(obj)

        _obj = EzsignbulksendGetEzsignbulksendtransmissionsV1Response.parse_obj({
            ...
            "m_payload": EzsignbulksendGetEzsignbulksendtransmissionsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
