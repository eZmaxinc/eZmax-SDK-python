...
class EzsignsignergroupGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/ezsignsignergroup/{pkiEzsignsignergroupID}  # noqa: E501
    """
    ...
    m_payload: EzsignsignergroupGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignergroupGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignergroupGetObjectV2Response:
        """Create an instance of EzsignsignergroupGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignergroupGetObjectV2Response.parse_obj(obj)

        _obj = EzsignsignergroupGetObjectV2Response.parse_obj({
            ...
            "m_payload": EzsignsignergroupGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
