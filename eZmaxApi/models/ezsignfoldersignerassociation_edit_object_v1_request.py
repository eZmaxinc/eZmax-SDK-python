...
class EzsignfoldersignerassociationEditObjectV1Request(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["objEzsignfoldersignerassociation"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "objEzsignfoldersignerassociation": EzsignfoldersignerassociationRequestCompound.from_dict(obj.get("objEzsignfoldersignerassociation")) if obj.get("objEzsignfoldersignerassociation") is not None else None
        })
        return _obj
