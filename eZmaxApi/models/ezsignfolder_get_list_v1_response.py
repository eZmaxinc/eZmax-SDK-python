...
class EzsignfolderGetListV1Response(BaseModel):
    """
    Response for GET /1/object/ezsignfolder/getList  # noqa: E501
    """
    ...
    m_payload: EzsignfolderGetListV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderGetListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderGetListV1Response:
        """Create an instance of EzsignfolderGetListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderGetListV1Response.parse_obj(obj)

        _obj = EzsignfolderGetListV1Response.parse_obj({
            ...
            "m_payload": EzsignfolderGetListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
