...
class EzsigntemplatepackagesignerResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatepackagesignerResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatepackagesignerResponse:
        """Create an instance of EzsigntemplatepackagesignerResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatepackagesignerResponse.parse_obj(obj)

        _obj = EzsigntemplatepackagesignerResponse.parse_obj({
