...
class UserstagedCreateUserV1Response(BaseModel):
    """
    Response for POST /1/object/userstaged/{pkiUserstagedID}/createUser  # noqa: E501
    """
    ...
    m_payload: UserstagedCreateUserV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserstagedCreateUserV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserstagedCreateUserV1Response:
        """Create an instance of UserstagedCreateUserV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserstagedCreateUserV1Response.parse_obj(obj)

        _obj = UserstagedCreateUserV1Response.parse_obj({
            ...
            "m_payload": UserstagedCreateUserV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
