...
class EzmaxinvoicingGetAutocompleteV2Response(BaseModel):
    """
    Response for GET /2/object/ezmaxinvoicing/getAutocomplete  # noqa: E501
    """
    ...
    m_payload: EzmaxinvoicingGetAutocompleteV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzmaxinvoicingGetAutocompleteV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzmaxinvoicingGetAutocompleteV2Response:
        """Create an instance of EzmaxinvoicingGetAutocompleteV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzmaxinvoicingGetAutocompleteV2Response.parse_obj(obj)

        _obj = EzmaxinvoicingGetAutocompleteV2Response.parse_obj({
            ...
            "m_payload": EzmaxinvoicingGetAutocompleteV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
