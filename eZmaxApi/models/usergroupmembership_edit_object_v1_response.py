...
class UsergroupmembershipEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/usergroupmembership/{pkiUsergroupmembershipID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupmembershipEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupmembershipEditObjectV1Response:
        """Create an instance of UsergroupmembershipEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupmembershipEditObjectV1Response.parse_obj(obj)

        _obj = UsergroupmembershipEditObjectV1Response.parse_obj({
