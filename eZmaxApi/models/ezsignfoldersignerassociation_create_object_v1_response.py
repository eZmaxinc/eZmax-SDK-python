...
class EzsignfoldersignerassociationCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/ezsignfoldersignerassociation  # noqa: E501
    """
    ...
    m_payload: EzsignfoldersignerassociationCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfoldersignerassociationCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfoldersignerassociationCreateObjectV1Response:
        """Create an instance of EzsignfoldersignerassociationCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfoldersignerassociationCreateObjectV1Response.parse_obj(obj)

        _obj = EzsignfoldersignerassociationCreateObjectV1Response.parse_obj({
            ...
            "m_payload": EzsignfoldersignerassociationCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
