...
class CustomEzsigndocumentGetEzsignannotationsResponse(BaseModel):
    """
    ...
    a_obj_ezsignannotation: List[EzsignannotationResponseCompound] = Field(alias="a_objEzsignannotation")
    __properties: ClassVar[List[str]] = ["pkiEzsigndocumentID", "sEzsigndocumentName", "a_objEzsignannotation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "a_objEzsignannotation": [EzsignannotationResponseCompound.from_dict(_item) for _item in obj["a_objEzsignannotation"]] if obj.get("a_objEzsignannotation") is not None else None
        })
        return _obj
