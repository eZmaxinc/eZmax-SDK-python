...
class EzsigntemplatedocumentFlattenV1Response(BaseModel):
    """
    Response for POST /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocument}/flatten  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatedocumentFlattenV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatedocumentFlattenV1Response:
        """Create an instance of EzsigntemplatedocumentFlattenV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatedocumentFlattenV1Response.parse_obj(obj)

        _obj = EzsigntemplatedocumentFlattenV1Response.parse_obj({
