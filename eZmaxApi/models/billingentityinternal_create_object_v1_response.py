...
class BillingentityinternalCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/billingentityinternal  # noqa: E501
    """
    ...
    m_payload: BillingentityinternalCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillingentityinternalCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillingentityinternalCreateObjectV1Response:
        """Create an instance of BillingentityinternalCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillingentityinternalCreateObjectV1Response.parse_obj(obj)

        _obj = BillingentityinternalCreateObjectV1Response.parse_obj({
            ...
            "m_payload": BillingentityinternalCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
