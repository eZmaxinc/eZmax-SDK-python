...
class FranchisereferalincomeCreateObjectV1ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_pkiFranchisereferalincomeID": obj.get("a_pkiFranchisereferalincomeID")
        })
        return _obj
