...
class FranchisereferalincomeCreateObjectV1ResponseMPayload(BaseModel):
    """
    Payload for POST /1/object/franchisereferalincome  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FranchisereferalincomeCreateObjectV1ResponseMPayload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FranchisereferalincomeCreateObjectV1ResponseMPayload:
        """Create an instance of FranchisereferalincomeCreateObjectV1ResponseMPayload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FranchisereferalincomeCreateObjectV1ResponseMPayload.parse_obj(obj)

        _obj = FranchisereferalincomeCreateObjectV1ResponseMPayload.parse_obj({
