...
class EzsignbulksenddocumentmappingCreateObjectV1Request(BaseModel):
    ...
    """ # noqa: E501
    a_obj_ezsignbulksenddocumentmapping: Annotated[List[EzsignbulksenddocumentmappingRequestCompound], Field(min_length=1)] = Field(alias="a_objEzsignbulksenddocumentmapping")
    __properties: ClassVar[List[str]] = ["a_objEzsignbulksenddocumentmapping"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objEzsignbulksenddocumentmapping": [EzsignbulksenddocumentmappingRequestCompound.from_dict(_item) for _item in obj.get("a_objEzsignbulksenddocumentmapping")] if obj.get("a_objEzsignbulksenddocumentmapping") is not None else None
        })
        return _obj
