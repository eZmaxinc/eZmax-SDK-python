...
class EzsignbulksenddocumentmappingCreateObjectV1Request(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objEzsignbulksenddocumentmapping": [EzsignbulksenddocumentmappingRequestCompound.from_dict(_item) for _item in obj["a_objEzsignbulksenddocumentmapping"]] if obj.get("a_objEzsignbulksenddocumentmapping") is not None else None
        })
        return _obj
