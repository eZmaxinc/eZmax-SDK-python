...
class EzsignfolderGetCommunicationListV1Response(BaseModel):
    """
    Response for GET /1/object/ezsignfolder/{pkiEzsignfolderID}/getCommunicationList  # noqa: E501
    """
    ...
    m_payload: EzsignfolderGetCommunicationListV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderGetCommunicationListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderGetCommunicationListV1Response:
        """Create an instance of EzsignfolderGetCommunicationListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderGetCommunicationListV1Response.parse_obj(obj)

        _obj = EzsignfolderGetCommunicationListV1Response.parse_obj({
            ...
            "m_payload": EzsignfolderGetCommunicationListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
