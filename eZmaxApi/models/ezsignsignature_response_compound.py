...
class EzsignsignatureResponseCompound(BaseModel):
    """
    An Ezsignsignature Object and children to create a complete structure  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignatureResponseCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignatureResponseCompound:
        """Create an instance of EzsignsignatureResponseCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignatureResponseCompound.parse_obj(obj)

        _obj = EzsignsignatureResponseCompound.parse_obj({
