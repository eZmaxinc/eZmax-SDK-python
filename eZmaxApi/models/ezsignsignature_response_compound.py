...
class EzsignsignatureResponseCompound(BaseModel):
    ...
    fki_ezsigndocument_id: Annotated[int, Field(strict=True, ge=0)] = Field(description="The unique ID of the Ezsigndocument", alias="fkiEzsigndocumentID", json_schema_extra={"examples": [97]})
    ...
    s_currency_description_x: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The description of the Currency in the language of the requester", alias="sCurrencyDescriptionX", json_schema_extra={"examples": ["Canadian"]})
    ...
    s_ezsignsignature_creditcardamountdescription: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The description of the Creditcard signature", alias="sEzsignsignatureCreditcardamountdescription", json_schema_extra={"examples": ["Invoice #123"]})
    b_ezsignsignature_creditcardcustomamount: Optional[StrictBool] = Field(default=None, description="Whether we can enter a custom amount while signing an Ezsignsignature 'Creditcard' or not", alias="bEzsignsignatureCreditcardcustomamount", json_schema_extra={"examples": [False]})
    s_ezsignsigningreason_description_x: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The description of the Ezsignsigningreason in the language of the requester", alias="sEzsignsigningreasonDescriptionX", json_schema_extra={"examples": ["I approve this document"]})
    ...
    i_ezsignsignature_x: Annotated[int, Field(strict=True, ge=0)] = Field(description="The X coordinate (Horizontal) where to put the Ezsignsignature on the page.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the Ezsignsignature 2 inches from the left border of the page, you would use \"200\" for the X coordinate.", alias="iEzsignsignatureX", json_schema_extra={"examples": [200]})
    ...
    i_ezsignsignature_height: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The height of the Ezsignsignature.  Size is calculated at 100dpi (dot per inch). So for example, if you want the Ezsignsignature to have an height of 2 inches, you would use \"200\" for the iEzsignsignatureHeight.", alias="iEzsignsignatureHeight", json_schema_extra={"examples": [200]})
    i_ezsignsignature_width: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The width of the Ezsignsignature.  Size is calculated at 100dpi (dot per inch). So for example, if you want the Ezsignsignature to have a width of 2 inches, you would use \"200\" for the iEzsignsignatureWidth.", alias="iEzsignsignatureWidth", json_schema_extra={"examples": [200]})
    i_ezsignsignature_step: StrictInt = Field(description="The step when the Ezsignsigner will be invited to sign", alias="iEzsignsignatureStep", json_schema_extra={"examples": [1]})
    i_ezsignsignature_stepadjusted: Optional[StrictInt] = Field(default=None, description="The step when the Ezsignsigner will be invited to sign", alias="iEzsignsignatureStepadjusted", json_schema_extra={"examples": [1]})
    ...
    t_ezsignsignature_tooltip: Optional[StrictStr] = Field(default=None, description="A tooltip that will be presented to Ezsignsigner about the Ezsignsignature", alias="tEzsignsignatureTooltip", json_schema_extra={"examples": ["Please sign here if you agree to the terms"]})
    ...
    i_ezsignsignature_validationstep: Optional[StrictInt] = Field(default=None, description="The step when the Ezsignsigner will be invited to validate the Ezsignsignature of eEzsignsignatureType Attachments", alias="iEzsignsignatureValidationstep", json_schema_extra={"examples": [1]})
    s_ezsignsignature_attachmentdescription: Optional[StrictStr] = Field(default=None, description="The description attached to the attachment name added in Ezsignsignature of eEzsignsignatureType Attachments", alias="sEzsignsignatureAttachmentdescription", json_schema_extra={"examples": ["Attachment"]})
    ...
    fki_ezsignfoldersignerassociation_id_validation: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The unique ID of the Ezsignfoldersignerassociation", alias="fkiEzsignfoldersignerassociationIDValidation", json_schema_extra={"examples": [20]})
    dt_ezsignsignature_date: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The date the Ezsignsignature was signed", alias="dtEzsignsignatureDate", json_schema_extra={"examples": ["2020-12-31 23:59:59"]})
    i_ezsignsignatureattachment_count: Optional[StrictInt] = Field(default=None, description="The count of Ezsignsignatureattachment", alias="iEzsignsignatureattachmentCount", json_schema_extra={"examples": [7]})
    s_ezsignsignature_description: Optional[StrictStr] = Field(default=None, description="The value entered while signing Ezsignsignature of eEzsignsignatureType **City**, **FieldText** and **FieldTextarea**", alias="sEzsignsignatureDescription", json_schema_extra={"examples": ["Montreal"]})
    i_ezsignsignature_maxlength: Optional[Annotated[int, Field(le=65535, strict=True, ge=0)]] = Field(default=None, description="The maximum length for the value in the Ezsignsignature  This can only be set if eEzsignsignatureType is **FieldText** or **FieldTextarea**", alias="iEzsignsignatureMaxlength", json_schema_extra={"examples": [75]})
    e_ezsignsignature_textvalidation: Optional[EnumTextvalidation] = Field(default=None, alias="eEzsignsignatureTextvalidation")
    s_ezsignsignature_textvalidationcustommessage: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=50)]] = Field(default=None, description="Description of validation rule. Show by signatory.", alias="sEzsignsignatureTextvalidationcustommessage", json_schema_extra={"examples": ["Phone number"]})
    ...
    dt_ezsignsignature_date_in_folder_timezone: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The date the Ezsignsignature was signed in folder's timezone", alias="dtEzsignsignatureDateInFolderTimezone", json_schema_extra={"examples": ["2020-12-31 23:59:59"]})
    ...
    a_obj_ezsignsignaturepaymentdetail: Optional[List[EzsignsignaturepaymentdetailResponseCompound]] = Field(default=None, alias="a_objEzsignsignaturepaymentdetail")
    ...
    def s_ezsignsignature_creditcardamountdescription_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "a_objEzsignsignaturepaymentdetail": [EzsignsignaturepaymentdetailResponseCompound.from_dict(_item) for _item in obj["a_objEzsignsignaturepaymentdetail"]] if obj.get("a_objEzsignsignaturepaymentdetail") is not None else None
        })
        return _obj
