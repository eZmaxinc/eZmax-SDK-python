...
class WebhookGetHistoryV1Response(BaseModel):
    """
    Response for GET /1/object/webhook/{pkiWebhookID}/getHistory  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhookGetHistoryV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookGetHistoryV1Response:
        """Create an instance of WebhookGetHistoryV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookGetHistoryV1Response.parse_obj(obj)

        _obj = WebhookGetHistoryV1Response.parse_obj({
            ...
            "m_payload": WebhookGetHistoryV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
