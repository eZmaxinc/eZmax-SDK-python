...
class CustomUserResponse(BaseModel):
    ...
    __properties = ["pkiUserID", "sUserLastname", "sUserFirstname", "sEmailAddress"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomUserResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomUserResponse:
        """Create an instance of CustomUserResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomUserResponse.parse_obj(obj)

        _obj = CustomUserResponse.parse_obj({
