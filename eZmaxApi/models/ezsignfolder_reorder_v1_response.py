...
class EzsignfolderReorderV1Response(BaseModel):
    """
    Response for POST /1/object/ezsignfolder/{pkiEzsignfolderID}/reorder  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderReorderV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderReorderV1Response:
        """Create an instance of EzsignfolderReorderV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderReorderV1Response.parse_obj(obj)

        _obj = EzsignfolderReorderV1Response.parse_obj({
