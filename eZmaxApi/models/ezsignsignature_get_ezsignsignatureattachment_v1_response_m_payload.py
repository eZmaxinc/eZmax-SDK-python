...
class EzsignsignatureGetEzsignsignatureattachmentV1ResponseMPayload(BaseModel):
    ...
    """ # noqa: E501
    a_obj_ezsignsignatureattachment: List[EzsignsignatureattachmentResponse] = Field(alias="a_objEzsignsignatureattachment")
    __properties: ClassVar[List[str]] = ["a_objEzsignsignatureattachment"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objEzsignsignatureattachment": [EzsignsignatureattachmentResponse.from_dict(_item) for _item in obj.get("a_objEzsignsignatureattachment")] if obj.get("a_objEzsignsignatureattachment") is not None else None
        })
        return _obj
