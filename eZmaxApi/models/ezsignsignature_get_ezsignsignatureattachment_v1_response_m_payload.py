...
class EzsignsignatureGetEzsignsignatureattachmentV1ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objEzsignsignatureattachment": [EzsignsignatureattachmentResponse.from_dict(_item) for _item in obj["a_objEzsignsignatureattachment"]] if obj.get("a_objEzsignsignatureattachment") is not None else None
        })
        return _obj
