...
class EzsigndocumentCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/ezsigndocument  # noqa: E501
    """
    ...
    m_payload: EzsigndocumentCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentCreateObjectV1Response:
        """Create an instance of EzsigndocumentCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentCreateObjectV1Response.parse_obj(obj)

        _obj = EzsigndocumentCreateObjectV1Response.parse_obj({
            ...
            "m_payload": EzsigndocumentCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
