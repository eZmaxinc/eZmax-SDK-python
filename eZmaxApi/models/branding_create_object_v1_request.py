...
class BrandingCreateObjectV1Request(BaseModel):
    ...
    """ # noqa: E501
    a_obj_branding: Annotated[List[BrandingRequestCompound], Field(min_length=1)] = Field(alias="a_objBranding")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objBranding": [BrandingRequestCompound.from_dict(_item) for _item in obj.get("a_objBranding")] if obj.get("a_objBranding") is not None else None
        })
        return _obj
