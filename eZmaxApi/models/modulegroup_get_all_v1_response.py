...
class ModulegroupGetAllV1Response(BaseModel):
    """
    ...
    m_payload: ModulegroupGetAllV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModulegroupGetAllV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModulegroupGetAllV1Response:
        """Create an instance of ModulegroupGetAllV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ModulegroupGetAllV1Response.parse_obj(obj)

        _obj = ModulegroupGetAllV1Response.parse_obj({
            ...
            "m_payload": ModulegroupGetAllV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
