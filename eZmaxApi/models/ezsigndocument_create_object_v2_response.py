...
class EzsigndocumentCreateObjectV2Response(BaseModel):
    """
    Response for POST /2/object/ezsigndocument  # noqa: E501
    """
    ...
    m_payload: EzsigndocumentCreateObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentCreateObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentCreateObjectV2Response:
        """Create an instance of EzsigndocumentCreateObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentCreateObjectV2Response.parse_obj(obj)

        _obj = EzsigndocumentCreateObjectV2Response.parse_obj({
            ...
            "m_payload": EzsigndocumentCreateObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
