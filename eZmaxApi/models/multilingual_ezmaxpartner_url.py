...
class MultilingualEzmaxpartnerUrl(BaseModel):
    """
    ...
    def s_ezmaxpartner_url1_validate_regular_expression(cls, value):
    ...
    @field_validator('s_ezmaxpartner_url2')
    def s_ezmaxpartner_url2_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MultilingualEzmaxpartnerUrl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MultilingualEzmaxpartnerUrl from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "sEzmaxpartnerUrl1": obj.get("sEzmaxpartnerUrl1"),
            "sEzmaxpartnerUrl2": obj.get("sEzmaxpartnerUrl2")
        })
        return _obj
