...
class UserGetListV1Response(BaseModel):
    """
    Response for GET /1/object/user/getList  # noqa: E501
    """
    ...
    m_payload: UserGetListV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserGetListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserGetListV1Response:
        """Create an instance of UserGetListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserGetListV1Response.parse_obj(obj)

        _obj = UserGetListV1Response.parse_obj({
            ...
            "m_payload": UserGetListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
