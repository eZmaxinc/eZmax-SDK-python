...
class TimezoneGetAutocompleteV2ResponseMPayload(BaseModel):
    ...
    """ # noqa: E501
    a_obj_timezone: List[TimezoneAutocompleteElementResponse] = Field(description="An array of Timezone autocomplete element response.", alias="a_objTimezone")
    __properties: ClassVar[List[str]] = ["a_objTimezone"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objTimezone": [TimezoneAutocompleteElementResponse.from_dict(_item) for _item in obj.get("a_objTimezone")] if obj.get("a_objTimezone") is not None else None
        })
        return _obj
