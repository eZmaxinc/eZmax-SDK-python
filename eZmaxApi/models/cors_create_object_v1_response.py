...
class CorsCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/cors  # noqa: E501
    """
    ...
    m_payload: CorsCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CorsCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CorsCreateObjectV1Response:
        """Create an instance of CorsCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CorsCreateObjectV1Response.parse_obj(obj)

        _obj = CorsCreateObjectV1Response.parse_obj({
            ...
            "m_payload": CorsCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
