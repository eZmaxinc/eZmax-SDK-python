...
class EzdoctemplatedocumentListElement(BaseModel):
    ...
    s_ezdoctemplatetype_description_x: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The description of the Ezdoctemplatetype in the language of the requester", alias="sEzdoctemplatetypeDescriptionX", json_schema_extra={"examples": ["Real Estate"]})
    s_ezdoctemplatefieldtypecategory_description_x: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The description of the Ezdoctemplatefieldtypecategory in the language of the requester", alias="sEzdoctemplatefieldtypecategoryDescriptionX", json_schema_extra={"examples": ["Sale"]})
    ...
    __properties: ClassVar[List[str]] = ["pkiEzdoctemplatedocumentID", "fkiLanguageID", "fkiEzsignfoldertypeID", "fkiEzdoctemplatetypeID", "fkiEzdoctemplatefieldtypecategoryID", "sEzsignfoldertypeNameX", "sEzdoctemplatetypeDescriptionX", "sEzdoctemplatefieldtypecategoryDescriptionX", "eEzdoctemplatedocumentPrivacylevel", "bEzdoctemplatedocumentIsactive", "sEzdoctemplatedocumentNameX"]
