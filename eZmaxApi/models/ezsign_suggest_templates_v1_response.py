...
class EzsignSuggestTemplatesV1Response(BaseModel):
    """
    Response for GET /1/module/ezsign/suggestTemplates  # noqa: E501
    """
    ...
    m_payload: EzsignSuggestTemplatesV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignSuggestTemplatesV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignSuggestTemplatesV1Response:
        """Create an instance of EzsignSuggestTemplatesV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignSuggestTemplatesV1Response.parse_obj(obj)

        _obj = EzsignSuggestTemplatesV1Response.parse_obj({
            ...
            "m_payload": EzsignSuggestTemplatesV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
