...
class EzsignfolderRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderRequest:
        """Create an instance of EzsignfolderRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderRequest.parse_obj(obj)

        _obj = EzsignfolderRequest.parse_obj({
