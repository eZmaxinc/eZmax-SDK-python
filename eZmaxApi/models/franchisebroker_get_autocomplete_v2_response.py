...
class FranchisebrokerGetAutocompleteV2Response(BaseModel):
    """
    Response for GET /2/object/franchisebroker/getAutocomplete  # noqa: E501
    """
    ...
    m_payload: FranchisebrokerGetAutocompleteV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FranchisebrokerGetAutocompleteV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FranchisebrokerGetAutocompleteV2Response:
        """Create an instance of FranchisebrokerGetAutocompleteV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FranchisebrokerGetAutocompleteV2Response.parse_obj(obj)

        _obj = FranchisebrokerGetAutocompleteV2Response.parse_obj({
            ...
            "m_payload": FranchisebrokerGetAutocompleteV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
