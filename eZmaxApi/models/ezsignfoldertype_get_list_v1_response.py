...
class EzsignfoldertypeGetListV1Response(BaseModel):
    """
    Response for GET /1/object/ezsignfoldertype/getList  # noqa: E501
    """
    ...
    m_payload: EzsignfoldertypeGetListV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfoldertypeGetListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfoldertypeGetListV1Response:
        """Create an instance of EzsignfoldertypeGetListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfoldertypeGetListV1Response.parse_obj(obj)

        _obj = EzsignfoldertypeGetListV1Response.parse_obj({
            ...
            "m_payload": EzsignfoldertypeGetListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
