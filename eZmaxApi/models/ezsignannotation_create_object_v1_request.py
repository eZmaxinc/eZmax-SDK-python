...
class EzsignannotationCreateObjectV1Request(BaseModel):
    """
    Request for POST /1/object/ezsignannotation
    """ # noqa: E501
    a_obj_ezsignannotation: Annotated[List[EzsignannotationRequestCompound], Field(min_length=1)] = Field(alias="a_objEzsignannotation")
    __properties: ClassVar[List[str]] = ["a_objEzsignannotation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objEzsignannotation": [EzsignannotationRequestCompound.from_dict(_item) for _item in obj["a_objEzsignannotation"]] if obj.get("a_objEzsignannotation") is not None else None
        })
        return _obj
