...
class EzmaxinvoicinguserResponseCompound(BaseModel):
    ...
    __properties = ["pkiEzmaxinvoicinguserID", "fkiEzmaxinvoicingID", "fkiBillingentityinternalID", "sBillingentityinternalDescriptionX", "fkiUserID", "iEzmaxinvoicinguserEzsigndocument", "bEzmaxinvoicinguserEzsignaccount", "bEzmaxinvoicinguserBillableezsign", "eEzmaxinvoicinguserVariationezsign", "objContactName"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzmaxinvoicinguserResponseCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzmaxinvoicinguserResponseCompound:
        """Create an instance of EzmaxinvoicinguserResponseCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzmaxinvoicinguserResponseCompound.parse_obj(obj)

        _obj = EzmaxinvoicinguserResponseCompound.parse_obj({
