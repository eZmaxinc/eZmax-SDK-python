...
class UsergroupdelegationGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/usergroupdelegation/{pkiUsergroupdelegationID}  # noqa: E501
    """
    ...
    m_payload: UsergroupdelegationGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupdelegationGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupdelegationGetObjectV2Response:
        """Create an instance of UsergroupdelegationGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupdelegationGetObjectV2Response.parse_obj(obj)

        _obj = UsergroupdelegationGetObjectV2Response.parse_obj({
            ...
            "m_payload": UsergroupdelegationGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
