...
class InscriptionGetCommunicationListV1Response(BaseModel):
    """
    Response for GET /1/object/inscription/{pkiInscriptionID}/getCommunicationList  # noqa: E501
    """
    ...
    m_payload: InscriptionGetCommunicationListV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InscriptionGetCommunicationListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InscriptionGetCommunicationListV1Response:
        """Create an instance of InscriptionGetCommunicationListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InscriptionGetCommunicationListV1Response.parse_obj(obj)

        _obj = InscriptionGetCommunicationListV1Response.parse_obj({
            ...
            "m_payload": InscriptionGetCommunicationListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
