...
class UsergroupGetUsergroupdelegationsV1Response(BaseModel):
    """
    ...
    m_payload: UsergroupGetUsergroupdelegationsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupGetUsergroupdelegationsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupGetUsergroupdelegationsV1Response:
        """Create an instance of UsergroupGetUsergroupdelegationsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupGetUsergroupdelegationsV1Response.parse_obj(obj)

        _obj = UsergroupGetUsergroupdelegationsV1Response.parse_obj({
            ...
            "m_payload": UsergroupGetUsergroupdelegationsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
