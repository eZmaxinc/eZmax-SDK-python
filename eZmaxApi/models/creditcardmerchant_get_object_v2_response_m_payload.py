...
class CreditcardmerchantGetObjectV2ResponseMPayload(BaseModel):
    """
    Payload for GET /2/object/creditcardmerchant/{pkiCreditcardmerchantID}
    """ # noqa: E501
    obj_creditcardmerchant: CreditcardmerchantResponseCompound = Field(alias="objCreditcardmerchant")
