...
class EzsignbulksendGetFormsDataV1Response(BaseModel):
    """
    Response for GET /1/object/ezsignbulksend/{pkiEzsignbulksendID}/getFormsData  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignbulksendGetFormsDataV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignbulksendGetFormsDataV1Response:
        """Create an instance of EzsignbulksendGetFormsDataV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignbulksendGetFormsDataV1Response.parse_obj(obj)

        _obj = EzsignbulksendGetFormsDataV1Response.parse_obj({
            ...
            "m_payload": EzsignbulksendGetFormsDataV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
