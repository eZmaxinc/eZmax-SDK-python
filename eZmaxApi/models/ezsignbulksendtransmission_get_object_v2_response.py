...
class EzsignbulksendtransmissionGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/ezsignbulksendtransmission/{pkiEzsignbulksendtransmissionID}  # noqa: E501
    """
    ...
    m_payload: EzsignbulksendtransmissionGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignbulksendtransmissionGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignbulksendtransmissionGetObjectV2Response:
        """Create an instance of EzsignbulksendtransmissionGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignbulksendtransmissionGetObjectV2Response.parse_obj(obj)

        _obj = EzsignbulksendtransmissionGetObjectV2Response.parse_obj({
            ...
            "m_payload": EzsignbulksendtransmissionGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
