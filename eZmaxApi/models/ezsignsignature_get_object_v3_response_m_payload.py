...
class EzsignsignatureGetObjectV3ResponseMPayload(BaseModel):
    """
    Payload for GET /3/object/ezsignsignature/{pkiEzsignsignatureID}
    """ # noqa: E501
    obj_ezsignsignature: EzsignsignatureResponseCompoundV3 = Field(alias="objEzsignsignature")
    __properties: ClassVar[List[str]] = ["objEzsignsignature"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objEzsignsignature": EzsignsignatureResponseCompoundV3.from_dict(obj["objEzsignsignature"]) if obj.get("objEzsignsignature") is not None else None
        })
        return _obj
