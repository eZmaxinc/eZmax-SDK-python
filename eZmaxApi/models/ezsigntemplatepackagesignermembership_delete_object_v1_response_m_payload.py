...
class EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload(BaseModel):
    """
    Payload for DELETE /1/object/ezsigntemplatepackagesignermembership/{pkiEzsigntemplatepackagesignermembershipID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload:
        """Create an instance of EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload.parse_obj(obj)

        _obj = EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload.parse_obj({
