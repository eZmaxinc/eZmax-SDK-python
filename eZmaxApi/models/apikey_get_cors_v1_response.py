...
class ApikeyGetCorsV1Response(BaseModel):
    """
    ...
    m_payload: ApikeyGetCorsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApikeyGetCorsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApikeyGetCorsV1Response:
        """Create an instance of ApikeyGetCorsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApikeyGetCorsV1Response.parse_obj(obj)

        _obj = ApikeyGetCorsV1Response.parse_obj({
            ...
            "m_payload": ApikeyGetCorsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
