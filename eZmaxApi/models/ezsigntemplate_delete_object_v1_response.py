...
class EzsigntemplateDeleteObjectV1Response(BaseModel):
    """
    Response for DELETE /1/object/ezsigntemplate/{pkiEzsigntemplateID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplateDeleteObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplateDeleteObjectV1Response:
        """Create an instance of EzsigntemplateDeleteObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplateDeleteObjectV1Response.parse_obj(obj)

        _obj = EzsigntemplateDeleteObjectV1Response.parse_obj({
