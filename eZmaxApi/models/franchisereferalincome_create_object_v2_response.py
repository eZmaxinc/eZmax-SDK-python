...
class FranchisereferalincomeCreateObjectV2Response(BaseModel):
    """
    Response for POST /2/object/franchisereferalincome  # noqa: E501
    """
    ...
    m_payload: FranchisereferalincomeCreateObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FranchisereferalincomeCreateObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FranchisereferalincomeCreateObjectV2Response:
        """Create an instance of FranchisereferalincomeCreateObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FranchisereferalincomeCreateObjectV2Response.parse_obj(obj)

        _obj = FranchisereferalincomeCreateObjectV2Response.parse_obj({
            ...
            "m_payload": FranchisereferalincomeCreateObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
