...
class BrandingRequestCompound(BaseModel):
    """
    A Branding Object and children  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BrandingRequestCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BrandingRequestCompound:
        """Create an instance of BrandingRequestCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BrandingRequestCompound.parse_obj(obj)

        _obj = BrandingRequestCompound.parse_obj({
