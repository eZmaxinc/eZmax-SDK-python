...
class EzsigntemplateGetAutocompleteV2ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objEzsigntemplate": [EzsigntemplateAutocompleteElementResponse.from_dict(_item) for _item in obj["a_objEzsigntemplate"]] if obj.get("a_objEzsigntemplate") is not None else None
        })
        return _obj
