...
class EzsigntemplateGetAutocompleteV2ResponseMPayload(BaseModel):
    ...
    """ # noqa: E501
    a_obj_ezsigntemplate: List[EzsigntemplateAutocompleteElementResponse] = Field(description="An array of Ezsigntemplate autocomplete element response.", alias="a_objEzsigntemplate")
    __properties: ClassVar[List[str]] = ["a_objEzsigntemplate"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objEzsigntemplate": [EzsigntemplateAutocompleteElementResponse.from_dict(_item) for _item in obj.get("a_objEzsigntemplate")] if obj.get("a_objEzsigntemplate") is not None else None
        })
        return _obj
