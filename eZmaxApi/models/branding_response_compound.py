...
class BrandingResponseCompound(BaseModel):
    ...
    fki_email_id: Optional[conint(strict=True, le=16777215, ge=1)] = Field(None, alias="fkiEmailID", description="The unique ID of the Email")
    ...
    s_branding_logourl: Optional[StrictStr] = Field(None, alias="sBrandingLogourl", description="The url of the picture used as logo in the Branding")
    __properties = ["pkiBrandingID", "fkiEmailID", "objBrandingDescription", "sBrandingDescriptionX", "sBrandingName", "sEmailAddress", "eBrandingLogo", "iBrandingColortext", "iBrandingColortextlinkbox", "iBrandingColortextbutton", "iBrandingColorbackground", "iBrandingColorbackgroundbutton", "iBrandingColorbackgroundsmallbox", "bBrandingIsactive", "sBrandingLogourl"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BrandingResponseCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BrandingResponseCompound:
        """Create an instance of BrandingResponseCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BrandingResponseCompound.parse_obj(obj)

        _obj = BrandingResponseCompound.parse_obj({
            ...
            "s_branding_logourl": obj.get("sBrandingLogourl")
        })
        return _obj
