...
class EzsigntemplatepackagesignermembershipCreateObjectV1Request(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objEzsigntemplatepackagesignermembership": [EzsigntemplatepackagesignermembershipRequestCompound.from_dict(_item) for _item in obj["a_objEzsigntemplatepackagesignermembership"]] if obj.get("a_objEzsigntemplatepackagesignermembership") is not None else None
        })
        return _obj
