...
class EzsigntemplatepackagesignermembershipCreateObjectV1Request(BaseModel):
    ...
    """ # noqa: E501
    a_obj_ezsigntemplatepackagesignermembership: Annotated[List[EzsigntemplatepackagesignermembershipRequestCompound], Field(min_length=1)] = Field(alias="a_objEzsigntemplatepackagesignermembership")
    __properties: ClassVar[List[str]] = ["a_objEzsigntemplatepackagesignermembership"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objEzsigntemplatepackagesignermembership": [EzsigntemplatepackagesignermembershipRequestCompound.from_dict(_item) for _item in obj.get("a_objEzsigntemplatepackagesignermembership")] if obj.get("a_objEzsigntemplatepackagesignermembership") is not None else None
        })
        return _obj
