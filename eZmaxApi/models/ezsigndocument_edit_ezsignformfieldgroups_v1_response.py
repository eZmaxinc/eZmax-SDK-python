...
class EzsigndocumentEditEzsignformfieldgroupsV1Response(BaseModel):
    """
    Response for PUT /1/object/ezsigndocument/{pkiEzsigndocumentID}/editEzsignformfieldgroups  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentEditEzsignformfieldgroupsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentEditEzsignformfieldgroupsV1Response:
        """Create an instance of EzsigndocumentEditEzsignformfieldgroupsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentEditEzsignformfieldgroupsV1Response.parse_obj(obj)

        _obj = EzsigndocumentEditEzsignformfieldgroupsV1Response.parse_obj({
            ...
            "m_payload": EzsigndocumentEditEzsignformfieldgroupsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
