...
class CorsEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/cors/{pkiCorsID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CorsEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CorsEditObjectV1Response:
        """Create an instance of CorsEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CorsEditObjectV1Response.parse_obj(obj)

        _obj = CorsEditObjectV1Response.parse_obj({
