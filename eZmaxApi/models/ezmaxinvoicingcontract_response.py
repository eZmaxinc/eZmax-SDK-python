...
class EzmaxinvoicingcontractResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzmaxinvoicingcontractResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzmaxinvoicingcontractResponse:
        """Create an instance of EzmaxinvoicingcontractResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzmaxinvoicingcontractResponse.parse_obj(obj)

        _obj = EzmaxinvoicingcontractResponse.parse_obj({
