...
class EzsigntemplatepackageEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatepackageEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatepackageEditObjectV1Response:
        """Create an instance of EzsigntemplatepackageEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatepackageEditObjectV1Response.parse_obj(obj)

        _obj = EzsigntemplatepackageEditObjectV1Response.parse_obj({
