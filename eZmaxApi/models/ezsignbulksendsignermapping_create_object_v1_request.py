...
class EzsignbulksendsignermappingCreateObjectV1Request(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objEzsignbulksendsignermapping": [EzsignbulksendsignermappingRequestCompound.from_dict(_item) for _item in obj["a_objEzsignbulksendsignermapping"]] if obj.get("a_objEzsignbulksendsignermapping") is not None else None
        })
        return _obj
