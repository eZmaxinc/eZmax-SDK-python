...
class EzsignbulksendsignermappingCreateObjectV1Request(BaseModel):
    ...
    """ # noqa: E501
    a_obj_ezsignbulksendsignermapping: Annotated[List[EzsignbulksendsignermappingRequestCompound], Field(min_length=1)] = Field(alias="a_objEzsignbulksendsignermapping")
    __properties: ClassVar[List[str]] = ["a_objEzsignbulksendsignermapping"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objEzsignbulksendsignermapping": [EzsignbulksendsignermappingRequestCompound.from_dict(_item) for _item in obj.get("a_objEzsignbulksendsignermapping")] if obj.get("a_objEzsignbulksendsignermapping") is not None else None
        })
        return _obj
