...
class BrandingGetAutocompleteV2Response(BaseModel):
    """
    Response for GET /2/object/branding/getAutocomplete  # noqa: E501
    """
    ...
    m_payload: BrandingGetAutocompleteV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BrandingGetAutocompleteV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BrandingGetAutocompleteV2Response:
        """Create an instance of BrandingGetAutocompleteV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BrandingGetAutocompleteV2Response.parse_obj(obj)

        _obj = BrandingGetAutocompleteV2Response.parse_obj({
            ...
            "m_payload": BrandingGetAutocompleteV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
