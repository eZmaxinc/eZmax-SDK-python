...
class PermissionEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/permission/{pkiPermissionID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PermissionEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PermissionEditObjectV1Response:
        """Create an instance of PermissionEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PermissionEditObjectV1Response.parse_obj(obj)

        _obj = PermissionEditObjectV1Response.parse_obj({
