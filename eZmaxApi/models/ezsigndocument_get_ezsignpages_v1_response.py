...
class EzsigndocumentGetEzsignpagesV1Response(BaseModel):
    """
    Response for GET /1/object/ezsigndocument/{pkiEzsigndocument}/getEzsignpages  # noqa: E501
    """
    ...
    m_payload: EzsigndocumentGetEzsignpagesV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentGetEzsignpagesV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentGetEzsignpagesV1Response:
        """Create an instance of EzsigndocumentGetEzsignpagesV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentGetEzsignpagesV1Response.parse_obj(obj)

        _obj = EzsigndocumentGetEzsignpagesV1Response.parse_obj({
            ...
            "m_payload": EzsigndocumentGetEzsignpagesV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
