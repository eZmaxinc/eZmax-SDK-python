...
class EzsigntemplatepackageRequestCompound(BaseModel):
    """
    A Ezsigntemplatepackage Object and children  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatepackageRequestCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatepackageRequestCompound:
        """Create an instance of EzsigntemplatepackageRequestCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatepackageRequestCompound.parse_obj(obj)
