...
class EzsignbulksendsignermappingGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/ezsignbulksendsignermapping/{pkiEzsignbulksendsignermappingID}  # noqa: E501
    """
    ...
    m_payload: EzsignbulksendsignermappingGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignbulksendsignermappingGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignbulksendsignermappingGetObjectV2Response:
        """Create an instance of EzsignbulksendsignermappingGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignbulksendsignermappingGetObjectV2Response.parse_obj(obj)

        _obj = EzsignbulksendsignermappingGetObjectV2Response.parse_obj({
            ...
            "m_payload": EzsignbulksendsignermappingGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
