...
class UsergroupdelegationEditObjectV1Request(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objUsergroupdelegation": UsergroupdelegationRequestCompound.from_dict(obj["objUsergroupdelegation"]) if obj.get("objUsergroupdelegation") is not None else None
        })
        return _obj
