...
class UsergroupdelegationEditObjectV1Request(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["objUsergroupdelegation"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "objUsergroupdelegation": UsergroupdelegationRequestCompound.from_dict(obj.get("objUsergroupdelegation")) if obj.get("objUsergroupdelegation") is not None else None
        })
        return _obj
