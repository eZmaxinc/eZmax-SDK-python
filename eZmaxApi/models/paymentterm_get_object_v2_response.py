...
class PaymenttermGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/paymentterm/{pkiPaymenttermID}  # noqa: E501
    """
    ...
    m_payload: PaymenttermGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymenttermGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymenttermGetObjectV2Response:
        """Create an instance of PaymenttermGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymenttermGetObjectV2Response.parse_obj(obj)

        _obj = PaymenttermGetObjectV2Response.parse_obj({
            ...
            "m_payload": PaymenttermGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
