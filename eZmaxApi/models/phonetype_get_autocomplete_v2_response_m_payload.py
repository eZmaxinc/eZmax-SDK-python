...
class PhonetypeGetAutocompleteV2ResponseMPayload(BaseModel):
    ...
    """ # noqa: E501
    a_obj_phonetype: List[PhonetypeAutocompleteElementResponse] = Field(description="An array of Phonetype autocomplete element response.", alias="a_objPhonetype")
    __properties: ClassVar[List[str]] = ["a_objPhonetype"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objPhonetype": [PhonetypeAutocompleteElementResponse.from_dict(_item) for _item in obj.get("a_objPhonetype")] if obj.get("a_objPhonetype") is not None else None
        })
        return _obj
