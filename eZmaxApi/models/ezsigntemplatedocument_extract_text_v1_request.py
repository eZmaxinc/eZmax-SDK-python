...
class EzsigntemplatedocumentExtractTextV1Request(BaseModel):
    """
    ...
    def e_section_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['FirstLine', 'LastLine', 'Region']):
            raise ValueError("must be one of enum values ('FirstLine', 'LastLine', 'Region')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "iPage": obj.get("iPage"),
            "eSection": obj.get("eSection"),
            "iX": obj.get("iX"),
            "iY": obj.get("iY"),
            "iWidth": obj.get("iWidth"),
            "iHeight": obj.get("iHeight")
        })
        return _obj
