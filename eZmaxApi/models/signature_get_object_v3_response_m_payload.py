...
class SignatureGetObjectV3ResponseMPayload(BaseModel):
    """
    Payload for GET /3/object/signature/{pkiSignatureID}
    """ # noqa: E501
    obj_signature: SignatureResponseCompoundV3 = Field(alias="objSignature")
    __properties: ClassVar[List[str]] = ["objSignature"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objSignature": SignatureResponseCompoundV3.from_dict(obj["objSignature"]) if obj.get("objSignature") is not None else None
        })
        return _obj
