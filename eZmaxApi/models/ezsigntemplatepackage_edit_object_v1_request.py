...
class EzsigntemplatepackageEditObjectV1Request(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objEzsigntemplatepackage": EzsigntemplatepackageRequestCompound.from_dict(obj["objEzsigntemplatepackage"]) if obj.get("objEzsigntemplatepackage") is not None else None
        })
        return _obj
