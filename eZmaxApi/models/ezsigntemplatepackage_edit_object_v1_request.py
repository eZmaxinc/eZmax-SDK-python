...
class EzsigntemplatepackageEditObjectV1Request(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "objEzsigntemplatepackage": EzsigntemplatepackageRequestCompound.from_dict(obj.get("objEzsigntemplatepackage")) if obj.get("objEzsigntemplatepackage") is not None else None
        })
        return _obj
