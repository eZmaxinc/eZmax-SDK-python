...
class EzsigntemplatepackageEditEzsigntemplatepackagesignersV1Response(BaseModel):
    """
    Response for PUT /1/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}/editEzsigntemplatepackagesigners  # noqa: E501
    """
    ...
    m_payload: EzsigntemplatepackageEditEzsigntemplatepackagesignersV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatepackageEditEzsigntemplatepackagesignersV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatepackageEditEzsigntemplatepackagesignersV1Response:
        """Create an instance of EzsigntemplatepackageEditEzsigntemplatepackagesignersV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatepackageEditEzsigntemplatepackagesignersV1Response.parse_obj(obj)

        _obj = EzsigntemplatepackageEditEzsigntemplatepackagesignersV1Response.parse_obj({
            ...
            "m_payload": EzsigntemplatepackageEditEzsigntemplatepackagesignersV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
