...
class EzsignsignatureEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/ezsignsignature/{pkiEzsignsignatureID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignatureEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignatureEditObjectV1Response:
        """Create an instance of EzsignsignatureEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignatureEditObjectV1Response.parse_obj(obj)

        _obj = EzsignsignatureEditObjectV1Response.parse_obj({
