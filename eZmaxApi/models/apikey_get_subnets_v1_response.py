...
class ApikeyGetSubnetsV1Response(BaseModel):
    """
    ...
    m_payload: ApikeyGetSubnetsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApikeyGetSubnetsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApikeyGetSubnetsV1Response:
        """Create an instance of ApikeyGetSubnetsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApikeyGetSubnetsV1Response.parse_obj(obj)

        _obj = ApikeyGetSubnetsV1Response.parse_obj({
            ...
            "m_payload": ApikeyGetSubnetsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
