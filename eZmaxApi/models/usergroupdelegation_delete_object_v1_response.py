...
class UsergroupdelegationDeleteObjectV1Response(BaseModel):
    """
    Response for DELETE /1/object/usergroupdelegation/{pkiUsergroupdelegationID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupdelegationDeleteObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupdelegationDeleteObjectV1Response:
        """Create an instance of UsergroupdelegationDeleteObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupdelegationDeleteObjectV1Response.parse_obj(obj)

        _obj = UsergroupdelegationDeleteObjectV1Response.parse_obj({
