...
class CommonGetReportV1Response(BaseModel):
    """
    Response for POST /1/report/xxx/xxx and /1/module/report/getReportFromCache  # noqa: E501
    """
    ...
    m_payload: CommonGetReportV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommonGetReportV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommonGetReportV1Response:
        """Create an instance of CommonGetReportV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommonGetReportV1Response.parse_obj(obj)

        _obj = CommonGetReportV1Response.parse_obj({
            ...
            "m_payload": CommonGetReportV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
