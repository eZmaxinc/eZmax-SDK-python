...
class EzsigntemplatedocumentGetEzsigntemplatedocumentpagesV1Response(BaseModel):
    """
    Response for GET /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/getEzsigntemplatedocumentpages  # noqa: E501
    """
    ...
    m_payload: EzsigntemplatedocumentGetEzsigntemplatedocumentpagesV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatedocumentGetEzsigntemplatedocumentpagesV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatedocumentGetEzsigntemplatedocumentpagesV1Response:
        """Create an instance of EzsigntemplatedocumentGetEzsigntemplatedocumentpagesV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatedocumentGetEzsigntemplatedocumentpagesV1Response.parse_obj(obj)

        _obj = EzsigntemplatedocumentGetEzsigntemplatedocumentpagesV1Response.parse_obj({
            ...
            "m_payload": EzsigntemplatedocumentGetEzsigntemplatedocumentpagesV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
