...
class InscriptionnotauthenticatedGetCommunicationListV1ResponseMPayload(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InscriptionnotauthenticatedGetCommunicationListV1ResponseMPayload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InscriptionnotauthenticatedGetCommunicationListV1ResponseMPayload:
        """Create an instance of InscriptionnotauthenticatedGetCommunicationListV1ResponseMPayload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InscriptionnotauthenticatedGetCommunicationListV1ResponseMPayload.parse_obj(obj)

        _obj = InscriptionnotauthenticatedGetCommunicationListV1ResponseMPayload.parse_obj({
