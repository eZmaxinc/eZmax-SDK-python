...
class OtherincomeGetCommunicationListV1Response(BaseModel):
    """
    Response for GET /1/object/otherincome/{pkiOtherincomeID}/getCommunicationList  # noqa: E501
    """
    ...
    m_payload: OtherincomeGetCommunicationListV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OtherincomeGetCommunicationListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OtherincomeGetCommunicationListV1Response:
        """Create an instance of OtherincomeGetCommunicationListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OtherincomeGetCommunicationListV1Response.parse_obj(obj)

        _obj = OtherincomeGetCommunicationListV1Response.parse_obj({
            ...
            "m_payload": OtherincomeGetCommunicationListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
