...
class WebsocketResponseInformationV1(BaseModel):
    """
    Response for Websocket Information V1  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebsocketResponseInformationV1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebsocketResponseInformationV1:
        """Create an instance of WebsocketResponseInformationV1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebsocketResponseInformationV1.parse_obj(obj)

        _obj = WebsocketResponseInformationV1.parse_obj({
            "e_websocket_messagetype": obj.get("eWebsocketMessagetype"),
            "m_payload": WebsocketResponseInformationV1MPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
