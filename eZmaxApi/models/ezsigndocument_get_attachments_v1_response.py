...
class EzsigndocumentGetAttachmentsV1Response(BaseModel):
    """
    ...
    m_payload: EzsigndocumentGetAttachmentsV1ResponseMPayload = Field(alias="mPayload")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "mPayload": EzsigndocumentGetAttachmentsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
