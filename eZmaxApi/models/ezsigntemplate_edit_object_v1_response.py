...
class EzsigntemplateEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/ezsigntemplate/{pkiEzsigntemplateID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplateEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplateEditObjectV1Response:
        """Create an instance of EzsigntemplateEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplateEditObjectV1Response.parse_obj(obj)

        _obj = EzsigntemplateEditObjectV1Response.parse_obj({
