...
class EzsigntemplatepackagesignerGetObjectV2ResponseMPayload(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["objEzsigntemplatepackagesigner"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "objEzsigntemplatepackagesigner": EzsigntemplatepackagesignerResponseCompound.from_dict(obj.get("objEzsigntemplatepackagesigner")) if obj.get("objEzsigntemplatepackagesigner") is not None else None
        })
        return _obj
