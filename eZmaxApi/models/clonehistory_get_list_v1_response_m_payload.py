...
class ClonehistoryGetListV1ResponseMPayload(BaseModel):
    ...
    a_obj_clonehistory: List[ClonehistoryListElement] = Field(alias="a_objClonehistory")
    __properties: ClassVar[List[str]] = ["iRowReturned", "iRowFiltered", "a_objClonehistory"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "a_objClonehistory": [ClonehistoryListElement.from_dict(_item) for _item in obj.get("a_objClonehistory")] if obj.get("a_objClonehistory") is not None else None
        })
        return _obj
