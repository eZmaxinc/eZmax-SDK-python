...
class AddressResponseCompound(BaseModel):
    """
    An Address Object and children to create a complete structure
    """ # noqa: E501
    pki_address_id: Annotated[int, Field(strict=True, ge=0)] = Field(description="The unique ID of the Address", alias="pkiAddressID", json_schema_extra={"examples": [142]})
    fki_addresstype_id: Annotated[int, Field(strict=True, ge=0)] = Field(description="The unique ID of the Addresstype.  Valid values:  |Value|Description| |-|-| |1|Office| |2|Home| |3|Real Estate Invoice| |4|Invoicing| |5|Shipping|", alias="fkiAddresstypeID", json_schema_extra={"examples": [1]})
    s_address_civic: StrictStr = Field(description="The Civic number.", alias="sAddressCivic", json_schema_extra={"examples": ["2540"]})
    s_address_street: StrictStr = Field(description="The Street Name", alias="sAddressStreet", json_schema_extra={"examples": ["Daniel-Johnson Blvd."]})
    ...
    s_address_city: StrictStr = Field(description="The City name", alias="sAddressCity", json_schema_extra={"examples": ["Laval"]})
    ...
    fki_country_id: Annotated[int, Field(strict=True, ge=0)] = Field(description="The unique ID of the Country.  Here are some common values (Complete list must be retrieved from API):  |Value|Description| |-|-| |1|Canada| |2|United-States|", alias="fkiCountryID", json_schema_extra={"examples": [1]})
    ...
    s_address_zip: StrictStr = Field(description="The Postal/Zip Code  The value must be entered without spaces", alias="sAddressZip", json_schema_extra={"examples": ["H7T2S3"]})
    f_address_longitude: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The Longitude of the Address", alias="fAddressLongitude", json_schema_extra={"examples": ["73.5674"]})
    f_address_latitude: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The Latitude of the Address", alias="fAddressLatitude", json_schema_extra={"examples": ["45.5019"]})
