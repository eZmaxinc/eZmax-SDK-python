...
class CommunicationattachmentRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommunicationattachmentRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommunicationattachmentRequest:
        ...
        _obj = CommunicationattachmentRequest.parse_obj({
