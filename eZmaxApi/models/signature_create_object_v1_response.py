...
class SignatureCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/signature  # noqa: E501
    """
    ...
    m_payload: SignatureCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SignatureCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SignatureCreateObjectV1Response:
        """Create an instance of SignatureCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SignatureCreateObjectV1Response.parse_obj(obj)

        _obj = SignatureCreateObjectV1Response.parse_obj({
            ...
            "m_payload": SignatureCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
