...
class CorsGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/cors/{pkiCorsID}  # noqa: E501
    """
    ...
    m_payload: CorsGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CorsGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CorsGetObjectV2Response:
        """Create an instance of CorsGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CorsGetObjectV2Response.parse_obj(obj)

        _obj = CorsGetObjectV2Response.parse_obj({
            ...
            "m_payload": CorsGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
