...
class InvoiceGetCommunicationListV1Response(BaseModel):
    """
    Response for GET /1/object/invoice/{pkiInvoiceID}/getCommunicationList  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InvoiceGetCommunicationListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InvoiceGetCommunicationListV1Response:
        """Create an instance of InvoiceGetCommunicationListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InvoiceGetCommunicationListV1Response.parse_obj(obj)

        _obj = InvoiceGetCommunicationListV1Response.parse_obj({
            ...
            "m_payload": InvoiceGetCommunicationListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
