...
class EmailResponseCompound(BaseModel):
    ...
    """ # noqa: E501
    pki_email_id: Annotated[int, Field(le=16777215, strict=True, ge=1)] = Field(description="The unique ID of the Email", alias="pkiEmailID", json_schema_extra={"examples": [22]})
