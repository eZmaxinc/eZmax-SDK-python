...
class EzsignsignatureDeleteObjectV1Response(BaseModel):
    """
    Response for DELETE /1/object/ezsignsignature/{pkiEzsignsignatureID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignatureDeleteObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignatureDeleteObjectV1Response:
        """Create an instance of EzsignsignatureDeleteObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignatureDeleteObjectV1Response.parse_obj(obj)

        _obj = EzsignsignatureDeleteObjectV1Response.parse_obj({
