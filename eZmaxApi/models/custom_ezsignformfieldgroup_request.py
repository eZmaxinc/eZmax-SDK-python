...
class CustomEzsignformfieldgroupRequest(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "a_objEzsignformfield": [CustomEzsignformfieldRequest.from_dict(_item) for _item in obj.get("a_objEzsignformfield")] if obj.get("a_objEzsignformfield") is not None else None
        })
        return _obj
