...
class EzsigndocumentGetObjectV3ResponseMPayload(BaseModel):
    """
    Payload for GET /3/object/ezsigndocument/{pkiEzsigndocumentID}
    """ # noqa: E501
    obj_ezsigndocument: EzsigndocumentResponseCompoundV3 = Field(alias="objEzsigndocument")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objEzsigndocument": EzsigndocumentResponseCompoundV3.from_dict(obj["objEzsigndocument"]) if obj.get("objEzsigndocument") is not None else None
        })
        return _obj
