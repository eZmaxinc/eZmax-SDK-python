...
class BillingentityinternalEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/billingentityinternal/{pkiBillingentityinternalID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillingentityinternalEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillingentityinternalEditObjectV1Response:
        """Create an instance of BillingentityinternalEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillingentityinternalEditObjectV1Response.parse_obj(obj)

        _obj = BillingentityinternalEditObjectV1Response.parse_obj({
