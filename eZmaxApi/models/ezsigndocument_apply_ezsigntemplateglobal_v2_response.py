...
class EzsigndocumentApplyEzsigntemplateglobalV2Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "a_objWarning": [CommonResponseWarning.from_dict(_item) for _item in obj["a_objWarning"]] if obj.get("a_objWarning") is not None else None
        })
        return _obj
