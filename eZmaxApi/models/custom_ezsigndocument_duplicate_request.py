...
class CustomEzsigndocumentDuplicateRequest(BaseModel):
    """
    ...
    @field_validator('e_ezsigndocument_version')
    def e_ezsigndocument_version_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Initial', 'Signed']):
            raise ValueError("must be one of enum values ('Initial', 'Signed')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "eEzsigndocumentVersion": obj.get("eEzsigndocumentVersion")
        })
        return _obj
