...
class LanguageGetAutocompleteV2Response(BaseModel):
    """
    Response for GET /2/object/language/getAutocomplete  # noqa: E501
    """
    ...
    m_payload: LanguageGetAutocompleteV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LanguageGetAutocompleteV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LanguageGetAutocompleteV2Response:
        """Create an instance of LanguageGetAutocompleteV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LanguageGetAutocompleteV2Response.parse_obj(obj)

        _obj = LanguageGetAutocompleteV2Response.parse_obj({
            ...
            "m_payload": LanguageGetAutocompleteV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
