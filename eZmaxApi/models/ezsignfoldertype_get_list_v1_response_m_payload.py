...
class EzsignfoldertypeGetListV1ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "a_objEzsignfoldertype": [EzsignfoldertypeListElement.from_dict(_item) for _item in obj["a_objEzsignfoldertype"]] if obj.get("a_objEzsignfoldertype") is not None else None
        })
        return _obj
