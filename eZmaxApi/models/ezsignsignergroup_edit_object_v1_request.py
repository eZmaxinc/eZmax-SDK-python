...
class EzsignsignergroupEditObjectV1Request(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["objEzsignsignergroup"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "objEzsignsignergroup": EzsignsignergroupRequestCompound.from_dict(obj.get("objEzsignsignergroup")) if obj.get("objEzsignsignergroup") is not None else None
        })
        return _obj
