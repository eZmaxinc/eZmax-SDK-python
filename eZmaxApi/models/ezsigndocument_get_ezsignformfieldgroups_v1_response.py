...
class EzsigndocumentGetEzsignformfieldgroupsV1Response(BaseModel):
    """
    Response for GET /1/object/ezsigndocument/{pkiEzsigndocument}/getEzsignformfieldgroups  # noqa: E501
    """
    ...
    m_payload: EzsigndocumentGetEzsignformfieldgroupsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentGetEzsignformfieldgroupsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentGetEzsignformfieldgroupsV1Response:
        """Create an instance of EzsigndocumentGetEzsignformfieldgroupsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentGetEzsignformfieldgroupsV1Response.parse_obj(obj)

        _obj = EzsigndocumentGetEzsignformfieldgroupsV1Response.parse_obj({
            ...
            "m_payload": EzsigndocumentGetEzsignformfieldgroupsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
