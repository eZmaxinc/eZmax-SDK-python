...
class ContactRequestCompoundV2(BaseModel):
    """
    ...
    b_contact_isactive: Optional[StrictBool] = Field(default=None, description="Whether the contact is active or not", alias="bContactIsactive", json_schema_extra={"examples": [True]})
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "objContactinformations": ContactinformationsRequestCompoundV2.from_dict(obj["objContactinformations"]) if obj.get("objContactinformations") is not None else None
        })
        return _obj
