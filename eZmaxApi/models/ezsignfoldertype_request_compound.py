...
class EzsignfoldertypeRequestCompound(BaseModel):
    """
    A Ezsignfoldertype Object and children  # noqa: E501
    """
    pki_ezsignfoldertype_id: Optional[conint(strict=True, ge=0)] = Field(None, alias="pkiEzsignfoldertypeID", description="The unique ID of the Ezsignfoldertype.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfoldertypeRequestCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfoldertypeRequestCompound:
        """Create an instance of EzsignfoldertypeRequestCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfoldertypeRequestCompound.parse_obj(obj)

        _obj = EzsignfoldertypeRequestCompound.parse_obj({
