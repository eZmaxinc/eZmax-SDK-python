...
class EzsignbulksenddocumentmappingCreateObjectV1ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_pkiEzsignbulksenddocumentmappingID": obj.get("a_pkiEzsignbulksenddocumentmappingID")
        })
        return _obj
