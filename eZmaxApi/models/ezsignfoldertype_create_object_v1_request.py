...
class EzsignfoldertypeCreateObjectV1Request(BaseModel):
    ...
    """ # noqa: E501
    a_obj_ezsignfoldertype: Annotated[List[EzsignfoldertypeRequestCompound], Field(min_length=1)] = Field(alias="a_objEzsignfoldertype")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objEzsignfoldertype": [EzsignfoldertypeRequestCompound.from_dict(_item) for _item in obj.get("a_objEzsignfoldertype")] if obj.get("a_objEzsignfoldertype") is not None else None
        })
        return _obj
