...
class EzsigntemplatedocumentEditEzsigntemplateformfieldgroupsV1ResponseMPayload(BaseModel):
    ...
    """ # noqa: E501
    a_pki_ezsigntemplateformfieldgroup_id: List[Annotated[int, Field(strict=True, ge=0)]] = Field(alias="a_pkiEzsigntemplateformfieldgroupID")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_pkiEzsigntemplateformfieldgroupID": obj.get("a_pkiEzsigntemplateformfieldgroupID")
        })
        return _obj
