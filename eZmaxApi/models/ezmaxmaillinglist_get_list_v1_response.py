...
class EzmaxmaillinglistGetListV1Response(BaseModel):
    """
    ...
    m_payload: EzmaxmaillinglistGetListV1ResponseMPayload = Field(alias="mPayload")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objDebugPayload": CommonResponseObjDebugPayloadGetList.from_dict(obj["objDebugPayload"]) if obj.get("objDebugPayload") is not None else None,
            "objDebug": CommonResponseObjDebug.from_dict(obj["objDebug"]) if obj.get("objDebug") is not None else None,
            "mPayload": EzmaxmaillinglistGetListV1ResponseMPayload.from_dict(obj["mPayload"]) if obj.get("mPayload") is not None else None
        })
        return _obj
