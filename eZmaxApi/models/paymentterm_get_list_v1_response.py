...
class PaymenttermGetListV1Response(BaseModel):
    """
    Response for GET /1/object/paymentterm/getList  # noqa: E501
    """
    ...
    m_payload: PaymenttermGetListV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymenttermGetListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymenttermGetListV1Response:
        """Create an instance of PaymenttermGetListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymenttermGetListV1Response.parse_obj(obj)

        _obj = PaymenttermGetListV1Response.parse_obj({
            ...
            "m_payload": PaymenttermGetListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
