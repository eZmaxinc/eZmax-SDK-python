...
class EzsignbulksendGetFormsDataV1ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objFormsDataFolder": [CustomFormsDataFolderResponse.from_dict(_item) for _item in obj.get("a_objFormsDataFolder")] if obj.get("a_objFormsDataFolder") is not None else None
        })
        return _obj
