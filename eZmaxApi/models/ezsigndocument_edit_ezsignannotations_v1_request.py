...
class EzsigndocumentEditEzsignannotationsV1Request(BaseModel):
    """
    Request for PUT /1/object/ezsigndocument/{pkiEzsigndocumentID}/editEzsignannotations
    """ # noqa: E501
    a_obj_ezsignannotation: List[EzsignannotationRequestCompound] = Field(alias="a_objEzsignannotation")
