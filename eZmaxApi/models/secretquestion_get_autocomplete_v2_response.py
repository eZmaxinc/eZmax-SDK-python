...
class SecretquestionGetAutocompleteV2Response(BaseModel):
    """
    Response for GET /2/object/secretquestion/getAutocomplete  # noqa: E501
    """
    ...
    m_payload: SecretquestionGetAutocompleteV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SecretquestionGetAutocompleteV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SecretquestionGetAutocompleteV2Response:
        """Create an instance of SecretquestionGetAutocompleteV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SecretquestionGetAutocompleteV2Response.parse_obj(obj)

        _obj = SecretquestionGetAutocompleteV2Response.parse_obj({
            ...
            "m_payload": SecretquestionGetAutocompleteV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
