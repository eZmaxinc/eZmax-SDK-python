...
class EzsignfolderEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/ezsignfolder/{pkiEzsignfolderID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderEditObjectV1Response:
        """Create an instance of EzsignfolderEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderEditObjectV1Response.parse_obj(obj)

        _obj = EzsignfolderEditObjectV1Response.parse_obj({
