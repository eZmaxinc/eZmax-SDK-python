...
class EzsigntemplateannotationCreateObjectV1Request(BaseModel):
    """
    Request for POST /1/object/ezsigntemplateannotation
    """ # noqa: E501
    a_obj_ezsigntemplateannotation: Annotated[List[EzsigntemplateannotationRequestCompound], Field(min_length=1)] = Field(alias="a_objEzsigntemplateannotation")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objEzsigntemplateannotation": [EzsigntemplateannotationRequestCompound.from_dict(_item) for _item in obj["a_objEzsigntemplateannotation"]] if obj.get("a_objEzsigntemplateannotation") is not None else None
        })
        return _obj
