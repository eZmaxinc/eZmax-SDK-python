...
class EzsigntemplatedocumentEditEzsigntemplateannotationsV1Request(BaseModel):
    """
    Request for PUT /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/editEzsigntemplateannotations
    """ # noqa: E501
    a_obj_ezsigntemplateannotation: List[EzsigntemplateannotationRequestCompound] = Field(alias="a_objEzsigntemplateannotation")
