...
class UserstagedMapV1Response(BaseModel):
    """
    Response for POST /1/object/userstaged/{pkiUserstagedID}/map  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserstagedMapV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserstagedMapV1Response:
        """Create an instance of UserstagedMapV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserstagedMapV1Response.parse_obj(obj)

        _obj = UserstagedMapV1Response.parse_obj({
