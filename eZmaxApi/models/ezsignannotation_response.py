...
class EzsignannotationResponse(BaseModel):
    """
    A Ezsignannotation Object
    """ # noqa: E501
    pki_ezsignannotation_id: StrictInt = Field(description="The unique ID of the Ezsignannotation", alias="pkiEzsignannotationID", json_schema_extra={"examples": [113]})
