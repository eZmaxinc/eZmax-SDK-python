...
class EzsignannotationResponse(BaseModel):
    ...
    __properties = ["pkiEzsignannotationID", "fkiEzsigndocumentID", "eEzsignannotationHorizontalalignment", "eEzsignannotationVerticalalignment", "eEzsignannotationType", "iEzsignannotationX", "iEzsignannotationY", "iEzsignannotationWidth", "iEzsignannotationHeight", "sEzsignannotationText", "iEzsignpagePagenumber"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignannotationResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignannotationResponse:
        """Create an instance of EzsignannotationResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignannotationResponse.parse_obj(obj)

        _obj = EzsignannotationResponse.parse_obj({
