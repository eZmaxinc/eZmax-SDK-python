...
class EzsigndocumentApplyEzsigntemplateV1Response(BaseModel):
    """
    Response for POST /1/object/ezsigndocument/{pkiEzsigndocument}/applyEzsigntemplate  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentApplyEzsigntemplateV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentApplyEzsigntemplateV1Response:
        """Create an instance of EzsigndocumentApplyEzsigntemplateV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentApplyEzsigntemplateV1Response.parse_obj(obj)

        _obj = EzsigndocumentApplyEzsigntemplateV1Response.parse_obj({
