...
class EzsignfolderDeleteObjectV1Response(BaseModel):
    """
    Response for DELETE /1/object/ezsignfolder/{pkiEzsignfolderID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderDeleteObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderDeleteObjectV1Response:
        """Create an instance of EzsignfolderDeleteObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderDeleteObjectV1Response.parse_obj(obj)

        _obj = EzsignfolderDeleteObjectV1Response.parse_obj({
