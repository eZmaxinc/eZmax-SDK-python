...
class OtherincometypeAutocompleteElementResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pkiOtherincometypeID": obj.get("pkiOtherincometypeID"),
            "sOtherincometypeDescriptionX": obj.get("sOtherincometypeDescriptionX"),
            "bOtherincometypeIsactive": obj.get("bOtherincometypeIsactive")
        })
        return _obj
