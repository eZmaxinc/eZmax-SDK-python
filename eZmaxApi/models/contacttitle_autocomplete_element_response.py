...
class ContacttitleAutocompleteElementResponse(BaseModel):
    """
    ...
    def s_contacttitle_name_x_validate_regular_expression(cls, value):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pkiContacttitleID": obj.get("pkiContacttitleID"),
            "sContacttitleNameX": obj.get("sContacttitleNameX")
        })
        return _obj
