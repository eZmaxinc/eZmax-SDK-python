...
class EzsignfolderGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/ezsignfolder/{pkiEzsignfolderID}  # noqa: E501
    """
    ...
    m_payload: EzsignfolderGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderGetObjectV2Response:
        """Create an instance of EzsignfolderGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderGetObjectV2Response.parse_obj(obj)

        _obj = EzsignfolderGetObjectV2Response.parse_obj({
            ...
            "m_payload": EzsignfolderGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
