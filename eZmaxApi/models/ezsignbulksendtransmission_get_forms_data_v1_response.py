...
class EzsignbulksendtransmissionGetFormsDataV1Response(BaseModel):
    """
    Response for GET /1/object/ezsignbulksendtransmission/{pkiEzsignbulksendtransmissionID}/getFormsData  # noqa: E501
    """
    ...
    m_payload: EzsignbulksendtransmissionGetFormsDataV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignbulksendtransmissionGetFormsDataV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignbulksendtransmissionGetFormsDataV1Response:
        """Create an instance of EzsignbulksendtransmissionGetFormsDataV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignbulksendtransmissionGetFormsDataV1Response.parse_obj(obj)

        _obj = EzsignbulksendtransmissionGetFormsDataV1Response.parse_obj({
            ...
            "m_payload": EzsignbulksendtransmissionGetFormsDataV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
