...
class EzsignsignatureSignV1Response(BaseModel):
    """
    Response for POST /1/object/ezsignsignature/{pkiEzsignsignatureID}/sign  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignatureSignV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignatureSignV1Response:
        """Create an instance of EzsignsignatureSignV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignatureSignV1Response.parse_obj(obj)

        _obj = EzsignsignatureSignV1Response.parse_obj({
