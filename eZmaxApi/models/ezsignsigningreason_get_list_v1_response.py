...
class EzsignsigningreasonGetListV1Response(BaseModel):
    """
    ...
    m_payload: EzsignsigningreasonGetListV1ResponseMPayload = Field(alias="mPayload")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "mPayload": EzsignsigningreasonGetListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
