...
class EzsigntemplatesignatureRequestCompound(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "a_objEzsigntemplatesignaturecustomdate": [EzsigntemplatesignaturecustomdateRequest.from_dict(_item) for _item in obj["a_objEzsigntemplatesignaturecustomdate"]] if obj.get("a_objEzsigntemplatesignaturecustomdate") is not None else None,
