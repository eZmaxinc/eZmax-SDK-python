...
class EzsigntemplatesignatureRequestCompound(BaseModel):
    """
    A Ezsigntemplatesignature Object and children  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatesignatureRequestCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatesignatureRequestCompound:
        """Create an instance of EzsigntemplatesignatureRequestCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatesignatureRequestCompound.parse_obj(obj)

        _obj = EzsigntemplatesignatureRequestCompound.parse_obj({
