...
class SupplierListElement(BaseModel):
    ...
    """ # noqa: E501
    pki_supplier_id: Annotated[int, Field(strict=True, ge=0)] = Field(description="The unique ID of the Supplier.", alias="pkiSupplierID", json_schema_extra={"examples": [1]})
    fki_paymentmethod_id: Optional[Annotated[int, Field(le=255, strict=True, ge=0)]] = Field(default=None, description="The unique ID of the Paymentmethod", alias="fkiPaymentmethodID", json_schema_extra={"examples": [166]})
    s_supplier_name: Annotated[str, Field(strict=True)] = Field(description="The name of the Supplier", alias="sSupplierName", json_schema_extra={"examples": ["Acme inc."]})
    s_supplier_code: Annotated[str, Field(strict=True)] = Field(description="The code of the Supplier", alias="sSupplierCode", json_schema_extra={"examples": ["Acme"]})
    s_supplier_account: Annotated[str, Field(strict=True)] = Field(description="The account of the Supplier", alias="sSupplierAccount", json_schema_extra={"examples": ["Acme"]})
    b_supplier_isactive: StrictBool = Field(description="Whether the supplier is active or not", alias="bSupplierIsactive", json_schema_extra={"examples": [True]})
    ...
    s_paymentmethod_description_x: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The description of the Paymentmethod in the language of the requester", alias="sPaymentmethodDescriptionX", json_schema_extra={"examples": ["Check"]})
    s_electronicfundstransferbankaccount_transit: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The transit of the Electronicfundstransferbankaccount", alias="sElectronicfundstransferbankaccountTransit", json_schema_extra={"examples": ["12345"]})
    s_electronicfundstransferbankaccount_institution: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The institution of the Electronicfundstransferbankaccount", alias="sElectronicfundstransferbankaccountInstitution", json_schema_extra={"examples": ["1234"]})
    s_electronicfundstransferbankaccount_account: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The account of the Electronicfundstransferbankaccount", alias="sElectronicfundstransferbankaccountAccount", json_schema_extra={"examples": ["123456789012"]})
