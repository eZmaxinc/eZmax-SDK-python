...
class EzsignsignergroupRequest(BaseModel):
    """
    A Ezsignsignergroup Object  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignergroupRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignergroupRequest:
        """Create an instance of EzsignsignergroupRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignergroupRequest.parse_obj(obj)

        _obj = EzsignsignergroupRequest.parse_obj({
