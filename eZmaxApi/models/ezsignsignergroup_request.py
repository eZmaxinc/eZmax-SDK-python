...
class EzsignsignergroupRequest(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "objEzsignsignergroupDescription": MultilingualEzsignsignergroupDescription.from_dict(obj.get("objEzsignsignergroupDescription")) if obj.get("objEzsignsignergroupDescription") is not None else None
        })
        return _obj
