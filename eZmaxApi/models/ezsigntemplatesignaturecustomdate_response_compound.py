...
class EzsigntemplatesignaturecustomdateResponseCompound(BaseModel):
    ...
    """ # noqa: E501
    pki_ezsigntemplatesignaturecustomdate_id: Annotated[int, Field(strict=True, ge=0)] = Field(description="The unique ID of the Ezsigntemplatesignaturecustomdate", alias="pkiEzsigntemplatesignaturecustomdateID", json_schema_extra={"examples": [58]})
    i_ezsigntemplatesignaturecustomdate_x: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The X coordinate (Horizontal) where to put the Ezsigntemplatesignaturecustomdate on the page.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the Ezsigntemplatesignaturecustomdate 2 inches from the left border of the page, you would use \"200\" for the X coordinate.", alias="iEzsigntemplatesignaturecustomdateX", json_schema_extra={"examples": [200]})
    i_ezsigntemplatesignaturecustomdate_y: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The Y coordinate (Vertical) where to put the Ezsigntemplatesignaturecustomdate on the page.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the Ezsigntemplatesignaturecustomdate 3 inches from the top border of the page, you would use \"300\" for the Y coordinate.", alias="iEzsigntemplatesignaturecustomdateY", json_schema_extra={"examples": [300]})
    i_ezsigntemplatesignaturecustomdate_offsetx: Optional[StrictInt] = Field(default=None, description="The X coordinate (Horizontal) where to put the Ezsigntemplatesignaturecustomdate on the page.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the Ezsigntemplatesignaturecustomdate 2 inches from the left of the signature, you would use \"200\" for the X coordinate.", alias="iEzsigntemplatesignaturecustomdateOffsetx", json_schema_extra={"examples": [200]})
