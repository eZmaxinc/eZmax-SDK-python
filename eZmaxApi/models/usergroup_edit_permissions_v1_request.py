...
class UsergroupEditPermissionsV1Request(BaseModel):
    ...
    """ # noqa: E501
    a_obj_permission: List[PermissionRequestCompound] = Field(alias="a_objPermission")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objPermission": [PermissionRequestCompound.from_dict(_item) for _item in obj.get("a_objPermission")] if obj.get("a_objPermission") is not None else None
        })
        return _obj
