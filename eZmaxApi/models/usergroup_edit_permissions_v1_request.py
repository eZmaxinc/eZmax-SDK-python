...
class UsergroupEditPermissionsV1Request(BaseModel):
    """
    Request for PUT /1/object/usergroup/{pkiUsergroupID}/editPermissions  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupEditPermissionsV1Request:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupEditPermissionsV1Request:
        """Create an instance of UsergroupEditPermissionsV1Request from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupEditPermissionsV1Request.parse_obj(obj)

        _obj = UsergroupEditPermissionsV1Request.parse_obj({
