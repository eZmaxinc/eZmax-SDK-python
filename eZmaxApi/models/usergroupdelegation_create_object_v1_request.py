...
class UsergroupdelegationCreateObjectV1Request(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objUsergroupdelegation": [UsergroupdelegationRequestCompound.from_dict(_item) for _item in obj.get("a_objUsergroupdelegation")] if obj.get("a_objUsergroupdelegation") is not None else None
        })
        return _obj
