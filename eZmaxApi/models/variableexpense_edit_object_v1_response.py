...
class VariableexpenseEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/variableexpense/{pkiVariableexpenseID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VariableexpenseEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VariableexpenseEditObjectV1Response:
        """Create an instance of VariableexpenseEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VariableexpenseEditObjectV1Response.parse_obj(obj)

        _obj = VariableexpenseEditObjectV1Response.parse_obj({
