...
class UserGetAutocompleteV2ResponseMPayload(BaseModel):
    ...
    """ # noqa: E501
    a_obj_user: List[UserAutocompleteElementResponse] = Field(description="An array of User autocomplete element response.", alias="a_objUser")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objUser": [UserAutocompleteElementResponse.from_dict(_item) for _item in obj.get("a_objUser")] if obj.get("a_objUser") is not None else None
        })
        return _obj
