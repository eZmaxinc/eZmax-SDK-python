...
class EzsignfolderImportEzsignfoldersignerassociationsV1Response(BaseModel):
    """
    Response for POST /1/object/ezsignfolder/{pkiEzsignfolder}/importEzsignfoldersignerassociations  # noqa: E501
    """
    ...
    m_payload: EzsignfolderImportEzsignfoldersignerassociationsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderImportEzsignfoldersignerassociationsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderImportEzsignfoldersignerassociationsV1Response:
        """Create an instance of EzsignfolderImportEzsignfoldersignerassociationsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderImportEzsignfoldersignerassociationsV1Response.parse_obj(obj)

        _obj = EzsignfolderImportEzsignfoldersignerassociationsV1Response.parse_obj({
            ...
            "m_payload": EzsignfolderImportEzsignfoldersignerassociationsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
