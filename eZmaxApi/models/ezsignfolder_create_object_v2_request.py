...
class EzsignfolderCreateObjectV2Request(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objEzsignfolder": [EzsignfolderRequestCompound.from_dict(_item) for _item in obj.get("a_objEzsignfolder")] if obj.get("a_objEzsignfolder") is not None else None
        })
        return _obj
