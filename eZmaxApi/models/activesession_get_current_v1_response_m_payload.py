...
class ActivesessionGetCurrentV1ResponseMPayload(BaseModel):
    ...
    b_activesession_debug: StrictBool = Field(description="Whether the active session is in debug or not", alias="bActivesessionDebug", json_schema_extra={"examples": [False]})
    b_activesession_issuperadmin: StrictBool = Field(description="Whether the active session is superadmin or not", alias="bActivesessionIssuperadmin", json_schema_extra={"examples": [False]})
    b_activesession_attachment: Optional[StrictBool] = Field(default=None, description="Can access attachment when we clone a user", alias="bActivesessionAttachment", json_schema_extra={"examples": [False]})
    b_activesession_canafe: Optional[StrictBool] = Field(default=None, description="Can access canafe when we clone a user", alias="bActivesessionCanafe", json_schema_extra={"examples": [False]})
    b_activesession_financial: Optional[StrictBool] = Field(default=None, description="Can access financial element when we clone a user", alias="bActivesessionFinancial", json_schema_extra={"examples": [False]})
    b_activesession_realestatecompleted: Optional[StrictBool] = Field(default=None, description="Can access closed realestate folders when we clone a user", alias="bActivesessionRealestatecompleted", json_schema_extra={"examples": [False]})
    ...
    fki_signature_id: Optional[Annotated[int, Field(le=16777215, strict=True, ge=0)]] = Field(default=None, description="The unique ID of the Signature", alias="fkiSignatureID", json_schema_extra={"examples": [12]})
    fki_ezsignuser_id: Optional[Annotated[int, Field(le=65535, strict=True, ge=0)]] = Field(default=None, description="The unique ID of the Ezsignuser", alias="fkiEzsignuserID", json_schema_extra={"examples": [94]})
    ...
    b_user_ezsigntrial: Optional[StrictBool] = Field(default=None, description="Whether the User's eZsign subscription is a trial", alias="bUserEzsigntrial", json_schema_extra={"examples": [False]})
    ...
    dt_user_npsrequest: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The date at which the NPS questionnaire will be show", alias="dtUserNpsrequest", json_schema_extra={"examples": ["2020-12-31"]})
    ...
    b_activesession_maillinglistrequest: Optional[StrictBool] = Field(default=None, description="If you need to ask which mailing lists this user wants to subscribe to", alias="bActivesessionMaillinglistrequest", json_schema_extra={"examples": [True]})
    ...
    @field_validator('dt_user_npsrequest')
    def dt_user_npsrequest_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
