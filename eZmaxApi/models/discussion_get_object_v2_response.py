...
class DiscussionGetObjectV2Response(BaseModel):
    """
    ...
    m_payload: DiscussionGetObjectV2ResponseMPayload = Field(alias="mPayload")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "mPayload": DiscussionGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
