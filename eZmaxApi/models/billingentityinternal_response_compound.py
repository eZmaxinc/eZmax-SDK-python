...
class BillingentityinternalResponseCompound(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "a_objBillingentityinternalproduct": [BillingentityinternalproductResponseCompound.from_dict(_item) for _item in obj.get("a_objBillingentityinternalproduct")] if obj.get("a_objBillingentityinternalproduct") is not None else None
        })
        return _obj
