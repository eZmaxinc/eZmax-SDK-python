...
class EzsigndocumentGetEzsignsignaturesAutomaticV1Response(BaseModel):
    """
    Response for GET /1/object/ezsigndocument/{pkiEzsigndocumentID}/getEzsignsignaturesAutomatic  # noqa: E501
    """
    ...
    m_payload: EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentGetEzsignsignaturesAutomaticV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentGetEzsignsignaturesAutomaticV1Response:
        """Create an instance of EzsigndocumentGetEzsignsignaturesAutomaticV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentGetEzsignsignaturesAutomaticV1Response.parse_obj(obj)

        _obj = EzsigndocumentGetEzsignsignaturesAutomaticV1Response.parse_obj({
            ...
            "m_payload": EzsigndocumentGetEzsignsignaturesAutomaticV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
