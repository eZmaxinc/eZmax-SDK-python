...
class TaxassignmentGetAutocompleteV2Response(BaseModel):
    """
    Response for GET /2/object/taxassignment/getAutocomplete  # noqa: E501
    """
    ...
    m_payload: TaxassignmentGetAutocompleteV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaxassignmentGetAutocompleteV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaxassignmentGetAutocompleteV2Response:
        """Create an instance of TaxassignmentGetAutocompleteV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaxassignmentGetAutocompleteV2Response.parse_obj(obj)

        _obj = TaxassignmentGetAutocompleteV2Response.parse_obj({
            ...
            "m_payload": TaxassignmentGetAutocompleteV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
