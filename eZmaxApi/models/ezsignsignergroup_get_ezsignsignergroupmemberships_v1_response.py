...
class EzsignsignergroupGetEzsignsignergroupmembershipsV1Response(BaseModel):
    """
    ...
    m_payload: EzsignsignergroupGetEzsignsignergroupmembershipsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignergroupGetEzsignsignergroupmembershipsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignergroupGetEzsignsignergroupmembershipsV1Response:
        """Create an instance of EzsignsignergroupGetEzsignsignergroupmembershipsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignergroupGetEzsignsignergroupmembershipsV1Response.parse_obj(obj)

        _obj = EzsignsignergroupGetEzsignsignergroupmembershipsV1Response.parse_obj({
            ...
            "m_payload": EzsignsignergroupGetEzsignsignergroupmembershipsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
