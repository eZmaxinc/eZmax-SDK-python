...
class EzsignbulksendCreateEzsignbulksendtransmissionV2Request(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["fkiUserlogintypeID", "fkiSecretquestionID", "fkiEzsigntsarequirementID", "sEzsignbulksendtransmissionDescription", "dtEzsigndocumentDuedate", "iEzsignfolderSendreminderfirstdays", "iEzsignfolderSendreminderotherdays", "tExtraMessage", "sCsvBase64"]
