...
class EzsignbulksendCreateEzsignbulksendtransmissionV2Request(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["fkiUserlogintypeID", "fkiEzsigntsarequirementID", "sEzsignbulksendtransmissionDescription", "dtEzsigndocumentDuedate", "iEzsignfolderSendreminderfirstdays", "iEzsignfolderSendreminderotherdays", "tExtraMessage", "sCsvBase64"]
