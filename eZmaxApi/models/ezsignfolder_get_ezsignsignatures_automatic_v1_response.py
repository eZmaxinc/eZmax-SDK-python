...
class EzsignfolderGetEzsignsignaturesAutomaticV1Response(BaseModel):
    """
    Response for GET /1/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignsignaturesAutomatic  # noqa: E501
    """
    ...
    m_payload: EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderGetEzsignsignaturesAutomaticV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderGetEzsignsignaturesAutomaticV1Response:
        """Create an instance of EzsignfolderGetEzsignsignaturesAutomaticV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderGetEzsignsignaturesAutomaticV1Response.parse_obj(obj)

        _obj = EzsignfolderGetEzsignsignaturesAutomaticV1Response.parse_obj({
            ...
            "m_payload": EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
