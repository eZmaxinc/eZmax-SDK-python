...
class EzsignfoldersignerassociationForceDisconnectV1Response(BaseModel):
    """
    Response for POST /1/object/ezsignfoldersignerassociation/{pkiEzsignfoldersignerassociation}/forceDisconnect  # noqa: E501
    """
    ...
    __properties = ["objDebugPayload", "objDebug"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfoldersignerassociationForceDisconnectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfoldersignerassociationForceDisconnectV1Response:
        """Create an instance of EzsignfoldersignerassociationForceDisconnectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfoldersignerassociationForceDisconnectV1Response.parse_obj(obj)

        _obj = EzsignfoldersignerassociationForceDisconnectV1Response.parse_obj({
