...
class EzsignfolderResponseCompound(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderResponseCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderResponseCompound:
        """Create an instance of EzsignfolderResponseCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderResponseCompound.parse_obj(obj)

        _obj = EzsignfolderResponseCompound.parse_obj({
