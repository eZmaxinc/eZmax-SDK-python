...
class BillingentityinternalRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillingentityinternalRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillingentityinternalRequest:
        """Create an instance of BillingentityinternalRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillingentityinternalRequest.parse_obj(obj)

        _obj = BillingentityinternalRequest.parse_obj({
