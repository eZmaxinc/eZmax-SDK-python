...
class EzsignfolderSendV2Response(BaseModel):
    """
    Response for POST /2/object/ezsignfolder/{pkiEzsignfolderID}/send  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderSendV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderSendV2Response:
        """Create an instance of EzsignfolderSendV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderSendV2Response.parse_obj(obj)

        _obj = EzsignfolderSendV2Response.parse_obj({
