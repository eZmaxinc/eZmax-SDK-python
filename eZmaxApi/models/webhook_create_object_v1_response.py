...
class WebhookCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/webhook  # noqa: E501
    """
    ...
    m_payload: WebhookCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhookCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookCreateObjectV1Response:
        """Create an instance of WebhookCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookCreateObjectV1Response.parse_obj(obj)

        _obj = WebhookCreateObjectV1Response.parse_obj({
            ...
            "m_payload": WebhookCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
