...
class EzsigntemplateformfieldgroupDeleteObjectV1Response(BaseModel):
    """
    Response for DELETE /1/object/ezsigntemplateformfieldgroup/{pkiEzsigntemplateformfieldgroupID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplateformfieldgroupDeleteObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplateformfieldgroupDeleteObjectV1Response:
        """Create an instance of EzsigntemplateformfieldgroupDeleteObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplateformfieldgroupDeleteObjectV1Response.parse_obj(obj)

        _obj = EzsigntemplateformfieldgroupDeleteObjectV1Response.parse_obj({
