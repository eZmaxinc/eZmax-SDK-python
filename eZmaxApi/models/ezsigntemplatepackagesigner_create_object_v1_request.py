...
class EzsigntemplatepackagesignerCreateObjectV1Request(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objEzsigntemplatepackagesigner": [EzsigntemplatepackagesignerRequestCompound.from_dict(_item) for _item in obj.get("a_objEzsigntemplatepackagesigner")] if obj.get("a_objEzsigntemplatepackagesigner") is not None else None
        })
        return _obj
