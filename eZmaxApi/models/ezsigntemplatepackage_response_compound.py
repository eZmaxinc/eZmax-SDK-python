...
class EzsigntemplatepackageResponseCompound(BaseModel):
    ...
    s_ezdoctemplatedocument_name_x: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The name of the Ezdoctemplatedocument in the language of the requester", alias="sEzdoctemplatedocumentNameX", json_schema_extra={"examples": ["Standard Contract"]})
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.a_obj_ezsigntemplatepackagesigner:
            for _item_a_obj_ezsigntemplatepackagesigner in self.a_obj_ezsigntemplatepackagesigner:
                if _item_a_obj_ezsigntemplatepackagesigner:
                    _items.append(_item_a_obj_ezsigntemplatepackagesigner.to_dict())
