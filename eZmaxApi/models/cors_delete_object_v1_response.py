...
class CorsDeleteObjectV1Response(BaseModel):
    """
    Response for DELETE /1/object/cors/{pkiCorsID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CorsDeleteObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CorsDeleteObjectV1Response:
        """Create an instance of CorsDeleteObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CorsDeleteObjectV1Response.parse_obj(obj)

        _obj = CorsDeleteObjectV1Response.parse_obj({
