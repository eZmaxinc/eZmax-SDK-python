...
class EzsignfolderGetCommunicationListV1ResponseMPayload(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderGetCommunicationListV1ResponseMPayload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderGetCommunicationListV1ResponseMPayload:
        """Create an instance of EzsignfolderGetCommunicationListV1ResponseMPayload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderGetCommunicationListV1ResponseMPayload.parse_obj(obj)

        _obj = EzsignfolderGetCommunicationListV1ResponseMPayload.parse_obj({
