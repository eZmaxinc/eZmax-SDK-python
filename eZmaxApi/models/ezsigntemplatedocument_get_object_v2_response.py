...
class EzsigntemplatedocumentGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}  # noqa: E501
    """
    ...
    m_payload: EzsigntemplatedocumentGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatedocumentGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatedocumentGetObjectV2Response:
        """Create an instance of EzsigntemplatedocumentGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatedocumentGetObjectV2Response.parse_obj(obj)

        _obj = EzsigntemplatedocumentGetObjectV2Response.parse_obj({
            ...
            "m_payload": EzsigntemplatedocumentGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
