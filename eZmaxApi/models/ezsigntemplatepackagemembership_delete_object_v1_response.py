...
class EzsigntemplatepackagemembershipDeleteObjectV1Response(BaseModel):
    """
    Response for DELETE /1/object/ezsigntemplatepackagemembership/{pkiEzsigntemplatepackagemembershipID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatepackagemembershipDeleteObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatepackagemembershipDeleteObjectV1Response:
        """Create an instance of EzsigntemplatepackagemembershipDeleteObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatepackagemembershipDeleteObjectV1Response.parse_obj(obj)

        _obj = EzsigntemplatepackagemembershipDeleteObjectV1Response.parse_obj({
