...
class NotificationtestGetElementsV1Response(BaseModel):
    """
    Response for GET /1/object/notificationtest/{pkiNotificationtestID}/getElements  # noqa: E501
    """
    ...
    m_payload: NotificationtestGetElementsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NotificationtestGetElementsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NotificationtestGetElementsV1Response:
        """Create an instance of NotificationtestGetElementsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NotificationtestGetElementsV1Response.parse_obj(obj)

        _obj = NotificationtestGetElementsV1Response.parse_obj({
            ...
            "m_payload": NotificationtestGetElementsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
