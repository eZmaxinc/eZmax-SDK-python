...
class MultilingualUserlogintypeDescription(BaseModel):
    """
    ...
    def s_userlogintype_description1_validate_regular_expression(cls, value):
    ...
    @field_validator('s_userlogintype_description2')
    def s_userlogintype_description2_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sUserlogintypeDescription1": obj.get("sUserlogintypeDescription1"),
            "sUserlogintypeDescription2": obj.get("sUserlogintypeDescription2")
        })
        return _obj
