...
class CompanyGetAutocompleteV2Response(BaseModel):
    """
    Response for GET /2/object/company/getAutocomplete  # noqa: E501
    """
    ...
    m_payload: CompanyGetAutocompleteV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CompanyGetAutocompleteV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CompanyGetAutocompleteV2Response:
        """Create an instance of CompanyGetAutocompleteV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CompanyGetAutocompleteV2Response.parse_obj(obj)

        _obj = CompanyGetAutocompleteV2Response.parse_obj({
            ...
            "m_payload": CompanyGetAutocompleteV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
