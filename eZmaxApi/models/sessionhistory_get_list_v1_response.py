...
class SessionhistoryGetListV1Response(BaseModel):
    """
    Response for GET /1/object/sessionhistory/getList  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SessionhistoryGetListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SessionhistoryGetListV1Response:
        """Create an instance of SessionhistoryGetListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SessionhistoryGetListV1Response.parse_obj(obj)

        _obj = SessionhistoryGetListV1Response.parse_obj({
            ...
            "m_payload": SessionhistoryGetListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
