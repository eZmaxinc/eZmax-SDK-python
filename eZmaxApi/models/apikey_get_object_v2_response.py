...
class ApikeyGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/apikey/{pkiApikeyID}  # noqa: E501
    """
    ...
    m_payload: ApikeyGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApikeyGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApikeyGetObjectV2Response:
        """Create an instance of ApikeyGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApikeyGetObjectV2Response.parse_obj(obj)

        _obj = ApikeyGetObjectV2Response.parse_obj({
            ...
            "m_payload": ApikeyGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
