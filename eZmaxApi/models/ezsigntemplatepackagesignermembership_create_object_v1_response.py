...
class EzsigntemplatepackagesignermembershipCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/ezsigntemplatepackagesignermembership  # noqa: E501
    """
    ...
    m_payload: EzsigntemplatepackagesignermembershipCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatepackagesignermembershipCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatepackagesignermembershipCreateObjectV1Response:
        """Create an instance of EzsigntemplatepackagesignermembershipCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatepackagesignermembershipCreateObjectV1Response.parse_obj(obj)

        _obj = EzsigntemplatepackagesignermembershipCreateObjectV1Response.parse_obj({
            ...
            "m_payload": EzsigntemplatepackagesignermembershipCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
