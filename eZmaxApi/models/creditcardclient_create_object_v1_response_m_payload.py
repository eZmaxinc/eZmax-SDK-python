...
class CreditcardclientCreateObjectV1ResponseMPayload(BaseModel):
    """
    Payload for POST /1/object/creditcardclient
    """ # noqa: E501
    a_pki_creditcardclient_id: List[Annotated[int, Field(le=65535, strict=True, ge=0)]] = Field(description="An array of unique IDs representing the object that were requested to be created.  They are returned in the same order as the array containing the objects to be created that was sent in the request.", alias="a_pkiCreditcardclientID")
    __properties: ClassVar[List[str]] = ["a_pkiCreditcardclientID"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_pkiCreditcardclientID": obj.get("a_pkiCreditcardclientID")
        })
        return _obj
