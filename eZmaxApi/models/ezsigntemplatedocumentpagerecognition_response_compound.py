...
class EzsigntemplatedocumentpagerecognitionResponseCompound(BaseModel):
    ...
    """ # noqa: E501
    pki_ezsigntemplatedocumentpagerecognition_id: Annotated[int, Field(le=65535, strict=True, ge=0)] = Field(description="The unique ID of the Ezsigntemplatedocumentpagerecognition", alias="pkiEzsigntemplatedocumentpagerecognitionID", json_schema_extra={"examples": [126]})
