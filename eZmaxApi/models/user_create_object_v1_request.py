...
class UserCreateObjectV1Request(BaseModel):
    ...
    """ # noqa: E501
    a_obj_user: Annotated[List[UserRequestCompound], Field(min_length=1)] = Field(alias="a_objUser")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objUser": [UserRequestCompound.from_dict(_item) for _item in obj.get("a_objUser")] if obj.get("a_objUser") is not None else None
        })
        return _obj
