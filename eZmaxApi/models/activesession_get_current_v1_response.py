...
class ActivesessionGetCurrentV1Response(BaseModel):
    """
    Response for GET /1/object/activesession/getCurrent  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ActivesessionGetCurrentV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ActivesessionGetCurrentV1Response:
        """Create an instance of ActivesessionGetCurrentV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ActivesessionGetCurrentV1Response.parse_obj(obj)

        _obj = ActivesessionGetCurrentV1Response.parse_obj({
            ...
            "m_payload": ActivesessionGetCurrentV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
