...
class EzsignfolderImportEzsigntemplatepackageV1Response(BaseModel):
    """
    Response for POST/1/object/ezsignfolder/{pkiEzsignfolderID}/importEzsigntemplatepackage  # noqa: E501
    """
    ...
    m_payload: EzsignfolderImportEzsigntemplatepackageV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderImportEzsigntemplatepackageV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderImportEzsigntemplatepackageV1Response:
        """Create an instance of EzsignfolderImportEzsigntemplatepackageV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderImportEzsigntemplatepackageV1Response.parse_obj(obj)

        _obj = EzsignfolderImportEzsigntemplatepackageV1Response.parse_obj({
            ...
            "m_payload": EzsignfolderImportEzsigntemplatepackageV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
