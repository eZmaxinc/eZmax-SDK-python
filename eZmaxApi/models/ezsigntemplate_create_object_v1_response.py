...
class EzsigntemplateCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/ezsigntemplate  # noqa: E501
    """
    ...
    m_payload: EzsigntemplateCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplateCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplateCreateObjectV1Response:
        """Create an instance of EzsigntemplateCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplateCreateObjectV1Response.parse_obj(obj)

        _obj = EzsigntemplateCreateObjectV1Response.parse_obj({
            ...
            "m_payload": EzsigntemplateCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
