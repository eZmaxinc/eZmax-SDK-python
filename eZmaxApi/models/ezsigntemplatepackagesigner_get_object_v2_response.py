...
class EzsigntemplatepackagesignerGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/ezsigntemplatepackagesigner/{pkiEzsigntemplatepackagesignerID}  # noqa: E501
    """
    ...
    m_payload: EzsigntemplatepackagesignerGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatepackagesignerGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatepackagesignerGetObjectV2Response:
        """Create an instance of EzsigntemplatepackagesignerGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatepackagesignerGetObjectV2Response.parse_obj(obj)

        _obj = EzsigntemplatepackagesignerGetObjectV2Response.parse_obj({
            ...
            "m_payload": EzsigntemplatepackagesignerGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
