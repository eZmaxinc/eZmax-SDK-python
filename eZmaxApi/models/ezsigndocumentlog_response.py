...
class EzsigndocumentlogResponse(BaseModel):
    """
    An Ezsigndocumentlog Object  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentlogResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentlogResponse:
        """Create an instance of EzsigndocumentlogResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentlogResponse.parse_obj(obj)

        _obj = EzsigndocumentlogResponse.parse_obj({
