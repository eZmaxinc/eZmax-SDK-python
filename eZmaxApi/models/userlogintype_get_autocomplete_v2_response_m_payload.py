...
class UserlogintypeGetAutocompleteV2ResponseMPayload(BaseModel):
    ...
    """ # noqa: E501
    a_obj_userlogintype: List[UserlogintypeAutocompleteElementResponse] = Field(description="An array of Userlogintype autocomplete element response.", alias="a_objUserlogintype")
    __properties: ClassVar[List[str]] = ["a_objUserlogintype"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objUserlogintype": [UserlogintypeAutocompleteElementResponse.from_dict(_item) for _item in obj.get("a_objUserlogintype")] if obj.get("a_objUserlogintype") is not None else None
        })
        return _obj
