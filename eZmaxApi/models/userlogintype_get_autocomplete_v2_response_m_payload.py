...
class UserlogintypeGetAutocompleteV2ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objUserlogintype": [UserlogintypeAutocompleteElementResponse.from_dict(_item) for _item in obj["a_objUserlogintype"]] if obj.get("a_objUserlogintype") is not None else None
        })
        return _obj
