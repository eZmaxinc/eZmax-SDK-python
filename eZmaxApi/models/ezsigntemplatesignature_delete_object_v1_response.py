...
class EzsigntemplatesignatureDeleteObjectV1Response(BaseModel):
    """
    Response for DELETE /1/object/ezsigntemplatesignature/{pkiEzsigntemplatesignatureID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatesignatureDeleteObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatesignatureDeleteObjectV1Response:
        """Create an instance of EzsigntemplatesignatureDeleteObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatesignatureDeleteObjectV1Response.parse_obj(obj)

        _obj = EzsigntemplatesignatureDeleteObjectV1Response.parse_obj({
