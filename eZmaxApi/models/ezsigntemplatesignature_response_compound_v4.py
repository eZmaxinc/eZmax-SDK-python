...
class EzsigntemplatesignatureResponseCompoundV4(BaseModel):
    ...
    """ # noqa: E501
    pki_ezsigntemplatesignature_id: Annotated[int, Field(strict=True, ge=0)] = Field(description="The unique ID of the Ezsigntemplatesignature", alias="pkiEzsigntemplatesignatureID")
    ...
    s_ezsigntemplatesignature_creditcardamountdescription: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The description of the Creditcard signature", alias="sEzsigntemplatesignatureCreditcardamountdescription")
    d_ezsigntemplatesignature_creditcardamount: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The amount of the Creditcard signature", alias="dEzsigntemplatesignatureCreditcardamount")
