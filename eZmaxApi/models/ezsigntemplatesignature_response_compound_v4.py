...
class EzsigntemplatesignatureResponseCompoundV4(BaseModel):
    """
    A Ezsigntemplatesignature Object
    """ # noqa: E501
    pki_ezsigntemplatesignature_id: Annotated[int, Field(strict=True, ge=0)] = Field(description="The unique ID of the Ezsigntemplatesignature", alias="pkiEzsigntemplatesignatureID", json_schema_extra={"examples": [99]})
    ...
    a_obj_ezsigntemplatesignaturepaymentdetail: Optional[List[EzsigntemplatesignaturepaymentdetailResponseCompound]] = Field(default=None, alias="a_objEzsigntemplatesignaturepaymentdetail")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "a_objEzsigntemplatesignaturecustomdate": [EzsigntemplatesignaturecustomdateResponseCompoundV2.from_dict(_item) for _item in obj["a_objEzsigntemplatesignaturecustomdate"]] if obj.get("a_objEzsigntemplatesignaturecustomdate") is not None else None,
            "a_objEzsigntemplateelementdependency": [EzsigntemplateelementdependencyResponseCompound.from_dict(_item) for _item in obj["a_objEzsigntemplateelementdependency"]] if obj.get("a_objEzsigntemplateelementdependency") is not None else None,
            "a_objEzsigntemplatesignaturepaymentdetail": [EzsigntemplatesignaturepaymentdetailResponseCompound.from_dict(_item) for _item in obj["a_objEzsigntemplatesignaturepaymentdetail"]] if obj.get("a_objEzsigntemplatesignaturepaymentdetail") is not None else None
        })
        return _obj
