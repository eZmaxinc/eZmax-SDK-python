...
class EzsigntemplatepackagesignermembershipGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/ezsigntemplatepackagesignermembership/{pkiEzsigntemplatepackagesignermembershipID}  # noqa: E501
    """
    ...
    m_payload: EzsigntemplatepackagesignermembershipGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatepackagesignermembershipGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatepackagesignermembershipGetObjectV2Response:
        """Create an instance of EzsigntemplatepackagesignermembershipGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatepackagesignermembershipGetObjectV2Response.parse_obj(obj)

        _obj = EzsigntemplatepackagesignermembershipGetObjectV2Response.parse_obj({
            ...
            "m_payload": EzsigntemplatepackagesignermembershipGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
