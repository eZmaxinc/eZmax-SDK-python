...
class EzsignfoldertypeCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/ezsignfoldertype  # noqa: E501
    """
    ...
    m_payload: EzsignfoldertypeCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfoldertypeCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfoldertypeCreateObjectV1Response:
        """Create an instance of EzsignfoldertypeCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfoldertypeCreateObjectV1Response.parse_obj(obj)

        _obj = EzsignfoldertypeCreateObjectV1Response.parse_obj({
            ...
            "m_payload": EzsignfoldertypeCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
