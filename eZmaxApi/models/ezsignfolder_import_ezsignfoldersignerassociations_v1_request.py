...
class EzsignfolderImportEzsignfoldersignerassociationsV1Request(BaseModel):
    ...
    """ # noqa: E501
    a_fki_ezsignfoldersignerassociation_id: Annotated[List[Annotated[int, Field(strict=True, ge=0)]], Field(min_length=1)] = Field(alias="a_fkiEzsignfoldersignerassociationID")
    __properties: ClassVar[List[str]] = ["a_fkiEzsignfoldersignerassociationID"]
