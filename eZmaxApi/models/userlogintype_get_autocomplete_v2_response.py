...
class UserlogintypeGetAutocompleteV2Response(BaseModel):
    """
    Response for GET /2/object/userlogintype/getAutocomplete  # noqa: E501
    """
    ...
    m_payload: UserlogintypeGetAutocompleteV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserlogintypeGetAutocompleteV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserlogintypeGetAutocompleteV2Response:
        """Create an instance of UserlogintypeGetAutocompleteV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserlogintypeGetAutocompleteV2Response.parse_obj(obj)

        _obj = UserlogintypeGetAutocompleteV2Response.parse_obj({
            ...
            "m_payload": UserlogintypeGetAutocompleteV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
