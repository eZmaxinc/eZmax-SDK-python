...
class CommunicationSendV1Response(BaseModel):
    """
    Response for POST /1/object/communication  # noqa: E501
    """
    ...
    m_payload: CommunicationCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommunicationSendV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommunicationSendV1Response:
        ...
        _obj = CommunicationSendV1Response.parse_obj({
            ...
            "m_payload": CommunicationCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
