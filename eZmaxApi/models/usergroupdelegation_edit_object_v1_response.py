...
class UsergroupdelegationEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/usergroupdelegation/{pkiUsergroupdelegationID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupdelegationEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupdelegationEditObjectV1Response:
        """Create an instance of UsergroupdelegationEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupdelegationEditObjectV1Response.parse_obj(obj)

        _obj = UsergroupdelegationEditObjectV1Response.parse_obj({
