...
class UsergroupdelegationCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/usergroupdelegation  # noqa: E501
    """
    ...
    m_payload: UsergroupdelegationCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupdelegationCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupdelegationCreateObjectV1Response:
        """Create an instance of UsergroupdelegationCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupdelegationCreateObjectV1Response.parse_obj(obj)

        _obj = UsergroupdelegationCreateObjectV1Response.parse_obj({
            ...
            "m_payload": UsergroupdelegationCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
