...
class EzsigndocumentGetAttachmentsV1ResponseMPayload(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.a_obj_attachmentdocumenttype:
            for _item_a_obj_attachmentdocumenttype in self.a_obj_attachmentdocumenttype:
                if _item_a_obj_attachmentdocumenttype:
                    _items.append(_item_a_obj_attachmentdocumenttype.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objAttachmentdocumenttype": [CustomAttachmentdocumenttypeResponse.from_dict(_item) for _item in obj["a_objAttachmentdocumenttype"]] if obj.get("a_objAttachmentdocumenttype") is not None else None
        })
        return _obj
