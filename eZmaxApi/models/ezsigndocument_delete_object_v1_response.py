...
class EzsigndocumentDeleteObjectV1Response(BaseModel):
    """
    Response for DELETE /1/object/ezsigndocument/{pkiEzsigndocumentID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentDeleteObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentDeleteObjectV1Response:
        """Create an instance of EzsigndocumentDeleteObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentDeleteObjectV1Response.parse_obj(obj)

        _obj = EzsigndocumentDeleteObjectV1Response.parse_obj({
