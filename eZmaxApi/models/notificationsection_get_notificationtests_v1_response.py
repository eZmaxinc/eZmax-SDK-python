...
class NotificationsectionGetNotificationtestsV1Response(BaseModel):
    """
    Response for GET /1/object/notificationsection/{pkiNotificationsectionID}/getNotificationtests  # noqa: E501
    """
    ...
    m_payload: NotificationsectionGetNotificationtestsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NotificationsectionGetNotificationtestsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NotificationsectionGetNotificationtestsV1Response:
        """Create an instance of NotificationsectionGetNotificationtestsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NotificationsectionGetNotificationtestsV1Response.parse_obj(obj)

        _obj = NotificationsectionGetNotificationtestsV1Response.parse_obj({
            ...
            "m_payload": NotificationsectionGetNotificationtestsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
