...
class EzsignsignergroupGetEzsignsignergroupmembershipsV1ResponseMPayload(BaseModel):
    ...
    """ # noqa: E501
    a_obj_ezsignsignergroupmembership: List[EzsignsignergroupmembershipResponseCompound] = Field(alias="a_objEzsignsignergroupmembership")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objEzsignsignergroupmembership": [EzsignsignergroupmembershipResponseCompound.from_dict(_item) for _item in obj["a_objEzsignsignergroupmembership"]] if obj.get("a_objEzsignsignergroupmembership") is not None else None
        })
        return _obj
