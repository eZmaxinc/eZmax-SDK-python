...
class EzsignsignergroupGetEzsignsignergroupmembershipsV1ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objEzsignsignergroupmembership": [EzsignsignergroupmembershipResponseCompound.from_dict(_item) for _item in obj.get("a_objEzsignsignergroupmembership")] if obj.get("a_objEzsignsignergroupmembership") is not None else None
        })
        return _obj
