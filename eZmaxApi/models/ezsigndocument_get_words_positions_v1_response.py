...
class EzsigndocumentGetWordsPositionsV1Response(BaseModel):
    """
    Response for POST /1/object/ezsigndocument/{pkiEzsigndocumentID}/getWordsPositions  # noqa: E501
    """
    ...
    m_payload: conlist(CustomWordPositionWordResponse) = Field(..., alias="mPayload", description="Payload for POST /1/object/ezsigndocument/{pkiEzsigndocumentID}/getWordsPositions")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentGetWordsPositionsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentGetWordsPositionsV1Response:
        """Create an instance of EzsigndocumentGetWordsPositionsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentGetWordsPositionsV1Response.parse_obj(obj)

        _obj = EzsigndocumentGetWordsPositionsV1Response.parse_obj({
