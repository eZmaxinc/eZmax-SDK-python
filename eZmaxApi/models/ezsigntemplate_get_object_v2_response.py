...
class EzsigntemplateGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/ezsigntemplate/{pkiEzsigntemplateID}  # noqa: E501
    """
    ...
    m_payload: EzsigntemplateGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplateGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplateGetObjectV2Response:
        """Create an instance of EzsigntemplateGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplateGetObjectV2Response.parse_obj(obj)

        _obj = EzsigntemplateGetObjectV2Response.parse_obj({
            ...
            "m_payload": EzsigntemplateGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
