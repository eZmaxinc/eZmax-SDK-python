...
class EzsignsignergroupCreateObjectV1Request(BaseModel):
    ...
    """ # noqa: E501
    a_obj_ezsignsignergroup: Annotated[List[EzsignsignergroupRequestCompound], Field(min_length=1)] = Field(alias="a_objEzsignsignergroup")
    __properties: ClassVar[List[str]] = ["a_objEzsignsignergroup"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objEzsignsignergroup": [EzsignsignergroupRequestCompound.from_dict(_item) for _item in obj.get("a_objEzsignsignergroup")] if obj.get("a_objEzsignsignergroup") is not None else None
        })
        return _obj
