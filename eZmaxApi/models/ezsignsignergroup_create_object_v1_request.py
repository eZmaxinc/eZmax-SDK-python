...
class EzsignsignergroupCreateObjectV1Request(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objEzsignsignergroup": [EzsignsignergroupRequestCompound.from_dict(_item) for _item in obj["a_objEzsignsignergroup"]] if obj.get("a_objEzsignsignergroup") is not None else None
        })
        return _obj
