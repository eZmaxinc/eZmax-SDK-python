...
class PaymentgatewayAutocompleteElementResponse(BaseModel):
    """
    ...
    b_paymentgateway_isactive: StrictBool = Field(description="Whether the Currency is active or not", alias="bPaymentgatewayIsactive")
    __properties: ClassVar[List[str]] = ["pkiPaymentgatewayID", "sPaymentgatewayDescriptionX", "bPaymentgatewayIsactive"]
