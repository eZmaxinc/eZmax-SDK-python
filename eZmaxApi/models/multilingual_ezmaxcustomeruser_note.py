...
class MultilingualEzmaxcustomeruserNote(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tEzmaxcustomeruserNote1": obj.get("tEzmaxcustomeruserNote1"),
            "tEzmaxcustomeruserNote2": obj.get("tEzmaxcustomeruserNote2")
        })
        return _obj
