...
class EzsigntemplatedocumentPatchObjectV1Response(BaseModel):
    """
    Response for PATCH /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatedocumentPatchObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatedocumentPatchObjectV1Response:
        """Create an instance of EzsigntemplatedocumentPatchObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatedocumentPatchObjectV1Response.parse_obj(obj)

        _obj = EzsigntemplatedocumentPatchObjectV1Response.parse_obj({
