...
class VersionhistoryGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/versionhistory/{pkiVersionhistoryID}  # noqa: E501
    """
    ...
    m_payload: VersionhistoryGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VersionhistoryGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VersionhistoryGetObjectV2Response:
        """Create an instance of VersionhistoryGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VersionhistoryGetObjectV2Response.parse_obj(obj)

        _obj = VersionhistoryGetObjectV2Response.parse_obj({
            ...
            "m_payload": VersionhistoryGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
