...
class EzsigntemplateformfieldRequestCompound(BaseModel):
    """
    An Ezsigntemplateformfield Object and children to create a complete structure  # noqa: E501
    """
    pki_ezsigntemplateformfield_id: Optional[conint(strict=True, ge=0)] = Field(None, alias="pkiEzsigntemplateformfieldID", description="The unique ID of the Ezsigntemplateformfield")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplateformfieldRequestCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplateformfieldRequestCompound:
        """Create an instance of EzsigntemplateformfieldRequestCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplateformfieldRequestCompound.parse_obj(obj)

        _obj = EzsigntemplateformfieldRequestCompound.parse_obj({
