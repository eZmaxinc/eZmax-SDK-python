...
class EzsignfolderGetFormsDataV1Response(BaseModel):
    """
    Response for GET /1/object/ezsignfolder/{pkiEzsignfolder}/getFormsData  # noqa: E501
    """
    ...
    m_payload: EzsignfolderGetFormsDataV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderGetFormsDataV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderGetFormsDataV1Response:
        """Create an instance of EzsignfolderGetFormsDataV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderGetFormsDataV1Response.parse_obj(obj)

        _obj = EzsignfolderGetFormsDataV1Response.parse_obj({
            ...
            "m_payload": EzsignfolderGetFormsDataV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
