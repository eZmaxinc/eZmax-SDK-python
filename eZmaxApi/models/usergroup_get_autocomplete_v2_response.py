...
class UsergroupGetAutocompleteV2Response(BaseModel):
    """
    Response for GET /2/object/usergroup/getAutocomplete  # noqa: E501
    """
    ...
    m_payload: UsergroupGetAutocompleteV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsergroupGetAutocompleteV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsergroupGetAutocompleteV2Response:
        """Create an instance of UsergroupGetAutocompleteV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsergroupGetAutocompleteV2Response.parse_obj(obj)

        _obj = UsergroupGetAutocompleteV2Response.parse_obj({
            ...
            "m_payload": UsergroupGetAutocompleteV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
