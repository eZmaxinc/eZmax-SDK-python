...
class MultilingualPaymentgatewayDescription(BaseModel):
    """
    ...
    def s_paymentgateway_description1_validate_regular_expression(cls, value):
    ...
    @field_validator('s_paymentgateway_description2')
    def s_paymentgateway_description2_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sPaymentgatewayDescription1": obj.get("sPaymentgatewayDescription1"),
            "sPaymentgatewayDescription2": obj.get("sPaymentgatewayDescription2")
        })
        return _obj
