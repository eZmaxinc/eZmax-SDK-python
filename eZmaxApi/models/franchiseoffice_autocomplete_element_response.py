...
class FranchiseofficeAutocompleteElementResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sFranchiseofficeDescription": obj.get("sFranchiseofficeDescription"),
            "pkiFranchiseofficeID": obj.get("pkiFranchiseofficeID"),
            "bFranchiseofficeIsactive": obj.get("bFranchiseofficeIsactive")
        })
        return _obj
