...
class EzsigndocumentGetEzsignannotationsV1ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objEzsignannotation": [EzsignannotationResponseCompound.from_dict(_item) for _item in obj.get("a_objEzsignannotation")] if obj.get("a_objEzsignannotation") is not None else None
        })
        return _obj
