...
class ElectronicfundstransferGetCommunicationListV1Response(BaseModel):
    """
    Response for GET /1/object/electronicfundstransfer/{pkiElectronicfundstransferID}/getCommunicationList  # noqa: E501
    """
    ...
    m_payload: ElectronicfundstransferGetCommunicationListV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ElectronicfundstransferGetCommunicationListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ElectronicfundstransferGetCommunicationListV1Response:
        """Create an instance of ElectronicfundstransferGetCommunicationListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ElectronicfundstransferGetCommunicationListV1Response.parse_obj(obj)

        _obj = ElectronicfundstransferGetCommunicationListV1Response.parse_obj({
            ...
            "m_payload": ElectronicfundstransferGetCommunicationListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
