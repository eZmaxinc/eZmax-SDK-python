...
class EmailtypeGetAutocompleteV2Response(BaseModel):
    """
    Response for GET /2/object/emailtype/getAutocomplete  # noqa: E501
    """
    ...
    m_payload: EmailtypeGetAutocompleteV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EmailtypeGetAutocompleteV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EmailtypeGetAutocompleteV2Response:
        """Create an instance of EmailtypeGetAutocompleteV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EmailtypeGetAutocompleteV2Response.parse_obj(obj)

        _obj = EmailtypeGetAutocompleteV2Response.parse_obj({
            ...
            "m_payload": EmailtypeGetAutocompleteV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
