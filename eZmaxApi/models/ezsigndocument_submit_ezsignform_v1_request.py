...
class EzsigndocumentSubmitEzsignformV1Request(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "a_objEzsignformfieldgroup": [CustomEzsignformfieldgroupRequest.from_dict(_item) for _item in obj.get("a_objEzsignformfieldgroup")] if obj.get("a_objEzsignformfieldgroup") is not None else None
        })
        return _obj
