...
class EzsigntemplatedocumentCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/ezsigntemplatedocument  # noqa: E501
    """
    ...
    m_payload: EzsigntemplatedocumentCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatedocumentCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatedocumentCreateObjectV1Response:
        """Create an instance of EzsigntemplatedocumentCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatedocumentCreateObjectV1Response.parse_obj(obj)

        _obj = EzsigntemplatedocumentCreateObjectV1Response.parse_obj({
            ...
            "m_payload": EzsigntemplatedocumentCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
