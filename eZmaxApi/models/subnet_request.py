...
class SubnetRequest(BaseModel):
    ...
    A Subnet Object
    """ # noqa: E501
    pki_subnet_id: Optional[Annotated[int, Field(le=65535, strict=True, ge=0)]] = Field(default=None, description="The unique ID of the Subnet", alias="pkiSubnetID", json_schema_extra={"examples": [3]})
