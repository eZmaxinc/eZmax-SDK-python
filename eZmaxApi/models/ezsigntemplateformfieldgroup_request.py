...
class EzsigntemplateformfieldgroupRequest(BaseModel):
    ...
    """ # noqa: E501
    pki_ezsigntemplateformfieldgroup_id: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The unique ID of the Ezsigntemplateformfieldgroup", alias="pkiEzsigntemplateformfieldgroupID", json_schema_extra={"examples": [64]})
