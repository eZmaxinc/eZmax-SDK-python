...
class UserstagedGetObjectV2Response(BaseModel):
    """
    Response for GET /2/object/userstaged/{pkiUserstagedID}  # noqa: E501
    """
    ...
    m_payload: UserstagedGetObjectV2ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserstagedGetObjectV2Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserstagedGetObjectV2Response:
        """Create an instance of UserstagedGetObjectV2Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserstagedGetObjectV2Response.parse_obj(obj)

        _obj = UserstagedGetObjectV2Response.parse_obj({
            ...
            "m_payload": UserstagedGetObjectV2ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
