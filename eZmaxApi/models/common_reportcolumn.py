...
class CommonReportcolumn(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "objReportcellstyleDefault": CommonReportcellstyle.from_dict(obj.get("objReportcellstyleDefault")) if obj.get("objReportcellstyleDefault") is not None else None,
