...
class SubnetEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/subnet/{pkiSubnetID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubnetEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubnetEditObjectV1Response:
        """Create an instance of SubnetEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubnetEditObjectV1Response.parse_obj(obj)

        _obj = SubnetEditObjectV1Response.parse_obj({
