...
class InfrastructureregionAutocompleteElementResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pkiInfrastructureregionID": obj.get("pkiInfrastructureregionID"),
            "sInfrastructureregionCode": obj.get("sInfrastructureregionCode"),
            "bInfrastructureregionProgrammer": obj.get("bInfrastructureregionProgrammer"),
            "bInfrastructureregionIsactive": obj.get("bInfrastructureregionIsactive")
        })
        return _obj
