...
class WebhookEditObjectV1Response(BaseModel):
    """
    Response for PUT /1/object/webhook/{pkiWebhookID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhookEditObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookEditObjectV1Response:
        """Create an instance of WebhookEditObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookEditObjectV1Response.parse_obj(obj)

        _obj = WebhookEditObjectV1Response.parse_obj({
