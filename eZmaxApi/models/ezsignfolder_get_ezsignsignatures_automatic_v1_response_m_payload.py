...
class EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload(BaseModel):
    """
    Payload for GET /1/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignsignaturesAutomatic  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload:
        """Create an instance of EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload.parse_obj(obj)

        _obj = EzsignfolderGetEzsignsignaturesAutomaticV1ResponseMPayload.parse_obj({
