...
class EzsigntemplatepackagesignerRequestCompound(BaseModel):
    """
    A Ezsigntemplatepackagesigner Object and children  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigntemplatepackagesignerRequestCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigntemplatepackagesignerRequestCompound:
        """Create an instance of EzsigntemplatepackagesignerRequestCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigntemplatepackagesignerRequestCompound.parse_obj(obj)

        _obj = EzsigntemplatepackagesignerRequestCompound.parse_obj({
