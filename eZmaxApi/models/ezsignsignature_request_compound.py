...
class EzsignsignatureRequestCompound(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignsignatureRequestCompound:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignsignatureRequestCompound:
        """Create an instance of EzsignsignatureRequestCompound from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignsignatureRequestCompound.parse_obj(obj)

        _obj = EzsignsignatureRequestCompound.parse_obj({
