...
class EzsigntemplatepublicResponseCompound(BaseModel):
    ...
    s_userlogintype_description_x: StrictStr = Field(description="The description of the Userlogintype in the language of the requester", alias="sUserlogintypeDescriptionX", json_schema_extra={"examples": ["Email and phone or SMS"]})
