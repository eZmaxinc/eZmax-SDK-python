...
class WebhookEzsignEzsignsignerAcceptclause(BaseModel):
    """
    ...
    obj_ezsignfolder: Optional[EzsignfolderResponse] = Field(None, alias="objEzsignfolder")
    ...
    __properties = ["objWebhook", "a_objAttempt", "objEzsignfolder", "objEzsignfoldersignerassociation"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhookEzsignEzsignsignerAcceptclause:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookEzsignEzsignsignerAcceptclause:
        """Create an instance of WebhookEzsignEzsignsignerAcceptclause from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookEzsignEzsignsignerAcceptclause.parse_obj(obj)

        _obj = WebhookEzsignEzsignsignerAcceptclause.parse_obj({
