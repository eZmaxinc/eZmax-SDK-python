...
class EzsigndocumentGetTemporaryProofV1ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objEzsigndocumentlog": [EzsigndocumentlogResponseCompound.from_dict(_item) for _item in obj.get("a_objEzsigndocumentlog")] if obj.get("a_objEzsigndocumentlog") is not None else None
        })
        return _obj
