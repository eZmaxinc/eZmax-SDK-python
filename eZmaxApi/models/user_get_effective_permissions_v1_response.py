...
class UserGetEffectivePermissionsV1Response(BaseModel):
    ...
    m_payload: UserGetEffectivePermissionsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserGetEffectivePermissionsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserGetEffectivePermissionsV1Response:
        """Create an instance of UserGetEffectivePermissionsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserGetEffectivePermissionsV1Response.parse_obj(obj)

        _obj = UserGetEffectivePermissionsV1Response.parse_obj({
            ...
            "m_payload": UserGetEffectivePermissionsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
