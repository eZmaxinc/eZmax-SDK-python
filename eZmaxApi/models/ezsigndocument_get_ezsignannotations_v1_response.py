...
class EzsigndocumentGetEzsignannotationsV1Response(BaseModel):
    """
    Response for GET /1/object/ezsigndocument/{pkiEzsigndocument}/getEzsignannotations  # noqa: E501
    """
    ...
    m_payload: EzsigndocumentGetEzsignannotationsV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentGetEzsignannotationsV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentGetEzsignannotationsV1Response:
        """Create an instance of EzsigndocumentGetEzsignannotationsV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentGetEzsignannotationsV1Response.parse_obj(obj)

        _obj = EzsigndocumentGetEzsignannotationsV1Response.parse_obj({
            ...
            "m_payload": EzsigndocumentGetEzsignannotationsV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
