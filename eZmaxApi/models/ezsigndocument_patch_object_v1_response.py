...
class EzsigndocumentPatchObjectV1Response(BaseModel):
    """
    Response for PATCH /1/object/ezsigndocument/{pkiEzsigndocumentID}  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsigndocumentPatchObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsigndocumentPatchObjectV1Response:
        """Create an instance of EzsigndocumentPatchObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsigndocumentPatchObjectV1Response.parse_obj(obj)

        _obj = EzsigndocumentPatchObjectV1Response.parse_obj({
