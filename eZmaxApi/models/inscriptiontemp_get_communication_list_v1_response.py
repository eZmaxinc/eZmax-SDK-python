...
class InscriptiontempGetCommunicationListV1Response(BaseModel):
    """
    ...
    m_payload: InscriptiontempGetCommunicationListV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InscriptiontempGetCommunicationListV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InscriptiontempGetCommunicationListV1Response:
        """Create an instance of InscriptiontempGetCommunicationListV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InscriptiontempGetCommunicationListV1Response.parse_obj(obj)

        _obj = InscriptiontempGetCommunicationListV1Response.parse_obj({
            ...
            "m_payload": InscriptiontempGetCommunicationListV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
