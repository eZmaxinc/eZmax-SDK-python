...
class LanguageGetAutocompleteV2ResponseMPayload(BaseModel):
    ...
    """ # noqa: E501
    a_obj_language: List[LanguageAutocompleteElementResponse] = Field(description="An array of Language autocomplete element response.", alias="a_objLanguage")
    __properties: ClassVar[List[str]] = ["a_objLanguage"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objLanguage": [LanguageAutocompleteElementResponse.from_dict(_item) for _item in obj.get("a_objLanguage")] if obj.get("a_objLanguage") is not None else None
        })
        return _obj
