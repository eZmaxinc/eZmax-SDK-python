...
class EzsignsignergroupCreateObjectV1ResponseMPayload(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_pkiEzsignsignergroupID": obj.get("a_pkiEzsignsignergroupID")
        })
        return _obj
