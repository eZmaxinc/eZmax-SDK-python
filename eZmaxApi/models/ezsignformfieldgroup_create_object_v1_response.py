...
class EzsignformfieldgroupCreateObjectV1Response(BaseModel):
    """
    Response for POST /1/object/ezsignformfieldgroup  # noqa: E501
    """
    ...
    m_payload: EzsignformfieldgroupCreateObjectV1ResponseMPayload = Field(..., alias="mPayload")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EzsignformfieldgroupCreateObjectV1Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EzsignformfieldgroupCreateObjectV1Response:
        """Create an instance of EzsignformfieldgroupCreateObjectV1Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EzsignformfieldgroupCreateObjectV1Response.parse_obj(obj)

        _obj = EzsignformfieldgroupCreateObjectV1Response.parse_obj({
            ...
            "m_payload": EzsignformfieldgroupCreateObjectV1ResponseMPayload.from_dict(obj.get("mPayload")) if obj.get("mPayload") is not None else None
        })
        return _obj
