...
class InvoiceGetCommunicationListV1ResponseMPayload(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InvoiceGetCommunicationListV1ResponseMPayload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InvoiceGetCommunicationListV1ResponseMPayload:
        """Create an instance of InvoiceGetCommunicationListV1ResponseMPayload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InvoiceGetCommunicationListV1ResponseMPayload.parse_obj(obj)

        _obj = InvoiceGetCommunicationListV1ResponseMPayload.parse_obj({
