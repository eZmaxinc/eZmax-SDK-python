...
class EzsigntemplateformfieldgroupsignerRequestCompound(BaseModel):
    ...
    """ # noqa: E501
    pki_ezsigntemplateformfieldgroupsigner_id: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The unique ID of the Ezsigntemplateformfieldgroupsigner", alias="pkiEzsigntemplateformfieldgroupsignerID", json_schema_extra={"examples": [87]})
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pkiEzsigntemplateformfieldgroupsignerID": obj.get("pkiEzsigntemplateformfieldgroupsignerID"),
