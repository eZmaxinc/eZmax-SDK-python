...
class EzsignformfieldgroupCreateObjectV1Request(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "a_objEzsignformfieldgroup": [EzsignformfieldgroupRequestCompound.from_dict(_item) for _item in obj["a_objEzsignformfieldgroup"]] if obj.get("a_objEzsignformfieldgroup") is not None else None
        })
        return _obj
