...
class EzsignformfieldgroupCreateObjectV1Request(BaseModel):
    ...
    """ # noqa: E501
    a_obj_ezsignformfieldgroup: Annotated[List[EzsignformfieldgroupRequestCompound], Field(min_length=1)] = Field(alias="a_objEzsignformfieldgroup")
    __properties: ClassVar[List[str]] = ["a_objEzsignformfieldgroup"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "a_objEzsignformfieldgroup": [EzsignformfieldgroupRequestCompound.from_dict(_item) for _item in obj.get("a_objEzsignformfieldgroup")] if obj.get("a_objEzsignformfieldgroup") is not None else None
        })
        return _obj
