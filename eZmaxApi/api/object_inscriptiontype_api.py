...
class ObjectInscriptiontypeApi:
    ...
    @validate_call
    def inscriptiontype_get_autocomplete_v2(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Inscriptiontypes to return")],
        ...
        :param s_selector: The type of Inscriptiontypes to return (required)
        :type s_selector: str
        ...
        _param = self._inscriptiontype_get_autocomplete_v2_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "InscriptiontypeGetAutocompleteV2Response",
        }
    ...
    @validate_call
    def inscriptiontype_get_autocomplete_v2_with_http_info(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Inscriptiontypes to return")],
        s_query: Annotated[Optional[StrictStr], Field(description="Allow to filter the returned results")] = None,
        accept_language: Optional[HeaderAcceptLanguage] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[InscriptiontypeGetAutocompleteV2Response]:
        """Retrieve Inscriptiontypes and IDs
    ...
    @validate_call
    def inscriptiontype_get_autocomplete_v2_without_preload_content(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Inscriptiontypes to return")],
        s_query: Annotated[Optional[StrictStr], Field(description="Allow to filter the returned results")] = None,
        accept_language: Optional[HeaderAcceptLanguage] = None,
    ...
    def _inscriptiontype_get_autocomplete_v2_serialize(
        self,
        s_selector,
        s_query,
        accept_language,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/2/object/inscriptiontype/getAutocomplete/{sSelector}',
