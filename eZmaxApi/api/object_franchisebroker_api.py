...
class ObjectFranchisebrokerApi:
    ...
    @validate_call
    def franchisebroker_get_autocomplete_v1(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Franchisebrokers to return")],
        ...
        """(Deprecated) Retrieve Franchisebrokers and IDs
        ...
        _param = self._franchisebroker_get_autocomplete_v1_serialize(
    ...
    @validate_call
    def franchisebroker_get_autocomplete_v1_without_preload_content(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Franchisebrokers to return")],
        e_filter_active: Annotated[Optional[StrictStr], Field(description="Specify which results we want to display.")] = None,
        s_query: Annotated[Optional[StrictStr], Field(description="Allow to filter the returned results")] = None,
    ...
    def _franchisebroker_get_autocomplete_v1_serialize(
        self,
        s_selector,
        e_filter_active,
        s_query,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/1/object/franchisebroker/getAutocomplete/{sSelector}',
    ...
    def franchisebroker_get_autocomplete_v2(
        ...
        _param = self._franchisebroker_get_autocomplete_v2_serialize(
            s_selector=s_selector,
            e_filter_active=e_filter_active,
            s_query=s_query,
            accept_language=accept_language,
    ...
    @validate_call
    def franchisebroker_get_autocomplete_v2_with_http_info(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Franchisebrokers to return")],
        e_filter_active: Annotated[Optional[StrictStr], Field(description="Specify which results we want to display.")] = None,
        s_query: Annotated[Optional[StrictStr], Field(description="Allow to filter the returned results")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FranchisebrokerGetAutocompleteV2Response]:
        """Retrieve Franchisebrokers and IDs
    ...
    @validate_call
    def franchisebroker_get_autocomplete_v2_without_preload_content(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Franchisebrokers to return")],
        e_filter_active: Annotated[Optional[StrictStr], Field(description="Specify which results we want to display.")] = None,
        s_query: Annotated[Optional[StrictStr], Field(description="Allow to filter the returned results")] = None,
    ...
    def _franchisebroker_get_autocomplete_v2_serialize(
        self,
        s_selector,
        e_filter_active,
        s_query,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/2/object/franchisebroker/getAutocomplete/{sSelector}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
