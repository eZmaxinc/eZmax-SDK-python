...
class ObjectAgentApi:
    ...
    @validate_call
    def agent_get_autocomplete_v2(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Agents to return")],
        ...
        :param s_selector: The type of Agents to return (required)
        :type s_selector: str
        ...
        _param = self._agent_get_autocomplete_v2_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AgentGetAutocompleteV2Response",
        }
    ...
    @validate_call
    def agent_get_autocomplete_v2_with_http_info(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Agents to return")],
        e_filter_active: Annotated[Optional[StrictStr], Field(description="Specify which results we want to display.")] = None,
        s_query: Annotated[Optional[StrictStr], Field(description="Allow to filter the returned results")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AgentGetAutocompleteV2Response]:
        """Retrieve Agents and IDs
    ...
    @validate_call
    def agent_get_autocomplete_v2_without_preload_content(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Agents to return")],
        e_filter_active: Annotated[Optional[StrictStr], Field(description="Specify which results we want to display.")] = None,
        s_query: Annotated[Optional[StrictStr], Field(description="Allow to filter the returned results")] = None,
    ...
    def _agent_get_autocomplete_v2_serialize(
        self,
        s_selector,
        e_filter_active,
        s_query,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/2/object/agent/getAutocomplete/{sSelector}',
    ...
    def agent_get_list_v1(
        ...
        _param = self._agent_get_list_v1_serialize(
    ...
    @validate_call
    def agent_get_list_v1_with_http_info(
        self,
        e_order_by: Annotated[Optional[StrictStr], Field(description="Specify how you want the results to be sorted")] = None,
        i_row_max: Optional[Annotated[int, Field(le=10000, strict=True, ge=1)]] = None,
        i_row_offset: Optional[Annotated[int, Field(strict=True, ge=0)]] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AgentGetListV1Response]:
        """Retrieve Agent list
    ...
    @validate_call
    def agent_get_list_v1_without_preload_content(
        self,
        e_order_by: Annotated[Optional[StrictStr], Field(description="Specify how you want the results to be sorted")] = None,
        i_row_max: Optional[Annotated[int, Field(le=10000, strict=True, ge=1)]] = None,
        i_row_offset: Optional[Annotated[int, Field(strict=True, ge=0)]] = None,
    ...
    def _agent_get_list_v1_serialize(
        self,
        e_order_by,
        i_row_max,
        i_row_offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/1/object/agent/getList',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def agent_import_into_edmv1(
        self,
        pki_agent_id: Annotated[int, Field(strict=True, ge=0)],
        agent_import_into_edmv1_request: AgentImportIntoEDMV1Request,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param pki_agent_id: (required)
        :type pki_agent_id: int
        :param agent_import_into_edmv1_request: (required)
        :type agent_import_into_edmv1_request: AgentImportIntoEDMV1Request
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._agent_import_into_edmv1_serialize(
            pki_agent_id=pki_agent_id,
            agent_import_into_edmv1_request=agent_import_into_edmv1_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AgentImportIntoEDMV1Response",
    ...
    @validate_call
    def agent_import_into_edmv1_with_http_info(
        self,
        pki_agent_id: Annotated[int, Field(strict=True, ge=0)],
        agent_import_into_edmv1_request: AgentImportIntoEDMV1Request,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AgentImportIntoEDMV1Response]:
        """Import attachments into the Agent
    ...
    @validate_call
    def agent_import_into_edmv1_without_preload_content(
        self,
        pki_agent_id: Annotated[int, Field(strict=True, ge=0)],
        agent_import_into_edmv1_request: AgentImportIntoEDMV1Request,
        _request_timeout: Union[
    ...
    def _agent_import_into_edmv1_serialize(
        self,
        pki_agent_id,
        ...
        # process the path parameters
        if pki_agent_id is not None:
            _path_params['pkiAgentID'] = pki_agent_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        if agent_import_into_edmv1_request is not None:
            _body_params = agent_import_into_edmv1_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/1/object/agent/{pkiAgentID}/importIntoEDM',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
