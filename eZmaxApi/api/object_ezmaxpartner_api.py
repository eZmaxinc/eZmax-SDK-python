...
class ObjectEzmaxpartnerApi:
    ...
    @validate_call
    def ezmaxpartner_get_custom_developpers_v1(
        self,
        ...
        _param = self._ezmaxpartner_get_custom_developpers_v1_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "EzmaxpartnerGetCustomDeveloppersV1Response",
    ...
    @validate_call
    def ezmaxpartner_get_custom_developpers_v1_with_http_info(
        self,
        e_order_by: Annotated[Optional[StrictStr], Field(description="Specify how you want the results to be sorted")] = None,
        i_row_max: Optional[Annotated[int, Field(le=10000, strict=True, ge=1)]] = None,
        i_row_offset: Optional[Annotated[int, Field(strict=True, ge=0)]] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EzmaxpartnerGetCustomDeveloppersV1Response]:
        """Retrieve Ezmaxpartner custom developpers list
    ...
    @validate_call
    def ezmaxpartner_get_custom_developpers_v1_without_preload_content(
        self,
        e_order_by: Annotated[Optional[StrictStr], Field(description="Specify how you want the results to be sorted")] = None,
        i_row_max: Optional[Annotated[int, Field(le=10000, strict=True, ge=1)]] = None,
        i_row_offset: Optional[Annotated[int, Field(strict=True, ge=0)]] = None,
    ...
    def _ezmaxpartner_get_custom_developpers_v1_serialize(
        self,
        e_order_by,
        i_row_max,
        i_row_offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/1/object/ezmaxpartner/getCustomDeveloppers',
    ...
    @validate_call
    def ezmaxpartner_get_object_v2(
        self,
        pki_ezmaxpartner_id: Annotated[int, Field(strict=True, ge=1, description="The unique ID of the Ezmaxpartner")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param pki_ezmaxpartner_id: The unique ID of the Ezmaxpartner (required)
        :type pki_ezmaxpartner_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._ezmaxpartner_get_object_v2_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "EzmaxpartnerGetObjectV2Response",
    ...
    @validate_call
    def ezmaxpartner_get_object_v2_with_http_info(
        self,
        pki_ezmaxpartner_id: Annotated[int, Field(strict=True, ge=1, description="The unique ID of the Ezmaxpartner")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EzmaxpartnerGetObjectV2Response]:
        """Retrieve an existing Ezmaxpartner
    ...
    @validate_call
    def ezmaxpartner_get_object_v2_without_preload_content(
        self,
        pki_ezmaxpartner_id: Annotated[int, Field(strict=True, ge=1, description="The unique ID of the Ezmaxpartner")],
        _request_timeout: Union[
            None,
    ...
    def _ezmaxpartner_get_object_v2_serialize(
        self,
        pki_ezmaxpartner_id,
        _request_auth,
        _content_type,
        ...
        # process the path parameters
        if pki_ezmaxpartner_id is not None:
            _path_params['pkiEzmaxpartnerID'] = pki_ezmaxpartner_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/2/object/ezmaxpartner/{pkiEzmaxpartnerID}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
