...
class ObjectEzsignfoldertypeApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.ezsignfoldertype_create_object_v1_endpoint = _Endpoint(
            settings={
                'response_type': (EzsignfoldertypeCreateObjectV1Response,),
                'auth': [
                    'Authorization'
                ],
                'endpoint_path': '/1/object/ezsignfoldertype',
                'operation_id': 'ezsignfoldertype_create_object_v1',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'ezsignfoldertype_create_object_v1_request': 'body',
                },
        ...
        self.ezsignfoldertype_edit_object_v1_endpoint = _Endpoint(
            settings={
                'response_type': (EzsignfoldertypeEditObjectV1Response,),
                'auth': [
                    'Authorization'
                ],
                'endpoint_path': '/1/object/ezsignfoldertype/{pkiEzsignfoldertypeID}',
                'operation_id': 'ezsignfoldertype_edit_object_v1',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'pki_ezsignfoldertype_id': 'path',
                    'ezsignfoldertype_edit_object_v1_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.ezsignfoldertype_get_autocomplete_v2_endpoint = _Endpoint(
            settings={
                'response_type': (EzsignfoldertypeGetAutocompleteV2Response,),
                'auth': [
                    'Authorization'
                ],
                'endpoint_path': '/2/object/ezsignfoldertype/getAutocomplete/{sSelector}',
                'operation_id': 'ezsignfoldertype_get_autocomplete_v2',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.ezsignfoldertype_get_object_v1_endpoint = _Endpoint(
            settings={
                'response_type': (EzsignfoldertypeGetObjectV1Response,),
                'auth': [
                    'Authorization'
                ],
                'endpoint_path': '/1/object/ezsignfoldertype/{pkiEzsignfoldertypeID}',
                'operation_id': 'ezsignfoldertype_get_object_v1',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.ezsignfoldertype_get_object_v2_endpoint = _Endpoint(
            settings={
                'response_type': (EzsignfoldertypeGetObjectV2Response,),
                'auth': [
                    'Authorization'
                ],
                'endpoint_path': '/2/object/ezsignfoldertype/{pkiEzsignfoldertypeID}',
                'operation_id': 'ezsignfoldertype_get_object_v2',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def ezsignfoldertype_create_object_v1(
        ...
        **kwargs
        ...
        kwargs['ezsignfoldertype_create_object_v1_request'] = \
            ezsignfoldertype_create_object_v1_request
        return self.ezsignfoldertype_create_object_v1_endpoint.call_with_http_info(**kwargs)
    ...
    def ezsignfoldertype_edit_object_v1(
        ...
        **kwargs
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        kwargs['pki_ezsignfoldertype_id'] = \
            pki_ezsignfoldertype_id
        kwargs['ezsignfoldertype_edit_object_v1_request'] = \
            ezsignfoldertype_edit_object_v1_request
        return self.ezsignfoldertype_edit_object_v1_endpoint.call_with_http_info(**kwargs)
    ...
    def ezsignfoldertype_get_autocomplete_v2(
        ...
        **kwargs
        ...
        >>> thread = api.ezsignfoldertype_get_autocomplete_v2(s_selector, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['s_selector'] = \
            s_selector
        return self.ezsignfoldertype_get_autocomplete_v2_endpoint.call_with_http_info(**kwargs)
    ...
    def ezsignfoldertype_get_object_v1(
        self,
        pki_ezsignfoldertype_id,
        **kwargs
    ):
        ...
        >>> thread = api.ezsignfoldertype_get_object_v1(pki_ezsignfoldertype_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['pki_ezsignfoldertype_id'] = \
            pki_ezsignfoldertype_id
        return self.ezsignfoldertype_get_object_v1_endpoint.call_with_http_info(**kwargs)
    ...
    def ezsignfoldertype_get_object_v2(
        ...
        **kwargs
        ...
        kwargs['pki_ezsignfoldertype_id'] = \
            pki_ezsignfoldertype_id
        return self.ezsignfoldertype_get_object_v2_endpoint.call_with_http_info(**kwargs)
