...
class ObjectEzsignfolderApi:
    ...
    @validate_arguments
    def ezsignfolder_get_ezsignfoldersignerassociationsmine_v1(self, pki_ezsignfolder_id : conint(strict=True, ge=0), **kwargs) -> EzsignfolderGetEzsignfoldersignerassociationsmineV1Response:  # noqa: E501
        ...
        >>> thread = api.ezsignfolder_get_ezsignfoldersignerassociationsmine_v1(pki_ezsignfolder_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: EzsignfolderGetEzsignfoldersignerassociationsmineV1Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the ezsignfolder_get_ezsignfoldersignerassociationsmine_v1_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.ezsignfolder_get_ezsignfoldersignerassociationsmine_v1_with_http_info(pki_ezsignfolder_id, **kwargs)  # noqa: E501

    @validate_arguments
    def ezsignfolder_get_ezsignfoldersignerassociationsmine_v1_with_http_info(self, pki_ezsignfolder_id : conint(strict=True, ge=0), **kwargs) -> ApiResponse:  # noqa: E501
        """Retrieve your own Ezsignfoldersignerassociations from an existing Ezsignfolder  # noqa: E501
        ...
        >>> thread = api.ezsignfolder_get_ezsignfoldersignerassociationsmine_v1_with_http_info(pki_ezsignfolder_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(EzsignfolderGetEzsignfoldersignerassociationsmineV1Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method ezsignfolder_get_ezsignfoldersignerassociationsmine_v1" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "EzsignfolderGetEzsignfoldersignerassociationsmineV1Response",
            '404': "CommonResponseError",
        }
