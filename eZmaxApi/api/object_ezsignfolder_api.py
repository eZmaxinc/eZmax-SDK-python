...
class ObjectEzsignfolderApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.ezsignfolder_get_object_v2_endpoint = _Endpoint(
            settings={
                'response_type': (EzsignfolderGetObjectV2Response,),
                'auth': [
                    'Authorization'
                ],
                'endpoint_path': '/2/object/ezsignfolder/{pkiEzsignfolderID}',
                'operation_id': 'ezsignfolder_get_object_v2',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.ezsignfolder_send_v3_endpoint = _Endpoint(
            settings={
                'response_type': (EzsignfolderSendV3Response,),
                'auth': [
                    'Authorization'
                ],
                'endpoint_path': '/3/object/ezsignfolder/{pkiEzsignfolderID}/send',
                'operation_id': 'ezsignfolder_send_v3',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'pki_ezsignfolder_id': 'path',
                    'ezsignfolder_send_v3_request': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def ezsignfolder_get_object_v2(
        ...
        **kwargs
        ...
        kwargs['pki_ezsignfolder_id'] = \
            pki_ezsignfolder_id
        return self.ezsignfolder_get_object_v2_endpoint.call_with_http_info(**kwargs)
    ...
    def ezsignfolder_send_v3(
        ...
        **kwargs
        ...
        kwargs['pki_ezsignfolder_id'] = \
            pki_ezsignfolder_id
        kwargs['ezsignfolder_send_v3_request'] = \
            ezsignfolder_send_v3_request
        return self.ezsignfolder_send_v3_endpoint.call_with_http_info(**kwargs)
