...
class ObjectEmployeeApi:
    ...
    def employee_get_list_v1(
        ...
        _param = self._employee_get_list_v1_serialize(
    ...
    @validate_call
    def employee_get_list_v1_with_http_info(
        self,
        e_order_by: Annotated[Optional[StrictStr], Field(description="Specify how you want the results to be sorted")] = None,
        i_row_max: Optional[Annotated[int, Field(le=10000, strict=True, ge=1)]] = None,
        i_row_offset: Optional[Annotated[int, Field(strict=True, ge=0)]] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EmployeeGetListV1Response]:
        """Retrieve Employee list
    ...
    @validate_call
    def employee_get_list_v1_without_preload_content(
        self,
        e_order_by: Annotated[Optional[StrictStr], Field(description="Specify how you want the results to be sorted")] = None,
        i_row_max: Optional[Annotated[int, Field(le=10000, strict=True, ge=1)]] = None,
        i_row_offset: Optional[Annotated[int, Field(strict=True, ge=0)]] = None,
    ...
    def _employee_get_list_v1_serialize(
        self,
        e_order_by,
        i_row_max,
        i_row_offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/1/object/employee/getList',
    ...
    @validate_call
    def employee_import_into_edmv1(
        self,
        pki_employee_id: Annotated[int, Field(strict=True, ge=0)],
        employee_import_into_edmv1_request: EmployeeImportIntoEDMV1Request,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param pki_employee_id: (required)
        :type pki_employee_id: int
        :param employee_import_into_edmv1_request: (required)
        :type employee_import_into_edmv1_request: EmployeeImportIntoEDMV1Request
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._employee_import_into_edmv1_serialize(
            pki_employee_id=pki_employee_id,
            employee_import_into_edmv1_request=employee_import_into_edmv1_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "EmployeeImportIntoEDMV1Response",
    ...
    @validate_call
    def employee_import_into_edmv1_with_http_info(
        self,
        pki_employee_id: Annotated[int, Field(strict=True, ge=0)],
        employee_import_into_edmv1_request: EmployeeImportIntoEDMV1Request,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EmployeeImportIntoEDMV1Response]:
        """Import attachments into the Employee
    ...
    @validate_call
    def employee_import_into_edmv1_without_preload_content(
        self,
        pki_employee_id: Annotated[int, Field(strict=True, ge=0)],
        employee_import_into_edmv1_request: EmployeeImportIntoEDMV1Request,
        _request_timeout: Union[
    ...
    def _employee_import_into_edmv1_serialize(
        self,
        pki_employee_id,
        ...
        # process the path parameters
        if pki_employee_id is not None:
            _path_params['pkiEmployeeID'] = pki_employee_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        if employee_import_into_edmv1_request is not None:
            _body_params = employee_import_into_edmv1_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/1/object/employee/{pkiEmployeeID}/importIntoEDM',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
