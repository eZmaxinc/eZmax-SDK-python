...
class ObjectGlaccountcontainerApi:
    ...
    @validate_call
    def glaccountcontainer_get_autocomplete_v2(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Glaccountcontainers to return")],
        ...
        :param s_selector: The type of Glaccountcontainers to return (required)
        :type s_selector: str
        ...
        _param = self._glaccountcontainer_get_autocomplete_v2_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GlaccountcontainerGetAutocompleteV2Response",
        }
    ...
    @validate_call
    def glaccountcontainer_get_autocomplete_v2_with_http_info(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Glaccountcontainers to return")],
        e_filter_active: Annotated[Optional[StrictStr], Field(description="Specify which results we want to display.")] = None,
        s_query: Annotated[Optional[StrictStr], Field(description="Allow to filter the returned results")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GlaccountcontainerGetAutocompleteV2Response]:
        """Retrieve Glaccountcontainers and IDs
    ...
    @validate_call
    def glaccountcontainer_get_autocomplete_v2_without_preload_content(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Glaccountcontainers to return")],
        e_filter_active: Annotated[Optional[StrictStr], Field(description="Specify which results we want to display.")] = None,
        s_query: Annotated[Optional[StrictStr], Field(description="Allow to filter the returned results")] = None,
    ...
    def _glaccountcontainer_get_autocomplete_v2_serialize(
        self,
        s_selector,
        e_filter_active,
        s_query,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/2/object/glaccountcontainer/getAutocomplete/{sSelector}',
