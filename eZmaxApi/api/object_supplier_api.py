...
class ObjectSupplierApi:
    ...
    def supplier_get_list_v1(
        ...
        _param = self._supplier_get_list_v1_serialize(
    ...
    @validate_call
    def supplier_get_list_v1_with_http_info(
        self,
        e_order_by: Annotated[Optional[StrictStr], Field(description="Specify how you want the results to be sorted")] = None,
        i_row_max: Optional[Annotated[int, Field(le=10000, strict=True, ge=1)]] = None,
        i_row_offset: Optional[Annotated[int, Field(strict=True, ge=0)]] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SupplierGetListV1Response]:
        """Retrieve Supplier list
    ...
    @validate_call
    def supplier_get_list_v1_without_preload_content(
        self,
        e_order_by: Annotated[Optional[StrictStr], Field(description="Specify how you want the results to be sorted")] = None,
        i_row_max: Optional[Annotated[int, Field(le=10000, strict=True, ge=1)]] = None,
        i_row_offset: Optional[Annotated[int, Field(strict=True, ge=0)]] = None,
    ...
    def _supplier_get_list_v1_serialize(
        self,
        e_order_by,
        i_row_max,
        i_row_offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/1/object/supplier/getList',
    ...
    @validate_call
    def supplier_import_into_edmv1(
        self,
        pki_supplier_id: Annotated[int, Field(strict=True, ge=0)],
        supplier_import_into_edmv1_request: SupplierImportIntoEDMV1Request,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param pki_supplier_id: (required)
        :type pki_supplier_id: int
        :param supplier_import_into_edmv1_request: (required)
        :type supplier_import_into_edmv1_request: SupplierImportIntoEDMV1Request
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._supplier_import_into_edmv1_serialize(
            pki_supplier_id=pki_supplier_id,
            supplier_import_into_edmv1_request=supplier_import_into_edmv1_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SupplierImportIntoEDMV1Response",
    ...
    @validate_call
    def supplier_import_into_edmv1_with_http_info(
        self,
        pki_supplier_id: Annotated[int, Field(strict=True, ge=0)],
        supplier_import_into_edmv1_request: SupplierImportIntoEDMV1Request,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SupplierImportIntoEDMV1Response]:
        """Import attachments into the Supplier
    ...
    @validate_call
    def supplier_import_into_edmv1_without_preload_content(
        self,
        pki_supplier_id: Annotated[int, Field(strict=True, ge=0)],
        supplier_import_into_edmv1_request: SupplierImportIntoEDMV1Request,
        _request_timeout: Union[
    ...
    def _supplier_import_into_edmv1_serialize(
        self,
        pki_supplier_id,
        ...
        # process the path parameters
        if pki_supplier_id is not None:
            _path_params['pkiSupplierID'] = pki_supplier_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        if supplier_import_into_edmv1_request is not None:
            _body_params = supplier_import_into_edmv1_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/1/object/supplier/{pkiSupplierID}/importIntoEDM',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
