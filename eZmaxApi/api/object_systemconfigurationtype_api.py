...
class ObjectSystemconfigurationtypeApi:
    ...
    @validate_call
    def systemconfigurationtype_get_autocomplete_v2(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Systemconfigurationtype to return")],
        ...
        :param s_selector: The type of Systemconfigurationtype to return (required)
        :type s_selector: str
        ...
        _param = self._systemconfigurationtype_get_autocomplete_v2_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SystemconfigurationtypeGetAutocompleteV2Response",
        }
    ...
    @validate_call
    def systemconfigurationtype_get_autocomplete_v2_with_http_info(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Systemconfigurationtype to return")],
        e_filter_active: Annotated[Optional[StrictStr], Field(description="Specify which results we want to display.")] = None,
        s_query: Annotated[Optional[StrictStr], Field(description="Allow to filter the returned results")] = None,
    ...
    @validate_call
    def systemconfigurationtype_get_autocomplete_v2_without_preload_content(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Systemconfigurationtype to return")],
        e_filter_active: Annotated[Optional[StrictStr], Field(description="Specify which results we want to display.")] = None,
        s_query: Annotated[Optional[StrictStr], Field(description="Allow to filter the returned results")] = None,
    ...
    def _systemconfigurationtype_get_autocomplete_v2_serialize(
        self,
        s_selector,
        e_filter_active,
        s_query,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/2/object/systemconfigurationtype/getAutocomplete/{sSelector}',
