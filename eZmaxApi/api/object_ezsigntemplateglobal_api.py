...
class ObjectEzsigntemplateglobalApi:
    ...
    @validate_call
    def ezsigntemplateglobal_get_autocomplete_v2(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Ezsigntemplateglobals to return")],
        ...
        :param s_selector: The type of Ezsigntemplateglobals to return (required)
        :type s_selector: str
        ...
        _param = self._ezsigntemplateglobal_get_autocomplete_v2_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "EzsigntemplateglobalGetAutocompleteV2Response",
        }
    ...
    @validate_call
    def ezsigntemplateglobal_get_autocomplete_v2_with_http_info(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Ezsigntemplateglobals to return")],
        e_filter_active: Annotated[Optional[StrictStr], Field(description="Specify which results we want to display.")] = None,
        s_query: Annotated[Optional[StrictStr], Field(description="Allow to filter the returned results")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EzsigntemplateglobalGetAutocompleteV2Response]:
        """Retrieve Ezsigntemplateglobals and IDs
    ...
    @validate_call
    def ezsigntemplateglobal_get_autocomplete_v2_without_preload_content(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Ezsigntemplateglobals to return")],
        e_filter_active: Annotated[Optional[StrictStr], Field(description="Specify which results we want to display.")] = None,
        s_query: Annotated[Optional[StrictStr], Field(description="Allow to filter the returned results")] = None,
    ...
    def _ezsigntemplateglobal_get_autocomplete_v2_serialize(
        self,
        s_selector,
        e_filter_active,
        s_query,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/2/object/ezsigntemplateglobal/getAutocomplete/{sSelector}',
    ...
    @validate_call
    def ezsigntemplateglobal_get_object_v2(
        self,
        pki_ezsigntemplateglobal_id: Annotated[int, Field(strict=True, ge=0)],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param pki_ezsigntemplateglobal_id: (required)
        :type pki_ezsigntemplateglobal_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._ezsigntemplateglobal_get_object_v2_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "EzsigntemplateglobalGetObjectV2Response",
    ...
    @validate_call
    def ezsigntemplateglobal_get_object_v2_with_http_info(
        self,
        pki_ezsigntemplateglobal_id: Annotated[int, Field(strict=True, ge=0)],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EzsigntemplateglobalGetObjectV2Response]:
        """Retrieve an existing Ezsigntemplateglobal
    ...
    @validate_call
    def ezsigntemplateglobal_get_object_v2_without_preload_content(
        self,
        pki_ezsigntemplateglobal_id: Annotated[int, Field(strict=True, ge=0)],
        _request_timeout: Union[
            None,
    ...
    def _ezsigntemplateglobal_get_object_v2_serialize(
        self,
        ...
        # process the path parameters
        if pki_ezsigntemplateglobal_id is not None:
            _path_params['pkiEzsigntemplateglobalID'] = pki_ezsigntemplateglobal_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/2/object/ezsigntemplateglobal/{pkiEzsigntemplateglobalID}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
