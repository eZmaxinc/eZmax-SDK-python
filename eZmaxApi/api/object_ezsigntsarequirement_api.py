...
class ObjectEzsigntsarequirementApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.ezsigntsarequirement_get_autocomplete_v1_endpoint = _Endpoint(
            settings={
                'response_type': (CommonGetAutocompleteDisabledV1Response,),
                'auth': [
                    'Authorization'
                ],
                'endpoint_path': '/1/object/ezsigntsarequirement/getAutocomplete/{sSelector}',
                'operation_id': 'ezsigntsarequirement_get_autocomplete_v1',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.ezsigntsarequirement_get_autocomplete_v2_endpoint = _Endpoint(
            settings={
                'response_type': (EzsigntsarequirementGetAutocompleteV2Response,),
                'auth': [
                    'Authorization'
                ],
                'endpoint_path': '/2/object/ezsigntsarequirement/getAutocomplete/{sSelector}',
                'operation_id': 'ezsigntsarequirement_get_autocomplete_v2',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def ezsigntsarequirement_get_autocomplete_v1(
        self,
        s_selector,
        **kwargs
    ):
        ...
        >>> thread = api.ezsigntsarequirement_get_autocomplete_v1(s_selector, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['s_selector'] = \
            s_selector
        return self.ezsigntsarequirement_get_autocomplete_v1_endpoint.call_with_http_info(**kwargs)
    ...
    def ezsigntsarequirement_get_autocomplete_v2(
        ...
        **kwargs
        ...
        >>> thread = api.ezsigntsarequirement_get_autocomplete_v2(s_selector, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['s_selector'] = \
            s_selector
        return self.ezsigntsarequirement_get_autocomplete_v2_endpoint.call_with_http_info(**kwargs)
