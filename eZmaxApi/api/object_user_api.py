...
class ObjectUserApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.user_get_autocomplete_v1_endpoint = _Endpoint(
            settings={
                'response_type': (CommonGetAutocompleteV1Response,),
                'auth': [
                    'Authorization'
                ],
                'endpoint_path': '/1/object/user/getAutocomplete/{sSelector}',
                'operation_id': 'user_get_autocomplete_v1',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.user_get_autocomplete_v2_endpoint = _Endpoint(
            settings={
                'response_type': (UserGetAutocompleteV2Response,),
                'auth': [
                    'Authorization'
                ],
                'endpoint_path': '/2/object/user/getAutocomplete/{sSelector}',
                'operation_id': 'user_get_autocomplete_v2',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def user_get_autocomplete_v1(
        ...
        **kwargs
        ...
        >>> thread = api.user_get_autocomplete_v1(s_selector, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['s_selector'] = \
            s_selector
        return self.user_get_autocomplete_v1_endpoint.call_with_http_info(**kwargs)
    ...
    def user_get_autocomplete_v2(
        ...
        **kwargs
        ...
        >>> thread = api.user_get_autocomplete_v2(s_selector, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['s_selector'] = \
            s_selector
        return self.user_get_autocomplete_v2_endpoint.call_with_http_info(**kwargs)
