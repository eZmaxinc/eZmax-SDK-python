...
class ObjectEmailtypeApi:
    ...
    @validate_call
    def emailtype_get_autocomplete_v2(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Emailtypes to return")],
        ...
        _param = self._emailtype_get_autocomplete_v2_serialize(
    ...
    def emailtype_get_autocomplete_v2_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EmailtypeGetAutocompleteV2Response]:
        """Retrieve Emailtypes and IDs
    ...
    @validate_call
    def emailtype_get_autocomplete_v2_without_preload_content(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Emailtypes to return")],
        e_filter_active: Annotated[Optional[StrictStr], Field(description="Specify which results we want to display.")] = None,
        s_query: Annotated[Optional[StrictStr], Field(description="Allow to filter the returned results")] = None,
    ...
    def _emailtype_get_autocomplete_v2_serialize(
        self,
        s_selector,
        e_filter_active,
        s_query,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/2/object/emailtype/getAutocomplete/{sSelector}',
