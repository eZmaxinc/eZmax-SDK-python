...
class ObjectCommunicationApi:
    ...
    @validate_call
    def communication_get_communication_body_v1(
        self,
        pki_communication_id: Annotated[int, Field(strict=True, ge=0)],
        ...
        _param = self._communication_get_communication_body_v1_serialize(
    ...
    @validate_call
    def communication_get_communication_body_v1_with_http_info(
        self,
        pki_communication_id: Annotated[int, Field(strict=True, ge=0)],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def communication_get_communication_body_v1_without_preload_content(
        self,
        pki_communication_id: Annotated[int, Field(strict=True, ge=0)],
        _request_timeout: Union[
            None,
    ...
    def _communication_get_communication_body_v1_serialize(
        self,
        ...
        if pki_communication_id is not None:
            _path_params['pkiCommunicationID'] = pki_communication_id
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/1/object/communication/{pkiCommunicationID}/getCommunicationBody',
    ...
    def communication_send_v1(
        ...
        _param = self._communication_send_v1_serialize(
    ...
    @validate_call
    def communication_send_v1_with_http_info(
        self,
        communication_send_v1_request: CommunicationSendV1Request,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CommunicationSendV1Response]:
        """Send a new Communication
    ...
    @validate_call
    def communication_send_v1_without_preload_content(
        self,
        communication_send_v1_request: CommunicationSendV1Request,
        _request_timeout: Union[
            None,
    ...
    def _communication_send_v1_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if communication_send_v1_request is not None:
            _body_params = communication_send_v1_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/1/object/communication/send',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
