...
class ObjectCompanyApi:
    ...
    def company_get_autocomplete_v2(self, s_selector : Annotated[StrictStr, Field(..., description="The type of Companys to return")], e_filter_active : Annotated[Optional[StrictStr], Field(description="Specify which results we want to display.")] = None, s_query : Annotated[Optional[StrictStr], Field(description="Allow to filter the returned results")] = None, accept_language : Optional[HeaderAcceptLanguage] = None, **kwargs) -> CompanyGetAutocompleteV2Response:  # noqa: E501
        ...
        :rtype: CompanyGetAutocompleteV2Response
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the company_get_autocomplete_v2_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.company_get_autocomplete_v2_with_http_info(s_selector, e_filter_active, s_query, accept_language, **kwargs)  # noqa: E501

    @validate_arguments
    def company_get_autocomplete_v2_with_http_info(self, s_selector : Annotated[StrictStr, Field(..., description="The type of Companys to return")], e_filter_active : Annotated[Optional[StrictStr], Field(description="Specify which results we want to display.")] = None, s_query : Annotated[Optional[StrictStr], Field(description="Allow to filter the returned results")] = None, accept_language : Optional[HeaderAcceptLanguage] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Retrieve Companys and IDs  # noqa: E501
        ...
        >>> thread = api.company_get_autocomplete_v2_with_http_info(s_selector, e_filter_active, s_query, accept_language, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CompanyGetAutocompleteV2Response, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method company_get_autocomplete_v2" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "CompanyGetAutocompleteV2Response",
        }
