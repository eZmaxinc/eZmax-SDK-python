...
class ModuleUserApi:
    ...
    @validate_call
    def user_create_ezsignuser_v1(
        self,
        user_create_ezsignuser_v1_request: List[UserCreateEzsignuserV1Request],
        ...
        _param = self._user_create_ezsignuser_v1_serialize(
            user_create_ezsignuser_v1_request=user_create_ezsignuser_v1_request,
    ...
    @validate_call
    def user_create_ezsignuser_v1_with_http_info(
        self,
        user_create_ezsignuser_v1_request: List[UserCreateEzsignuserV1Request],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UserCreateEzsignuserV1Response]:
        """Create a new User of type Ezsignuser
    ...
    @validate_call
    def user_create_ezsignuser_v1_without_preload_content(
        self,
        user_create_ezsignuser_v1_request: List[UserCreateEzsignuserV1Request],
        _request_timeout: Union[
            None,
    ...
    def _user_create_ezsignuser_v1_serialize(
        self,
        ...
        if user_create_ezsignuser_v1_request is not None:
            _body_params = user_create_ezsignuser_v1_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/1/module/user/createezsignuser',
