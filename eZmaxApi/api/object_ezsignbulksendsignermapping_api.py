...
class ObjectEzsignbulksendsignermappingApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.ezsignbulksendsignermapping_get_object_v2_endpoint = _Endpoint(
            settings={
                'response_type': (EzsignbulksendsignermappingGetObjectV2Response,),
                'auth': [
                    'Authorization'
                ],
                'endpoint_path': '/2/object/ezsignbulksendsignermapping/{pkiEzsignbulksendsignermappingID}',
                'operation_id': 'ezsignbulksendsignermapping_get_object_v2',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def ezsignbulksendsignermapping_get_object_v2(
        ...
        **kwargs
        ...
        kwargs['pki_ezsignbulksendsignermapping_id'] = \
            pki_ezsignbulksendsignermapping_id
        return self.ezsignbulksendsignermapping_get_object_v2_endpoint.call_with_http_info(**kwargs)
