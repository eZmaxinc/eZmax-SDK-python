...
class ObjectEzsignsignatureApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.ezsignsignature_get_object_v2_endpoint = _Endpoint(
            settings={
                'response_type': (EzsignsignatureGetObjectV2Response,),
                'auth': [
                    'Authorization'
                ],
                'endpoint_path': '/2/object/ezsignsignature/{pkiEzsignsignatureID}',
                'operation_id': 'ezsignsignature_get_object_v2',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.ezsignsignature_sign_v1_endpoint = _Endpoint(
            settings={
                'response_type': (EzsignsignatureSignV1Response,),
                'auth': [
                    'Authorization'
                ],
                'endpoint_path': '/1/object/ezsignsignature/{pkiEzsignsignatureID}/sign',
                'operation_id': 'ezsignsignature_sign_v1',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'pki_ezsignsignature_id': 'path',
                    'ezsignsignature_sign_v1_request': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def ezsignsignature_get_object_v2(
        ...
        **kwargs
        ...
        kwargs['pki_ezsignsignature_id'] = \
            pki_ezsignsignature_id
        return self.ezsignsignature_get_object_v2_endpoint.call_with_http_info(**kwargs)
    ...
    def ezsignsignature_sign_v1(
        ...
        **kwargs
        ...
        kwargs['pki_ezsignsignature_id'] = \
            pki_ezsignsignature_id
        kwargs['ezsignsignature_sign_v1_request'] = \
            ezsignsignature_sign_v1_request
        return self.ezsignsignature_sign_v1_endpoint.call_with_http_info(**kwargs)
