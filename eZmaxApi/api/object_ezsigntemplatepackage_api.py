...
class ObjectEzsigntemplatepackageApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.ezsigntemplatepackage_get_object_v2_endpoint = _Endpoint(
            settings={
                'response_type': (EzsigntemplatepackageGetObjectV2Response,),
                'auth': [
                    'Authorization'
                ],
                'endpoint_path': '/2/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}',
                'operation_id': 'ezsigntemplatepackage_get_object_v2',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def ezsigntemplatepackage_get_object_v2(
        ...
        **kwargs
        ...
        kwargs['pki_ezsigntemplatepackage_id'] = \
            pki_ezsigntemplatepackage_id
        return self.ezsigntemplatepackage_get_object_v2_endpoint.call_with_http_info(**kwargs)
