...
class ModuleListApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_listpresentation_v1_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'list_listpresentation_v1',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def list_listpresentation_v1(
        ...
        **kwargs
        ...
        >>> thread = api.list_listpresentation_v1(s_list_name, list_save_listpresentation_v1_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['list_save_listpresentation_v1_request'] = \
            list_save_listpresentation_v1_request
        return self.list_listpresentation_v1_endpoint.call_with_http_info(**kwargs)
