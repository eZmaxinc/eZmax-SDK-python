...
class ObjectFranchisereferalincomeApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.franchisereferalincome_create_object_v1_endpoint = _Endpoint(
            settings={
        ...
        self.franchisereferalincome_create_object_v2_endpoint = _Endpoint(
            settings={
                'response_type': (FranchisereferalincomeCreateObjectV2Response,),
                'auth': [
                    'Authorization'
                ],
                'endpoint_path': '/2/object/franchisereferalincome',
                'operation_id': 'franchisereferalincome_create_object_v2',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'franchisereferalincome_create_object_v2_request': 'body',
                },
                'collection_format_map': {
                }
            },
