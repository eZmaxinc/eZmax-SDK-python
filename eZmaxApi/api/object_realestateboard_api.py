...
class ObjectRealestateboardApi:
    ...
    @validate_call
    def realestateboard_get_autocomplete_v2(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Realestateboards to return")],
        ...
        fki_province_id: Annotated[Optional[StrictStr], Field(description="The province ID to filter the results expected")] = None,
        ...
        :param s_selector: The type of Realestateboards to return (required)
        :type s_selector: str
        ...
        :param fki_province_id: The province ID to filter the results expected
        :type fki_province_id: str
        ...
        _param = self._realestateboard_get_autocomplete_v2_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RealestateboardGetAutocompleteV2Response",
        }
    ...
    @validate_call
    def realestateboard_get_autocomplete_v2_with_http_info(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Realestateboards to return")],
        e_filter_active: Annotated[Optional[StrictStr], Field(description="Specify which results we want to display.")] = None,
        s_query: Annotated[Optional[StrictStr], Field(description="Allow to filter the returned results")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RealestateboardGetAutocompleteV2Response]:
        """Retrieve Realestateboards and IDs
    ...
    @validate_call
    def realestateboard_get_autocomplete_v2_without_preload_content(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Realestateboards to return")],
        e_filter_active: Annotated[Optional[StrictStr], Field(description="Specify which results we want to display.")] = None,
        s_query: Annotated[Optional[StrictStr], Field(description="Allow to filter the returned results")] = None,
    ...
    def _realestateboard_get_autocomplete_v2_serialize(
        self,
        s_selector,
        e_filter_active,
        s_query,
        ...
        if fki_province_id is not None:
            
            _query_params.append(('fkiProvinceID', fki_province_id))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/2/object/realestateboard/getAutocomplete/{sSelector}',
