...
class ObjectEzsigndocumentApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.ezsigndocument_get_object_v2_endpoint = _Endpoint(
            settings={
                'response_type': (EzsigndocumentGetObjectV2Response,),
                'auth': [
                    'Authorization'
                ],
                'endpoint_path': '/2/object/ezsigndocument/{pkiEzsigndocumentID}',
                'operation_id': 'ezsigndocument_get_object_v2',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def ezsigndocument_get_object_v2(
        ...
        **kwargs
        ...
        kwargs['pki_ezsigndocument_id'] = \
            pki_ezsigndocument_id
        return self.ezsigndocument_get_object_v2_endpoint.call_with_http_info(**kwargs)
