...
class ObjectDomainApi:
    ...
    @validate_call
    def domain_get_autocomplete_v2(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Domain to return")],
        ...
        :param s_selector: The type of Domain to return (required)
        :type s_selector: str
        ...
        _param = self._domain_get_autocomplete_v2_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DomainGetAutocompleteV2Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def domain_get_autocomplete_v2_with_http_info(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Domain to return")],
        e_filter_active: Annotated[Optional[StrictStr], Field(description="Specify which results we want to display.")] = None,
        s_query: Annotated[Optional[StrictStr], Field(description="Allow to filter the returned results")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DomainGetAutocompleteV2Response]:
        """Retrieve Domain and IDs
    ...
    @validate_call
    def domain_get_autocomplete_v2_without_preload_content(
        self,
        s_selector: Annotated[StrictStr, Field(description="The type of Domain to return")],
        e_filter_active: Annotated[Optional[StrictStr], Field(description="Specify which results we want to display.")] = None,
        s_query: Annotated[Optional[StrictStr], Field(description="Allow to filter the returned results")] = None,
    ...
    def _domain_get_autocomplete_v2_serialize(
        self,
        s_selector,
        e_filter_active,
        s_query,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/2/object/domain/getAutocomplete/{sSelector}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
