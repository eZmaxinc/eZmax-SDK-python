...
class ObjectEzsignbulksendApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.ezsignbulksend_get_object_v2_endpoint = _Endpoint(
            settings={
                'response_type': (EzsignbulksendGetObjectV2Response,),
                'auth': [
                    'Authorization'
                ],
                'endpoint_path': '/2/object/ezsignbulksend/{pkiEzsignbulksendID}',
                'operation_id': 'ezsignbulksend_get_object_v2',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def ezsignbulksend_get_object_v2(
        ...
        **kwargs
        ...
        kwargs['pki_ezsignbulksend_id'] = \
            pki_ezsignbulksend_id
        return self.ezsignbulksend_get_object_v2_endpoint.call_with_http_info(**kwargs)
