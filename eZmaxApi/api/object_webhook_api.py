...
class ObjectWebhookApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.webhook_get_object_v2_endpoint = _Endpoint(
            settings={
                'response_type': (WebhookGetObjectV2Response,),
                'auth': [
                    'Authorization'
                ],
                'endpoint_path': '/2/object/webhook/{pkiWebhookID}',
                'operation_id': 'webhook_get_object_v2',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.webhook_test_v1_endpoint = _Endpoint(
            settings={
    ...
    def webhook_get_object_v2(
        ...
        **kwargs
        ...
        kwargs['pki_webhook_id'] = \
            pki_webhook_id
        return self.webhook_get_object_v2_endpoint.call_with_http_info(**kwargs)
    ...
    def webhook_test_v1(
        ...
        **kwargs
        ...
        kwargs['body'] = \
            body
        return self.webhook_test_v1_endpoint.call_with_http_info(**kwargs)
