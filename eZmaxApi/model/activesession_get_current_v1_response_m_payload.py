...
class ActivesessionGetCurrentV1ResponseMPayload(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, s_customer_code, fki_language_id, s_company_name_x, s_department_name_x, a_registered_modules, a_permissions, fki_user_id, fki_apikey_id, *args, **kwargs):  # noqa: E501
