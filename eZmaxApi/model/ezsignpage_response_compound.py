...
class EzsignpageResponseCompound(ModelComposed):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'pki_ezsignpage_id': (int,),  # noqa: E501
            'i_ezsignpage_widthimage': (int,),  # noqa: E501
            'i_ezsignpage_heightimage': (int,),  # noqa: E501
            'i_ezsignpage_widthpdf': (int,),  # noqa: E501
            'i_ezsignpage_heightpdf': (int,),  # noqa: E501
