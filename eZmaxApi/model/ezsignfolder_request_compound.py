...
class EzsignfolderRequestCompound(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, a_ezsignfoldersignerassociation, fki_ezsignfoldertype_id, fki_ezsigntsarequirement_id, s_ezsignfolder_description, t_ezsignfolder_note, e_ezsignfolder_sendreminderfrequency, *args, **kwargs):  # noqa: E501
