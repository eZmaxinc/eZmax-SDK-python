...
class EzsignfolderResponseAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, fki_ezsignfoldertype_id, fki_ezsigntsarequirement_id, s_ezsignfolder_description, t_ezsignfolder_note, e_ezsignfolder_sendreminderfrequency, pki_ezsignfolder_id, dt_ezsignfolder_sentdate, e_ezsignfolder_step, dt_ezsignfolder_close, obj_audit, *args, **kwargs):  # noqa: E501
        """EzsignfolderResponseAllOf - a model defined in OpenAPI
