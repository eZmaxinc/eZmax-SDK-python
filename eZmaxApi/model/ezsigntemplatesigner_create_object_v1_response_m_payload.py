...
class EzsigntemplatesignerCreateObjectV1ResponseMPayload(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'a_pki_ezsigntemplatesigner_id': ([FieldPkiEzsigntemplatesignerID],),  # noqa: E501
    ...
    attribute_map = {
        'a_pki_ezsigntemplatesigner_id': 'a_pkiEzsigntemplatesignerID',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, a_pki_ezsigntemplatesigner_id, b_ezsigntemplatepackage_needvalidation, b_ezsignbulksend_needvalidation, *args, **kwargs):  # noqa: E501
        """EzsigntemplatesignerCreateObjectV1ResponseMPayload - a model defined in OpenAPI

        Args:
            a_pki_ezsigntemplatesigner_id ([FieldPkiEzsigntemplatesignerID]): An array of unique IDs representing the object that were requested to be created.  They are returned in the same order as the array containing the objects to be created that was sent in the request.
        ...
        self.a_pki_ezsigntemplatesigner_id = a_pki_ezsigntemplatesigner_id
    ...
    @convert_js_args_to_python_args
    def __init__(self, a_pki_ezsigntemplatesigner_id, b_ezsigntemplatepackage_needvalidation, b_ezsignbulksend_needvalidation, *args, **kwargs):  # noqa: E501
        """EzsigntemplatesignerCreateObjectV1ResponseMPayload - a model defined in OpenAPI
