...
class EzsignbulksendResponse(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, pki_ezsignbulksend_id, fki_ezsignfoldertype_id, fki_language_id, s_language_name_x, e_ezsignfoldertype_privacylevel, s_ezsignfoldertype_name_x, s_ezsignbulksend_description, t_ezsignbulksend_note, b_ezsignbulksend_needvalidation, b_ezsignbulksend_isactive, obj_audit, *args, **kwargs):  # noqa: E501
        """EzsignbulksendResponse - a model defined in OpenAPI
