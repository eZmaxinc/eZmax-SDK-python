...
class EzsignfoldersignerassociationResponseCompoundUser(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, pki_user_id, fki_language_id, s_user_firstname, s_user_lastname, s_email_address, *args, **kwargs):  # noqa: E501
        """EzsignfoldersignerassociationResponseCompoundUser - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, pki_user_id, fki_language_id, s_user_firstname, s_user_lastname, s_email_address, *args, **kwargs):  # noqa: E501
        """EzsignfoldersignerassociationResponseCompoundUser - a model defined in OpenAPI
