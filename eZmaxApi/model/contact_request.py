...
class ContactRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'fki_contacttitle_id': (FieldPkiContacttitleID,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, fki_contacttitle_id, fki_language_id, s_contact_firstname, s_contact_lastname, s_contact_company, *args, **kwargs):  # noqa: E501
        """ContactRequest - a model defined in OpenAPI

        Args:
            fki_contacttitle_id (FieldPkiContacttitleID):
    ...
    @convert_js_args_to_python_args
    def __init__(self, fki_contacttitle_id, fki_language_id, s_contact_firstname, s_contact_lastname, s_contact_company, *args, **kwargs):  # noqa: E501
        """ContactRequest - a model defined in OpenAPI
