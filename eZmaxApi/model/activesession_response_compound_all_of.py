...
class ActivesessionResponseCompoundAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, a_pki_permission_id, obj_user_real, a_e_module_internalname, *args, **kwargs):  # noqa: E501
        """ActivesessionResponseCompoundAllOf - a model defined in OpenAPI
        ...
        self.a_pki_permission_id = a_pki_permission_id
        self.obj_user_real = obj_user_real
        self.a_e_module_internalname = a_e_module_internalname
    ...
    @convert_js_args_to_python_args
    def __init__(self, a_pki_permission_id, obj_user_real, a_e_module_internalname, *args, **kwargs):  # noqa: E501
        """ActivesessionResponseCompoundAllOf - a model defined in OpenAPI
