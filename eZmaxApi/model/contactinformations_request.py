...
class ContactinformationsRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, i_address_default, i_phone_default, i_email_default, i_website_default, *args, **kwargs):  # noqa: E501
        """ContactinformationsRequest - a model defined in OpenAPI
        ...
        self.i_address_default = i_address_default
        self.i_phone_default = i_phone_default
        self.i_email_default = i_email_default
        self.i_website_default = i_website_default
    ...
    @convert_js_args_to_python_args
    def __init__(self, i_address_default, i_phone_default, i_email_default, i_website_default, *args, **kwargs):  # noqa: E501
        """ContactinformationsRequest - a model defined in OpenAPI
