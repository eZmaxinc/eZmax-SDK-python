...
class EzsignfolderListElement(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, pki_ezsignfolder_id, fki_ezsignfoldertype_id, s_ezsignfoldertype_name_x, s_ezsignfolder_description, e_ezsignfolder_step, dt_created_date, dt_ezsignfolder_sentdate, dt_due_date, i_total_document, i_total_document_edm, i_total_signature, i_total_signature_signed, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, pki_ezsignfolder_id, fki_ezsignfoldertype_id, s_ezsignfoldertype_name_x, s_ezsignfolder_description, e_ezsignfolder_step, dt_created_date, dt_ezsignfolder_sentdate, dt_due_date, i_total_document, i_total_document_edm, i_total_signature, i_total_signature_signed, *args, **kwargs):  # noqa: E501
        """EzsignfolderListElement - a model defined in OpenAPI
