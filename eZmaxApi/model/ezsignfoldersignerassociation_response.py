...
class EzsignfoldersignerassociationResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, pki_ezsignfoldersignerassociation_id, fki_ezsignfolder_id, b_ezsignfoldersignerassociation_receivecopy, t_ezsignfoldersignerassociation_message, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, pki_ezsignfoldersignerassociation_id, fki_ezsignfolder_id, b_ezsignfoldersignerassociation_receivecopy, t_ezsignfoldersignerassociation_message, *args, **kwargs):  # noqa: E501
        """EzsignfoldersignerassociationResponse - a model defined in OpenAPI
