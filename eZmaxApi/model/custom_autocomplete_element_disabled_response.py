...
class CustomAutocompleteElementDisabledResponse(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CustomAutocompleteElementDisabledResponse - a model defined in OpenAPI
