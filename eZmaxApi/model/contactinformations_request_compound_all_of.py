...
class ContactinformationsRequestCompoundAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, a_obj_address, a_obj_phone, a_obj_email, a_obj_website, *args, **kwargs):  # noqa: E501
        ...
        self.a_obj_address = a_obj_address
        self.a_obj_phone = a_obj_phone
        self.a_obj_email = a_obj_email
        self.a_obj_website = a_obj_website
    ...
    @convert_js_args_to_python_args
    def __init__(self, a_obj_address, a_obj_phone, a_obj_email, a_obj_website, *args, **kwargs):  # noqa: E501
        """ContactinformationsRequestCompoundAllOf - a model defined in OpenAPI
