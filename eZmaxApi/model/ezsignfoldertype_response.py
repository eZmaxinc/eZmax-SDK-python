...
class EzsignfoldertypeResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, pki_ezsignfoldertype_id, obj_ezsignfoldertype_name, fki_branding_id, s_branding_description_x, e_ezsignfoldertype_privacylevel, i_ezsignfoldertype_archivaldays, e_ezsignfoldertype_disposal, i_ezsignfoldertype_deadlinedays, b_ezsignfoldertype_sendattatchmentsigner, b_ezsignfoldertype_sendsignedtodocumentowner, b_ezsignfoldertype_sendsignedtofolderowner, b_ezsignfoldertype_sendsignedtocolleague, b_ezsignfoldertype_sendsummarytodocumentowner, b_ezsignfoldertype_sendsummarytofolderowner, b_ezsignfoldertype_sendsummarytocolleague, b_ezsignfoldertype_includeproofsigner, b_ezsignfoldertype_includeproofuser, b_ezsignfoldertype_isactive, *args, **kwargs):  # noqa: E501
        """EzsignfoldertypeResponse - a model defined in OpenAPI
        ...
        self.pki_ezsignfoldertype_id = pki_ezsignfoldertype_id
        self.obj_ezsignfoldertype_name = obj_ezsignfoldertype_name
        self.fki_branding_id = fki_branding_id
        ...
        self.i_ezsignfoldertype_archivaldays = i_ezsignfoldertype_archivaldays
        self.e_ezsignfoldertype_disposal = e_ezsignfoldertype_disposal
        self.i_ezsignfoldertype_deadlinedays = i_ezsignfoldertype_deadlinedays
        self.b_ezsignfoldertype_sendattatchmentsigner = b_ezsignfoldertype_sendattatchmentsigner
        self.b_ezsignfoldertype_sendsignedtodocumentowner = b_ezsignfoldertype_sendsignedtodocumentowner
        self.b_ezsignfoldertype_sendsignedtofolderowner = b_ezsignfoldertype_sendsignedtofolderowner
        self.b_ezsignfoldertype_sendsignedtocolleague = b_ezsignfoldertype_sendsignedtocolleague
        self.b_ezsignfoldertype_sendsummarytodocumentowner = b_ezsignfoldertype_sendsummarytodocumentowner
        self.b_ezsignfoldertype_sendsummarytofolderowner = b_ezsignfoldertype_sendsummarytofolderowner
        self.b_ezsignfoldertype_sendsummarytocolleague = b_ezsignfoldertype_sendsummarytocolleague
        self.b_ezsignfoldertype_includeproofsigner = b_ezsignfoldertype_includeproofsigner
        self.b_ezsignfoldertype_includeproofuser = b_ezsignfoldertype_includeproofuser
        self.b_ezsignfoldertype_isactive = b_ezsignfoldertype_isactive
    ...
    @convert_js_args_to_python_args
    def __init__(self, pki_ezsignfoldertype_id, obj_ezsignfoldertype_name, fki_branding_id, s_branding_description_x, e_ezsignfoldertype_privacylevel, i_ezsignfoldertype_archivaldays, e_ezsignfoldertype_disposal, i_ezsignfoldertype_deadlinedays, b_ezsignfoldertype_sendattatchmentsigner, b_ezsignfoldertype_sendsignedtodocumentowner, b_ezsignfoldertype_sendsignedtofolderowner, b_ezsignfoldertype_sendsignedtocolleague, b_ezsignfoldertype_sendsummarytodocumentowner, b_ezsignfoldertype_sendsummarytofolderowner, b_ezsignfoldertype_sendsummarytocolleague, b_ezsignfoldertype_includeproofsigner, b_ezsignfoldertype_includeproofuser, b_ezsignfoldertype_isactive, *args, **kwargs):  # noqa: E501
        """EzsignfoldertypeResponse - a model defined in OpenAPI
