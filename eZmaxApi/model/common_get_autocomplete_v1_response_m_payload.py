...
class CommonGetAutocompleteV1ResponseMPayload(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, group, id, option, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, group, id, option, *args, **kwargs):  # noqa: E501
        """CommonGetAutocompleteV1ResponseMPayload - a model defined in OpenAPI
