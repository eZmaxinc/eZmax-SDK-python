...
class CommonGetAutocompleteV1ResponseMPayload(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """CommonGetAutocompleteV1ResponseMPayload - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([CustomAutocompleteElementResponse]): Generic Autocomplete Response.  # noqa: E501

        Keyword Args:
            value ([CustomAutocompleteElementResponse]): Generic Autocomplete Response.  # noqa: E501
