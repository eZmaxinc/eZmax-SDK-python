...
class FieldEEzsigndocumentlogType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """FieldEEzsigndocumentlogType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): The Ezsigndocumentlog Type.., must be one of ["Clone", "Login", "Sendcode", "Badcode", "Goodcode", "Authentication", "Createpage", "Download", "Send", "Sign", "Upload", "View", "Completion", "Changelimitdate", "Unsign", "ImportFromInstanet", "SendEmail", "FormCompletion", "SignatureAttachmentAdd", "SignatureAttachmentValidation", "SignatureAttachmentRefused", "SignatureAttachmentDeleted", "DeclinedToSign", ]  # noqa: E501
