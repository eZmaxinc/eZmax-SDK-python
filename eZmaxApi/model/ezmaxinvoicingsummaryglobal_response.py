...
class EzmaxinvoicingsummaryglobalResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, fki_ezmaxproduct_id, s_ezmaxproduct_description_x, dt_ezmaxinvoicingsummaryglobal_start, dt_ezmaxinvoicingsummaryglobal_end, i_ezmaxinvoicingsummaryglobal_days, d_ezmaxinvoicingsummaryglobal_countreal, d_ezmaxinvoicingsummaryglobal_countbilled, d_ezmaxinvoicingsummaryglobal_subtotal, d_ezmaxinvoicingsummaryglobal_rebateamount, d_ezmaxinvoicingsummaryglobal_rebatepercent, d_ezmaxinvoicingsummaryglobal_rebatetotal, d_ezmaxinvoicingsummaryglobal_total, b_ezmaxinvoicingsummaryglobal_adjustment, *args, **kwargs):  # noqa: E501
        """EzmaxinvoicingsummaryglobalResponse - a model defined in OpenAPI
        ...
        self.dt_ezmaxinvoicingsummaryglobal_start = dt_ezmaxinvoicingsummaryglobal_start
        self.dt_ezmaxinvoicingsummaryglobal_end = dt_ezmaxinvoicingsummaryglobal_end
        self.i_ezmaxinvoicingsummaryglobal_days = i_ezmaxinvoicingsummaryglobal_days
        self.d_ezmaxinvoicingsummaryglobal_countreal = d_ezmaxinvoicingsummaryglobal_countreal
        self.d_ezmaxinvoicingsummaryglobal_countbilled = d_ezmaxinvoicingsummaryglobal_countbilled
        self.d_ezmaxinvoicingsummaryglobal_subtotal = d_ezmaxinvoicingsummaryglobal_subtotal
        self.d_ezmaxinvoicingsummaryglobal_rebateamount = d_ezmaxinvoicingsummaryglobal_rebateamount
        self.d_ezmaxinvoicingsummaryglobal_rebatepercent = d_ezmaxinvoicingsummaryglobal_rebatepercent
        self.d_ezmaxinvoicingsummaryglobal_rebatetotal = d_ezmaxinvoicingsummaryglobal_rebatetotal
        self.d_ezmaxinvoicingsummaryglobal_total = d_ezmaxinvoicingsummaryglobal_total
        self.b_ezmaxinvoicingsummaryglobal_adjustment = b_ezmaxinvoicingsummaryglobal_adjustment
    ...
    @convert_js_args_to_python_args
    def __init__(self, fki_ezmaxproduct_id, s_ezmaxproduct_description_x, dt_ezmaxinvoicingsummaryglobal_start, dt_ezmaxinvoicingsummaryglobal_end, i_ezmaxinvoicingsummaryglobal_days, d_ezmaxinvoicingsummaryglobal_countreal, d_ezmaxinvoicingsummaryglobal_countbilled, d_ezmaxinvoicingsummaryglobal_subtotal, d_ezmaxinvoicingsummaryglobal_rebateamount, d_ezmaxinvoicingsummaryglobal_rebatepercent, d_ezmaxinvoicingsummaryglobal_rebatetotal, d_ezmaxinvoicingsummaryglobal_total, b_ezmaxinvoicingsummaryglobal_adjustment, *args, **kwargs):  # noqa: E501
        """EzmaxinvoicingsummaryglobalResponse - a model defined in OpenAPI
