...
class CustomEzmaxinvoicingEzsigndocumentResponseAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, fki_ezsignfolder_id, s_name, s_ezsignfolder_description, s_ezsigndocument_name, b_ezsignfolder_allowed, *args, **kwargs):  # noqa: E501
        """CustomEzmaxinvoicingEzsigndocumentResponseAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, fki_ezsignfolder_id, s_name, s_ezsignfolder_description, s_ezsigndocument_name, b_ezsignfolder_allowed, *args, **kwargs):  # noqa: E501
        """CustomEzmaxinvoicingEzsigndocumentResponseAllOf - a model defined in OpenAPI
