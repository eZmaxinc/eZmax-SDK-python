...
class EzsigndocumentRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, fki_ezsignfolder_id, fki_language_id, e_ezsigndocument_source, dt_ezsigndocument_duedate, s_ezsigndocument_name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            pki_ezsigndocument_id (FieldPkiEzsigndocumentID): [optional]  # noqa: E501
            fki_ezsigntemplate_id (FieldPkiEzsigntemplateID): [optional]  # noqa: E501
            fki_ezsignfoldersignerassociation_id (FieldPkiEzsignfoldersignerassociationID): [optional]  # noqa: E501
