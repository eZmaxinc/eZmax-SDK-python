...
class EzsigndocumentResponseCompoundAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, i_ezsigndocument_stepformtotal, i_ezsigndocument_stepformcurrent, i_ezsigndocument_stepsignaturetotal, i_ezsigndocument_stepsignature_current, a_obj_ezsignfoldersignerassociationstatus, *args, **kwargs):  # noqa: E501
        """EzsigndocumentResponseCompoundAllOf - a model defined in OpenAPI
        ...
        self.i_ezsigndocument_stepformtotal = i_ezsigndocument_stepformtotal
        self.i_ezsigndocument_stepformcurrent = i_ezsigndocument_stepformcurrent
        self.i_ezsigndocument_stepsignaturetotal = i_ezsigndocument_stepsignaturetotal
        self.i_ezsigndocument_stepsignature_current = i_ezsigndocument_stepsignature_current
        self.a_obj_ezsignfoldersignerassociationstatus = a_obj_ezsignfoldersignerassociationstatus
    ...
    @convert_js_args_to_python_args
    def __init__(self, i_ezsigndocument_stepformtotal, i_ezsigndocument_stepformcurrent, i_ezsigndocument_stepsignaturetotal, i_ezsigndocument_stepsignature_current, a_obj_ezsignfoldersignerassociationstatus, *args, **kwargs):  # noqa: E501
        """EzsigndocumentResponseCompoundAllOf - a model defined in OpenAPI
