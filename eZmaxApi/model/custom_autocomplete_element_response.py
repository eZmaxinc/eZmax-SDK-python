...
class CustomAutocompleteElementResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, s_category, s_label, s_value, b_active, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, s_category, s_label, s_value, b_active, *args, **kwargs):  # noqa: E501
        """CustomAutocompleteElementResponse - a model defined in OpenAPI
