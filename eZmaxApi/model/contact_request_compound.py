...
class ContactRequestCompound(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, obj_contactinformations, fki_contacttitle_id, fki_language_id, s_contact_firstname, s_contact_lastname, s_contact_company, *args, **kwargs):  # noqa: E501
