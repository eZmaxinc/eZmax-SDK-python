...
class ActivesessionResponseCompoundUser(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, pki_user_id, s_avatar_url, s_user_firstname, s_user_lastname, s_email_address, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, pki_user_id, s_avatar_url, s_user_firstname, s_user_lastname, s_email_address, *args, **kwargs):  # noqa: E501
        """ActivesessionResponseCompoundUser - a model defined in OpenAPI
