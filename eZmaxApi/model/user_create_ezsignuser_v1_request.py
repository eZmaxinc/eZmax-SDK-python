...
class UserCreateEzsignuserV1Request(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, fki_language_id, s_user_firstname, s_user_lastname, s_email_address, s_phone_region, s_phone_exchange, s_phone_number, *args, **kwargs):  # noqa: E501
        """UserCreateEzsignuserV1Request - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, fki_language_id, s_user_firstname, s_user_lastname, s_email_address, s_phone_region, s_phone_exchange, s_phone_number, *args, **kwargs):  # noqa: E501
        """UserCreateEzsignuserV1Request - a model defined in OpenAPI
