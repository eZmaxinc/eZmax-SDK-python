...
class PhoneRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'fki_phonetype_id': (FieldPkiPhonetypeID,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, fki_phonetype_id, e_phone_type, *args, **kwargs):  # noqa: E501
        """PhoneRequest - a model defined in OpenAPI

        Args:
            fki_phonetype_id (FieldPkiPhonetypeID):
