...
class CommonWebhook(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'obj_webhook': (CustomWebhookResponse,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, obj_webhook, a_obj_attempt, *args, **kwargs):  # noqa: E501
        """CommonWebhook - a model defined in OpenAPI
        ...
        self.a_obj_attempt = a_obj_attempt
    ...
    @convert_js_args_to_python_args
    def __init__(self, obj_webhook, a_obj_attempt, *args, **kwargs):  # noqa: E501
        """CommonWebhook - a model defined in OpenAPI
