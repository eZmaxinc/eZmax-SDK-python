...
class EzsignpageResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, pki_ezsignpage_id, i_ezsignpage_widthimage, i_ezsignpage_heightimage, i_ezsignpage_widthpdf, i_ezsignpage_heightpdf, i_ezsignpage_pagenumber, s_computed_imageurl, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, pki_ezsignpage_id, i_ezsignpage_widthimage, i_ezsignpage_heightimage, i_ezsignpage_widthpdf, i_ezsignpage_heightpdf, i_ezsignpage_pagenumber, s_computed_imageurl, *args, **kwargs):  # noqa: E501
        """EzsignpageResponse - a model defined in OpenAPI
