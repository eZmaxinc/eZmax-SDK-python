...
class CustomDropdownElementResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, s_label, s_value, *args, **kwargs):  # noqa: E501
        """CustomDropdownElementResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, s_label, s_value, *args, **kwargs):  # noqa: E501
        """CustomDropdownElementResponse - a model defined in OpenAPI
