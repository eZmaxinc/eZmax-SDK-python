...
class EzsignformfieldRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, i_ezsignpage_pagenumber, s_ezsignformfield_label, i_ezsignformfield_x, i_ezsignformfield_y, i_ezsignformfield_width, i_ezsignformfield_height, *args, **kwargs):  # noqa: E501
        """EzsignformfieldRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            pki_ezsignformfield_id (int): The unique ID of the Ezsignformfield. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, i_ezsignpage_pagenumber, s_ezsignformfield_label, i_ezsignformfield_x, i_ezsignformfield_y, i_ezsignformfield_width, i_ezsignformfield_height, *args, **kwargs):  # noqa: E501
        """EzsignformfieldRequest - a model defined in OpenAPI
