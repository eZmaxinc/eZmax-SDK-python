...
class WebhookRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, s_webhook_description, e_webhook_module, s_webhook_url, s_webhook_emailfailed, b_webhook_isactive, b_webhook_skipsslvalidation, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            pki_webhook_id (int): The unique ID of the Webhook. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, s_webhook_description, e_webhook_module, s_webhook_url, s_webhook_emailfailed, b_webhook_isactive, b_webhook_skipsslvalidation, *args, **kwargs):  # noqa: E501
        """WebhookRequest - a model defined in OpenAPI
