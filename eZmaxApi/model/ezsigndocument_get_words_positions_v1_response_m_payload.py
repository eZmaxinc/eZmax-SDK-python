...
def lazy_import():
    ...
    globals()['WordPositionResponse'] = WordPositionResponse


class EzsigndocumentGetWordsPositionsV1ResponseMPayload(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'a_s_words': ([WordPositionResponse],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, a_s_words, *args, **kwargs):  # noqa: E501
        ...
        Args:
            a_s_words ([WordPositionResponse]): An array of words with an array of pages and positions X,Y  They are returned with the sames words that was sent in the request.
