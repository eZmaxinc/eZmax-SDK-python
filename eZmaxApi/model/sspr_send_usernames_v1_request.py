...
class SsprSendUsernamesV1Request(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, pks_customer_code, fki_language_id, e_user_type_sspr, s_email_address, *args, **kwargs):  # noqa: E501
        """SsprSendUsernamesV1Request - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, pks_customer_code, fki_language_id, e_user_type_sspr, s_email_address, *args, **kwargs):  # noqa: E501
        """SsprSendUsernamesV1Request - a model defined in OpenAPI
