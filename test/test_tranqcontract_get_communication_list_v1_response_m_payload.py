...
class TestTranqcontractGetCommunicationListV1ResponseMPayload(unittest.TestCase):
    """TranqcontractGetCommunicationListV1ResponseMPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TranqcontractGetCommunicationListV1ResponseMPayload:
        ...
        if include_optional:
            return TranqcontractGetCommunicationListV1ResponseMPayload(
                a_obj_communication = [
    ...
    def testTranqcontractGetCommunicationListV1ResponseMPayload(self):
        """Test TranqcontractGetCommunicationListV1ResponseMPayload"""
