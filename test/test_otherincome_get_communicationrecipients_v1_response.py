...
class TestOtherincomeGetCommunicationrecipientsV1Response(unittest.TestCase):
    """OtherincomeGetCommunicationrecipientsV1Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OtherincomeGetCommunicationrecipientsV1Response:
        ...
        if include_optional:
            return OtherincomeGetCommunicationrecipientsV1Response(
                m_payload = eZmaxApi.models.otherincome_get_communicationrecipients_v1_response_m_payload.otherincome-getCommunicationrecipients-v1-Response-mPayload(
    ...
    def testOtherincomeGetCommunicationrecipientsV1Response(self):
        """Test OtherincomeGetCommunicationrecipientsV1Response"""
