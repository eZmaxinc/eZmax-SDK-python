...
class TestEzsigndiscussionResponse(unittest.TestCase):
    """EzsigndiscussionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EzsigndiscussionResponse:
    ...
    def testEzsigndiscussionResponse(self):
        """Test EzsigndiscussionResponse"""
