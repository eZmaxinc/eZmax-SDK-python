...
class TestEzsignsigningreasonResponse(unittest.TestCase):
    """EzsignsigningreasonResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EzsignsigningreasonResponse:
    ...
    def testEzsignsigningreasonResponse(self):
        """Test EzsignsigningreasonResponse"""
