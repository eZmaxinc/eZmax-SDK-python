...
class TestWebsiteResponse(unittest.TestCase):
    """WebsiteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebsiteResponse:
