...
class TestUsergroupGetListV1Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UsergroupGetListV1Response:
        ...
        if include_optional:
            return UsergroupGetListV1Response(
                ...
                m_payload = eZmaxApi.models.usergroup_get_list_v1_response_m_payload.usergroup-getList-v1-Response-mPayload()
            )
        else:
            return UsergroupGetListV1Response(
                obj_debug_payload = eZmaxApi.models.common_response_obj_debug_payload_get_list.Common-Response-objDebugPayload_getList(),
    ...
    def testUsergroupGetListV1Response(self):
        """Test UsergroupGetListV1Response"""
