...
class TestEzsignsigningreasonRequest(unittest.TestCase):
    """EzsignsigningreasonRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EzsignsigningreasonRequest:
    ...
    def testEzsignsigningreasonRequest(self):
        """Test EzsignsigningreasonRequest"""
