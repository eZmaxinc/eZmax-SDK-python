...
class TestInscriptiontempGetCommunicationCountV1ResponseMPayload(unittest.TestCase):
    """InscriptiontempGetCommunicationCountV1ResponseMPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InscriptiontempGetCommunicationCountV1ResponseMPayload:
        ...
        if include_optional:
            return InscriptiontempGetCommunicationCountV1ResponseMPayload(
    ...
    def testInscriptiontempGetCommunicationCountV1ResponseMPayload(self):
        """Test InscriptiontempGetCommunicationCountV1ResponseMPayload"""
