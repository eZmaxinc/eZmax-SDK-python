...
class TestCreditcardmerchantListElement(unittest.TestCase):
    """CreditcardmerchantListElement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreditcardmerchantListElement:
    ...
    def testCreditcardmerchantListElement(self):
        """Test CreditcardmerchantListElement"""
