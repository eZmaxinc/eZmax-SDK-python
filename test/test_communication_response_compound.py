...
from eZmaxApi.models.communication_response_compound import CommunicationResponseCompound  # noqa: E501

class TestCommunicationResponseCompound(unittest.TestCase):
    """CommunicationResponseCompound unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommunicationResponseCompound:
        ...
        # uncomment below to create an instance of `CommunicationResponseCompound`
        """
        model = CommunicationResponseCompound()  # noqa: E501
        if include_optional:
            return CommunicationResponseCompound(
                ...
                a_obj_communicationattachment = [
                    eZmaxApi.models.communicationattachment_response_compound.communicationattachment-ResponseCompound()
                    ],
                a_obj_communicationrecipient = [
                    eZmaxApi.models.communicationrecipient_response_compound.communicationrecipient-ResponseCompound()
                    ],
                a_obj_communicationexternalrecipient = [
                    eZmaxApi.models.communicationexternalrecipient_response_compound.communicationexternalrecipient-ResponseCompound()
                    ]
            )
        else:
            return CommunicationResponseCompound(
    ...
    def testCommunicationResponseCompound(self):
        """Test CommunicationResponseCompound"""
