...
from eZmaxApi.models.inscriptiontemp_get_communication_list_v1_response import InscriptiontempGetCommunicationListV1Response  # noqa: E501
...
class TestInscriptiontempGetCommunicationListV1Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InscriptiontempGetCommunicationListV1Response:
        ...
        """
        model = InscriptiontempGetCommunicationListV1Response()  # noqa: E501
        if include_optional:
