...
class TestModulegroupGetAllV1Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ModulegroupGetAllV1Response:
        ...
        if include_optional:
            return ModulegroupGetAllV1Response(
                ...
                m_payload = eZmaxApi.models.modulegroup_get_all_v1_response_m_payload.modulegroup-getAll-v1-Response-mPayload(
                    a_obj_modulegroup = [
    ...
    def testModulegroupGetAllV1Response(self):
        """Test ModulegroupGetAllV1Response"""
