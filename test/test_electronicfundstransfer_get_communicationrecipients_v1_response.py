...
class TestElectronicfundstransferGetCommunicationrecipientsV1Response(unittest.TestCase):
    """ElectronicfundstransferGetCommunicationrecipientsV1Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ElectronicfundstransferGetCommunicationrecipientsV1Response:
        ...
        if include_optional:
            return ElectronicfundstransferGetCommunicationrecipientsV1Response(
                m_payload = eZmaxApi.models.electronicfundstransfer_get_communicationrecipients_v1_response_m_payload.electronicfundstransfer-getCommunicationrecipients-v1-Response-mPayload(
    ...
    def testElectronicfundstransferGetCommunicationrecipientsV1Response(self):
        """Test ElectronicfundstransferGetCommunicationrecipientsV1Response"""
