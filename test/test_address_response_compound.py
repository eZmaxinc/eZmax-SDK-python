...
class TestAddressResponseCompound(unittest.TestCase):
    """AddressResponseCompound unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddressResponseCompound:
        ...
        if include_optional:
            return AddressResponseCompound(
                pki_address_id = 142,
    ...
    def testAddressResponseCompound(self):
        """Test AddressResponseCompound"""
