...
class TestEzsignannotationRequest(unittest.TestCase):
    """EzsignannotationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EzsignannotationRequest:
        ...
        if include_optional:
            return EzsignannotationRequest(
    ...
    def testEzsignannotationRequest(self):
        """Test EzsignannotationRequest"""
