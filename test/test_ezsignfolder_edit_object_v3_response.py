...
class TestEzsignfolderEditObjectV3Response(unittest.TestCase):
    """EzsignfolderEditObjectV3Response unit test stubs"""
    ...
    def testEzsignfolderEditObjectV3Response(self):
        """Test EzsignfolderEditObjectV3Response"""
