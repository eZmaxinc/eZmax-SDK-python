...
class TestCustomEzsigndocumentEzsignsignaturesAutomaticResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CustomEzsigndocumentEzsignsignaturesAutomaticResponse:
    ...
    def testCustomEzsigndocumentEzsignsignaturesAutomaticResponse(self):
        """Test CustomEzsigndocumentEzsignsignaturesAutomaticResponse"""
