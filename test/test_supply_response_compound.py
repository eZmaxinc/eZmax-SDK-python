...
class TestSupplyResponseCompound(unittest.TestCase):
    """SupplyResponseCompound unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupplyResponseCompound:
    ...
    def testSupplyResponseCompound(self):
        """Test SupplyResponseCompound"""
