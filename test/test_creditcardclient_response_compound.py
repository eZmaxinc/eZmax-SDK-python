...
class TestCreditcardclientResponseCompound(unittest.TestCase):
    """CreditcardclientResponseCompound unit test stubs"""
    ...
    def testCreditcardclientResponseCompound(self):
        """Test CreditcardclientResponseCompound"""
