...
class TestInscriptionGetCommunicationrecipientsV1Response(unittest.TestCase):
    """InscriptionGetCommunicationrecipientsV1Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InscriptionGetCommunicationrecipientsV1Response:
        ...
        if include_optional:
            return InscriptionGetCommunicationrecipientsV1Response(
                m_payload = eZmaxApi.models.inscription_get_communicationrecipients_v1_response_m_payload.inscription-getCommunicationrecipients-v1-Response-mPayload(
    ...
    def testInscriptionGetCommunicationrecipientsV1Response(self):
        """Test InscriptionGetCommunicationrecipientsV1Response"""
