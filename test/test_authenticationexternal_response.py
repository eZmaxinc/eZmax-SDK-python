...
class TestAuthenticationexternalResponse(unittest.TestCase):
    """AuthenticationexternalResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthenticationexternalResponse:
    ...
    def testAuthenticationexternalResponse(self):
        """Test AuthenticationexternalResponse"""
