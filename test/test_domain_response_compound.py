...
class TestDomainResponseCompound(unittest.TestCase):
    """DomainResponseCompound unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DomainResponseCompound:
    ...
    def testDomainResponseCompound(self):
        """Test DomainResponseCompound"""
