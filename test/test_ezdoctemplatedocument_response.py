...
class TestEzdoctemplatedocumentResponse(unittest.TestCase):
    """EzdoctemplatedocumentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EzdoctemplatedocumentResponse:
    ...
    def testEzdoctemplatedocumentResponse(self):
        """Test EzdoctemplatedocumentResponse"""
