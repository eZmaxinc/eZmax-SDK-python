...
class TestCreditcardmerchantRequest(unittest.TestCase):
    """CreditcardmerchantRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreditcardmerchantRequest:
    ...
    def testCreditcardmerchantRequest(self):
        """Test CreditcardmerchantRequest"""
