...
class TestDiscussionmembershipRequest(unittest.TestCase):
    """DiscussionmembershipRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DiscussionmembershipRequest:
    ...
    def testDiscussionmembershipRequest(self):
        """Test DiscussionmembershipRequest"""
