...
class TestClonehistoryGetListV1Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ClonehistoryGetListV1Response:
        ...
        if include_optional:
            return ClonehistoryGetListV1Response(
                ...
                m_payload = eZmaxApi.models.clonehistory_get_list_v1_response_m_payload.clonehistory-getList-v1-Response-mPayload()
            )
        else:
            return ClonehistoryGetListV1Response(
                obj_debug_payload = eZmaxApi.models.common_response_obj_debug_payload_get_list.Common-Response-objDebugPayload_getList(),
    ...
    def testClonehistoryGetListV1Response(self):
        """Test ClonehistoryGetListV1Response"""
