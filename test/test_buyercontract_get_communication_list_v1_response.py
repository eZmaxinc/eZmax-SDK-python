...
class TestBuyercontractGetCommunicationListV1Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BuyercontractGetCommunicationListV1Response:
        ...
        if include_optional:
            return BuyercontractGetCommunicationListV1Response(
                ...
                m_payload = eZmaxApi.models.buyercontract_get_communication_list_v1_response_m_payload.buyercontract-getCommunicationList-v1-Response-mPayload()
            )
        else:
            return BuyercontractGetCommunicationListV1Response(
                obj_debug_payload = eZmaxApi.models.common_response_obj_debug_payload_get_list.Common-Response-objDebugPayload_getList(),
    ...
    def testBuyercontractGetCommunicationListV1Response(self):
        """Test BuyercontractGetCommunicationListV1Response"""
