...
class TestInscriptiontempGetCommunicationrecipientsV1Response(unittest.TestCase):
    """InscriptiontempGetCommunicationrecipientsV1Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InscriptiontempGetCommunicationrecipientsV1Response:
        ...
        if include_optional:
            return InscriptiontempGetCommunicationrecipientsV1Response(
                m_payload = eZmaxApi.models.inscriptiontemp_get_communicationrecipients_v1_response_m_payload.inscriptiontemp-getCommunicationrecipients-v1-Response-mPayload(
    ...
    def testInscriptiontempGetCommunicationrecipientsV1Response(self):
        """Test InscriptiontempGetCommunicationrecipientsV1Response"""
