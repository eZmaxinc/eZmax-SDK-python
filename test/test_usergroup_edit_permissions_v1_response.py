...
from eZmaxApi.models.usergroup_edit_permissions_v1_response import UsergroupEditPermissionsV1Response  # noqa: E501
...
class TestUsergroupEditPermissionsV1Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UsergroupEditPermissionsV1Response:
        ...
        """
        model = UsergroupEditPermissionsV1Response()  # noqa: E501
        if include_optional:
