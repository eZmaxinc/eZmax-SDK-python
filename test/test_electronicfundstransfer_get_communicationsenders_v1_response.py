...
class TestElectronicfundstransferGetCommunicationsendersV1Response(unittest.TestCase):
    """ElectronicfundstransferGetCommunicationsendersV1Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ElectronicfundstransferGetCommunicationsendersV1Response:
        ...
        if include_optional:
            return ElectronicfundstransferGetCommunicationsendersV1Response(
                m_payload = eZmaxApi.models.electronicfundstransfer_get_communicationsenders_v1_response_m_payload.electronicfundstransfer-getCommunicationsenders-v1-Response-mPayload(
    ...
    def testElectronicfundstransferGetCommunicationsendersV1Response(self):
        """Test ElectronicfundstransferGetCommunicationsendersV1Response"""
