...
class TestEzsigntemplatepublicGetFormsDataV1Response(unittest.TestCase):
    """EzsigntemplatepublicGetFormsDataV1Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EzsigntemplatepublicGetFormsDataV1Response:
        ...
        if include_optional:
            return EzsigntemplatepublicGetFormsDataV1Response(
                m_payload = eZmaxApi.models.ezsigntemplatepublic_get_forms_data_v1_response_m_payload.ezsigntemplatepublic-getFormsData-v1-Response-mPayload(
    ...
    def testEzsigntemplatepublicGetFormsDataV1Response(self):
        """Test EzsigntemplatepublicGetFormsDataV1Response"""
